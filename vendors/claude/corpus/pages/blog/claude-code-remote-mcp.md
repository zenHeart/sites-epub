...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/swiper@11/swiper-bundle.min.css" /><meta property="og:image:alt" content="Remote MCP support in Claude Code | Claude by Anthropic" />
<meta property="og:url" content="https://claude.com/blog/claude-code-remote-mcp" />
...
<script type="application/ld+json">
{
  ...
  "@type": "BlogPosting",
  "headline": "Remote MCP support in Claude Code",
  "description": "Connect your favorite development tools and data sources securely to Claude Code through remote MCP servers. Today, we’re announcing support for remote MCP servers in Claude Code.",
  ...
  "mainEntityOfPage": {
    "@type": "WebPage",
    "@id": "https://claude.com/blog/claude-code-remote-mcp"
  }
}
</script>
