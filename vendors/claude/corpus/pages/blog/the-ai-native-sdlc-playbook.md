...
<style>
  ...
  .w-richtext .sd-vs .sd-old {
    background: #f1efe8;
    color: #3b3a36;
  }
  .w-richtext .sd-vs .sd-new {
    background: #f3e3dc;
    color: #3b3a36;
  }
  .w-richtext .sd-vs .sd-new small {
    color: #b4553a;
  }
  .w-richtext .sd-vs a {
    color: #141413;
  }
  .w-richtext .sd-vs code,
  .w-richtext .sd-kv code,
  .w-richtext .sd-tbl code,
  .w-richtext .sd-side code {
  ...
  .w-richtext .sd-tbl table {
    width: 100%;
    border-collapse: collapse;
    font-size: 14px;
    line-height: 1.45;
  }
  .w-richtext .sd-tbl th {
    background: #141413;
    color: #faf9f5;
    text-align: left;
    padding: 10px 12px;
  ...
  .w-richtext .sd-tbl th:first-child {
    border-radius: 8px 0 0 0;
  }
  .w-richtext .sd-tbl th:last-child {
    border-radius: 0 8px 0 0;
  }
  .w-richtext .sd-tbl td {
    padding: 12px;
    border-bottom: 1px solid color-mix(in srgb, currentColor 18%, transparent);
    vertical-align: top;
    color: inherit;
  }
  .w-richtext .sd-tbl td:first-child {
    font-weight: 600;
    white-space: nowrap;
  }
  .w-richtext .sd-tbl td:last-child {
    background: #fbf1ec;
    color: #3b3a36;
  }
  .w-richtext .sd-tbl a {
  ...
  .w-richtext .sd-side i {
    font-style: normal;
    font-size: 12.5px;
    color: #b0aea5;
    display: block;
  }
  .w-richtext .sd-side div div {
    color: #e8e6dc;
  }
  .w-richtext .sd-side b {
    color: #faf9f5;
    font-weight: 600;
  }
  .w-richtext .sd-side a {
    color: #faf9f5;
  }
  .w-richtext .sd-side code {
    background: rgba(250, 249, 245, 0.14);
  }
  .w-richtext .sd-side pre {
    margin: 0;
    padding: 14px 16px;
    background: #000;
    border-radius: 8px;
  ...
  @media (max-width: 560px) {
    ...
    .w-richtext .sd-tbl table,
    .w-richtext .sd-tbl tbody,
    .w-richtext .sd-tbl tr,
    .w-richtext .sd-tbl td {
      display: block;
    }
    .w-richtext .sd-tbl thead {
      display: none;
    }
    .w-richtext .sd-tbl tr {
      border: 1px solid color-mix(in srgb, currentColor 18%, transparent);
