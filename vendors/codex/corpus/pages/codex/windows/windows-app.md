...
</style><!-- Canonical URL --><link rel="canonical" href="https://learn.chatgpt.com/docs/windows/windows-app"><!-- Primary Meta Tags --><title data-default-meta-title="ChatGPT desktop app for Windows – Codex | OpenAI Developers" data-site-variant-meta-titles="{&#34;chatgpt-docs&#34;:&#34;ChatGPT desktop app for Windows | ChatGPT Learn&#34;}">
  ChatGPT desktop app for Windows | ChatGPT Learn
</title><meta name="title" content="ChatGPT desktop app for Windows | ChatGPT Learn"><meta name="description" content="Use the ChatGPT desktop app on Windows with native sandbox and PowerShell support"><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url" content="https://learn.chatgpt.com/docs/windows/windows-app"><meta property="og:site_name" content="ChatGPT Learn"><meta property="og:title" content="ChatGPT desktop app for Windows | ChatGPT Learn"><meta property="og:description" content="Use the ChatGPT desktop app on Windows with native sandbox and PowerShell support"><meta property="og:image" content="https://learn.chatgpt.com/og/docs/windows/windows-app.png"><meta property="og:image:alt" content="ChatGPT desktop app for Windows | ChatGPT Learn"><meta property="og:image:type" content="image/png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><!-- Twitter --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:site" content="@ChatGPTapp"><meta name="twitter:url" content="https://learn.chatgpt.com/docs/windows/windows-app"><meta name="twitter:title" content="ChatGPT desktop app for Windows | ChatGPT Learn"><meta name="twitter:description" content="Use the ChatGPT desktop app on Windows with native sandbox and PowerShell support"><meta name="twitter:image" content="https://learn.chatgpt.com/og/docs/windows/windows-app.png"><meta name="twitter:image:width" content="1200"><meta name="twitter:image:height" content="630"><meta name="twitter:image:alt" content="ChatGPT desktop app for Windows | ChatGPT Learn"><!-- Sitemap --><link rel="sitemap" href="/sitemap-index.xml"><!-- RSS Feed --><link rel="alternate" type="application/rss+xml" title="ChatGPT desktop app for Windows | ChatGPT Learn" data-page-meta-title href="https://developers.openai.com/rss.xml"><!-- Global Scripts --><script src="/js/theme.js"></script><script src="/js/scroll.js"></script><script src="/js/animate.js"></script><script defer src="/js/copy.js"></script><script type="module" src="/_astro/BaseHead.astro_astro_type_script_index_0_lang.DksHusRH.js"></script><meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback" content="swap"><script type="module" src="/_astro/ClientRouter.astro_astro_type_script_index_0_lang.BYUM-eHF.js"></script><link rel="stylesheet" href="/_astro/PageLayout.le5dKQy-.css">
...
<h2 id="__codexlocalizedvalueprops__codextranslations-u0006-download-the-chatgpt-desktop-app">Download the ChatGPT desktop app</h2>
<p>Download the <a href="https://get.microsoft.com/installer/download/9PLM9XGG6VKS?cid=website_cta_psi">ChatGPT desktop app</a> for Windows.</p>
<p>Then follow the <a href="/codex/quickstart?setup=app">quickstart</a> to get started.</p>
<p>For enterprise installation and update options, see
<a href="/codex/enterprise/windows-deployment">Deploy the Windows app</a>.</p>
<p>If you prefer a command-line install path, run:</p>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="powershell"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id 9PLM9XGG6VKS </span><span style="color:#D73A49;--shiki-dark:#F97583">-</span><span style="color:#24292E;--shiki-dark:#E1E4E8">s msstore</span></span></code></pre>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0011-native-sandbox">Native sandbox</h2>
<p>The ChatGPT desktop app on Windows supports a native <a href="/codex/windows/windows-sandbox#windows-sandbox">Windows sandbox</a> when the agent runs in PowerShell, and uses Linux sandboxing when you run the agent in <a href="#windows-subsystem-for-linux-wsl">Windows Subsystem for Linux 2 (WSL2)</a>. To apply sandbox protections in either mode, select <strong>Ask for approval</strong> beneath the composer before sending messages to Codex.</p>
<div class="not-prose [&amp;_a]:underline border-default border border-solid rounded-lg p-2 py-4 pl-5 mt-4 first:mt-0 mb-4 text-sm"><div class="flex items-center gap-4"><div class="text-default"><svg viewBox="0 0 20 20" fill="currentColor" xmlns="http://www.w3.org/2000/svg" class="w-4 h-4 "><path d="M11 10C11 9.44771 10.5523 9 10 9C9.44771 9 9 9.44771 9 10V14C9 14.5523 9.44771 15 10 15C10.5523 15 11 14.5523 11 14V10Z"></path><path d="M10 0C4.47715 0 0 4.47715 0 10C0 15.5228 4.47715 20 10 20C15.5228 20 20 15.5228 20 10C20 4.47715 15.5228 0 10 0ZM2 10C2 5.58172 5.58172 2 10 2C14.4183 2 18 5.58172 18 10C18 14.4183 14.4183 18 10 18C5.58172 18 2 14.4183 2 10Z"></path><path d="M10 7.30005C10.6351 7.30005 11.15 6.78518 11.15 6.15005C11.15 5.51492 10.6351 5.00005 10 5.00005C9.36487 5.00005 8.85 5.51492 8.85 6.15005C8.85 6.78518 9.36487 7.30005 10 7.30005Z"></path></svg></div><div class="text-default not-prose "><p>Running Codex in full access mode means Codex is not limited to your project
...
<a href="/codex/agent-configuration/rules">rules</a> for targeted exceptions, or set your
<a href="/codex/agent-approvals-security#run-without-approval-prompts">approval policy to
  never</a> to have
  Codex attempt to solve problems without asking for escalated permissions,
  based on your <a href="/codex/agent-approvals-security">approval and security setup</a>.</p></div></div></div>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0014-customize-for-your-dev-setup">Customize for your dev setup</h2>
<section class="feature-grid"><div><h3 id="__codexlocalizedvalueprops__codextranslations-u0015-preferred-editor">Preferred editor</h3><p>Choose a default app for <strong>Open</strong>, such as Visual Studio, VS Code, or another
editor. You can override that choice per project. If you already picked a
different app from the <strong>Open</strong> menu for a project, that project-specific
choice takes precedence.</p></div><div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexSettingsDetailIllustration:windows-open-in" data-documentation-screenshot-inline-max-width="784px" style="--documentation-screenshot-light-source-width: 784px; --documentation-screenshot-dark-source-width: 786px; --documentation-screenshot-light-aspect-ratio: 784 / 441; --documentation-screenshot-dark-aspect-ratio: 786 / 443; --documentation-screenshot-light-height-width-limit: calc(520px * 784 / 441); --documentation-screenshot-dark-height-width-limit: calc(520px * 786 / 443); --documentation-screenshot-max-height: 520px; --documentation-screenshot-max-width: 784px;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="ChatGPT desktop app settings showing the default Open In app on Windows"> <figure aria-label="ChatGPT desktop app settings showing the default Open In app on Windows" data-markdown-description="ChatGPT desktop app settings showing the default Open In app on Windows" data-markdown-export="illustration" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:784px;--documentation-light-canvas-aspect-ratio:784 / 441;--documentation-dark-canvas-width:786px;--documentation-dark-canvas-aspect-ratio:786 / 443"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center" data-documentation-canvas="true" data-documentation-canvas-width="784" data-documentation-dark-canvas-width="786"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] text-[1.02cqw] leading-[1.44] tracking-[-0.008em] antialiased" data-documentation-typography-scope="illustration"><div class="bg-white text-[#202020] ring-black/[0.045] dark:text-[#ececec] dark:ring-white/[0.075] relative flex h-[77.32%] w-[25.26%] flex-col rounded-[0.95cqw] px-[1.75cqw] pt-[1.65cqw] pb-[2.2cqw] text-[1.48cqw] leading-[1.2] dark:bg-[#181818] shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] ring-0 dark:shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] dark:ring-0" data-documentation-floating-surface="true" data-documentation-surface-name="windows-open-in"><div class="mb-[0.58cqw] h-[3.4cqw] shrink-0"><span class="absolute top-[14px] left-[59px] flex h-[28px] items-center gap-[15px] dark:top-[18px]" data-documentation-windows-open-toolbar="true"><span class="size-[18px] -translate-y-px bg-[#0d0d0d]/50 [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain] dark:bg-white/50" data-documentation-app-icon="play-outline" style="mask-image:url(&quot;/images/codex/icons/app-play-outline.svg&quot;)"></span><span class="inline-flex h-[28px] w-[92px] items-center overflow-hidden rounded-[10px] bg-white bg-[linear-gradient(90deg,#ffffff_0%,#ffffff_76%,#e7e7e7_76%)] bg-center bg-no-repeat text-[13px] leading-[18px] ring-1 ring-[#0d0d0d]/[0.08] ring-inset [background-size:100%_25px] supports-[corner-shape:superellipse(1.5)]:rounded-[12.5px] supports-[corner-shape:superellipse(1.5)]:[corner-shape:superellipse(1.5)] dark:bg-[#181818] dark:bg-[linear-gradient(90deg,#181818_0%,#181818_76%,#242424_76%)] dark:ring-white/[0.08]" data-documentation-windows-open-control="true"><span class="flex min-w-0 flex-1 items-center gap-[6px] pl-[9px]"><img alt="" class="size-[18px] shrink-0" data-documentation-windows-open-icon="visual-studio" src="/images/codex/icons/visual-studio.svg"/>Open</span><span class="flex h-[25px] w-[22px] shrink-0 items-center justify-center" data-documentation-windows-open-split="true"><img alt="" class="size-[14px] opacity-50 dark:invert" data-documentation-windows-open-chevron="true" src="/images/codex/icons/chevron.svg"/></span></span></span></div><div class="overflow-hidden border-transparent bg-white/90 shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] ring-[0.5px] ring-[#0d0d0d]/[0.08] backdrop-blur-[8px] dark:border-transparent dark:bg-[#282828]/90 dark:shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] dark:ring-white/[0.08] absolute top-[42px] left-[15px] flex w-[168px] shrink-0 flex-col gap-[2px] rounded-[12px] border-0 p-0 px-[4px] pt-[8px] pb-[4px] tracking-[0px] [font-family:Segoe_UI,Tahoma,Arial,sans-serif] dark:top-[46px]" data-documentation-menu="true" data-documentation-menu-profile="windows-open-in" data-documentation-source-stroke="windows-popup"><div class="shrink-0 px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d]/50 dark:text-white/50" data-documentation-menu-title="true">Open in</div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="vscode" src="/images/codex/icons/vscode-windows.svg"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">VS Code</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="visual-studio" src="/images/codex/icons/visual-studio.svg"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Visual Studio</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="sublime" src="/images/codex/icons/sublime-text.webp"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Sublime Text</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="github-desktop" src="/images/codex/icons/github-desktop-windows.webp"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">GitHub Desktop</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="explorer" src="/images/codex/icons/file-explorer-windows.svg"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">File Explorer</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><span class="size-[18px] min-h-0 min-w-0 shrink-0 bg-[conic-gradient(from_-45deg,#ed9092_0deg_90deg,#98d073_90deg_180deg,#fbe597_180deg_270deg,#84b4f9_270deg_360deg)] [mask-position:center] [mask-repeat:no-repeat] [mask-size:114.2857142857%]" data-documentation-windows-app="git-bash" style="mask-image:url(&quot;/images/codex/icons/app-git-bash.svg&quot;);-webkit-mask-image:url(&quot;/images/codex/icons/app-git-bash.svg&quot;)"></span><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Git Bash</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="cmder" src="/images/codex/icons/cmder.webp"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Cmder</span></span></div><div class="flex min-w-0 items-center h-[28px] min-h-0 shrink-0 gap-[6px] rounded-[6px] px-[8px] py-[5px] text-[12px] leading-[1.4285714286] font-normal tracking-[0px] text-[#0d0d0d] dark:text-[#ffffff]" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 object-contain" data-documentation-windows-app="rider" src="/images/codex/icons/rider.webp"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Rider</span></span></div></div></div></div></div></div></figure> </div> </div> </div> </div> </div>  <style>
  [data-documentation-screenshot-presentation] {
    --documentation-screenshot-source-width: var(
      --documentation-screenshot-light-source-width
    );
...
<section class="feature-grid inverse"><div><h3 id="__codexlocalizedvalueprops__codextranslations-u0019-integrated-terminal">Integrated terminal</h3><p>You can also choose the default integrated terminal. Depending on what you have
installed, options include:</p><ul>
<li>PowerShell</li>
<li>Command Prompt</li>
<li>Git Bash</li>
<li>WSL</li>
</ul><p>This change applies only to new terminal sessions. If you already have an
integrated terminal open, restart the app or start a new chat before
expecting the new default terminal to appear.</p></div><div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexSettingsDetailIllustration:windows-shell" data-documentation-screenshot-inline-max-width="788px" style="--documentation-screenshot-light-source-width: 788px; --documentation-screenshot-dark-source-width: 787px; --documentation-screenshot-light-aspect-ratio: 788 / 444; --documentation-screenshot-dark-aspect-ratio: 787 / 442; --documentation-screenshot-light-height-width-limit: calc(520px * 788 / 444); --documentation-screenshot-dark-height-width-limit: calc(520px * 787 / 442); --documentation-screenshot-max-height: 520px; --documentation-screenshot-max-width: 788px;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="ChatGPT desktop app settings showing the integrated terminal selection on Windows"> <figure aria-label="ChatGPT desktop app settings showing the integrated terminal selection on Windows" data-markdown-description="ChatGPT desktop app settings showing the integrated terminal selection on Windows" data-markdown-export="illustration" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:788px;--documentation-light-canvas-aspect-ratio:788 / 444;--documentation-dark-canvas-width:787px;--documentation-dark-canvas-aspect-ratio:787 / 442"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center" data-documentation-canvas="true" data-documentation-canvas-width="788" data-documentation-dark-canvas-width="787"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] text-[1.02cqw] leading-[1.44] tracking-[-0.008em] antialiased" data-documentation-typography-scope="illustration"><div class="text-[#202020] ring-black/[0.045] dark:text-[#ececec] dark:ring-white/[0.075] relative flex h-[46.2%] w-[87.25%] flex-col rounded-[0.9cqw] bg-[#fbfbfb] px-[2.55cqw] py-[0.42cqw] text-[1.52cqw] leading-[1.32] dark:bg-[#1f1f1f] shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] ring-0 dark:shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] dark:ring-0" data-documentation-floating-surface="true" data-documentation-rhythm-profile="windows-settings"><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] border-b border-black/[0.06] dark:border-white/[0.08] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Integrated terminal shell</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Choose which shell opens in the integrated terminal.</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-active h-[28px] w-[240px] translate-y-[3px] bg-[#e2e2e2] py-0 dark:bg-[#363636]" data-documentation-setting-value="true"><span class="truncate">PowerShell</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] border-b border-black/[0.06] dark:border-white/[0.08] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Language</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Language for the app UI</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-inactive h-[28px] w-[240px] translate-y-[3px] bg-[#efefef] py-0 dark:bg-[#2a2a2a]" data-documentation-setting-value="true"><span class="truncate">English</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Thread detail</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Choose how much command output to show in threads</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-inactive h-[28px] w-[240px] translate-y-[3px] bg-[#efefef] py-0 dark:bg-[#2a2a2a]" data-documentation-setting-value="true"><span class="truncate">Standard</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="overflow-hidden border absolute top-[26.7%] right-[2.6%] rounded-[1.35cqw] p-[0.54cqw] w-[34%] border-transparent bg-white/90 shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] ring-[0.5px] ring-[#0d0d0d]/[0.08] backdrop-blur-[8px] dark:border-transparent dark:bg-[#282828]/90 dark:shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] dark:ring-white/[0.08]" data-documentation-menu="true" data-documentation-source-stroke="windows-popup"><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.78cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">PowerShell</span></span><span class="min-h-0 min-w-0 shrink-0 size-[14px] bg-current [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain]" data-documentation-selection-check="powershell" style="mask-image:url(/images/codex/icons/app-check-md.svg)"></span></div><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.78cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Command Prompt</span></span></div><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.78cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Git Bash</span></span></div><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.78cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">WSL</span></span></div></div></div></div></div></div></figure> </div> </div> </div> </div> </div> <script type="module" src="/_astro/CodexScreenshotPresentation.astro_astro_type_script_index_0_lang.DDyaJJf-.js"></script> <style>
  [data-documentation-screenshot-presentation] {
    --documentation-screenshot-source-width: var(
      --documentation-screenshot-light-source-width
    );
...
<h2 id="__codexlocalizedvalueprops__codextranslations-u0028-windows-subsystem-for-linux-wsl">Windows Subsystem for Linux (WSL)</h2>
<p>By default, the ChatGPT desktop app uses the Windows-native Codex agent. That means the agent
runs commands in PowerShell. The app can still work with projects that live in
Windows Subsystem for Linux 2 (WSL2) by using the <code>wsl</code> CLI when needed.</p>
<p>If you want to add a project from the WSL filesystem, click <strong>Add new project</strong>
or press <kbd>Ctrl</kbd>+<kbd>O</kbd>, then type <code>\\wsl$\</code> into the File
Explorer window. From there, choose your Linux distribution and the folder you
want to open.</p>
<p>If you plan to keep using the Windows-native agent, prefer storing projects on
your Windows filesystem and accessing them from WSL through
<code>/mnt/&lt;drive&gt;/...</code>. This setup is more reliable than opening projects
directly from the WSL filesystem.</p>
<p>If you want the agent itself to run in WSL2, open <strong><a href="codex://settings">Settings</a></strong>,
switch the agent from Windows native to WSL, and <strong>restart the app</strong>. The
change doesn&#39;t take effect until you restart. Your projects should remain in
place after restart.</p>
<p>WSL1 was supported through Codex <code>0.114</code>. Starting in Codex <code>0.115</code>, the Linux
sandbox moved to <code>bubblewrap</code>, so WSL1 is no longer supported.</p>
<div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexSettingsDetailIllustration:windows-agent" data-documentation-screenshot-inline-max-width="786px" style="--documentation-screenshot-light-source-width: 786px; --documentation-screenshot-dark-source-width: 787px; --documentation-screenshot-light-aspect-ratio: 786 / 442; --documentation-screenshot-dark-aspect-ratio: 787 / 442; --documentation-screenshot-light-height-width-limit: calc(520px * 786 / 442); --documentation-screenshot-dark-height-width-limit: calc(520px * 787 / 442); --documentation-screenshot-max-height: 520px; --documentation-screenshot-max-width: 786px;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2 mb-8"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="ChatGPT desktop app settings showing the agent selector with Windows native and WSL options"> <figure aria-label="ChatGPT desktop app settings showing the agent selector with Windows native and WSL options" data-markdown-description="ChatGPT desktop app settings showing the agent selector with Windows native and WSL options" data-markdown-export="illustration" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:786px;--documentation-light-canvas-aspect-ratio:786 / 442;--documentation-dark-canvas-width:787px;--documentation-dark-canvas-aspect-ratio:787 / 442"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center" data-documentation-canvas="true" data-documentation-canvas-width="786" data-documentation-dark-canvas-width="787"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] text-[1.02cqw] leading-[1.44] tracking-[-0.008em] antialiased" data-documentation-typography-scope="illustration"><div class="text-[#202020] ring-black/[0.045] dark:text-[#ececec] dark:ring-white/[0.075] relative flex h-[46.2%] w-[87.25%] flex-col rounded-[0.9cqw] bg-[#fbfbfb] px-[2.55cqw] py-[0.42cqw] text-[1.52cqw] leading-[1.32] dark:bg-[#1f1f1f] shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] ring-0 dark:shadow-[0_5.25px_8.25px_-0.15px_rgba(0,0,0,0.19),0_17.4px_24.2px_3.65px_rgba(0,0,0,0.099)] dark:ring-0" data-documentation-floating-surface="true" data-documentation-rhythm-profile="windows-settings"><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] border-b border-black/[0.06] dark:border-white/[0.08] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Agent environment</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Choose where the agent runs on Windows</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-active h-[28px] w-[240px] translate-y-[3px] bg-[#e2e2e2] py-0 dark:bg-[#363636]" data-documentation-setting-value="true"><span class="truncate">Windows native</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] border-b border-black/[0.06] dark:border-white/[0.08] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Integrated terminal shell</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Choose which shell opens in the integrated terminal.</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-inactive h-[28px] w-[240px] translate-y-[3px] bg-[#efefef] py-0 dark:bg-[#2a2a2a]" data-documentation-setting-value="true"><span class="truncate">PowerShell</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center justify-between gap-[1.2cqw] min-h-0 flex-1 py-[0.92cqw]" data-documentation-setting-row="true"><span class="min-w-0 leading-[1.36]"><span class="block truncate font-medium tracking-[-0.005em]" data-documentation-setting-label="true">Language</span><span class="block text-[#777] dark:text-[#a5a5a5] mt-[0.66cqw] text-[1.3cqw] leading-[1.28]" data-documentation-setting-description="true">Language for the app UI</span></span><span class="flex min-w-0 shrink-0 items-center gap-[0.6cqw] justify-between rounded-[0.95cqw] px-[1cqw] text-[#333] dark:text-[#dedede] documentation-windows-picker-inactive h-[28px] w-[240px] translate-y-[3px] bg-[#efefef] py-0 dark:bg-[#2a2a2a]" data-documentation-setting-value="true"><span class="truncate">Auto Detect</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw] min-h-0 min-w-0 shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="overflow-hidden border absolute top-[26.7%] right-[2.6%] rounded-[1.35cqw] p-[0.54cqw] w-[48.5%] border-transparent bg-white/90 shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] ring-[0.5px] ring-[#0d0d0d]/[0.08] backdrop-blur-[8px] dark:border-transparent dark:bg-[#282828]/90 dark:shadow-[0_4px_8px_-2px_rgba(0,0,0,0.1)] dark:ring-white/[0.08]" data-documentation-menu="true" data-documentation-source-stroke="windows-popup"><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.92cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Windows native</span><span class="min-w-0 truncate text-[#898989] dark:text-[#aaa] mt-[0.16cqw] block text-[0.86em]">Run the agent directly in Windows</span></span></div><div class="flex min-w-0 items-center gap-[0.7cqw] rounded-[0.7cqw] px-[1.02cqw] text-[1.48cqw] leading-[1.28] py-[0.92cqw]" data-documentation-selection-row="true"><span class="min-w-0 flex-1"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Windows Subsystem for Linux</span><span class="min-w-0 truncate text-[#898989] dark:text-[#aaa] mt-[0.16cqw] block text-[0.86em]">Run the agent inside WSL</span></span></div></div></div></div></div></div></figure> </div> </div> </div> </div> </div>  <style>
  [data-documentation-screenshot-presentation] {
    --documentation-screenshot-source-width: var(
      --documentation-screenshot-light-source-width
    );
...
<p>You configure the integrated terminal independently from the agent. See
<a href="#customize-for-your-dev-setup">Customize for your dev setup</a> for the
terminal options. You can keep the agent in WSL and still use PowerShell in the
terminal, or use WSL for both, depending on your workflow.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0037-useful-developer-tools">Useful developer tools</h2>
<p>Codex works best when a few common developer tools are already installed:</p>
<ul>
<li><strong>Git</strong>: Powers the review panel in the ChatGPT desktop app and lets you inspect or
  revert changes.</li>
<li><strong>Node.js</strong>: A common tool that the agent uses to perform tasks more
  efficiently.</li>
<li><strong>Python</strong>: A common tool that the agent uses to perform tasks more
  efficiently.</li>
<li><strong>.NET SDK</strong>: Useful when you want to build native Windows apps.</li>
<li><strong>GitHub CLI</strong>: Powers GitHub-specific functionality in the ChatGPT desktop app.</li>
</ul>
<p>Install them with the default Windows package manager <code>winget</code> by pasting this
into the <a href="/codex/integrated-terminal">integrated terminal</a> or
asking Codex to install them:</p>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="powershell"><code><span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id Git.Git</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id OpenJS.NodeJS.LTS</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id Python.Python.</span><span style="color:#005CC5;--shiki-dark:#79B8FF">3.14</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id Microsoft.DotNet.SDK.</span><span style="color:#005CC5;--shiki-dark:#79B8FF">10</span></span>
<span class="line"><span style="color:#24292E;--shiki-dark:#E1E4E8">winget install </span><span style="color:#D73A49;--shiki-dark:#F97583">--</span><span style="color:#24292E;--shiki-dark:#E1E4E8">id GitHub.cli</span></span></code></pre>
<p>After installing GitHub CLI, run <code>gh auth login</code> to enable GitHub features in
the app.</p>
<p>If you need a different Python or .NET version, change the package IDs to the
version you want.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0047-troubleshooting-and-faq">Troubleshooting and FAQ</h2>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0048-run-commands-with-elevated-permissions">Run commands with elevated permissions</h3>
<p>If you need Codex to run commands with elevated permissions, start the ChatGPT
desktop app itself as an administrator. After installation, open the Start menu,
find the app, and choose <strong>Run as administrator</strong>. The Codex agent inherits that
permission level.</p>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0050-powershell-execution-policy-blocks-commands">PowerShell execution policy blocks commands</h3>
<p>If you have never used tools such as Node.js or <code>npm</code> in PowerShell before, the
Codex agent or integrated terminal may hit execution policy errors.</p>
<p>This can also happen if Codex creates PowerShell scripts for you. In that case,
you may need a less restrictive execution policy before PowerShell will run
them.</p>
<p>An error may look something like this:</p>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="text"><code><span class="line"><span>npm.ps1 cannot be loaded because running scripts is disabled on this system.</span></span></code></pre>
<p>A common fix is to set the execution policy to <code>RemoteSigned</code>:</p>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="powershell"><code><span class="line"><span style="color:#005CC5;--shiki-dark:#79B8FF">Set-ExecutionPolicy</span><span style="color:#D73A49;--shiki-dark:#F97583"> -</span><span style="color:#24292E;--shiki-dark:#E1E4E8">ExecutionPolicy RemoteSigned</span></span></code></pre>
<p>For details and other options, check Microsoft&#39;s
<a href="https://learn.microsoft.com/en-us/powershell/module/microsoft.powershell.core/about/about_execution_policies">execution policy guide</a>
before changing the policy.</p>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0056-local-environment-scripts-on-windows">Local environment scripts on Windows</h3>
<p>If your <a href="/codex/environments/local-environment">local environment</a> uses cross-platform
commands such as <code>npm</code> scripts, you can keep one shared setup script or
set of actions for every platform.</p>
<p>If you need Windows-specific behavior, create Windows-specific setup scripts or
Windows-specific actions.</p>
<p>Actions run in the environment used by your integrated terminal. See
<a href="#customize-for-your-dev-setup">Customize for your dev setup</a>.</p>
<p>Local setup scripts run in the agent environment: WSL if the agent uses WSL,
and PowerShell otherwise.</p>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0061-share-config-auth-and-sessions-with-wsl">Share config, auth, and sessions with WSL</h3>
<p>The Windows app uses the same Codex home directory as native Codex on Windows:
<code>%USERPROFILE%\.codex</code>.</p>
<p>If you also run the Codex CLI inside WSL, the CLI uses the Linux home
directory by default, so it doesn&#39;t automatically share configuration, cached
auth, or session history with the Windows app.</p>
<p>To share them, use one of these approaches:</p>
<ul>
<li>Sync WSL <code>~/.codex</code> with <code>%USERPROFILE%\.codex</code> on your file system.</li>
<li>Point WSL at the Windows Codex home directory by setting <code>CODEX_HOME</code>:</li>
</ul>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="bash"><code><span class="line"><span style="color:#D73A49;--shiki-dark:#F97583">export</span><span style="color:#24292E;--shiki-dark:#E1E4E8"> CODEX_HOME</span><span style="color:#D73A49;--shiki-dark:#F97583">=</span><span style="color:#24292E;--shiki-dark:#E1E4E8">/mnt/c/Users/</span><span style="color:#D73A49;--shiki-dark:#F97583">&lt;</span><span style="color:#24292E;--shiki-dark:#E1E4E8">windows-user</span><span style="color:#D73A49;--shiki-dark:#F97583">&gt;</span><span style="color:#24292E;--shiki-dark:#E1E4E8">/.codex</span></span></code></pre>
<p>If you want that setting in every shell, add it to your WSL shell profile, such
as <code>~/.bashrc</code> or <code>~/.zshrc</code>.</p>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0068-git-features-are-unavailable">Git features are unavailable</h3>
<p>If you don&#39;t have Git installed natively on Windows, the app can&#39;t use some
features. Install it with <code>winget install Git.Git</code> from PowerShell or <code>cmd.exe</code>.</p>
<h3 id="__codexrendertypedmessagevdom-translation-__codexhastranslationprops__codextranslations-u0070--props__codextranslationsu0070--git-isnt-detected-for-projects-opened-from-code_1-unit-idu0070encodingmdx-complete-messagesourcegit-isnt-detected-for-projects-opened-from-code_1rawgit-isnt-detected-for-projects-opened-from-wslplaceholderskeycode_1typeargumentnodetypeinlinecodeparentnullrawwslsemanticvaluewsl-factories--code_1--renderargument---__codexmdxelementpropscomponentscode--code--wsl---reconstruction-props__codexreconstruction-">Git isn&#39;t detected for projects opened from <code>\\wsl$</code></h3>
<p>For now, if you want to use the Windows-native agent with a project also
accessible from WSL, the most reliable workaround is to store the project
on the native Windows drive and access it in WSL through <code>/mnt/&lt;drive&gt;/...</code>.</p>
<h3 id="__codexrendertypedmessagevdom-translation-__codexhastranslationprops__codextranslations-u0072--props__codextranslationsu0072--code_1-isnt-listed-in-the-open-dialog-unit-idu0072encodingmdx-complete-messagesourcecode_1-isnt-listed-in-the-open-dialograwcmder-isnt-listed-in-the-open-dialogplaceholderskeycode_1typeargumentnodetypeinlinecodeparentnullrawcmdersemanticvaluecmder-factories--code_1--renderargument---__codexmdxelementpropscomponentscode--code--cmder---reconstruction-props__codexreconstruction-"><code>Cmder</code> isn&#39;t listed in the open dialog</h3>
<p>If <code>Cmder</code> is installed but doesn&#39;t show in Codex&#39;s open dialog, add it to the
Windows Start Menu: right-click <code>Cmder</code> and choose <strong>Add to Start</strong>, then
restart Codex or reboot.</p>  </article>  </div> </div> </div> <script>
