...
</style><!-- Canonical URL --><link rel="canonical" href="https://learn.chatgpt.com/docs/environments/local-environment"><!-- Primary Meta Tags --><title data-default-meta-title="Local environments – Codex | OpenAI Developers" data-site-variant-meta-titles="{&#34;chatgpt-docs&#34;:&#34;Local environments | ChatGPT Learn&#34;}">
  Local environments | ChatGPT Learn
</title><meta name="title" content="Local environments | ChatGPT Learn"><meta name="description" content="Configure common actions and setup scripts for worktrees"><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url" content="https://learn.chatgpt.com/docs/environments/local-environment"><meta property="og:site_name" content="ChatGPT Learn"><meta property="og:title" content="Local environments | ChatGPT Learn"><meta property="og:description" content="Configure common actions and setup scripts for worktrees"><meta property="og:image" content="https://learn.chatgpt.com/og/docs/environments/local-environment.png"><meta property="og:image:alt" content="Local environments | ChatGPT Learn"><meta property="og:image:type" content="image/png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><!-- Twitter --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:site" content="@ChatGPTapp"><meta name="twitter:url" content="https://learn.chatgpt.com/docs/environments/local-environment"><meta name="twitter:title" content="Local environments | ChatGPT Learn"><meta name="twitter:description" content="Configure common actions and setup scripts for worktrees"><meta name="twitter:image" content="https://learn.chatgpt.com/og/docs/environments/local-environment.png"><meta name="twitter:image:width" content="1200"><meta name="twitter:image:height" content="630"><meta name="twitter:image:alt" content="Local environments | ChatGPT Learn"><!-- Sitemap --><link rel="sitemap" href="/sitemap-index.xml"><!-- RSS Feed --><link rel="alternate" type="application/rss+xml" title="Local environments | ChatGPT Learn" data-page-meta-title href="https://developers.openai.com/rss.xml"><!-- Global Scripts --><script src="/js/theme.js"></script><script src="/js/scroll.js"></script><script src="/js/animate.js"></script><script defer src="/js/copy.js"></script><script type="module" src="/_astro/BaseHead.astro_astro_type_script_index_0_lang.DksHusRH.js"></script><meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback" content="swap"><script type="module" src="/_astro/ClientRouter.astro_astro_type_script_index_0_lang.BYUM-eHF.js"></script><link rel="stylesheet" href="/_astro/PageLayout.le5dKQy-.css">
...
<span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npm</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> run</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> build</span></span></code></pre>
<p>If your setup is platform-specific, define setup scripts for macOS, Windows, or Linux to override the default.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0012-actions" class="group flex items-center gap-2 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Actions</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0012-actions" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0012 actions" title="Copy link to __codexlocalizedvalueprops__codextranslations u0012 actions"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h2>
<section class="feature-grid"><div><p>Use actions to define common tasks like starting your app&#39;s development server or running your test suite. These actions appear in the ChatGPT desktop app top bar for quick access. The actions run within the app&#39;s <a href="/codex/integrated-terminal">integrated terminal</a>.</p><p>Actions are helpful to keep you from typing common actions like triggering a build for your project or starting a development server. For one-off quick debugging you can use the integrated terminal directly.</p></div><div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexComposerDetailIllustration:actions" style="--documentation-screenshot-light-source-width: 1090px; --documentation-screenshot-dark-source-width: 1098px; --documentation-screenshot-light-aspect-ratio: 1090 / 612; --documentation-screenshot-dark-aspect-ratio: 1098 / 618; --documentation-screenshot-light-height-width-limit: calc(400px * 1090 / 612); --documentation-screenshot-dark-height-width-limit: calc(400px * 1098 / 618); --documentation-screenshot-max-height: 400px; --documentation-screenshot-max-width: 100%;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2 mb-4 lg:mb-0"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="Project actions list shown in ChatGPT desktop app settings"> <figure aria-label="Project actions list shown in ChatGPT desktop app settings" data-markdown-description="Project actions list shown in ChatGPT desktop app settings" data-markdown-export="illustration" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:545px;--documentation-light-canvas-aspect-ratio:1090 / 612;--documentation-dark-canvas-width:549px;--documentation-dark-canvas-aspect-ratio:1098 / 618"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center" data-documentation-canvas="true" data-documentation-canvas-width="545" data-documentation-dark-canvas-width="549"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] text-[1.02cqw] leading-[1.44] tracking-[-0.008em] antialiased" data-documentation-typography-scope="illustration"><div class="bg-white text-[#202020] shadow-[0_0.55cqw_1.8cqw_rgba(21,25,31,0.07)] ring-1 ring-black/[0.045] dark:text-[#ececec] dark:shadow-[0_0.7cqw_2.15cqw_rgba(0,0,0,0.22)] dark:ring-white/[0.075] relative h-[67.3%] w-[68.1%] rounded-[1.3cqw] text-[2.4cqw] leading-[1.23] dark:bg-[#181818]" data-documentation-floating-surface="true" data-documentation-rhythm-profile="actions-menu"><div class="absolute top-[7.9%] right-[16px] flex items-center gap-[7px]"><span class="flex h-[28px] items-center overflow-hidden rounded-[10px] border border-black/[0.1] dark:border-white/[0.12]"><img alt="" class="mx-[7px] size-[18px] shrink-0 dark:invert" data-documentation-action-icon="header-run" data-documentation-app-icon="play-outline" src="/images/codex/icons/app-play-outline.svg"/><span class="flex h-full w-[21px] items-center justify-center border-l border-black/[0.09] dark:border-white/[0.1]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[16px]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></span><span class="flex h-[28px] items-center gap-[6px] rounded-[10px] border border-black/[0.1] px-[10px] dark:border-white/[0.11]"><img alt="" class="size-[16px] shrink-0" src="/images/codex/icons/vscode.webp"/>Open<svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[12px]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><div class="overflow-hidden border-black/[0.09] bg-white p-[0.65cqw] dark:border-white/[0.12] dark:shadow-[0_12px_38px_rgba(0,0,0,0.35)] absolute top-[22%] left-[20%] w-[48.8%] rounded-[1.85cqw] border-0 px-[7px] pt-[7px] pb-[0.7cqw] shadow-[0_9px_22px_rgba(0,0,0,0.11)] ring-[0.5px] ring-black/[0.085] dark:bg-[#262626] dark:ring-white/[0.1]" data-documentation-menu="true" data-documentation-source-stroke="actions-popup"><div class="text-[#777] dark:text-[#aaa] flex h-[5.2cqw] items-center whitespace-nowrap px-[5px] py-0 text-[12px] leading-[1.16]" data-documentation-menu-title="true">developers-website actions</div><div class="flex min-w-0 items-center rounded-[0.7cqw] h-[5.5cqw] min-h-0 gap-[1.05cqw] px-[5px] py-0 text-[2.16cqw] leading-[1.16] [&amp;_svg]:min-h-0 [&amp;_svg]:min-w-0" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 dark:invert" data-documentation-action-icon="run" data-documentation-app-icon="play-outline" src="/images/codex/icons/app-play-outline.svg"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Run</span></span><span class="min-h-0 min-w-0 shrink-0 size-[14px] bg-current [mask-position:center] [mask-repeat:no-repeat] [mask-size:contain]" data-documentation-selection-check="run" style="mask-image:url(/images/codex/icons/app-check-md.svg)"></span></div><div class="flex min-w-0 items-center rounded-[0.7cqw] h-[5.5cqw] min-h-0 gap-[1.05cqw] px-[5px] py-0 text-[2.16cqw] leading-[1.16] [&amp;_svg]:min-h-0 [&amp;_svg]:min-w-0" data-documentation-selection-row="true"><span class="flex size-[18px] shrink-0 items-center justify-center"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[17px] min-h-0 min-w-0 shrink-0 dark:[&amp;_path]:fill-current" data-documentation-action-icon="build"><path d="M9.5 13.5C10.3284 13.5 11 12.9404 11 12.25C11 11.5596 10.3284 11 9.5 11C8.67157 11 8 11.5596 8 12.25C8 12.9404 8.67157 13.5 9.5 13.5Z" fill="currentColor"></path><path d="M13.5 16.5C13.5 17.6046 12.8284 18.5 12 18.5C11.1716 18.5 10.5 17.6046 10.5 16.5C10.5 15.3954 11.1716 14.5 12 14.5C12.8284 14.5 13.5 15.3954 13.5 16.5Z" fill="currentColor"></path><path d="M14.5 13.5C15.3284 13.5 16 12.9404 16 12.25C16 11.5596 15.3284 11 14.5 11C13.6716 11 13 11.5596 13 12.25C13 12.9404 13.6716 13.5 14.5 13.5Z" fill="currentColor"></path><path d="M10.1689 5.17703C10.7615 5.0609 11.3741 5 12 5C12.6259 5 13.2385 5.0609 13.8311 5.17703C14.2125 4.34087 14.7295 3.51088 15.3887 2.90913C16.0678 2.2891 16.9848 1.84347 18.0577 2.05199C19.0855 2.25177 19.9991 3.00672 20.8169 4.16677C21.1354 4.61856 21.0278 5.24335 20.5766 5.56226C20.1254 5.88118 19.5014 5.77346 19.183 5.32167C18.5007 4.35394 17.9768 4.07629 17.6766 4.01793C17.4212 3.9683 17.1195 4.03899 16.7362 4.38899C16.3912 4.70395 16.054 5.18667 15.7606 5.77733C18.8328 7.11381 21 10.0398 21 13.5C21 18.2542 16.9088 22 12 22C7.09121 22 3 18.2542 3 13.5C3 10.0398 5.16716 7.11381 8.2394 5.77733C7.946 5.18667 7.60881 4.70395 7.26383 4.38899C6.88046 4.03899 6.57876 3.9683 6.32345 4.01793C6.02318 4.07629 5.49926 4.35394 4.81705 5.32167C4.49855 5.77346 3.87459 5.88118 3.4234 5.56226C2.9722 5.24335 2.86462 4.61856 3.18312 4.16677C4.00091 3.00672 4.91449 2.25177 5.94234 2.05199C7.01515 1.84347 7.9322 2.2891 8.61134 2.90913C9.27045 3.51088 9.78747 4.34087 10.1689 5.17703ZM12 7C11.6011 7 11.2111 7.03063 10.8322 7.08936C10.8946 7.34259 10.9462 7.59208 10.9865 7.83391C11.0773 8.3794 10.7093 8.8953 10.1645 8.98622C9.61971 9.07713 9.10448 8.70863 9.01369 8.16314C8.98674 8.00125 8.95305 7.83368 8.91295 7.6627C6.57573 8.73108 5 10.9719 5 13.5C5 17.03 8.07223 20 12 20C15.9278 20 19 17.03 19 13.5C19 10.9719 17.4243 8.73108 15.0871 7.6627C15.0469 7.83368 15.0133 8.00125 14.9863 8.16314C14.8955 8.70863 14.3803 9.07713 13.8355 8.98622C13.2907 8.8953 12.9227 8.3794 13.0135 7.83391C13.0538 7.59208 13.1054 7.34259 13.1678 7.08936C12.7889 7.03063 12.3989 7 12 7Z" fill="currentColor"></path></svg></span><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Build</span></span></div><div class="flex min-w-0 items-center rounded-[0.7cqw] h-[5.5cqw] min-h-0 gap-[1.05cqw] px-[5px] py-0 text-[2.16cqw] leading-[1.16] [&amp;_svg]:min-h-0 [&amp;_svg]:min-w-0" data-documentation-selection-row="true"><img alt="" class="size-[18px] min-h-0 min-w-0 shrink-0 dark:invert" data-documentation-action-icon="add" src="/images/codex/icons/app-plus.svg"/><span class="min-w-0 flex-1 flex items-center gap-[0.72cqw]"><span class="max-w-full shrink-0 truncate" data-documentation-selection-label="true">Add action</span></span></div></div></div></div></div></div></figure> </div> </div> </div> </div> </div> <script type="module" src="/_astro/CodexScreenshotPresentation.astro_astro_type_script_index_0_lang.DDyaJJf-.js"></script> <style>
...
<p>For example, for a Node.js project you might create a &quot;Run&quot; action that contains the following script:</p>
<pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="bash"><code><span class="line"><span style="color:#6F42C1;--shiki-dark:#B392F0">npm</span><span style="color:#032F62;--shiki-dark:#9ECBFF"> start</span></span></code></pre>
<p>If the commands for your action are platform-specific, define platform-specific scripts for macOS, Windows, and Linux.</p>
<p>To identify your actions, choose an icon associated with each action.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0020-use-built-in-git-tools" class="group flex items-center gap-2 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Use built-in Git tools</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0020-use-built-in-git-tools" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0020 use built in git tools" title="Copy link to __codexlocalizedvalueprops__codextranslations u0020 use built in git tools"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h2>
<div class="my-8 grid gap-6 md:grid-cols-[minmax(0,1fr)_minmax(16rem,42%)] md:items-center"><div><p>In Codex, the ChatGPT desktop app provides common Git controls alongside each
...
a pull request without leaving the app.</p><p>Use the <a href="/codex/integrated-terminal">integrated terminal</a> for Git
operations that aren&#39;t exposed in the app. To isolate concurrent changes from
your local checkout, start the task in a <a href="/codex/environments/git-worktrees">worktree</a>.</p></div><div class="contents" data-markdown-export="illustration" data-markdown-description="Codex environment summary panel"> <figure aria-label="Codex environment summary panel" data-markdown-description="Codex environment summary panel" data-markdown-export="illustration" role="img" class="not-prose relative isolate m-0 w-full [container-type:inline-size] overflow-visible" style="aspect-ratio:343 / 285"><div aria-hidden="true" class="absolute overflow-hidden rounded-[clamp(1rem,6.41cqw,2.75rem)] border-[0.5px] border-black/[0.08] bg-[#f3f3f3] px-[clamp(0.75rem,4.66cqw,2rem)] pt-[clamp(0.625rem,3.5cqw,1.5rem)] pb-[clamp(0.125rem,0.87cqw,0.375rem)] text-[#202020] shadow-[0_0.5px_0_rgba(255,255,255,0.75)_inset,0_10px_26px_rgba(0,0,0,0.08)] dark:border-white/[0.08] dark:bg-[#2d2d2d] dark:text-[#f4f4f4] dark:shadow-[0_0.5px_0_rgba(255,255,255,0.08)_inset,0_12px_30px_rgba(0,0,0,0.22)] top-[10%] right-[6%] left-[6%]"><div class="flex h-[clamp(1.125rem,5.83cqw,2.5rem)] min-w-0 items-center text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none text-[#707070] dark:text-[#a8a8a8]"><span class="min-w-0 flex-1 truncate">Environment</span><span class="flex shrink-0 items-center gap-[clamp(0.75rem,4.66cqw,2rem)]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-[clamp(0.75rem,4.08cqw,1.75rem)]"><path d="M3 12a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm7 0a2 2 0 1 1 4 0 2 2 0 0 1-4 0Zm7 0a2 2 0 1 1 4 0 2 2 0 0 1-4 0Z"></path></svg><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-[clamp(0.75rem,4.08cqw,1.75rem)]"><path fill-rule="evenodd" d="M7 7.638v8.724c0 1.294 1.464 2.075 2.577 1.376l6.94-4.363a1.615 1.615 0 0 0 0-2.75l-6.94-4.363C8.464 5.562 7 6.344 7 7.638Z" clip-rule="evenodd"></path></svg></span></div><ul class="m-0 list-none p-0 mt-[clamp(0.375rem,2.33cqw,1rem)]"><li class="flex h-[clamp(1.625rem,9.04cqw,3.875rem)] min-w-0 items-center gap-[clamp(0.625rem,3.5cqw,1.5rem)] text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none"><span class="flex size-[clamp(0.75rem,4.08cqw,1.75rem)] shrink-0 items-center justify-center text-[#3f3f3f] dark:text-[#f1f1f1]"><span aria-hidden="true" class="relative block size-full rounded-[22%] border-[0.08em] border-current"><span class="absolute top-[30%] left-1/2 h-[0.08em] w-[38%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-current before:absolute before:top-1/2 before:left-1/2 before:h-[0.08em] before:w-full before:-translate-x-1/2 before:-translate-y-1/2 before:rotate-90 before:rounded-full before:bg-current"></span><span class="absolute bottom-[27%] left-1/2 h-[0.08em] w-[38%] -translate-x-1/2 translate-y-1/2 rounded-full bg-current"></span></span></span><span class="min-w-0 flex-1 truncate font-normal tracking-[-0.012em]">Changes</span><span class="flex shrink-0 gap-[clamp(0.2rem,1.17cqw,0.5rem)] font-normal tracking-[-0.012em] tabular-nums"><span class="text-[#00a86b] dark:text-[#20d894]">+25,813</span><span class="text-[#d52d28] dark:text-[#ff453f]">-8,475</span></span></li><li class="flex h-[clamp(1.625rem,9.04cqw,3.875rem)] min-w-0 items-center gap-[clamp(0.625rem,3.5cqw,1.5rem)] text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none"><span class="flex size-[clamp(0.75rem,4.08cqw,1.75rem)] shrink-0 items-center justify-center text-[#3f3f3f] dark:text-[#f1f1f1]"><span aria-hidden="true" class="relative block size-full"><span class="absolute inset-x-[8%] top-[8%] h-[65%] rounded-[8%] border-[0.08em] border-current"></span><span class="absolute right-0 bottom-[10%] left-0 h-[0.08em] rounded-full bg-current"></span><span class="absolute bottom-[2%] left-1/2 h-[0.08em] w-[78%] -translate-x-1/2 rounded-full bg-current"></span></span></span><span class="min-w-0 flex-1 truncate font-normal tracking-[-0.012em]">Local</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-[clamp(0.625rem,3.5cqw,1.5rem)] shrink-0 text-[#6d6d6d] dark:text-[#a8a8a8]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></li><li class="flex h-[clamp(1.625rem,9.04cqw,3.875rem)] min-w-0 items-center gap-[clamp(0.625rem,3.5cqw,1.5rem)] text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none"><span class="flex size-[clamp(0.75rem,4.08cqw,1.75rem)] shrink-0 items-center justify-center text-[#3f3f3f] dark:text-[#f1f1f1]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-full"><path d="M7.75 18C7.75 17.3096 7.19036 16.75 6.5 16.75C5.80964 16.75 5.25 17.3096 5.25 18C5.25 18.6904 5.80964 19.25 6.5 19.25C7.19036 19.25 7.75 18.6904 7.75 18ZM7.75 6C7.75 5.30964 7.19036 4.75 6.5 4.75C5.80964 4.75 5.25 5.30964 5.25 6C5.25 6.69036 5.80964 7.25 6.5 7.25C7.19036 7.25 7.75 6.69036 7.75 6ZM18.75 6C18.75 5.30964 18.1904 4.75 17.5 4.75C16.8096 4.75 16.25 5.30964 16.25 6C16.25 6.69036 16.8096 7.25 17.5 7.25C18.1904 7.25 18.75 6.69036 18.75 6ZM20.75 6C20.75 7.44586 19.8054 8.66989 18.5 9.0918V10C18.5 11.6569 17.1569 13 15.5 13H8.5C7.94772 13 7.5 13.4477 7.5 14V14.9072C8.80556 15.329 9.75 16.554 9.75 18C9.75 19.7949 8.29493 21.25 6.5 21.25C4.70507 21.25 3.25 19.7949 3.25 18C3.25 16.554 4.19444 15.329 5.5 14.9072V9.0918C4.19459 8.66989 3.25 7.44586 3.25 6C3.25 4.20507 4.70507 2.75 6.5 2.75C8.29493 2.75 9.75 4.20507 9.75 6C9.75 7.44586 8.80541 8.66989 7.5 9.0918V11.1738C7.81306 11.0631 8.149 11 8.5 11H15.5C16.0523 11 16.5 10.5523 16.5 10V9.0918C15.1946 8.66989 14.25 7.44586 14.25 6C14.25 4.20507 15.7051 2.75 17.5 2.75C19.2949 2.75 20.75 4.20507 20.75 6Z" fill="currentColor"></path></svg></span><span class="min-w-0 flex-1 truncate font-normal tracking-[-0.012em]">codex/update-controls</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-[clamp(0.625rem,3.5cqw,1.5rem)] shrink-0 text-[#6d6d6d] dark:text-[#a8a8a8]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></li><li class="flex h-[clamp(1.625rem,9.04cqw,3.875rem)] min-w-0 items-center gap-[clamp(0.625rem,3.5cqw,1.5rem)] text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none"><span class="flex size-[clamp(0.75rem,4.08cqw,1.75rem)] shrink-0 items-center justify-center text-[#3f3f3f] dark:text-[#f1f1f1]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-full"><path d="M6.5 2.75C8.29493 2.75 9.75 4.20507 9.75 6C9.75 7.44586 8.80541 8.66989 7.5 9.0918V10C7.5 10.5523 7.94772 11 8.5 11H15.5C17.1569 11 18.5 12.3431 18.5 14V14.9072C19.8056 15.329 20.75 16.554 20.75 18C20.75 19.7949 19.2949 21.25 17.5 21.25C15.7051 21.25 14.25 19.7949 14.25 18C14.25 16.554 15.1944 15.329 16.5 14.9072V14C16.5 13.4477 16.0523 13 15.5 13H8.5C8.14888 13 7.81314 12.936 7.5 12.8252V14.9072C8.80556 15.329 9.75 16.554 9.75 18C9.75 19.7949 8.29493 21.25 6.5 21.25C4.70507 21.25 3.25 19.7949 3.25 18C3.25 16.554 4.19444 15.329 5.5 14.9072V9.0918C4.19459 8.66989 3.25 7.44586 3.25 6C3.25 4.20507 4.70507 2.75 6.5 2.75ZM6.5 16.75C5.80964 16.75 5.25 17.3096 5.25 18C5.25 18.6904 5.80964 19.25 6.5 19.25C7.19036 19.25 7.75 18.6904 7.75 18C7.75 17.3096 7.19036 16.75 6.5 16.75ZM17.5 16.75C16.8096 16.75 16.25 17.3096 16.25 18C16.25 18.6904 16.8096 19.25 17.5 19.25C18.1904 19.25 18.75 18.6904 18.75 18C18.75 17.3096 18.1904 16.75 17.5 16.75ZM6.5 4.75C5.80964 4.75 5.25 5.30964 5.25 6C5.25 6.69036 5.80964 7.25 6.5 7.25C7.19036 7.25 7.75 6.69036 7.75 6C7.75 5.30964 7.19036 4.75 6.5 4.75Z" fill="currentColor"></path></svg></span><span class="min-w-0 flex-1 truncate font-normal tracking-[-0.012em]">Commit or push</span></li><li class="flex h-[clamp(1.625rem,9.04cqw,3.875rem)] min-w-0 items-center gap-[clamp(0.625rem,3.5cqw,1.5rem)] text-[clamp(0.625rem,4.08cqw,1.75rem)] leading-none"><span class="flex size-[clamp(0.75rem,4.08cqw,1.75rem)] shrink-0 items-center justify-center text-[#3f3f3f] dark:text-[#f1f1f1]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="size-full"><path d="M12 1.95068C17.525 1.95068 22 6.42568 22 11.9507C21.9995 14.0459 21.3419 16.0883 20.1198 17.7902C18.8977 19.4922 17.1727 20.768 15.1875 21.4382C14.6875 21.5382 14.5 21.2257 14.5 20.9632C14.5 20.6257 14.5125 19.5507 14.5125 18.2132C14.5125 17.2757 14.2 16.6757 13.8375 16.3632C16.0625 16.1132 18.4 15.2632 18.4 11.4257C18.4 10.3257 18.0125 9.43818 17.375 8.73818C17.475 8.48818 17.825 7.46318 17.275 6.08818C17.275 6.08818 16.4375 5.81318 14.525 7.11318C13.725 6.88818 12.875 6.77568 12.025 6.77568C11.175 6.77568 10.325 6.88818 9.525 7.11318C7.6125 5.82568 6.775 6.08818 6.775 6.08818C6.225 7.46318 6.575 8.48818 6.675 8.73818C6.0375 9.43818 5.65 10.3382 5.65 11.4257C5.65 15.2507 7.975 16.1132 10.2 16.3632C9.9125 16.6132 9.65 17.0507 9.5625 17.7007C8.9875 17.9632 7.55 18.3882 6.65 16.8757C6.4625 16.5757 5.9 15.8382 5.1125 15.8507C4.275 15.8632 4.775 16.3257 5.125 16.5132C5.55 16.7507 6.0375 17.6382 6.15 17.9257C6.35 18.4882 7 19.5632 9.5125 19.1007C9.5125 19.9382 9.525 20.7257 9.525 20.9632C9.525 21.2257 9.3375 21.5257 8.8375 21.4382C6.8458 20.7752 5.11342 19.502 3.88611 17.799C2.65881 16.096 1.9989 14.0498 2 11.9507C2 6.42568 6.475 1.95068 12 1.95068Z" fill="currentColor"></path></svg></span><span class="min-w-0 flex-1 truncate font-normal tracking-[-0.012em]">Create pull request</span></li></ul></div></figure> </div></div>  </article>  </div> </div> </div> <script>
