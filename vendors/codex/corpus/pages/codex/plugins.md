...
</style><!-- Canonical URL --><link rel="canonical" href="https://learn.chatgpt.com/docs/plugins"><!-- Primary Meta Tags --><title data-default-meta-title="Plugins – Codex | OpenAI Developers" data-site-variant-meta-titles="{&#34;chatgpt-docs&#34;:&#34;Plugins | ChatGPT Learn&#34;}">
  Plugins | ChatGPT Learn
</title><meta name="title" content="Plugins | ChatGPT Learn"><meta name="description" content="Browse, install, and use plugins on supported ChatGPT and Codex surfaces"><!-- Open Graph / Facebook --><meta property="og:type" content="website"><meta property="og:url" content="https://learn.chatgpt.com/docs/plugins"><meta property="og:site_name" content="ChatGPT Learn"><meta property="og:title" content="Plugins | ChatGPT Learn"><meta property="og:description" content="Browse, install, and use plugins on supported ChatGPT and Codex surfaces"><meta property="og:image" content="https://learn.chatgpt.com/og/docs/plugins.png"><meta property="og:image:alt" content="Plugins | ChatGPT Learn"><meta property="og:image:type" content="image/png"><meta property="og:image:width" content="1200"><meta property="og:image:height" content="630"><!-- Twitter --><meta name="twitter:card" content="summary_large_image"><meta name="twitter:site" content="@ChatGPTapp"><meta name="twitter:url" content="https://learn.chatgpt.com/docs/plugins"><meta name="twitter:title" content="Plugins | ChatGPT Learn"><meta name="twitter:description" content="Browse, install, and use plugins on supported ChatGPT and Codex surfaces"><meta name="twitter:image" content="https://learn.chatgpt.com/og/docs/plugins.png"><meta name="twitter:image:width" content="1200"><meta name="twitter:image:height" content="630"><meta name="twitter:image:alt" content="Plugins | ChatGPT Learn"><!-- Sitemap --><link rel="sitemap" href="/sitemap-index.xml"><!-- RSS Feed --><link rel="alternate" type="application/rss+xml" title="Plugins | ChatGPT Learn" data-page-meta-title href="https://developers.openai.com/rss.xml"><!-- Global Scripts --><script src="/js/theme.js"></script><script src="/js/scroll.js"></script><script src="/js/animate.js"></script><script defer src="/js/copy.js"></script><script type="module" src="/_astro/BaseHead.astro_astro_type_script_index_0_lang.DksHusRH.js"></script><meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback" content="swap"><script type="module" src="/_astro/ClientRouter.astro_astro_type_script_index_0_lang.BYUM-eHF.js"></script><link rel="stylesheet" href="/_astro/PageLayout.le5dKQy-.css">
...
surfaces.</p>
<p>Plugins work in Chat and Work across ChatGPT on the web, desktop, and mobile,
and in Codex in the ChatGPT desktop app. Codex CLI also has a plugin browser
for Codex environments. The IDE extension doesn&#39;t support plugins.</p>
<p>On mobile, you can use plugins available to your account in Chat or Work.</p>
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="app" data-ids="[&#34;app&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <p>Open the <strong>Plugins</strong> tab to browse and install plugins. After installation, you
can use plugins in Chat or Work in ChatGPT, or in Codex. Installed plugins can
add skills, connectors, and MCP tools to new chats.</p> </div> <script data-astro-rerun>
  (() => {
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="web" data-ids="[&#34;web&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface" data-markdown-ignore hidden> <p>Open the <strong>Plugins</strong> tab to browse and install plugins. After installation, you
can use plugins in Chat or Work. A plugin can prompt you to connect an external
service before its tools become available.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="cli" data-ids="[&#34;cli&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface" data-markdown-ignore hidden> <p>In Codex CLI, enter <code>/plugins</code> to open the plugin browser. Install a plugin from
a configured marketplace, then start a new session before using its bundled
skills or tools.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="ide" data-ids="[&#34;ide&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface" data-markdown-ignore hidden> <a id="plugin-directory-in-the-ide-extension"></a><h3 id="__codexlocalizedvalueprops__codextranslations-u0010-use-plugins-from-a-supported-surface" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Use plugins from a supported surface</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0010-use-plugins-from-a-supported-surface" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0010 use plugins from a supported surface" title="Copy link to __codexlocalizedvalueprops__codextranslations u0010 use plugins from a supported surface"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>Plugins aren&#39;t available in the IDE extension. To browse and install plugins
for Codex, use the ChatGPT desktop app or Codex CLI.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<p>Extend what ChatGPT and Codex can do, for example:</p>
<ul>
<li>Install the Codex Security plugin to scan authorized code and confirm
plausible vulnerability findings.</li>
<li>Install the Gmail plugin to work with Gmail.</li>
<li>Install the Google Drive plugin to work across Drive, Docs, Sheets, and
Slides.</li>
<li>Install the Slack plugin to summarize channels or draft replies.</li>
</ul>
<p>A plugin can contain one or more of these parts:</p>
<ul>
<li><strong>Skills:</strong> reusable instructions for specific kinds of work. ChatGPT and
  Codex can load them when needed so they follow the right steps and use the
  right references or helper scripts for a task.</li>
<li><strong>Connectors:</strong> connections to tools like GitHub, Slack, or Google Drive, so
  ChatGPT and Codex can read information from those tools and take actions in
  them. Connectors expose tools and can optionally include custom UI.</li>
<li><strong>MCP servers:</strong> services that give ChatGPT and Codex access to more tools or
  ...
  structured data, and perform actions against external systems.</li>
<li><strong>Browser extensions:</strong> browser capabilities that a plugin needs for its
  workflow.</li>
<li><strong>Hooks:</strong> commands that run at configured lifecycle points. Review and trust
  plugin hooks before you enable them.</li>
<li><strong>Scheduled task templates:</strong> reusable starting points for recurring tasks
  where scheduled tasks are available.</li>
</ul>
<p>You can share plugins by publishing them through a marketplace source, such as a
repo marketplace for a project or team. See <a href="https://developers.openai.com/plugins/build/plugins">Build plugins</a>
for marketplace setup, packaging, and distribution guidance.</p>
<p>If you are building an integration, start with
<a href="https://developers.openai.com/plugins/build/mcp-server">Build an MCP server</a>.
If the plugin needs custom UI, use the
<a href="https://developers.openai.com/plugins/build/chatgpt-ui">optional UI guide</a>.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0026-use-and-install-plugins" class="group flex items-center gap-2 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Use and install plugins</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0026-use-and-install-plugins" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0026 use and install plugins" title="Copy link to __codexlocalizedvalueprops__codextranslations u0026 use and install plugins"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h2>
<a id="plugin-directory-in-the-codex-app"></a>
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-ids="[&#34;app&#34;,&#34;web&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <h3 id="__codexlocalizedvalueprops__codextranslations-u0027-universal-plugin-directory" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Universal plugin directory</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0027-universal-plugin-directory" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0027 universal plugin directory" title="Copy link to __codexlocalizedvalueprops__codextranslations u0027 universal plugin directory"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>ChatGPT and Codex use the same public plugin catalog. On the web or in the
ChatGPT desktop app, open the <strong>Plugins</strong> tab to browse and install plugins.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="app" data-ids="[&#34;app&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexProductWorkspaceIllustration:plugin-marketplace" style="--documentation-screenshot-light-source-width: 4924px; --documentation-screenshot-dark-source-width: 4928px; --documentation-screenshot-light-aspect-ratio: 4924 / 3088; --documentation-screenshot-dark-aspect-ratio: 4928 / 3096; --documentation-screenshot-light-height-width-limit: calc(400px * 4924 / 3088); --documentation-screenshot-dark-height-width-limit: calc(400px * 4928 / 3096); --documentation-screenshot-max-height: 400px; --documentation-screenshot-max-width: 100%;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="Plugins Directory in the ChatGPT desktop app"> <figure aria-label="Plugins Directory in the ChatGPT desktop app" data-markdown-description="Plugins Directory in the ChatGPT desktop app" data-markdown-export="illustration" data-documentation-source-density="screenshot" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:2462px;--documentation-light-canvas-aspect-ratio:4924 / 3088;--documentation-dark-canvas-width:2464px;--documentation-dark-canvas-aspect-ratio:4928 / 3096"><div class="overflow-hidden rounded-[1.35cqw] p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center bg-transparent" data-documentation-canvas="true" data-documentation-canvas-width="2462" data-documentation-dark-canvas-width="2464"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] tracking-[-0.008em] antialiased text-[0.72cqw] leading-[1.38]" data-documentation-typography-scope="illustration"><div data-documentation-source-stroke="window" class="relative flex min-h-0 min-w-0 flex-col overflow-hidden border bg-white dark:border-white/[0.1] dark:shadow-[0_18px_48px_rgba(0,0,0,0.36)] border-black/[0.055] shadow-[0_1.5cqw_4cqw_rgba(0,0,0,0.15)] mt-[5.22cqw] h-[83.35%] w-[83.35%] self-start rounded-[0.45cqw] dark:bg-[#181818]"><div class="flex h-[3.5cqw] shrink-0 items-center gap-[0.9cqw] bg-white px-[1.08cqw] dark:bg-[#181818] text-[0.63cqw]" data-documentation-marketplace-chrome="true"><span class="mr-[0.8cqw] flex shrink-0 gap-[0.47cqw]"><span class="size-[0.78cqw] rounded-full" style="background-color:#ff5f57"></span><span class="size-[0.78cqw] rounded-full" style="background-color:#febc2e"></span><span class="size-[0.78cqw] rounded-full" style="background-color:#28c840"></span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.08cqw] text-[#777]"><path d="M8 5.4541C8 5.42548 8.00155 5.39716 8.00391 5.36914C7.55522 5.37527 7.18036 5.38745 6.85449 5.41406C6.32513 5.45732 5.99243 5.53344 5.74121 5.6416L5.6377 5.69043C5.14381 5.94215 4.73058 6.32494 4.44238 6.79492L4.32715 7.00098C4.19296 7.26434 4.10023 7.61261 4.05078 8.21777C4.00041 8.83458 4 9.62723 4 10.7637V13.2363C4 14.3728 4.00039 15.1654 4.05078 15.7822C4.10023 16.3871 4.19298 16.7347 4.32715 16.998L4.44238 17.2041C4.73056 17.6741 5.14377 18.0568 5.6377 18.3086L5.74121 18.3574C5.99244 18.4656 6.32506 18.5417 6.85449 18.585C7.17941 18.6115 7.55304 18.6228 8 18.6289V5.4541ZM22 13.2363C22 14.3396 22.001 15.2273 21.9424 15.9443C21.8903 16.5821 21.7876 17.1524 21.5605 17.6816L21.4551 17.9063C20.9758 18.8468 20.211 19.6115 19.2705 20.0908C18.6783 20.3925 18.0373 20.5186 17.3086 20.5781C16.5914 20.6367 15.7032 20.6357 14.5996 20.6357H9.40039C9.27572 20.6357 9.15341 20.6339 9.03418 20.6338C9.02282 20.6342 9.01146 20.6357 9 20.6357C8.98557 20.6357 8.97131 20.6334 8.95703 20.6328C8.05556 20.632 7.31 20.6287 6.69141 20.5781C6.05356 20.526 5.48347 20.4235 4.9541 20.1963L4.73047 20.0908C3.84834 19.6413 3.12017 18.9412 2.6377 18.0801L2.54492 17.9063C2.24315 17.3139 2.11717 16.6732 2.05762 15.9443C1.99905 15.2273 2 14.3396 2 13.2363V10.7637C2 9.66008 1.99903 8.77186 2.05762 8.05469C2.11716 7.32598 2.24327 6.68595 2.54492 6.09375L2.6377 5.91895C3.12017 5.05789 3.8484 4.35763 4.73047 3.9082L4.9541 3.80274C5.48344 3.57561 6.05359 3.47301 6.69141 3.4209C7.40857 3.36231 8.29681 3.36328 9.40039 3.36328H14.5996C15.7032 3.36328 16.5914 3.36231 17.3086 3.4209C18.0373 3.48044 18.6773 3.60656 19.2695 3.9082L19.4443 4.00195C20.3052 4.48442 21.0057 5.21184 21.4551 6.09375L21.5605 6.31738C21.7877 6.84672 21.8903 7.41688 21.9424 8.05469C22.001 8.77186 22 9.66008 22 10.7637V13.2363ZM10 18.6357H14.5996C15.7361 18.6357 16.5287 18.6353 17.1455 18.585C17.7507 18.5355 18.0989 18.4428 18.3623 18.3086L18.5684 18.1934C19.0383 17.9051 19.4211 17.492 19.6729 16.998L19.7217 16.8945C19.8298 16.6434 19.906 16.3112 19.9492 15.7822C19.9996 15.1654 20 14.3728 20 13.2363V10.7637C20 9.62722 19.9996 8.83458 19.9492 8.21777C19.906 7.68841 19.8299 7.35572 19.7217 7.10449L19.6729 7.00098C19.4211 6.50707 19.0383 6.09385 18.5684 5.80567L18.3623 5.69043C18.0989 5.55623 17.7507 5.46351 17.1455 5.41406C16.5287 5.36369 15.736 5.36328 14.5996 5.36328H9.99609C9.99879 5.39319 10 5.42349 10 5.4541V18.6357Z" fill="currentColor"></path></svg><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] text-[#777]"><path fill-rule="evenodd" d="M5.293 12.707a1 1 0 0 1 0-1.414l5-5a1 1 0 1 1 1.414 1.414L8.414 11H18a1 1 0 1 1 0 2H8.414l3.293 3.293a1 1 0 0 1-1.414 1.414l-5-5Z" clip-rule="evenodd"></path></svg><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] text-[#b1b1b1]"><path fill-rule="evenodd" d="M18.707 12.707a1 1 0 0 0 0-1.414l-5-5a1 1 0 1 0-1.414 1.414L15.586 11H6a1 1 0 1 0 0 2h9.586l-3.293 3.293a1 1 0 0 0 1.414 1.414l5-5Z" clip-rule="evenodd"></path></svg><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.12cqw] text-[#777]"><path d="M15.6729 3.91275C16.8918 2.6938 18.8682 2.6938 20.0871 3.91275C21.3061 5.1317 21.3061 7.10801 20.0871 8.32696L14.1499 14.2642C13.3849 15.0291 12.3925 15.5254 11.3215 15.6784L9.14142 15.9898C8.82983 16.0343 8.51546 15.9295 8.29289 15.707C8.07033 15.4844 7.96554 15.17 8.01005 14.8584L8.32149 12.6784C8.47449 11.6074 8.97072 10.6149 9.7357 9.84994L15.6729 3.91275ZM18.6729 5.32696C18.235 4.88906 17.525 4.88906 17.0871 5.32696L11.1499 11.2642C10.6909 11.7231 10.3932 12.3186 10.3014 12.9612L10.1785 13.8213L11.0386 13.6985C11.6812 13.6067 12.2767 13.3089 12.7357 12.8499L18.6729 6.91275C19.1108 6.47485 19.1108 5.76486 18.6729 5.32696ZM11 3.99916C11.0004 4.55145 10.5531 4.99951 10.0008 4.99994C9.00227 5.00072 8.29769 5.00815 7.74651 5.06052C7.20685 5.11179 6.88488 5.20104 6.63803 5.32682C6.07354 5.61444 5.6146 6.07339 5.32698 6.63787C5.19279 6.90123 5.10062 7.24891 5.05118 7.85408C5.00078 8.47092 5 9.26324 5 10.3998V13.5998C5 14.7364 5.00078 15.5288 5.05118 16.1456C5.10062 16.7508 5.19279 17.0985 5.32698 17.3618C5.6146 17.9263 6.07354 18.3852 6.63803 18.6729C6.90138 18.807 7.24907 18.8992 7.85424 18.9487C8.47108 18.9991 9.26339 18.9998 10.4 18.9998H13.6C14.7366 18.9998 15.5289 18.9991 16.1458 18.9487C16.7509 18.8992 17.0986 18.807 17.362 18.6729C17.9265 18.3852 18.3854 17.9263 18.673 17.3618C18.7988 17.115 18.8881 16.793 18.9393 16.2533C18.9917 15.7021 18.9991 14.9976 18.9999 13.9991C19.0003 13.4468 19.4484 12.9994 20.0007 12.9998C20.553 13.0003 21.0003 13.4483 20.9999 14.0006C20.9991 14.9788 20.9932 15.7807 20.9304 16.4425C20.8664 17.1159 20.7385 17.7135 20.455 18.2698C19.9757 19.2106 19.2108 19.9755 18.27 20.4549C17.6777 20.7567 17.0375 20.8825 16.3086 20.942C15.6008 20.9999 14.7266 20.9999 13.6428 20.9998H10.3572C9.27339 20.9999 8.39925 20.9999 7.69138 20.942C6.96253 20.8825 6.32234 20.7567 5.73005 20.4549C4.78924 19.9755 4.02433 19.2106 3.54497 18.2698C3.24318 17.6775 3.11737 17.0373 3.05782 16.3085C2.99998 15.6006 2.99999 14.7264 3 13.6426V10.357C2.99999 9.27325 2.99998 8.3991 3.05782 7.69122C3.11737 6.96237 3.24318 6.32218 3.54497 5.72989C4.02433 4.78908 4.78924 4.02418 5.73005 3.54481C6.28633 3.26137 6.88399 3.13346 7.55735 3.06948C8.21919 3.0066 9.02103 3.00071 9.99922 2.99994C10.5515 2.99951 10.9996 3.44688 11 3.99916Z"></path></svg><span class="rounded-[0.7cqw] bg-[#f3f3f3] px-[0.85cqw] py-[0.4cqw] dark:bg-[#242424]" data-documentation-marketplace-window-control="plugins">Plugins</span><span class="text-[#888]" data-documentation-marketplace-window-control="skills">Skills</span><span class="min-w-0 flex-1"></span><span class="flex items-center gap-[0.42cqw] rounded-[0.68cqw] bg-[#f3f3f3] px-[0.76cqw] py-[0.42cqw] dark:bg-[#242424]" data-documentation-marketplace-window-control="manage"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1cqw]"><path fill-rule="evenodd" clip-rule="evenodd" d="M11.6099 3.75C11.2549 3.75 10.9266 3.93813 10.7471 4.24434L9.99036 5.53548C9.45636 6.44657 8.48265 7.00978 7.42663 7.01839L5.94021 7.03051C5.58531 7.0334 5.25853 7.22419 5.08156 7.53183L4.6852 8.22082C4.50905 8.52702 4.50752 8.90345 4.68118 9.21107L5.42305 10.5252C5.93977 11.4405 5.93977 12.5595 5.42305 13.4748L4.68118 14.7889C4.50752 15.0966 4.50905 15.473 4.6852 15.7792L5.08156 16.4682C5.25853 16.7758 5.58531 16.9666 5.94021 16.9695L7.42665 16.9816C8.48266 16.9902 9.45637 17.5535 9.99037 18.4645L10.7471 19.7557C10.9266 20.0619 11.2549 20.25 11.6099 20.25H12.3901C12.7451 20.25 13.0734 20.0619 13.2529 19.7557L14.0096 18.4645C14.5436 17.5535 15.5173 16.9902 16.5734 16.9816L18.0599 16.9695C18.4148 16.9666 18.7416 16.7758 18.9185 16.4682L19.3149 15.7792C19.491 15.473 19.4926 15.0966 19.3189 14.7889L18.577 13.4748C18.0603 12.5595 18.0603 11.4405 18.577 10.5252L19.3189 9.21107C19.4926 8.90345 19.491 8.52702 19.3149 8.22082L18.9185 7.53183C18.7416 7.22419 18.4148 7.0334 18.0599 7.03051L16.5734 7.01839C15.5174 7.00978 14.5437 6.44657 14.0096 5.53548L13.2529 4.24434C13.0734 3.93813 12.7451 3.75 12.3901 3.75H11.6099ZM9.02167 3.23301C9.56009 2.31439 10.5451 1.75 11.6099 1.75H12.3901C13.4549 1.75 14.4399 2.31439 14.9783 3.23301L15.7351 4.52415C15.9131 4.82785 16.2377 5.01558 16.5897 5.01845L18.0762 5.03058C19.1409 5.03926 20.1212 5.61161 20.6521 6.53452L21.0485 7.22352C21.577 8.14213 21.5815 9.27141 21.0605 10.1943L20.3187 11.5084C20.1464 11.8135 20.1464 12.1865 20.3187 12.4916L21.0605 13.8057C21.5815 14.7286 21.577 15.8579 21.0485 16.7765L20.6521 17.4655C20.1212 18.3884 19.1409 18.9608 18.0762 18.9694L16.5897 18.9816C16.2377 18.9844 15.9131 19.1722 15.7351 19.4759L14.9783 20.767C14.4399 21.6856 13.4549 22.25 12.3901 22.25H11.6099C10.5451 22.25 9.56009 21.6856 9.02167 20.767L8.26491 19.4759C8.08691 19.1722 7.76234 18.9844 7.41034 18.9816L5.9239 18.9694C4.8592 18.9608 3.87888 18.3884 3.34795 17.4655L2.95159 16.7765C2.42314 15.8579 2.41856 14.7286 2.93954 13.8057L3.68141 12.4916C3.85365 12.1865 3.85365 11.8135 3.68141 11.5084L2.93954 10.1943C2.41856 9.27141 2.42314 8.14213 2.95159 7.22352L3.34795 6.53453C3.87888 5.61162 4.8592 5.03926 5.9239 5.03058L7.41032 5.01845C7.76233 5.01558 8.0869 4.82785 8.2649 4.52415L9.02167 3.23301Z" fill="currentColor"></path><path fill-rule="evenodd" clip-rule="evenodd" d="M12 10.5C11.1716 10.5 10.5 11.1716 10.5 12C10.5 12.8284 11.1716 13.5 12 13.5C12.8285 13.5 13.5 12.8284 13.5 12C13.5 11.1716 12.8285 10.5 12 10.5ZM8.50004 12C8.50004 10.067 10.067 8.5 12 8.5C13.933 8.5 15.5 10.067 15.5 12C15.5 13.933 13.933 15.5 12 15.5C10.067 15.5 8.50004 13.933 8.50004 12Z" fill="currentColor"></path></svg> Manage</span><span class="flex items-center gap-[0.45cqw] rounded-[0.67cqw] border border-black/[0.08] px-[0.76cqw] py-[0.38cqw] dark:border-white/[0.1]" data-documentation-marketplace-window-control="create">Create <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.86cqw]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.08cqw] text-[#777]"><path d="M3 12C3 10.8954 3.89543 10 5 10C6.10457 10 7 10.8954 7 12C7 13.1046 6.10457 14 5 14C3.89543 14 3 13.1046 3 12ZM10 12C10 10.8954 10.8954 10 12 10C13.1046 10 14 10.8954 14 12C14 13.1046 13.1046 14 12 14C10.8954 14 10 13.1046 10 12ZM17 12C17 10.8954 17.8954 10 19 10C20.1046 10 21 10.8954 21 12C21 13.1046 20.1046 14 19 14C17.8954 14 17 13.1046 17 12Z" fill="currentColor"></path></svg></div><div class="flex min-h-0 min-w-0 flex-1"><div class="min-h-0 min-w-0 flex-1 overflow-hidden bg-white px-[23.6cqw] pt-[0.1cqw] text-[0.88cqw] dark:bg-[#181818] font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif]" data-documentation-marketplace-surface="true"><div class="text-center text-[1.41cqw] font-semibold leading-[1.63cqw] tracking-[-0.045em]" data-documentation-marketplace-heading="true">Make Codex work your way</div><div class="mt-[1.37cqw] flex min-w-0 items-center justify-between gap-[0.95cqw] whitespace-nowrap text-[0.7cqw] leading-[1.32] tracking-[-0.042em] text-[#777] dark:text-[#aaa]" data-documentation-marketplace-navigation="true" data-documentation-rhythm-profile="plugin-marketplace-tabs"><span class="shrink-0 rounded-full bg-[#f3f3f3] px-[0.47cqw] py-[0.15cqw] font-medium text-[#202020] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-tab="selected">Curated by OpenAI</span><span class="shrink-0" data-documentation-marketplace-tab="inactive">Shared with you</span><span class="shrink-0" data-documentation-marketplace-tab="inactive">Created by me</span><span class="flex shrink-0 items-center gap-[0.18cqw]" data-documentation-marketplace-tab="inactive">More <svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="inline size-[0.8cqw]"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><span class="mr-[3.2cqw] ml-auto flex shrink-0 items-center gap-[0.37cqw] rounded-[0.65cqw] border border-black/[0.08] bg-white px-[0.58cqw] py-[0.12cqw] dark:border-white/[0.1] dark:bg-[#282828]" data-documentation-marketplace-search="true"><svg viewBox="0 0 24 24" width="1em" height="1em" fill="currentColor" class="size-[0.85cqw]"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.875 4.5C7.35418 4.5 4.5 7.35418 4.5 10.875C4.5 14.3958 7.35418 17.25 10.875 17.25C14.3958 17.25 17.25 14.3958 17.25 10.875C17.25 7.35418 14.3958 4.5 10.875 4.5ZM2.5 10.875C2.5 6.24962 6.24962 2.5 10.875 2.5C15.5004 2.5 19.25 6.24962 19.25 10.875C19.25 12.8273 18.582 14.6236 17.462 16.0478L21.2071 19.7929C21.5976 20.1834 21.5976 20.8166 21.2071 21.2071C20.8166 21.5976 20.1834 21.5976 19.7929 21.2071L16.0478 17.462C14.6236 18.582 12.8273 19.25 10.875 19.25C6.24962 19.25 2.5 15.5004 2.5 10.875Z"></path></svg><span>Search plugins</span></span></div><div class="relative mt-[0.36cqw] flex h-[13.4cqw] flex-col items-center justify-end rounded-[0.82cqw] bg-cover bg-center pb-[1.05cqw]" style="background-image:url(&quot;/images/codex/codex-wallpaper-1.webp&quot;)"><span class="pointer-events-none absolute inset-0 rounded-[0.82cqw] bg-[#ddd6f5]/45 dark:bg-[#08083f]/80" data-documentation-marketplace-hero-scrim="true"></span><div class="relative z-10 rounded-[1.3cqw] border border-white/60 bg-white/75 px-[0.72cqw] py-[0.58cqw] whitespace-nowrap text-[#292929] dark:border-white/[0.12] dark:bg-[#111]/85 dark:text-white text-[0.72cqw] leading-[1.38]"><span class="dark:hidden" data-documentation-marketplace-hero="light"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="mr-[0.45cqw] inline size-[1.1cqw]"><path d="M6.54552 19.5021V11.7747L4.14899 9.58218L2 8.36554V18.1384C2 18.893 2.61137 19.5021 3.36366 19.5021H6.54552Z" fill="#4285F4"></path><path d="M17.4546 19.5021H20.6365C21.391 19.5021 22.0001 18.8907 22.0001 18.1384V8.36554L19.566 9.75916L17.4546 11.7747V19.5021Z" fill="#34A853"></path><path d="M6.54533 11.7747L6.21924 8.75535L6.54533 5.86554L12 9.9565L17.4546 5.86554L17.8194 8.59933L17.4546 11.7747L12 15.8657L6.54533 11.7747Z" fill="#EA4335"></path><path d="M17.4546 5.86552V11.7747L22.0001 8.36556V6.54734C22.0001 4.86095 20.0751 3.89957 18.7274 4.91095L17.4546 5.86552Z" fill="#FBBC04"></path><path d="M2 8.3655L4.09056 9.93341L6.54552 11.7746V5.86546L5.27277 4.91089C3.92275 3.89951 2 4.86089 2 6.54728V8.3655Z" fill="#C5221F"></path></svg><span class="text-[#df534c]">Gmail</span> Draft replies for every email I&#x27;m behind on</span><span class="hidden items-center dark:inline-flex" data-documentation-marketplace-hero="dark"><img alt="" class="mr-[0.45cqw] size-[1.1cqw] object-contain" src="/images/codex/icons/computer-use-plugin-icon.png"/><span class="mr-[0.35cqw] text-[#909090]">Computer Use</span>Play a playlist to help me lock in</span></div><span class="relative z-10 mt-[0.65cqw] rounded-[0.8cqw] bg-black px-[0.9cqw] py-[0.45cqw] text-white dark:bg-white dark:text-[#161616]"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="mr-[0.46cqw] inline size-[1.08cqw]"><path fill-rule="evenodd" clip-rule="evenodd" d="M10.8338 4.78537C12.0783 3.67377 13.7568 3 15.5909 3C19.3379 3 22.5 5.84379 22.5 9.5C22.5 10.6675 22.1723 11.7617 21.6035 12.7049C21.7082 13.3446 21.9041 13.9807 22.1568 14.6441C22.2777 14.9617 22.2291 15.319 22.0276 15.5928C21.8261 15.8665 21.4994 16.0192 21.1602 15.9981C20.0211 15.9272 18.9547 15.7195 17.9166 15.3624C17.3944 15.1827 17.1167 14.6137 17.2963 14.0914C17.476 13.5692 18.045 13.2915 18.5673 13.4712C18.9672 13.6088 19.3734 13.7202 19.7912 13.8061C19.6925 13.4107 19.6153 13.0038 19.5687 12.5843C19.542 12.3446 19.6029 12.1033 19.7402 11.9049C20.2241 11.2056 20.5 10.3815 20.5 9.5C20.5 7.08108 18.3709 5 15.5909 5C14.2496 5 13.0451 5.4919 12.1662 6.27698C11.7543 6.64489 11.1221 6.60924 10.7542 6.19734C10.3863 5.78544 10.4219 5.15328 10.8338 4.78537ZM8.5 10C5.65489 10 3.5 12.0948 3.5 14.5C3.5 15.3779 3.77893 16.1999 4.27013 16.899C4.41055 17.0989 4.47295 17.3433 4.44557 17.586C4.39815 18.0063 4.31955 18.4139 4.21925 18.8099C4.65229 18.7232 5.07312 18.61 5.48727 18.4697C5.72968 18.3875 5.99435 18.4015 6.22679 18.5086C6.90579 18.8216 7.67742 19 8.5 19C11.3451 19 13.5 16.9052 13.5 14.5C13.5 12.0948 11.3451 10 8.5 10ZM1.5 14.5C1.5 10.83 4.71769 8 8.5 8C12.2823 8 15.5 10.83 15.5 14.5C15.5 18.17 12.2823 21 8.5 21C7.53025 21 6.60309 20.8166 5.75878 20.4828C4.82364 20.7669 3.86215 20.9357 2.84316 20.9981C2.50317 21.0189 2.17597 20.8653 1.97489 20.5903C1.7738 20.3154 1.72649 19.957 1.84935 19.6393C2.10511 18.9779 2.3033 18.3443 2.40969 17.7075C1.83301 16.7645 1.5 15.6694 1.5 14.5Z" fill="currentColor"></path></svg>Try in chat</span><span class="absolute top-1/2 right-[0.66cqw] z-10 flex -translate-y-1/2 flex-col gap-[0.24cqw]"><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#222]"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span><span class="size-[0.24cqw] rounded-full bg-[#888]/55"></span></span></div><div class="mt-[1.58cqw] border-b border-black/[0.06] pb-[0.5cqw] text-[0.72cqw] font-medium leading-[1.34cqw] dark:border-white/[0.08]" data-documentation-marketplace-section-heading="featured">Featured</div><div class="grid grid-cols-2 gap-x-[1.6cqw] mt-[0.45cqw] gap-y-[0.12cqw]"><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="computer-use"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="computer-use"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/computer-use-plugin-icon.png"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="computer-use">Computer Use</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="computer-use">Control Mac apps from Codex</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="computer-use"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="chrome"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-white dark:text-[#181818]" data-documentation-marketplace-icon-surface="chrome"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" data-documentation-marketplace-chrome-icon="true" src="/images/codex/icons/chrome-production-large.png"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="chrome">Chrome</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="chrome">Control Chrome with Codex</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="chrome"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="spreadsheets"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="spreadsheets"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/file-spreadsheet.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="spreadsheets">Spreadsheets</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="spreadsheets">Create and edit spreadsheet files</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="presentations"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="presentations"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/file-presentation.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="presentations">Presentations</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="presentations">Create and edit presentations</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div></div><div class="mt-[1.34cqw] border-b border-black/[0.06] pb-[0.5cqw] text-[0.72cqw] font-medium leading-[1.34cqw] dark:border-white/[0.08]" data-documentation-marketplace-section-heading="coding">Coding</div><div class="mt-[0.45cqw] grid grid-cols-2 gap-x-[1.6cqw] gap-y-[0.12cqw]"><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="huggingface"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-white dark:text-[#181818]" data-documentation-marketplace-icon-surface="huggingface"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="https://raw.githubusercontent.com/openai/plugins/main/plugins/hugging-face/assets/logo.png"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="huggingface">Hugging Face</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="huggingface">Inspect models, datasets, Spaces, and apps</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="huggingface"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="netlify"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-white dark:text-[#181818]" data-documentation-marketplace-icon-surface="netlify"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="https://raw.githubusercontent.com/openai/plugins/main/plugins/netlify/assets/app-icon.png"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="netlify">Netlify</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="netlify">Deploy projects and manage releases</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="netlify"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="vercel"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-white dark:text-[#181818]" data-documentation-marketplace-icon-surface="vercel"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/vercel.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="vercel">Vercel</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="vercel">Build and deploy web apps and agents</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="game-studio"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="game-studio"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/plugin-game-studio.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="game-studio">Game Studio</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="game-studio">Design, prototype, and ship browser games</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="superpowers"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="superpowers"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/plugin-superpowers.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="superpowers">Superpowers</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="superpowers">Planning, TDD, debugging, and delivery</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="github"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-white dark:text-[#181818]" data-documentation-marketplace-icon-surface="github"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.45cqw] min-h-0 min-w-0"><path d="M12 1.95068C17.525 1.95068 22 6.42568 22 11.9507C21.9995 14.0459 21.3419 16.0883 20.1198 17.7902C18.8977 19.4922 17.1727 20.768 15.1875 21.4382C14.6875 21.5382 14.5 21.2257 14.5 20.9632C14.5 20.6257 14.5125 19.5507 14.5125 18.2132C14.5125 17.2757 14.2 16.6757 13.8375 16.3632C16.0625 16.1132 18.4 15.2632 18.4 11.4257C18.4 10.3257 18.0125 9.43818 17.375 8.73818C17.475 8.48818 17.825 7.46318 17.275 6.08818C17.275 6.08818 16.4375 5.81318 14.525 7.11318C13.725 6.88818 12.875 6.77568 12.025 6.77568C11.175 6.77568 10.325 6.88818 9.525 7.11318C7.6125 5.82568 6.775 6.08818 6.775 6.08818C6.225 7.46318 6.575 8.48818 6.675 8.73818C6.0375 9.43818 5.65 10.3382 5.65 11.4257C5.65 15.2507 7.975 16.1132 10.2 16.3632C9.9125 16.6132 9.65 17.0507 9.5625 17.7007C8.9875 17.9632 7.55 18.3882 6.65 16.8757C6.4625 16.5757 5.9 15.8382 5.1125 15.8507C4.275 15.8632 4.775 16.3257 5.125 16.5132C5.55 16.7507 6.0375 17.6382 6.15 17.9257C6.35 18.4882 7 19.5632 9.5125 19.1007C9.5125 19.9382 9.525 20.7257 9.525 20.9632C9.525 21.2257 9.3375 21.5257 8.8375 21.4382C6.8458 20.7752 5.11342 19.502 3.88611 17.799C2.65881 16.096 1.9989 14.0498 2 11.9507C2 6.42568 6.475 1.95068 12 1.95068Z" fill="currentColor"></path></svg></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="github">GitHub</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="github">Triage PRs, issues, CI, and publish flows</span></span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.05cqw] shrink-0 text-[#aaa]"><path fill-rule="evenodd" d="M18.063 5.674a1 1 0 0 1 .263 1.39l-7.5 11a1 1 0 0 1-1.533.143l-4.5-4.5a1 1 0 1 1 1.414-1.414l3.647 3.647 6.82-10.003a1 1 0 0 1 1.39-.263Z" clip-rule="evenodd"></path></svg></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="circleci"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="circleci"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="/images/codex/icons/plugin-circleci.svg"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="circleci">CircleCI</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="circleci">Build, test, and deploy any application</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="circleci"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div><div class="flex min-w-0 items-center rounded-[0.8cqw] bg-white min-h-[3.8cqw] gap-[0.9cqw] px-[0.3cqw] py-[0.58cqw] dark:bg-[#181818]" data-documentation-plugin-card="marketplace" data-documentation-marketplace-card-surface="cloudflare"><span class="flex size-[1.9cqw] min-h-0 min-w-0 items-center justify-center rounded-[0.7cqw] border border-black/[0.06] bg-white text-[#181818] dark:border-white/[0.08] dark:bg-[#181818] dark:text-white" data-documentation-marketplace-icon-surface="cloudflare"><img alt="" class="size-[1.45cqw] min-h-0 min-w-0" src="https://raw.githubusercontent.com/openai/plugins/main/plugins/cloudflare/assets/cloudflare.png"/></span><span class="min-w-0 flex-1"><span class="block truncate font-medium text-[0.66cqw] leading-[1.25]" data-documentation-marketplace-card-title="cloudflare">Cloudflare</span><span class="block truncate text-[#777] dark:text-[#aaa] text-[0.64cqw] leading-[1.32]" data-documentation-marketplace-card-description="cloudflare">Cloudflare platform guidance and workflows</span></span><span class="flex size-[1.42cqw] shrink-0 items-center justify-center rounded-[0.43cqw] bg-[#f3f3f3] text-[#0d0d0d] dark:bg-[#242424] dark:text-white" data-documentation-marketplace-install-control="cloudflare"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.84cqw]"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg></span></div></div></div></div></div></div></div></div></figure> </div> </div> </div> </div> </div>  <style>
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-ids="[&#34;app&#34;,&#34;web&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <p>The Plugins Directory organizes plugins into tabs:</p><ul>
<li><strong>OpenAI:</strong> plugins built by OpenAI.</li>
<li><strong>Your workspace name:</strong> plugins provided by your workspace.</li>
<li><strong>Personal:</strong> personal marketplace plugins, including <strong>Created by me</strong> and
<strong>Shared with me</strong> sections when those plugins are available.</li>
</ul><p>Use the separate <strong>Installed</strong> row to review plugins you already installed.</p><p>Workspace admins can import and sync a GitHub marketplace for their team. See
<a href="/codex/enterprise/plugin-management">Plugin management</a> for setup and access
requirements.</p><h3 id="__codexlocalizedvalueprops__codextranslations-u0037-install-and-use-a-plugin" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Install and use a plugin</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0037-install-and-use-a-plugin" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0037 install and use a plugin" title="Copy link to __codexlocalizedvalueprops__codextranslations u0037 install and use a plugin"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>Once you open the Plugins Directory:</p><div class="workflow-steps astro-4drqtmie"> <ol>
<li>Search or browse for a plugin, then open its details.</li>
<li>Select the plus button to install the plugin.</li>
<li>If the plugin needs a connector, connect it when prompted. Some plugins
ask you to authenticate during install. Others wait until the first time you
use them.</li>
<li>After installation, start a new chat and ask ChatGPT or Codex to use the
plugin.</li>
</ol> </div><h3 id="__codexlocalizedvalueprops__codextranslations-u0043-connect-supported-partners-with-sign-in-with-chatgpt" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Connect supported partners with Sign in with ChatGPT</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0043-connect-supported-partners-with-sign-in-with-chatgpt" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0043 connect supported partners with sign in with chatgpt" title="Copy link to __codexlocalizedvalueprops__codextranslations u0043 connect supported partners with sign in with chatgpt"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p><strong>Sign in with ChatGPT</strong> is rolling out in beta for supported plugins and
partner sites, including Airtable, GitLab, HubSpot, Notion, Supabase, and
Vercel. When the option is available, select <strong>Sign in with ChatGPT</strong> while
connecting the plugin to create or link your account with that service.</p><p>Signing in shares only your name, email address, and profile picture, when
...
permissions as a separate step before using the connection.</p><p>After you install a plugin, you can use it directly in the prompt window:</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="app" data-ids="[&#34;app&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexComposerDetailIllustration:github-invocation" style="--documentation-screenshot-light-source-width: 1780px; --documentation-screenshot-dark-source-width: 1786px; --documentation-screenshot-light-aspect-ratio: 1780 / 568; --documentation-screenshot-dark-aspect-ratio: 1786 / 564; --documentation-screenshot-light-height-width-limit: calc(400px * 1780 / 568); --documentation-screenshot-dark-height-width-limit: calc(400px * 1786 / 564); --documentation-screenshot-max-height: 400px; --documentation-screenshot-max-width: 100%;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="Installed plugin on the Plugins page"> <figure aria-label="Installed plugin on the Plugins page" data-markdown-description="Installed plugin on the Plugins page" data-markdown-export="illustration" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:890px;--documentation-light-canvas-aspect-ratio:1780 / 568;--documentation-dark-canvas-width:893px;--documentation-dark-canvas-aspect-ratio:1786 / 564"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center" data-documentation-canvas="true" data-documentation-canvas-width="890" data-documentation-dark-canvas-width="893"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] text-[1.02cqw] leading-[1.44] tracking-[-0.008em] antialiased" data-documentation-typography-scope="illustration"><div class="bg-white text-[#202020] shadow-[0_0.55cqw_1.8cqw_rgba(21,25,31,0.07)] ring-1 ring-black/[0.045] dark:text-[#ececec] dark:shadow-[0_0.7cqw_2.15cqw_rgba(0,0,0,0.22)] dark:ring-white/[0.075] flex flex-col rounded-[1.05cqw] pb-[1.32cqw] dark:bg-[#181818] relative w-[85.2%] dark:w-[85.22%] h-[53.5%] dark:h-[53.19%] px-[1.58cqw] pt-[1.26cqw] text-[1.51cqw]" data-documentation-floating-surface="true" data-documentation-rhythm-profile="plugin-invocation"><div class="flex min-w-0 flex-col border bg-white p-[1.3cqw] dark:border-white/[0.11] dark:shadow-[0_9px_25px_rgba(0,0,0,0.25)] py-[0.63cqw] shadow-[0_0.22cqw_0.7cqw_rgba(0,0,0,0.06)] min-h-0 flex-1 rounded-[2.22cqw] border-black/[0.08] px-[1.4cqw] pt-[1.3cqw] pb-[0.88cqw] dark:bg-[#232323] dark:pt-[0.78cqw]" data-documentation-composer="true" data-documentation-source-stroke="composer" data-documentation-composer-density="screenshot"><div class="flex min-w-0 gap-[0.48cqw] min-h-0 flex-1 text-[#181818] dark:text-[#ececec] items-baseline text-[1.53cqw]"><span class="flex shrink-0 items-center gap-[0.38cqw] rounded-[0.8cqw] bg-[#f2e9fb] px-[0.57cqw] py-[0.21cqw] text-[#751ed9] dark:bg-[#312c39] dark:text-[#ae7bf9]" data-documentation-plugin-source-mention="true"><span class="flex size-[1.6cqw] shrink-0 items-center justify-center rounded-[0.45cqw] bg-white text-[#151515]" data-documentation-plugin-mention-icon="github"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[1.08cqw]"><path d="M12 1.95068C17.525 1.95068 22 6.42568 22 11.9507C21.9995 14.0459 21.3419 16.0883 20.1198 17.7902C18.8977 19.4922 17.1727 20.768 15.1875 21.4382C14.6875 21.5382 14.5 21.2257 14.5 20.9632C14.5 20.6257 14.5125 19.5507 14.5125 18.2132C14.5125 17.2757 14.2 16.6757 13.8375 16.3632C16.0625 16.1132 18.4 15.2632 18.4 11.4257C18.4 10.3257 18.0125 9.43818 17.375 8.73818C17.475 8.48818 17.825 7.46318 17.275 6.08818C17.275 6.08818 16.4375 5.81318 14.525 7.11318C13.725 6.88818 12.875 6.77568 12.025 6.77568C11.175 6.77568 10.325 6.88818 9.525 7.11318C7.6125 5.82568 6.775 6.08818 6.775 6.08818C6.225 7.46318 6.575 8.48818 6.675 8.73818C6.0375 9.43818 5.65 10.3382 5.65 11.4257C5.65 15.2507 7.975 16.1132 10.2 16.3632C9.9125 16.6132 9.65 17.0507 9.5625 17.7007C8.9875 17.9632 7.55 18.3882 6.65 16.8757C6.4625 16.5757 5.9 15.8382 5.1125 15.8507C4.275 15.8632 4.775 16.3257 5.125 16.5132C5.55 16.7507 6.0375 17.6382 6.15 17.9257C6.35 18.4882 7 19.5632 9.5125 19.1007C9.5125 19.9382 9.525 20.7257 9.525 20.9632C9.525 21.2257 9.3375 21.5257 8.8375 21.4382C6.8458 20.7752 5.11342 19.502 3.88611 17.799C2.65881 16.096 1.9989 14.0498 2 11.9507C2 6.42568 6.475 1.95068 12 1.95068Z" fill="currentColor"></path></svg></span>GitHub</span><span class="min-w-0 truncate" data-documentation-composer-placeholder="true">address the latest comments on my PR and summarize changes</span></div><div class="flex min-w-0 shrink-0 items-center text-[#666] dark:text-[#b0b0b0] mt-auto gap-[0.95cqw] text-[1.52cqw]" data-documentation-composer-footer="true"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 size-[1.55cqw] min-h-0 min-w-0"><path fill-rule="evenodd" d="M12 5a1 1 0 0 1 1 1v5h5a1 1 0 1 1 0 2h-5v5a1 1 0 1 1-2 0v-5H6a1 1 0 1 1 0-2h5V6a1 1 0 0 1 1-1Z" clip-rule="evenodd"></path></svg><span class="flex min-w-0 shrink-0 items-center gap-[0.42cqw]" data-documentation-composer-model="true"><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 size-[0.83cqw] min-h-0 min-w-0"><path fill-rule="evenodd" d="M15.24 3.486v.002l-1.056 4.517h5.823c1.726 0 2.596 2.021 1.518 3.3l-.002.003-9.308 10.965-.002.002c-1.397 1.656-3.922.223-3.454-1.76v-.003l1.057-4.517H3.993c-1.726 0-2.596-2.021-1.519-3.3l.003-.003 9.308-10.965.002-.002c1.397-1.656 3.922-.223 3.454 1.76Zm-1.95-.444-1.34 5.735a.998.998 0 0 0 .973 1.226h7.074a.04.04 0 0 1 .003.01.045.045 0 0 1-.004.005l-9.287 10.94 1.341-5.735a.998.998 0 0 0-.973-1.226H4.003a.041.041 0 0 1-.003-.01l.004-.005 9.287-10.94Z" clip-rule="evenodd"></path></svg><span class="truncate">5.6 Sol</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 size-[0.72cqw] min-h-0 min-w-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><span class="flex min-w-0 shrink-0 items-center gap-[0.42cqw]" data-documentation-composer-effort="true"><span class="truncate">Extra High</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="shrink-0 size-[0.72cqw] min-h-0 min-w-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><span class="min-w-0 flex-1"></span><img alt="" class="shrink-0 opacity-70 dark:invert size-[1.55cqw] min-h-0 min-w-0" data-documentation-app-icon="microphone" src="/images/codex/icons/app-mic.svg"/><span class="flex items-center justify-center rounded-full bg-[#171717] text-white dark:bg-white dark:text-black size-[3.05cqw] min-h-0 min-w-0"><img alt="" class="brightness-0 invert dark:invert-0 size-[1.58cqw] min-h-0 min-w-0" data-documentation-app-icon="arrow-up" src="/images/codex/icons/arrow-up.svg"/></span></div></div><div class="flex min-w-0 items-center gap-[1.2cqw] text-[#747474] dark:text-[#a3a3a3] text-[1.48cqw] mt-[1.38cqw] dark:mt-[1.92cqw] dark:pr-[4.8cqw]" data-documentation-composer-status="true" data-documentation-composer-status-density="screenshot"><span class="flex min-w-0 shrink-0 items-center gap-[0.45cqw]" data-documentation-composer-status-group="location"><span aria-hidden="true" class="size-[1.1cqw] shrink-0" data-documentation-composer-status-icon="location" style="background-color:currentColor;mask-image:url(&quot;/images/codex/icons/app-laptop.svg&quot;);mask-position:center;mask-repeat:no-repeat;mask-size:contain;-webkit-mask-image:url(&quot;/images/codex/icons/app-laptop.svg&quot;);-webkit-mask-position:center;-webkit-mask-repeat:no-repeat;-webkit-mask-size:contain"></span><span class="truncate">Local</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.9cqw] shrink-0 min-h-0 min-w-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><span class="flex min-w-0 items-center gap-[0.45cqw]" data-documentation-composer-status-group="permission"><span aria-hidden="true" class="size-[1.1cqw] shrink-0" data-documentation-composer-status-icon="permission" style="background-color:currentColor;mask-image:url(&quot;/images/codex/icons/app-shield-code.svg&quot;);mask-position:center;mask-repeat:no-repeat;mask-size:contain;-webkit-mask-image:url(&quot;/images/codex/icons/app-shield-code.svg&quot;);-webkit-mask-position:center;-webkit-mask-repeat:no-repeat;-webkit-mask-size:contain"></span><span class="truncate">Default permissions</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.85cqw] shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span><span class="ml-auto flex min-w-0 shrink-0 items-center gap-[0.45cqw]" data-documentation-composer-status-group="branch"><span aria-hidden="true" class="size-[1.1cqw] shrink-0 min-h-0 min-w-0" data-documentation-composer-status-icon="branch" style="background-color:currentColor;mask-image:url(&quot;/images/codex/icons/app-branch.svg&quot;);mask-position:center;mask-repeat:no-repeat;mask-size:contain;-webkit-mask-image:url(&quot;/images/codex/icons/app-branch.svg&quot;);-webkit-mask-position:center;-webkit-mask-repeat:no-repeat;-webkit-mask-size:contain"></span><span class="truncate">main</span><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="size-[0.85cqw] shrink-0"><path fill-rule="evenodd" d="M4.293 8.293a1 1 0 0 1 1.414 0L12 14.586l6.293-6.293a1 1 0 1 1 1.414 1.414l-7 7a1 1 0 0 1-1.414 0l-7-7a1 1 0 0 1 0-1.414Z" clip-rule="evenodd"></path></svg></span></div><svg width="1em" height="1em" viewBox="0 0 24 24" fill="currentColor" class="absolute right-[1.4cqw] bottom-[1.5cqw] hidden size-[1.5cqw] text-[#737373] dark:block" data-documentation-plugin-source-loading="github-dark"><path opacity="0.3" fill-rule="evenodd" clip-rule="evenodd" d="M12 4C7.58172 4 4 7.58172 4 12C4 16.4183 7.58172 20 12 20C16.4183 20 20 16.4183 20 12C20 7.58172 16.4183 4 12 4ZM2 12C2 6.47715 6.47715 2 12 2C17.5228 2 22 6.47715 22 12C22 17.5228 17.5228 22 12 22C6.47715 22 2 17.5228 2 12Z" fill="currentColor"></path><path d="M12.9995 2.04938C18.0529 2.55089 21.9993 6.81427 21.9995 11.9996C21.9995 17.5224 17.5224 21.9996 11.9995 21.9996C6.81421 21.9994 2.55083 18.053 2.04932 12.9996H4.06494C4.557 16.9458 7.92007 19.9994 11.9995 19.9996C16.4178 19.9996 19.9995 16.4179 19.9995 11.9996C19.9993 7.92009 16.9458 4.55604 12.9995 4.06403V2.04938Z" fill="currentColor"></path></svg></div></div></div></div></figure> </div> </div> </div> </div> </div>  <style>
  [data-documentation-screenshot-presentation] {
    --documentation-screenshot-source-width: var(
      --documentation-screenshot-light-source-width
    );
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-ids="[&#34;app&#34;,&#34;web&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <div class="not-prose mt-4 grid gap-4 md:grid-cols-2"><div class="rounded-xl border border-subtle bg-surface px-5 py-4"><p class="text-sm font-semibold text-default">Describe the task directly</p><p class="mt-2 text-sm text-secondary"><p>Ask for the outcome you want, such as &quot;Summarize unread Gmail threads
from today&quot; or &quot;Pull the latest launch notes from Google Drive.&quot;</p></p><p class="mt-3 text-sm text-secondary"><p>Use this when you want ChatGPT to choose the right installed tools for the
task.</p></p></div><div class="rounded-xl border border-subtle bg-surface px-5 py-4"><p class="text-sm font-semibold text-default">Choose a specific plugin</p><p class="mt-2 text-sm text-secondary"><p>Type <code>@</code> to invoke the plugin or one of its bundled skills
      explicitly.</p></p><p class="mt-3 text-sm text-secondary"><p>Use this when you want to be specific about which plugin or skill ChatGPT
      should use. See <a href="/codex/skills-and-plugins">Skills &amp; Plugins</a>.</p></p></div></div> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="app" data-ids="[&#34;app&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <h3 id="__codexlocalizedvalueprops__codextranslations-u0055-use-apple-messages-from-codex" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Use Apple Messages from Codex</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0055-use-apple-messages-from-codex" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0055 use apple messages from codex" title="Copy link to __codexlocalizedvalueprops__codextranslations u0055 use apple messages from codex"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>The Apple Messages plugin is available on all plans in the ChatGPT desktop app
...
doesn&#39;t work in regular ChatGPT chats.</p><p>For this release, the Messages plugin is included only in the Apple Silicon
(arm64) build of the ChatGPT desktop app.</p><div class="workflow-steps astro-4drqtmie"> <ol>
<li>Open <strong>Plugins</strong>, find the Apple Messages plugin, and install it.</li>
<li>Start a new Codex or ChatGPT Work chat and ask it to find, summarize, draft,
or send a message.</li>
<li>Grant the requested macOS permissions before ChatGPT reads Messages.</li>
<li>Review the message and its recipients before allowing a send.</li>
</ol> </div><p>By default, ChatGPT sends messages only after you approve the message and its
recipients. Choose <strong>Allow once</strong> to approve only that send. If you select
<strong>Always allow sending to this chat</strong>, ChatGPT can send future messages to that
Messages chat without another send approval.</p><p>Keep per-send approval for chats that may contain untrusted or misleading
instructions. Persistent approval removes your final chance to review a message
before ChatGPT sends it as you. Use it only when you accept that risk.</p><p>To restore per-send approval, open <strong>Settings</strong> &gt; <strong>Computer use</strong> and select
<strong>Manage</strong> next to <strong>Messages</strong>. Under <strong>Always allowed to send</strong>, select the
trash icon next to the chat, then confirm <strong>Remove</strong>. ChatGPT will ask
before sending to that chat again.</p><p><strong>Known issue:</strong> If your task is set to <strong>Full access</strong> or otherwise disables
approval prompts, Apple Messages may be unable to show the confirmation needed
to send. Switch to <strong>Ask for approval</strong> or <strong>Approve for me</strong> and try again.</p><p>Apple Messages runs on your Mac. It isn&#39;t directly available in ChatGPT on the
web or mobile, Codex CLI, or the IDE extension.</p><p>In managed workspaces, administrators can disable Apple Messages through the
existing Computer Use control.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="cli" data-ids="[&#34;cli&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface" data-markdown-ignore hidden> <a id="plugin-directory-in-codex-cli"></a><h3 id="__codexlocalizedvalueprops__codextranslations-u0068-plugin-browser-in-codex-cli" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Plugin browser in Codex CLI</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0068-plugin-browser-in-codex-cli" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0068 plugin browser in codex cli" title="Copy link to __codexlocalizedvalueprops__codextranslations u0068 plugin browser in codex cli"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>In Codex CLI, run the following command to open the plugin browser:</p><pre class="astro-code astro-code-themes github-light github-dark" style="background-color:#fff;--shiki-dark-bg:#24292e;color:#24292e;--shiki-dark:#e1e4e8;overflow-x:auto" tabindex="0" data-language="text"><code><span class="line"><span>codex</span></span>
<span class="line"><span>/plugins</span></span></code></pre><div class="min-w-0" data-documentation-screenshot-presentation="screenshot" data-documentation-screenshot-variant="wallpaper" data-documentation-screenshot-canvas-key="CodexPluginCliIllustration:default" style="--documentation-screenshot-light-source-width: 2372px; --documentation-screenshot-dark-source-width: 3252px; --documentation-screenshot-light-aspect-ratio: 2372 / 1212; --documentation-screenshot-dark-aspect-ratio: 3252 / 1416; --documentation-screenshot-light-height-width-limit: calc(400px * 2372 / 1212); --documentation-screenshot-dark-height-width-limit: calc(400px * 3252 / 1416); --documentation-screenshot-max-height: 400px; --documentation-screenshot-max-width: 100%;"> <div class="not-prose flex w-full items-center justify-center rounded-xl bg-[url('/images/codex/codex-wallpaper-1.webp')] bg-cover bg-center p-2"> <div class="mx-auto flex min-w-0 max-w-full items-center justify-center overflow-hidden object-contain w-full" data-documentation-screenshot-viewport style="max-height: var(--documentation-screenshot-max-height); max-width: min(100%, var(--documentation-screenshot-max-width));"> <div class="mx-auto min-w-0 w-full" data-documentation-screenshot-artwork> <div class="contents" data-markdown-export="illustration" data-markdown-description="Plugins list in Codex CLI"> <figure aria-label="Plugins list in Codex CLI" data-markdown-description="Plugins list in Codex CLI" data-markdown-export="illustration" data-documentation-source-density="application" data-documentation-canonical-frame="true" role="img" class="not-prose relative isolate m-0 w-full"><div aria-hidden="true" data-documentation-canvas-stage="true" style="--documentation-light-canvas-width:1186px;--documentation-light-canvas-aspect-ratio:2372 / 1212;--documentation-dark-canvas-width:1626px;--documentation-dark-canvas-aspect-ratio:3252 / 1416"><div class="overflow-hidden rounded-[1.35cqw] bg-transparent p-0 text-[#202020] dark:text-[#ececec] flex items-center justify-center font-mono" data-documentation-canvas="true" data-documentation-canvas-width="1186" data-documentation-dark-canvas-width="1626"><div class="contents font-[-apple-system,BlinkMacSystemFont,Segoe_UI,sans-serif] tracking-[-0.008em] antialiased text-[0.89cqw] leading-[1.4]" data-documentation-typography-scope="illustration"><div class="h-[78.2%] w-[88.87%] overflow-hidden rounded-[0.95cqw] bg-white px-[0.76cqw] py-[0.72cqw] font-mono text-[1.13cqw] leading-[1.27] tracking-[-0.1em] dark:h-[81.36%] dark:w-[91.88%] dark:bg-black" data-documentation-rhythm-profile="plugin-cli"><div class="w-[32.4%] rounded-[0.3cqw] border border-[#878787] px-[0.78cqw] py-[0.67cqw] dark:w-[30.5%]" data-documentation-source-stroke="cli-identity" data-documentation-source-stroke-width="2"><div class="overflow-hidden whitespace-nowrap" data-documentation-cli-line="true"><span class="inline-block whitespace-nowrap" data-documentation-cli-header-line="identity"><span class="mr-[0.65cqw] text-[#828282]">&gt;_</span><span class="font-semibold">OpenAI Codex</span> <span class="text-[#858585]">(v<!-- -->0.117.0-alpha.15<!-- -->)</span></span></div><div class="mt-[1.35cqw] overflow-hidden whitespace-nowrap" data-documentation-cli-line="true"><span class="inline-block whitespace-nowrap" data-documentation-cli-header-line="model"><span class="text-[#858585]">model:</span> <span class="ml-[1.4cqw] dark:hidden">5.6 Sol<!-- --> medium</span><span class="ml-[1.4cqw] hidden dark:inline">5.6 Sol<!-- --> xhigh</span> <span class="text-[#00c5c8] dark:text-[#d1d1ff]" data-documentation-cli-model-link="true">/model</span> <span class="text-[#858585]">to change</span></span></div><div class="overflow-hidden whitespace-nowrap" data-documentation-cli-line="true"><span class="inline-block whitespace-nowrap" data-documentation-cli-header-line="directory"><span class="text-[#858585]">directory:</span> <!-- -->~/code/OpenAIDevelopers/openai</span></div></div><div class="mt-[2.05cqw] overflow-hidden text-ellipsis whitespace-nowrap text-[1.13cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="inline-block whitespace-nowrap" data-documentation-cli-tip="true"><span class="font-semibold">Tip:</span> <span class="italic">New</span> Try the<!-- --> <span class="font-semibold">Codex App</span> with 2x rate limits until <span class="italic">April 2nd.</span> Run &#x27;codex app&#x27; or visit https://chatgpt.com/codex?app-landing-page=true</span></div><div class="mt-[1.15cqw] bg-[#f3f4f4] px-[1.05cqw] pt-[1.95cqw] pb-[0.41cqw] dark:bg-[#1e1e1e] dark:pt-[1.55cqw] dark:pb-[0.81cqw]" data-documentation-cli-content="true"><div class="font-semibold" data-documentation-cli-line="true">Plugins</div><div class="text-[#818181]" data-documentation-cli-line="true">Browse plugins from available marketplaces.</div><div class="text-[#818181]" data-documentation-cli-line="true">Installed <span class="dark:hidden">11</span><span class="hidden dark:inline">9</span> of 29 available plugins.</div><div class="mt-[1.35cqw] text-[#818181]" data-documentation-cli-line="true">Type to search plugins</div><div class="mt-[0.18cqw] text-[1.13cqw] leading-[1.27] tracking-[-0.1em]" data-documentation-cli-plugin-theme="light-and-dark"><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27] text-[#009c9d] dark:text-[#e6e6ff]" data-documentation-cli-line="true" data-documentation-cli-selected-row="true"><span class="truncate"><span class="absolute -left-[1.15cqw]">›</span>Canva</span><span class="whitespace-nowrap" data-documentation-cli-install-state="true">Installed</span><span class="truncate">Press Enter to view plugin details.</span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate">Figma</span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span>· Codex official · <!-- -->Design-to-code workflows powered by the Figma integration</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate">GitHub</span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span>· Codex official · <!-- -->Triage PRs, issues, CI, and publish flows</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate">Gmail</span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span>· Codex official · <!-- -->Read and manage Gmail</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate">Google Calendar</span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span>· Codex official · <!-- -->Manage Google Calendar events and schedules</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate">Google Drive</span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span>· Codex official · <!-- -->Work across Drive, Docs, Sheets, and Slides</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate"><span class="dark:hidden">Linear</span><span class="hidden dark:inline">Sentry</span></span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span class="dark:hidden">· Codex official · <!-- -->Find and reference issues and projects.</span><span class="hidden dark:inline">· Codex official · <!-- -->Inspect recent Sentry issues and events</span></span></div><div class="relative grid min-w-0 grid-cols-[20.1%_8%_1fr] gap-[0.5cqw] leading-[1.27]" data-documentation-cli-line="true"><span class="truncate"><span class="dark:hidden">Notion</span><span class="hidden dark:inline">Slack</span></span><span class="whitespace-nowrap text-[#858585]" data-documentation-cli-install-state="true">Installed</span><span class="truncate text-[#858585]"><span class="dark:hidden">· Codex official · <!-- -->Notion workflows for specs, research, meetings, and knowledge capture</span><span class="hidden dark:inline">· Codex official · <!-- -->Read and manage Slack</span></span></div></div></div><div class="mt-[0.3cqw] pl-[1.1cqw] text-[#818181]">Press esc to close.</div></div></div></div></div></figure> </div> </div> </div> </div> </div> <script type="module" src="/_astro/CodexScreenshotPresentation.astro_astro_type_script_index_0_lang.DDyaJJf-.js"></script> <style>
  [data-documentation-screenshot-presentation] {
    --documentation-screenshot-source-width: var(
      --documentation-screenshot-light-source-width
    );
...
</style><p>The CLI plugin browser groups plugins by marketplace. Use the marketplace tabs
...
on or off.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-ids="[&#34;app&#34;,&#34;cli&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <h3 id="__codexlocalizedvalueprops__codextranslations-u0073-api-key-availability" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">API key availability</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0073-api-key-availability" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0073 api key availability" title="Copy link to __codexlocalizedvalueprops__codextranslations u0073 api key availability"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3><p>If you <a href="/codex/auth#sign-in-with-an-api-key">sign in to Codex with an OpenAI API
key</a>, you can browse, install, and manage
...
on the <a href="https://platform.openai.com/usage">Platform Usage page</a>.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<h3 id="__codexlocalizedvalueprops__codextranslations-u0075-how-permissions-and-data-sharing-work" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">How permissions and data sharing work</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0075-how-permissions-and-data-sharing-work" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0075 how permissions and data sharing work" title="Copy link to __codexlocalizedvalueprops__codextranslations u0075 how permissions and data sharing work"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3>
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-id="web" data-ids="[&#34;web&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface" data-markdown-ignore hidden> <p>In ChatGPT on the web, Chat and Work use the workspace permissions and tools
available to that chat. Connectors still require their own sign-in and access.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<div class="content-mode-switch" data-content-mode-switch data-group="codex-surface" data-ids="[&#34;app&#34;,&#34;cli&#34;]" data-default="app" data-choices="[&#34;app&#34;,&#34;web&#34;,&#34;cli&#34;,&#34;ide&#34;]" data-query-param="surface"> <p>When a plugin capability runs through a Codex host, the host&#39;s <a href="/codex/agent-approvals-security">sandbox and
approval policy</a> applies.
Connections to external services use that service&#39;s own authentication and
access controls.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<ul>
<li>Bundled skills become available when you start a new chat or CLI session
after installation.</li>
<li>If a plugin includes connectors, the active product may prompt you to install
or sign in to those connectors during setup or the first time you use them.</li>
<li>If a plugin includes MCP servers, they may require extra setup or
authentication before you can use them.</li>
<li>When ChatGPT sends data through a bundled connector, that service&#39;s terms and privacy
policy apply.</li>
</ul>
<h3 id="__codexlocalizedvalueprops__codextranslations-u0082-remove-a-plugin" class="group flex items-center gap-1 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Remove a plugin</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0082-remove-a-plugin" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0082 remove a plugin" title="Copy link to __codexlocalizedvalueprops__codextranslations u0082 remove a plugin"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-3.5 w-3.5 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h3>
<p>To remove a plugin, open it from a supported plugin browser and select
<strong>Uninstall plugin</strong> when that action is available. Workspace-installed or
default plugins may not offer that action; your workspace administrator controls
them instead.</p>
<p>Uninstalling a plugin removes the plugin bundle from that ChatGPT or Codex
environment, but bundled connectors stay connected until you manage them in
ChatGPT.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0085-build-your-own-plugin" class="group flex items-center gap-2 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Build your own plugin</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0085-build-your-own-plugin" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0085 build your own plugin" title="Copy link to __codexlocalizedvalueprops__codextranslations u0085 build your own plugin"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h2>
<p>If you want to create, test, or distribute your own plugin, see
<a href="https://developers.openai.com/plugins/build/plugins">Build plugins</a>. That page covers local scaffolding,
manual marketplace setup, workspace sharing, plugin manifests, and packaging
guidance.</p>
<p>If your plugin includes server-backed capabilities, see
<a href="https://developers.openai.com/plugins/build/mcp-server">Build an MCP server</a>.
MCP tools can work without custom UI or return UI when a visual surface helps
the workflow.</p>
<p>When your plugin is ready for review, see
<a href="https://developers.openai.com/plugins/deploy/submission">Submit plugins</a> for the OpenAI Platform submission
flow, required permissions, review materials, MCP checks, and test case
requirements.</p>
<h2 id="__codexlocalizedvalueprops__codextranslations-u0089-plugin-guides" class="group flex items-center gap-2 mt-7 mb-2 scroll-mt-[110px] " ><span class="min-w-0">Plugin guides</span><button type="button" class="shrink-0 self-center inline-flex items-center justify-center rounded-md p-0.5 opacity-0 transition-colors transition-opacity duration-200 ease-out text-info hover:text-info focus-visible:opacity-100 group-focus-within:opacity-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-gray-300 group-hover:opacity-100 dark:focus-visible:outline-gray-600 motion-reduce:transition-none relative -top-0.5" data-anchor-id="__codexlocalizedvalueprops__codextranslations-u0089-plugin-guides" aria-label="Copy link to __codexlocalizedvalueprops__codextranslations u0089 plugin guides" title="Copy link to __codexlocalizedvalueprops__codextranslations u0089 plugin guides"><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 "><path d="M18.2929 5.7071C16.4743 3.88849 13.5257 3.88849 11.7071 5.7071L10.7071 6.7071C10.3166 7.09763 9.68341 7.09763 9.29289 6.7071C8.90236 6.31658 8.90236 5.68341 9.29289 5.29289L10.2929 4.29289C12.8926 1.69322 17.1074 1.69322 19.7071 4.29289C22.3068 6.89255 22.3068 11.1074 19.7071 13.7071L18.7071 14.7071C18.3166 15.0976 17.6834 15.0976 17.2929 14.7071C16.9024 14.3166 16.9024 13.6834 17.2929 13.2929L18.2929 12.2929C20.1115 10.4743 20.1115 7.52572 18.2929 5.7071ZM15.7071 8.29289C16.0976 8.68341 16.0976 9.31658 15.7071 9.7071L9.7071 15.7071C9.31658 16.0976 8.68341 16.0976 8.29289 15.7071C7.90236 15.3166 7.90236 14.6834 8.29289 14.2929L14.2929 8.29289C14.6834 7.90236 15.3166 7.90236 15.7071 8.29289ZM6.7071 9.29289C7.09763 9.68341 7.09763 10.3166 6.7071 10.7071L5.7071 11.7071C3.88849 13.5257 3.88849 16.4743 5.7071 18.2929C7.52572 20.1115 10.4743 20.1115 12.2929 18.2929L13.2929 17.2929C13.6834 16.9024 14.3166 16.9024 14.7071 17.2929C15.0976 17.6834 15.0976 18.3166 14.7071 18.7071L13.7071 19.7071C11.1074 22.3068 6.89255 22.3068 4.29289 19.7071C1.69322 17.1074 1.69322 12.8926 4.29289 10.2929L5.29289 9.29289C5.68341 8.90236 6.31658 8.90236 6.7071 9.29289Z" fill="currentColor"></path></svg></button></h2>
<ul>
<li><a href="/codex/extend/record-and-replay">Record &amp; Replay</a>: Show ChatGPT a workflow
  once and turn it into a reusable skill.</li>
<li><a href="/codex/security/plugin">Codex Security plugin</a>: Scan authorized code,
  confirm findings, and prepare reviewed fixes.</li>
