...
<h2 id="use-a-slash-command">Use a slash command</h2>
<ol>
...
<h2 id="available-slash-commands">Available slash commands</h2>
...
<h2 id="set-or-manage-a-goal-with-goal">Set or manage a goal with <code>/goal</code></h2>
