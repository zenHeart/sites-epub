...
</style><!-- Canonical URL --><link rel="canonical" href="https://learn.chatgpt.com/docs/sandboxing"><!-- Primary Meta Tags --><title data-default-meta-title="Sandbox – Codex | OpenAI Developers" data-site-variant-meta-titles="{&#34;chatgpt-docs&#34;:&#34;Sandbox | ChatGPT Learn&#34;}">
...
</script><p>Codex uses the first <code>bwrap</code> executable it finds on <code>PATH</code>. If no <code>bwrap</code>
...
broadening access across unrelated repositories.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
Codex sandbox or approval-mode selector.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
to open the permissions picker and change the active permissions profile.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
</style></div> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
...
<a href="/codex/agent-approvals-security">Agent approvals &amp; security</a>.</p> </div> <script data-astro-rerun>
  (() => {
    const root = document.currentScript?.previousElementSibling;
    if (!root) return;
    const { group, default: defaultValue, queryParam = group } = root.dataset;
