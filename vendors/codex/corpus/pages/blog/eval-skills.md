...
The creator asks you what the skill does, when it should trigger, and whether it's instruction-only or script-backed (instruction-only is the default recommendation). To learn more about creating a skill, [check out the documentation](/codex/build-skills#create-a-skill).
