...
11. For encryption with your own keys, enable **[CMEK](https://cursor.com/docs/enterprise/privacy-and-data-governance.md#data-encryption)** when your compliance program requires it (Cloud Agent data).
...
| **CMEK**                     | Encrypt Cloud Agent data with your own key when your compliance program requires customer-managed keys.                                                                                             | [CMEK](https://cursor.com/docs/enterprise/privacy-and-data-governance.md#data-encryption)                               |
...
| :------------------------------------ | :-------------------------------------------------------------------------------------------------------------------------- | :----------------------------------------------------------------------------------------------------------------------------------------------------- |
| **Individual account deletion**       | That user's account and associated data; removed within 30 days. Does not by itself complete enterprise tenant offboarding. | Dashboard → Advanced Account Settings → Delete Account ([guide](https://cursor.com/help/account-and-billing/delete-account.md))                        |
...
| **Automatic expiry**                  | Cloud Agent snapshots (90 days inactivity).                                                                                 | Automatic, no action needed ([snapshots](https://cursor.com/docs/cloud-agent/security-network.md#data-retention))                                      |
