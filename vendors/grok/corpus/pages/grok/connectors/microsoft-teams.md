...
**We do not train on your data.** SpaceXAI does not use your Microsoft Teams data for model training.

**Nothing is stored.** Conversations that use your Teams connector do not result in any of your Teams data being stored on SpaceXAI servers. Grok accesses your data in real time when you ask a question, and does not retain it afterward.
