...
<ResponseField name="api" type="API">
  Configuration for API settings. Learn more about API pages at [API Components](/docs/api-playground/demo).
    ...
    <ResponseField name="playground" type="Playground">
      ...
      <Expandable title="Playground">
        <ResponseField name="mode" default="show" type="&#x22;show&#x22; | &#x22;simple&#x22; | &#x22;hide&#x22;">
          ...
          Learn more at the [playground guides](/docs/api-playground/demo)
        </ResponseField>
      </Expandable>
    </ResponseField>
