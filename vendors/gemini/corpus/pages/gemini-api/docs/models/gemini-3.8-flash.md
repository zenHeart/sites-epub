...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash?hl=bn" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash?hl=fa" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash?hl=ru" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash?hl=sq" /><title>Gemini 3.8 Flash &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini 3.8 Flash &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn about Gemini 3.8 Flash from Google">
  <meta property="og:description" content="Learn about Gemini 3.8 Flash from Google"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/models/gemini-3.8-flash"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini 3.8 Flash<devsite-actions hidden data-nosnippet>
...
<p>Gemini 3.8 Flash is our most intelligent Flash model, engineered for long-horizon software engineering, autonomous agents, and complex enterprise workflows—all with the speed and cost efficiency of Flash.</p>

<div style="text-align: center; padding: 1rem; margin-bottom: -3rem;">
  <a href="https://aistudio.google.com/prompts/new_chat?model=gemini-3.8-flash"class="gemini-api-model-button">Try in Google AI Studio</a>
</div>
...
<h2 id="gemini-38-flash" data-text="gemini-3.8-flash" tabindex="-1">gemini-3.8-flash</h2>
...
<p><span class="gemini-api-supported">Supported (low, medium, high)</span></p>
<p>Note: <code translate="no" dir="ltr">minimal</code> is not supported and returns an error.</p>
</section>
      <section>
...
<ul>
<li>Stable: <code translate="no" dir="ltr">gemini-3.8-flash</code></li>
</ul>
</section>
</td>
</tr>
...
<td><a href="https://deepmind.google/models/model-cards/gemini-3-8-flash/">Model card</a></td>
</tr>
</table>
