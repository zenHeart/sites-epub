...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe?hl=sq" /><title>Gemini 3.5 Transcribe &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini 3.5 Transcribe &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn about the Gemini 3.5 Transcribe model from Google">
  <meta property="og:description" content="Learn about the Gemini 3.5 Transcribe model from Google"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-transcribe"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini 3.5 Transcribe<devsite-actions hidden data-nosnippet>
...
<p>Gemini 3.5 Transcribe is a speech-to-text model based on Gemini&#39;s audio understanding capabilities. It provides low-latency, accurate transcription with utterance-based language detection, speaker diarization, word-level timestamps, Smart transcription, and custom vocabulary speech biasing.</p>

<div style="text-align: center; padding: 1rem; margin-bottom: -3rem;">
  <a href="https://aistudio.google.com/prompts/new_chat?model=gemini-3.5-transcribe" class="gemini-api-model-button">Try in Google AI Studio</a>
</div>

<h2 id="documentation" data-text="Documentation" tabindex="-1">Documentation</h2>

<p>Gemini 3.5 Transcribe converts speech to text from audio files. It automatically detects 85+ languages, handles multi-language code-switching, identifies individual speakers, outputs word-level timestamps, and adapts to domain-specific terms through custom vocabulary biasing.</p>

<p>Visit the <a href="/gemini-api/docs/transcribe">Audio transcription</a> guide for full coverage of non-streaming features. For real-time, low-latency streaming transcription over WebSockets, visit the <a href="/gemini-api/docs/live-api/live-transcribe">Live transcription</a> guide using <code translate="no" dir="ltr">gemini-3.5-transcribe-live</code>. For detailed pricing, see the <a href="/gemini-api/docs/pricing#gemini-3.5-transcribe">Pricing page</a>.</p>

<h2 id="gemini-35-transcribe" data-text="gemini-3.5-transcribe" tabindex="-1">gemini-3.5-transcribe</h2>
...
<section>
<p><b>Inputs</b></p>
<p>Audio (up to 1 hour)</p>
</section>
<section>
<p><b>Output</b></p>
<p>Text, Word annotations</p>
</section>
</td>
</tr>
<tr>
<td><span aria-hidden="true" class="google-symbols">token_auto</span>Audio limits</td>
<td class="gemini-api-model-table-grid">
<section>
<p><b>Unary audio limit</b></p>
<p>Up to 1 hour per request (up to 30 minutes when speaker diarization or word-level timestamps are enabled)</p>
</section>
</td>
</tr>
<tr>
...
<p><b><a href="/gemini-api/docs/transcribe">Audio transcription</a></b></p>
<p><span class="gemini-api-supported">Supported</span></p>
</section>
      <section>
<p><b><a href="/gemini-api/docs/transcribe#speaker-diarization">Speaker diarization</a></b></p>
<p><span class="gemini-api-supported">Supported</span></p>
</section>
      <section>
<p><b><a href="/gemini-api/docs/transcribe#word-timestamps">Word-level timestamps</a></b></p>
<p><span class="gemini-api-supported">Supported</span></p>
</section>
      <section>
<p><b><a href="/gemini-api/docs/transcribe#custom-vocabulary">Custom vocabulary</a></b></p>
<p><span class="gemini-api-supported">Supported</span></p>
</section>
      <section>
<p><b><a href="/gemini-api/docs/transcribe#transcription-modes">Smart transcription</a></b></p>
<p><span class="gemini-api-supported">Supported</span></p>
</section>
      <section>
...
<p><span class="gemini-api-not-supported">Not supported</span></p>
      ...
      <section><p><b><a href="/gemini-api/docs/flex-inference">Flex inference</a></b></p>
        <p><span class="gemini-api-not-supported">Not supported</span></p>
      </section>
      <section><p><b><a href="/gemini-api/docs/priority-inference">Priority inference</a></b></p>
        <p><span class="gemini-api-not-supported">Not supported</span></p>
      </section>
      </td>
  </tr>
...
<ul>
<li><code translate="no" dir="ltr">gemini-3.5-transcribe</code> (Unary)</li>
<li><code translate="no" dir="ltr">gemini-3.5-transcribe-live</code> (Live API)</li>
</ul>
</section>
</td>
</tr>
...
<h2 id="feature-support-and-limitations" data-text="Feature support and limitations" tabindex="-1">Feature support and limitations</h2>

<p>Gemini 3.5 Transcribe supports the following features across its two endpoints:</p>

<table>
<thead>
<tr>
<th style="text-align: left">Feature</th>
<th style="text-align: left">Live Streaming (<code translate="no" dir="ltr">gemini-3.5-transcribe-live</code>)</th>
<th style="text-align: left">Audio File Processing (<code translate="no" dir="ltr">gemini-3.5-transcribe</code>)</th>
...
<tbody>
<tr>
<td style="text-align: left"><strong>Language Auto-detection</strong></td>
<td style="text-align: left">Supported (85+ languages)</td>
<td style="text-align: left">Supported (85+ languages)</td>
<td style="text-align: left">Includes mid-session code-mixing.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Word-level Timestamps</strong></td>
<td style="text-align: left">Not Supported</td>
<td style="text-align: left">Supported</td>
<td style="text-align: left">Degrades transcription accuracy. Incompatible with custom vocabulary.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Custom Vocabulary Biasing</strong></td>
<td style="text-align: left">Supported (up to 1,000 terms)</td>
<td style="text-align: left">Supported (up to 1,000 terms)</td>
<td style="text-align: left">Customers typically see best results with up to 100 terms. Incompatible with diarization and timestamps.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Smart Dictation &amp; Formatting</strong></td>
<td style="text-align: left">Supported</td>
<td style="text-align: left">Supported</td>
<td style="text-align: left">Includes filler word removal and intent-aware alphanumeric formatting.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Speaker Diarization</strong></td>
<td style="text-align: left">Not Supported</td>
<td style="text-align: left">Supported (up to 8 speakers)</td>
<td style="text-align: left">Attribution for 3+ speakers is experimental. Incompatible with custom vocabulary.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Max Audio Duration</strong></td>
<td style="text-align: left">10 minutes per session.</td>
<td style="text-align: left">Up to 1 hour</td>
<td style="text-align: left">File processing is limited to 30 minutes when features like diarization or timestamps are enabled.</td>
</tr>
</tbody>
</table>
...
<devsite-content-footer class="nocontent" data-nosnippet>
  ...
  <p>Last updated 2026-09-01 UTC.</p>
