...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite?hl=sq" /><title>Gemini 3.5 Flash-Lite &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini 3.5 Flash-Lite &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn about Gemini 3.5 Flash-Lite from Google">
  <meta property="og:description" content="Learn about Gemini 3.5 Flash-Lite from Google"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/models/gemini-3.5-flash-lite"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini 3.5 Flash-Lite<devsite-actions hidden data-nosnippet>
...
<p>Gemini 3.5 Flash-Lite is a low-latency, cost-effective multimodal model
...
primary constraints.</p>

<div style="text-align: center; padding: 1rem; margin-bottom: -3rem;">
  <a href="https://aistudio.google.com/prompts/new_chat?model=gemini-3.5-flash-lite"class="gemini-api-model-button">Try in Google AI Studio</a>
</div>

<h2 id="documentation" data-text="Documentation" tabindex="-1">Documentation</h2>

<p>Visit the
<a href="/gemini-api/docs/latest-model">Latest model</a>
page for full coverage of features and capabilities.</p>

<h2 id="gemini-35-flash-lite" data-text="gemini-3.5-flash-lite" tabindex="-1">gemini-3.5-flash-lite</h2>
...
<table class="gemini-api-model-table">
  ...
  <tr>
    ...
    <td class="gemini-api-model-table-grid">
      ...
      <section>
        ...
        <p><span class="gemini-api-supported">Supported (Preview)</span></p>
      </section>
      <section>
  ...
  <tr>
    ...
    <td>
      <section>
        ...
        <ul>
          <li>Stable: <code translate="no" dir="ltr">gemini-3.5-flash-lite</code></li>
        </ul>
      </section>
    </td>
  </tr>
  ...
  <tr>
    ...
    <td><a href="https://deepmind.google/models/model-cards/gemini-3-5-flash-lite/">Model card</a></td>
  </tr>
</table>
