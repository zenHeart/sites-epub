...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/rate-limits"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/rate-limits" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/rate-limits" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/rate-limits?hl=sq" /><title>Rate limits &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Rate limits &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/rate-limits"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Rate limits<devsite-actions hidden data-nosnippet>
...
<p>Rate limits regulate the number of requests you can make to the Gemini API
within a given timeframe. These limits help maintain fair usage, protect against
abuse, and help maintain system performance for all users.</p>

<p><a href="https://aistudio.google.com/rate-limit?timeRange=last-28-days" class="button button-primary ais">View your active rate limits in AI Studio</a></p>

<h2 id="how-rate-limits-work" data-text="How rate limits work" tabindex="-1">How rate limits work</h2>

<p>Rate limits are usually measured across three dimensions:</p>

<ul>
<li>Requests per minute (<strong>RPM</strong>)</li>
<li>Tokens per minute (input) (<strong>TPM</strong>)</li>
<li>Requests per day (<strong>RPD</strong>)</li>
</ul>

<p>Your usage is evaluated against each limit, and exceeding any of them will
...
your TPM or other limits.</p>

<p>Rate limits are applied per project, not per API key. Requests per day (<strong>RPD</strong>)
quotas reset at midnight Pacific time.</p>

<p>Limits vary depending on the specific model being used, and some limits only
...
conceptually similar to TPM. Other models might have a token per day limit (TPD).</p>

<p>Rate limits are more restricted for experimental and preview models.</p>

<h3 id="spend-rate-limits" data-text="Spend-based rate limits" tabindex="-1">Spend-based rate limits</h3>

<p>In addition to requests per minute (RPM) and tokens per minute (TPM) limits, the
...
history and <a href="#usage-tiers">usage tier</a>.</p>

<p>The following table shows the spend-based rate limits for each
<a href="#usage-tiers">usage tier</a>. These limits are evaluated on a rolling 10-minute
window. Whether these limits apply to your account depends on your billing
history and account standing.</p>

<table>
<thead>
<tr>
<th style="text-align: left">Usage tier</th>
<th style="text-align: left">Spend rate limit (per 10 minutes)</th>
</tr>
</thead>
...
<p>If you hit a spend-based rate limit, the API returns a <code translate="no" dir="ltr">429 RESOURCE_EXHAUSTED</code>
error. To resolve this:</p>

<ul>
<li><strong>Wait and retry</strong> after a short period.</li>
<li><strong>Reduce the rate of expensive requests</strong>, for example by using smaller
context windows or shorter outputs.</li>
<li>If you consistently hit this limit during normal usage,
<a href="#request-rate-limit-increase">request a rate limit increase</a>.</li>
</ul>

<h2 id="usage-tiers" data-text="Usage tiers" tabindex="-1">Usage tiers</h2>

<p>Rate limits are tied to the project&#39;s usage tier. As your API usage and spending
increase, you&#39;ll be automatically upgraded to a higher tier with increased rate
limits.</p>

<p>The qualifications for Tiers 2 and 3 are based on the total cumulative spending
on Google Cloud services (including, but not limited to, the Gemini API) for the
billing account linked to your project.</p>
...
<th style="text-align: left"><a href="/gemini-api/docs/billing#tier-spend-caps">Billing tier cap</a></th>
</tr>
</thead>
...
<tr>
<td style="text-align: left"><strong>Tier 1</strong></td>
<td style="text-align: left"><a href="/gemini-api/docs/billing#setup-billing">Set up and link an active billing account</a></td>
...
<p>While meeting the stated qualification criteria is generally
sufficient for approval, in rare cases an upgrade request may be denied based on
other factors identified during the review process.</p>

<p>This system helps maintain the security and integrity of the Gemini API platform
for all users.</p>

<h2 id="current-rate-limits" data-text="Gemini API rate limits" tabindex="-1">Gemini API rate limits</h2>

<p>Rate limits depend on a variety of factors (such as your usage tier) and can be
viewed in Google AI Studio. As your tier and account status change over time,
your rate limits will automatically update.</p>

<p><a href="https://aistudio.google.com/rate-limit?timeRange=last-28-days" class="button button-primary ais">View your active rate limits in AI Studio</a></p>

<p>Specified rate limits are not guaranteed and actual capacity may vary.</p>

<h2 id="priority" data-text="Priority inference rate limits" tabindex="-1">Priority inference rate limits</h2>

<p><a href="/gemini-api/docs/priority-inference">Priority</a> consumption holds its own rate
limits even though consumption is counted towards overall interactive traffic
rate limits. <strong>Default rate limits are: 0.3x the <a href="https://aistudio.google.com/rate-limit">standard rate limit</a> for each model and tier</strong></p>

<h2 id="batch-api" data-text="Batch API rate limits" tabindex="-1">Batch API rate limits</h2>

<p><a href="/gemini-api/docs/batch-api">Batch API</a> requests are subject to their own rate
limits, separate from the non-batch API calls.</p>

<ul>
<li><strong>Concurrent batch requests:</strong> 100</li>
<li><strong>Input file size limit:</strong> 2GB</li>
<li><strong>File storage limit:</strong> 20GB</li>
<li><strong>Enqueued tokens per model:</strong> The <strong>Batch enqueued tokens</strong> table lists the
maximum number of tokens that can be enqueued for batch processing across
all your active batch jobs for a given model.</li>
</ul>

<div>
  <devsite-selector>
    <section>
      <h3 id="tier-1" data-text="Tier 1" tabindex="-1">Tier 1</h3>
      <table>
        <thead>
          <tr>
            <th>Model</th>
            <th>Batch enqueued tokens</th>
          </tr>
        </thead>
        <tbody>
          <tr>
            <th colspan="5" class="sub-heading">Text-out models</th>
          </tr>
          ...
          <tr>
            <td>Gemini 2.5 Flash Image Preview</td>
            <td>3,000,000</td>
          </tr>
          <tr>
          ...
          <tr>
            <td>Gemini 2.5 Flash Lite Preview</td>
            <td>10,000,000</td>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="5" class="sub-heading">Multi-modal generation models</th>
          </tr>
          <tr>
          ...
          <tr>
            <th colspan="5" class="sub-heading">Embedding models</th>
          </tr>
          <tr>
    ...
    <section>
      <h3 id="tier-2" data-text="Tier 2" tabindex="-1">Tier 2</h3>
      <table>
        <thead>
          <tr>
            <th>Model</th>
    ...
    <section>
      <h3 id="tier-3" data-text="Tier 3" tabindex="-1">Tier 3</h3>
      <table>
        <thead>
          <tr>
            <th>Model</th>
...
<h2 id="how-to-upgrade-to-the-next-tier" data-text="How to upgrade to the next tier" tabindex="-1">How to upgrade to the next tier</h2>

<p>To transition from the Free tier to a paid tier, you must first
<a href="/gemini-api/docs/billing">set up billing in AI Studio</a>.</p>

<p>Once your project meets the <a href="#usage-tiers">specified criteria</a>, it will be
...
effect within 10 minutes. Navigate to the <a href="https://aistudio.google.com/projects">Projects page</a> in AI Studio to check your tiers.</p>

<h2 id="request-rate-limit-increase" data-text="Request a rate limit increase" tabindex="-1">Request a rate limit increase</h2>

<p>Each model variation has an associated rate limit (requests per minute, RPM).
For details on those rate limits, see the
<a href="https://aistudio.google.com/rate-limit">AI Studio Rate Limit</a> page.</p>

<p><a href="https://forms.gle/ETzX94k8jf7iSotH9" class="button button-primary ais">Request paid tier rate limit increase</a></p>

<p>We offer no guarantees about increasing your rate limit, but we&#39;ll do our best
