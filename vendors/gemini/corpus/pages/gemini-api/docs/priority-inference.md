...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/priority-inference"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/priority-inference" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/priority-inference" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/priority-inference?hl=sq" /><title>Priority inference &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Priority inference &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/priority-inference"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Priority inference<devsite-actions hidden data-nosnippet>
...
<p><div id="gemini-api-switcher-trigger" style="display:none;"></div>Description: Learn how to optimize latency with the Priority inference tier in the Interactions API</p>

<p>
</p>


<aside class="preview"><strong>Preview:</strong><span> The Gemini Priority API is in
<a href="https://cloud.google.com/products#product-launch-stages">Preview</a>.</span></aside>
<p>The Gemini Priority API is a premium inference tier designed for
...
standard API and Flex tier traffic.</p>

<p>Priority inference is available across the Interactions API endpoints.</p>

<h2 id="how-to-use" data-text="How to use Priority" tabindex="-1">How to use Priority</h2>

<p>To use the Priority tier, set the <code translate="no" dir="ltr">service_tier</code> field in your request to <code translate="no" dir="ltr">priority</code>. The default tier is standard if the field is omitted.</p>
...
<span class="devsite-syntax-n">interaction</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">interactions</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">create</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-nb">input</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s2">"Triage this critical customer support ticket immediately."</span><span class="devsite-syntax-p">,</span>
    <span class="devsite-syntax-n">service_tier</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s1">'priority'</span>
...
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-nx">input</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Triage this critical customer support ticket immediately."</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-nx">service_tier</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"priority"</span>
...
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">input</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">InteractionsInput</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">of</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-s">"Perform a priority inference task."</span><span class="devsite-syntax-p">))</span>
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">serviceTier</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">ServiceTier</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">PRIORITY</span><span class="devsite-syntax-p">)</span>
...
<span class="devsite-syntax-s1">    "input": "Triage this critical customer support ticket immediately.",</span>
<span class="devsite-syntax-s1">    "service_tier": "priority"</span>
<span class="devsite-syntax-s1">  }'</span>
</code></pre></devsite-code></section>
</devsite-selector></div>
<h2 id="how-it-works" data-text="How Priority inference works" tabindex="-1">How Priority inference works</h2>

<p>Priority inference routes requests to high-criticality compute queues, offering
...
<ul>
<li><strong>Low latency</strong>: Designed for second response times for interactive,
user-facing AI tools.</li>
<li><strong>High reliability</strong>: Traffic is treated with the highest criticality and is
strictly non-sheddable.</li>
<li><strong>Graceful degradation</strong>: Traffic spikes exceeding dynamic limits are
automatically downgraded to the Standard tier for processing instead of failing,
preventing service outages.</li>
<li><strong>Low friction</strong>: Uses the same synchronous <code translate="no" dir="ltr">create</code> method as the
standard and Flex tiers.</li>
</ul>

<h3 id="use-cases" data-text="Use cases" tabindex="-1">Use cases</h3>

<p>Priority processing is ideal for business-critical workflows where performance
and reliability are paramount.</p>

<ul>
<li><strong>Interactive AI applications</strong>: Customer service chatbots and copilots where
users pay a premium and expect fast, consistent responses.</li>
<li><strong>Real-time decision engines</strong>: Systems requiring highly reliable, low-latency
outcomes, such as live ticket triaging or fraud detection.</li>
<li><strong>Premium customer features</strong>: Developers who need to guarantee higher service
level objectives (SLOs) for paying customers.</li>
</ul>

<h3 id="rate-limits" data-text="Rate limits" tabindex="-1">Rate limits</h3>

<p>Priority consumption holds its own rate limits even though consumption is
counted towards <a href="https://aistudio.google.com/rate-limit">overall interactive traffic rate limits</a>. The default rate limits
for Priority inference are <strong>0.3x standard rate limit for Model / Tier</strong></p>

<h3 id="downgrade" data-text="Graceful downgrade logic" tabindex="-1">Graceful downgrade logic</h3>

<p>If Priority limits are exceeded due to congestion, overflow requests are
<strong>automatically and gracefully</strong> downgraded to Standard processing instead of
failing with a 503 or 429 error. Downgraded requests are billed at the standard
rate, not the Priority premium rate.</p>

<h3 id="client" data-text="Client responsibility" tabindex="-1">Client responsibility</h3>

<ul>
<li><strong>Response monitoring</strong>: Developers should monitor the <code translate="no" dir="ltr">x-gemini-service-tier</code>
header in the API response to detect if requests are being frequently downgraded to
<code translate="no" dir="ltr">standard</code>.</li>
<li><strong>Retries</strong>: Clients must implement retry logic/exponential backoff for
standard errors, such as <code translate="no" dir="ltr">DEADLINE_EXCEEDED</code>.</li>
</ul>

<h2 id="pricing" data-text="Pricing" tabindex="-1">Pricing</h2>

<p>Priority inference is priced at 75-100% more than the <a href="/gemini-api/docs/pricing">standard API</a> and billed per token.</p>

<h2 id="supported-models" data-text="Supported models" tabindex="-1">Supported models</h2>

<p>The following models support Priority inference:</p>

<table>
<thead>
<tr>
<th>Model</th>
<th style="text-align: center">Priority inference</th>
</tr>
</thead>
...
<ul>
<li><a href="/gemini-api/docs/flex-inference">Flex inference</a> for cost reduction.</li>
