...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/agents"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/agents" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/agents" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/agents?hl=sq" /><title>Agents overview &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Agents overview &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Build agents that reason, write code, manage files, and browse the web with the Gemini API.">
  <meta property="og:description" content="Build agents that reason, write code, manage files, and browse the web with the Gemini API."><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/agents"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Agents overview<devsite-actions hidden data-nosnippet>
...
<p>Managed agents on the Gemini API give you a configurable agent
harness. A single API call provisions a Linux sandbox where the agent reasons,
executes code, manages files, and browses the web autonomously.</p>
...
<h2 id="managed-agents" data-text="Available Managed agents" tabindex="-1">Available Managed agents</h2>

<ul>
<li><strong><a href="/gemini-api/docs/antigravity-agent">Antigravity agent</a></strong>: General-purpose
managed agent built with Gemini 3.8 Flash. Runs code, manages files, and
...
using <code translate="no" dir="ltr">agent_config</code>, and extend it with your own instructions, skills, and data to
<a href="/gemini-api/docs/custom-agents">build a custom agent</a>.</li>
<li><strong><a href="/gemini-api/docs/deep-research">Deep Research</a></strong>: Autonomous research agent
that plans, executes, and synthesizes multi-step research tasks for use cases
like market analysis, due diligence, and literature reviews.</li>
</ul>

<h2 id="security-best-practices" data-text="Security and best practices" tabindex="-1">Security and best practices</h2>
<aside class="note"><strong>Note:</strong><span> Managed agents are in <strong>Public Preview</strong>. Review the agent&#39;s actions and
outputs before relying on them in sensitive workflows.</span></aside>
<p>Every agent runs in a sandboxed environment that is isolated at the OS level.
The sandbox has unrestricted outbound network access by default. You can
restrict or disable network access using an allowlist.</p>

<h3 id="network_access" data-text="Network access" tabindex="-1">Network access</h3>

<p>By default, environments have unrestricted outbound network access. Use a
<code translate="no" dir="ltr">network</code> allowlist to restrict outbound traffic to specific domains or
wildcard patterns. For configuration details, see
<a href="/gemini-api/docs/aistudio-agents#network_allow_list">Network Allow List</a> (AI
Studio) or <a href="/gemini-api/docs/custom-agents#with_network_rules">Network rules</a>
(API).</p>

<h3 id="external_tools_and_apis" data-text="External tools and APIs" tabindex="-1">External tools and APIs</h3>

<p>You can connect external tools and APIs to extend the agent. Only use tools
...
so only provide credentials whose full scope you are willing to grant.</p>

<ul>
<li>Use least-privilege service accounts or API keys.</li>
<li>Prefer short-lived tokens over long-lived keys.</li>
<li>Only provide credentials whose full scope you are willing to grant.</li>
<li>Rotate credentials on a regular schedule.</li>
</ul>

<p>For details on configuring header transformations, see
<a href="/gemini-api/docs/agent-environment#credentials">Credentials</a>.</p>

<h3 id="human_oversight" data-text="Human oversight" tabindex="-1">Human oversight</h3>

<p>Always verify outputs (generated code, data transformations, configuration
...
<p>Managed agents use a <a href="/gemini-api/docs/pricing#pricing-for-agents">pay-as-you-go model</a>
...
compute is <strong>not billed</strong> during the preview. See <a href="/gemini-api/docs/antigravity-agent#availability-and-pricing">estimated costs</a>
for per-task breakdowns. Managed agents are also available on the free tier with
a free rate limit and usage quota.</p>

<h2 id="limits" data-text="Limits" tabindex="-1">Limits</h2>
...
<tbody>
<tr>
<td style="text-align: left"><strong>Environment Lifetime</strong></td>
<td style="text-align: left">Environments are permanently deleted after 7 days of inactivity.</td>
</tr>
<tr>
<td style="text-align: left"><strong>VM Spin-down</strong></td>
<td style="text-align: left">VMs shut down after a brief period of inactivity to conserve resources. The next request restores the state (with a cold start).</td>
</tr>
<tr>
<td style="text-align: left"><strong>Pre-installed Software</strong></td>
<td style="text-align: left">Ubuntu-based environment with Python 3.12 and Node.js 22. For more information on the environment&#39;s base image, see <a href="/gemini-api/docs/agent-environment#pre-installed-software">Pre-installed software</a>.</td>
</tr>
<tr>
<td style="text-align: left"><strong>Max agents</strong></td>
<td style="text-align: left">You can have up to 1,000 managed agents.</td>
</tr>
</tbody>
</table>

<h2 id="agent-frameworks" data-text="Agent frameworks" tabindex="-1">Agent frameworks</h2>

<p>You can also build agents with Gemini using these frameworks and SDKs:</p>

<ul>
<li><a href="/gemini-api/docs/langgraph-example"><strong>LangChain / LangGraph</strong></a>: Build
stateful, complex application flows and multi-agent systems using graph
structures.</li>
<li><a href="/gemini-api/docs/llama-index"><strong>LlamaIndex</strong></a>: Connect Gemini agents to
your private data for RAG-enhanced workflows.</li>
<li><a href="/gemini-api/docs/crewai-example"><strong>CrewAI</strong></a>: Orchestrate collaborative,
role-playing autonomous AI agents.</li>
<li><a href="/gemini-api/docs/vercel-ai-sdk-example"><strong>Vercel AI SDK</strong></a>: Build
AI-powered user interfaces and agents in JavaScript/TypeScript.</li>
<li><a href="https://google.github.io/adk-docs/get-started/python/"><strong>Google ADK</strong></a>: An
open-source framework for building and orchestrating interoperable AI
agents.</li>
<li><a href="https://antigravity.google/product/antigravity-sdk"><strong>Antigravity SDK</strong></a>: Build
autonomous AI agents using the same tools, agent loop, and context
management that power Google Antigravity, programmable in Python.</li>
</ul>
