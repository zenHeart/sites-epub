...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/optimization"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/optimization" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/optimization" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/optimization?hl=sq" /><title>Gemini API optimization and inference &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini API optimization and inference &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn about the different inference and optimization options from the Gemini API.">
  <meta property="og:description" content="Learn about the different inference and optimization options from the Gemini API."><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/optimization"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini API optimization and inference<devsite-actions hidden data-nosnippet>
...
<p>The Gemini API offers a variety of optimization mechanisms to help you balance
...
<th style="text-align: left">Caching</th>
</tr>
</thead>
...
<td style="text-align: left">75% to 100% more than standard</td>
<td style="text-align: left">50% discount</td>
<td style="text-align: left">90% discount + Prorated token storage</td>
</tr>
<tr>
...
<td style="text-align: left">Faster time-to-first-token</td>
</tr>
<tr>
...
<td style="text-align: left">Saved state</td>
</tr>
<tr>
<td style="text-align: left"><strong>Best use case</strong></td>
<td style="text-align: left">General application workflows</td>
<td style="text-align: left">Non-urgent sequential chains</td>
<td style="text-align: left">Production, user-facing apps</td>
<td style="text-align: left">Massive datasets, offline evals</td>
<td style="text-align: left">Recurring queries over same file</td>
</tr>
</tbody>
</table>

<h2 id="inference-tiers" data-text="Inference service tiers (Synchronous)" tabindex="-1">Inference service tiers (Synchronous)</h2>

<p>You can shift between reliability-optimized and cost-optimized synchronous traffic
by passing the <code translate="no" dir="ltr">service_tier</code> parameter in your standard generation calls.</p>

<h3 id="standard" data-text="Standard inference (Default)" tabindex="-1">Standard inference (Default)</h3>

<p>The standard tier is the default option for sequential content generation.
It provides normal response times without extra premiums or heavy queuing.</p>

<ul>
<li><strong>Reliability:</strong> Standard criticality</li>
<li><strong>Price:</strong> Standard pricing.</li>
<li><strong>Best For:</strong> Most interactive day-to-day applications.</li>
</ul>

<h3 id="priority" data-text="Priority inference (Latency-optimized)" tabindex="-1">Priority inference (Latency-optimized)</h3>

<p><a href="/gemini-api/docs/priority-inference">Priority</a> processing routes your requests
...
of failing with an error.</p>

<ul>
<li><strong>Reliability:</strong> Highest criticality</li>
<li><strong>Price:</strong> 75% to 100% over Standard rates.</li>
<li><strong>Best for:</strong> Customer chatbots, real-time fraud detection, and
business-critical copilots.</li>
</ul>

<h3 id="flex" data-text="Flex inference (Cost-optimized)" tabindex="-1">Flex inference (Cost-optimized)</h3>

<p><a href="/gemini-api/docs/flex-inference">Flex inference</a> offers a 50% discount
...
experiences standard traffic spikes.</p>

<ul>
<li><strong>Reliability:</strong> Non-guaranteed, sheddable criticality</li>
<li><strong>Price:</strong> 50% of Standard Pricing (billed per token).</li>
<li><strong>Best for:</strong> Multi-step agentic workflows where call N+1 depends on the
output of call N, background CRM updates, and offline evaluations.</li>
</ul>

<h2 id="batch" data-text="Batch API (Bulk, asynchronous)" tabindex="-1">Batch API (Bulk, asynchronous)</h2>

<p><a href="/gemini-api/docs/batch-api">The Batch API</a> is designed to process large volumes
...
throughput queues with a target turnaround time of 24 hours.</p>

<ul>
<li><strong>Reliability:</strong> Sheddable but with 24h automated retries and queuing system</li>
<li><strong>Price:</strong> 50% of Standard pricing.</li>
<li><strong>Best for:</strong> Pre-processing massive datasets, running periodic regression
test suites, and high-volume image or embedding generations.</li>
</ul>

<h2 id="caching" data-text="Context caching (Input savings)" tabindex="-1">Context caching (Input savings)</h2>

<p><a href="/gemini-api/docs/caching">Context caching</a> is used when a substantial initial
context is referenced repeatedly by shorter requests.</p>

<ul>
<li><strong>Implicit caching:</strong> Automatically enabled on Gemini 2.5 and newer models.
The system passes on cost savings if your request hits existing caches based on
common prompt prefixes.</li>
<li><strong>Explicit Caching:</strong> You can manually create a cache object with a specific
Time-To-Live (TTL). Once created, you refer to the cached tokens for subsequent
requests to avoid passing the same corpus payload repeatedly.</li>
<li><strong>Price:</strong> Billed based on cache token count and storage duration (TTL).</li>
<li><strong>Best For:</strong> Chatbots with extensive system instructions, repetitive analysis
of lengthy video files, or queries against large document sets.</li>
</ul>

<h2 id="agentic-video-processing" data-text="Reduce video input costs with agentic processing" tabindex="-1">Reduce video input costs with agentic processing</h2>

<p>For long-form video content, agentic processing can reduce input token costs by
...
internal reasoning and tool round-trips before generation begins.</p>

<p>To use agentic processing with Gemini 3.7 Flash, 3.6 Flash, or 3.5 Flash Lite,
set <code translate="no" dir="ltr">processing: &quot;agentic&quot;</code> (Interactions API) or
<code translate="no" dir="ltr">media_processing: &quot;AGENTIC&quot;</code> (GenerateContent API) on your video input. If the
model does not support agentic processing, it will return an error.</p>

<p>See
<a href="/gemini-api/docs/video-understanding#agentic-video-understanding">Agentic video understanding</a>
for code examples.</p>
