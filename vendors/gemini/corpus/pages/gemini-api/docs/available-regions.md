...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/available-regions"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/available-regions" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/available-regions" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/available-regions?hl=sq" /><title>Available regions for Google AI Studio and Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Available regions for Google AI Studio and Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/available-regions"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Available regions for Google AI Studio and Gemini API<devsite-actions hidden data-nosnippet>
...
<p>If you reached this page while attempting to access <a href="https://aistudio.google.com/">Google AI Studio</a>, it may
be due to one of the following reasons:</p>

<ul>
<li><strong>Regional restrictions</strong>: Google AI Studio is not available in your region. Refer to the section below for a list of supported regions.</li>
<li><strong>Age requirements</strong>: You do not meet the minimum age requirement (18+) to access this service.</li>
<li><strong>Account verification</strong>: You may have access to the service, but you haven&#39;t yet <a href="https://support.google.com/accounts/answer/10071085">verified your age</a> on your Google Account.</li>
</ul>

<p>For further details regarding requirements, review our <a href="/gemini-api/terms">Terms of Service</a>.</p>

<h2 id="available-regions" data-text="Available regions" tabindex="-1">Available regions</h2>
<aside class="note"><strong>Note:</strong><span> For Colab users - Region restrictions are applied based on
the region that the <strong>Colab instance</strong> is in, not the region that <strong>the user</strong>
is in. You can check the location of the <strong>Colab instance</strong> using
<code translate="no" dir="ltr">!curl ipinfo.io</code></span></aside>
<p>The Gemini API and Google AI Studio are available in the following countries and
territories. If you&#39;re not in one of these countries or territories, try the
<a href="https://cloud.google.com/gemini-enterprise-agent-platform">Gemini API in Gemini Enterprise Agent Platform</a>:</p>
