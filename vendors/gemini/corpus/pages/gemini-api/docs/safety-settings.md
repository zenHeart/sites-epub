...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/safety-settings"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/safety-settings" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/safety-settings" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/safety-settings?hl=sq" /><title>Safety settings &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Safety settings &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/safety-settings"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Safety settings<devsite-actions hidden data-nosnippet>
...
<p>The Gemini API provides safety settings that you can adjust during the
...
filter categories to restrict or allow certain types of content.</p>

<p>This guide covers how the Gemini API handles safety settings and filtering and
how you can change the safety settings for your application.</p>
<aside class="note"><strong>Note:</strong><span> Applications that use less restrictive safety settings may be subject to
review. See the <a href="/gemini-api/terms#use-restrictions">Terms of Service</a> for more information.</span></aside>
<h2 id="safety-filters" data-text="Safety filters" tabindex="-1">Safety filters</h2>

<p>The Gemini API&#39;s adjustable safety filters cover the following categories:</p>
...
<p>These categories are defined in <a href="/api/rest/v1/HarmCategory"><code translate="no" dir="ltr">HarmCategory</code></a>. You
...
allow more content that&#39;s rated as <em>Dangerous</em> due to the nature of the game.</p>
...
These types of harm are always blocked and cannot be adjusted.</p>

<h3 id="safety-filtering-level" data-text="Content safety filtering level" tabindex="-1">Content safety filtering level</h3>

<p>The Gemini API categorizes the probability level of content being unsafe as
<code translate="no" dir="ltr">HIGH</code>, <code translate="no" dir="ltr">MEDIUM</code>, <code translate="no" dir="ltr">LOW</code>, or <code translate="no" dir="ltr">NEGLIGIBLE</code>.</p>

<p>The Gemini API blocks content based on the probability of content being unsafe
...
still be high. For example, comparing the sentences:</p>
...
<p>The first sentence might result in a higher probability of being unsafe, but you
...
minimizing harm to end users.</p>

<h3 id="safety-filtering-per-request" data-text="Safety filtering per request" tabindex="-1">Safety filtering per request</h3>

<p>You can adjust the safety settings for each request you make to the API. When
...
category equal to <code translate="no" dir="ltr">HARASSMENT</code> and harm probability set to <code translate="no" dir="ltr">HIGH</code>.</p>

<p>Due to the model&#39;s inherent safety, additional filters are <strong>Off</strong> by default.
...
speech content is blocked. But anything with a lower probability is allowed.</p>

<table>
  <tr>
    <th>Threshold (Google AI Studio)</th>
    <th>Threshold (API)</th>
    <th>Description</th>
  </tr>
  <tr>
    <td>Off</td>
    <td><code translate="no" dir="ltr">OFF</code></td>
    <td>Turn off the safety filter</td>
  </tr>
  <tr>
    <td>Block none</td>
    <td><code translate="no" dir="ltr">BLOCK_NONE</code></td>
    <td>Always show regardless of probability of unsafe content</td>
  </tr>
  <tr>
    <td>Block few</td>
    <td><code translate="no" dir="ltr">BLOCK_ONLY_HIGH</code></td>
    <td>Block when high probability of unsafe content</td>
  </tr>
  <tr>
   <td>Block some</td>
   <td><code translate="no" dir="ltr">BLOCK_MEDIUM_AND_ABOVE</code></td>
   <td>Block when medium or high probability of unsafe content</td>
  </tr>
  <tr>
   <td>Block most</td>
   <td><code translate="no" dir="ltr">BLOCK_LOW_AND_ABOVE</code></td>
   <td>Block when low, medium or high probability of unsafe content</td>
  </tr>
  <tr>
    <td>N/A</td>
    <td><code translate="no" dir="ltr">HARM_BLOCK_THRESHOLD_UNSPECIFIED</code></td>
    <td>Threshold is unspecified, block using default threshold</td>
  </tr>
</table>

<p>If the threshold is not set, the default block threshold is <strong>Off</strong> for Gemini
2.5 and 3 models.</p>

<p>You can set these settings for each request you make to the generative service.
See the <a href="/api/generate-content#harmblockthreshold"><code translate="no" dir="ltr">HarmBlockThreshold</code></a> API
reference for details.</p>

<h3 id="safety-feedback" data-text="Safety feedback" tabindex="-1">Safety feedback</h3>

<p><a href="/api/generate-content#method:-models.generatecontent"><code translate="no" dir="ltr">generateContent</code></a>
returns a
<a href="/api/generate-content#generatecontentresponse"><code translate="no" dir="ltr">GenerateContentResponse</code></a> which
includes safety feedback.</p>

<p>Prompt feedback is included in
<a href="/api/generate-content#promptfeedback"><code translate="no" dir="ltr">promptFeedback</code></a>. If
<code translate="no" dir="ltr">promptFeedback.blockReason</code> is set, then the content of the prompt was blocked.</p>

<p>Response candidate feedback is included in
<a href="/api/generate-content#candidate"><code translate="no" dir="ltr">Candidate.finishReason</code></a> and
<a href="/api/generate-content#candidate"><code translate="no" dir="ltr">Candidate.safetyRatings</code></a>. If response
content was blocked and the <code translate="no" dir="ltr">finishReason</code> was <code translate="no" dir="ltr">SAFETY</code>, you can inspect
<code translate="no" dir="ltr">safetyRatings</code> for more details. The content that was blocked is not returned.</p>

<h2 id="adjust-safety-settings" data-text="Adjust safety settings" tabindex="-1">Adjust safety settings</h2>

<p>This section covers how to adjust the safety settings in both Google AI Studio
and in your code.</p>

<h3 id="safety-settings-ai-studio" data-text="Google AI Studio" tabindex="-1">Google AI Studio</h3>

<p>You can adjust safety settings in Google AI Studio.</p>

<p>Click <strong>Safety settings</strong> under <strong>Advanced settings</strong> in the <strong>Run settings</strong> panel to open the <strong>Run
safety settings</strong> modal. In the modal, you can use the sliders to adjust the
content filtering level per safety category:</p>

<p><img src="/static/gemini-api/docs/images/safety_settings_ui.png" width="50%" style="margin-left:25%;
margin-right:25%" class="screenshot" aria-hidden="true"></p>
<aside class="note"><strong>Note:</strong><span> You are responsible for ensuring that safety settings for your intended
use case comply with the <a href="/gemini-api/terms#use-restrictions">Terms of Service</a>.</span></aside>
<p>When you send a request (for example, by asking the model a question), a <span class="material-icons" aria-hidden="true" translate="no">warning</span>
<strong>Content blocked</strong> message appears if the request&#39;s content is blocked. To see
more details, hold the pointer over the
<strong>Content blocked</strong> text to see the category and the probability of the harm
classification.</p>

<h3 id="code-examples" data-text="Code examples" tabindex="-1">Code examples</h3>

<p>The following code snippet shows how to set safety settings in your
<code translate="no" dir="ltr">GenerateContent</code> call. This sets the threshold for the hate speech
(<code translate="no" dir="ltr">HARM_CATEGORY_HATE_SPEECH</code>) category. Setting this category to
<code translate="no" dir="ltr">BLOCK_LOW_AND_ABOVE</code> blocks any content that has a low or higher probability of
being hate speech. To understand the threshold settings, see <a href="#safety-filtering-per-request">Safety filtering
per request</a>.</p>
...
<span class="devsite-syntax-n">response</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">models</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">generate_content</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-n">contents</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s2">"Some potentially unsafe prompt"</span><span class="devsite-syntax-p">,</span>
    <span class="devsite-syntax-n">config</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-n">types</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">GenerateContentConfig</span><span class="devsite-syntax-p">(</span>
      <span class="devsite-syntax-n">safety_settings</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-p">[</span>
        <span class="devsite-syntax-n">types</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">SafetySetting</span><span class="devsite-syntax-p">(</span>
            <span class="devsite-syntax-n">category</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-n">types</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">HarmCategory</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">HARM_CATEGORY_HATE_SPEECH</span><span class="devsite-syntax-p">,</span>
            <span class="devsite-syntax-n">threshold</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-n">types</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">HarmBlockThreshold</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">BLOCK_LOW_AND_ABOVE</span><span class="devsite-syntax-p">,</span>
...
<span class="devsite-syntax-w">                </span><span class="devsite-syntax-nx">Threshold</span><span class="devsite-syntax-p">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s">"BLOCK_LOW_AND_ABOVE"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">            </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">}</span>
...
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-nx">genai</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">Text</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-s">"Some potentially unsafe prompt."</span><span class="devsite-syntax-p">),</span>
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-nx">config</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">)</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-k">if</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">err</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">!=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-kc">nil</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span>
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-nx">log</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">Fatal</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-nx">err</span><span class="devsite-syntax-p">)</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">fmt</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">Println</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-nx">response</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">Text</span><span class="devsite-syntax-p">())</span>
<span class="devsite-syntax-p">}</span>
</code></pre></devsite-code></section>
...
<span class="devsite-syntax-kd">const</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">safetySettings</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">[</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">{</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">threshold</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"BLOCK_LOW_AND_ABOVE"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-p">];</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">contents</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Some potentially unsafe prompt."</span><span class="devsite-syntax-p">,</span>
...
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">safetySettings</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">safetySettings</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">});</span>
...
<section><h3 id="java" data-text="Java" tabindex="-1">Java</h3><div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Java"><code translate="no" dir="ltr"><span class="devsite-syntax-n">SafetySetting</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-n">hateSpeechSafety</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-k">new</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-n">SafetySetting</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">HarmCategory</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">HATE_SPEECH</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-n">BlockThreshold</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">LOW_AND_ABOVE</span><span class="devsite-syntax-p">);</span>

<span class="devsite-syntax-n">GenerativeModel</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-n">gm</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-k">new</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-n">GenerativeModel</span><span class="devsite-syntax-p">(</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-s">"gemini-3.8-flash"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-n">BuildConfig</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">apiKey</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-kc">null</span><span class="devsite-syntax-p">,</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-c1">// generation config is optional</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-n">Arrays</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">asList</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">hateSpeechSafety</span><span class="devsite-syntax-p">)</span>
<span class="devsite-syntax-p">);</span>
...
<section><h3 id="rest" data-text="REST" tabindex="-1">REST</h3><div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">curl<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"https://generativelanguage.googleapis.com/v1beta/models/gemini-3.8-flash:generateContent"</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-se">\</span>
...
<span class="devsite-syntax-s1">        {"category": "HARM_CATEGORY_HATE_SPEECH", "threshold": "BLOCK_LOW_AND_ABOVE"}</span>
<span class="devsite-syntax-s1">    ],</span>
<span class="devsite-syntax-s1">    "contents": [{</span>
<span class="devsite-syntax-s1">        "parts":[{</span>
<span class="devsite-syntax-s1">            "text": "'</span><span class="devsite-syntax-se">\'</span><span class="devsite-syntax-s1">'Some potentially unsafe prompt.'</span><span class="devsite-syntax-se">\'</span><span class="devsite-syntax-s1">'"</span>
<span class="devsite-syntax-s1">        }]</span>
<span class="devsite-syntax-s1">    }]</span>
<span class="devsite-syntax-s1">}'</span>
</code></pre></devsite-code></section>
...
<ul>
<li>See the <a href="/api">API reference</a> to learn more about the full API.</li>
<li>Review the <a href="/gemini-api/docs/safety-guidance">safety guidance</a> for a general look at safety
considerations when developing with LLMs.</li>
<li>Learn more about assessing probability versus severity from the <a href="https://developers.perspectiveapi.com/s/about-the-api-score">Jigsaw
team</a> </li>
<li>Learn more about the products that contribute to safety solutions like the
<a href="https://medium.com/jigsaw/reducing-toxicity-in-large-language-models-with-perspective-api-c31c39b7a4d7">Perspective
API</a>.
                *   You can use these safety settings to create a toxicity
                    classifier. See the <a href="/examples/train_text_classifier_embeddings">classification
                    example</a> to
                    get started.</li>
</ul>
