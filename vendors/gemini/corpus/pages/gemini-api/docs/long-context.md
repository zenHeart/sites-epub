...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/long-context"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/long-context" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/long-context" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/long-context?hl=sq" /><title>Long context &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Long context &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn about how to get started building with long context (1 million context window) on Gemini.">
  <meta property="og:description" content="Learn about how to get started building with long context (1 million context window) on Gemini."><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/long-context"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/long-context.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Long context<devsite-actions hidden data-nosnippet>
...
<p>Many Gemini models come with large context windows of 1 million or more tokens.
...
<p>The code you already use for cases like <a href="/gemini-api/docs/text-generation">text
generation</a> or <a href="/gemini-api/docs/vision">multimodal
inputs</a> will work without any changes with long context.</p>

<p>This document gives you an overview of what you can achieve using models with
...
<p>For the context window sizes of specific models, see the
<a href="/gemini-api/docs/models">Models</a> page.</p>

<h2 id="what-is-context-window" data-text="What is a context window?" tabindex="-1">What is a context window?</h2>

<p>The basic way you use the Gemini models is by passing information (context)
...
<p>You can read more about how models work under the hood in our <a href="/gemini-api/docs/prompting-strategies#under-the-hood">generative models
guide</a>.</p>

<h2 id="getting-started-with-long-context" data-text="Getting started with long context" tabindex="-1">Getting started with long context</h2>

<p>Earlier versions of generative models were only able to process 8,000
tokens at a time. Newer models pushed this further by accepting 32,000 or even
128,000 tokens. Gemini is the first model capable of accepting 1 million tokens.</p>

<p>In practice, 1 million tokens would look like:</p>

<ul>
<li>50,000 lines of code (with the standard 80 characters per line)</li>
<li>All the text messages you have sent in the last 5 years</li>
<li>8 average length English novels</li>
<li>Transcripts of over 200 average length podcast episodes</li>
</ul>

<p>The more limited context windows common in many other models often require
strategies like arbitrarily dropping old messages, summarizing content, using
RAG with vector databases, or filtering prompts to save tokens.</p>

<p>While these techniques remain valuable in specific scenarios, Gemini&#39;s extensive
...
<a href="https://storage.googleapis.com/deepmind-media/gemini/gemini_v1_5_report.pdf">learned to translate</a>
...
empowering new possibilities through robust in-context learning.</p>

<h2 id="long-context-use-cases" data-text="Long context use cases" tabindex="-1">Long context use cases</h2>

<p>While the standard use case for most generative models is still text input, the
...
accompanied by the <a href="/gemini-api/docs/prompting_with_media">Gemini API that takes in multimodal file
types</a> for
convenience.</p>

<h3 id="long-form-text" data-text="Long form text" tabindex="-1">Long form text</h3>

<p>Text has proved to be the layer of intelligence underpinning much of the
...
new techniques becoming available which unlock new use cases.</p>

<p>Some emerging and standard use cases for text based long context include:</p>

<ul>
<li>Summarizing large corpuses of text
<ul>
<li>Previous summarization options with smaller context models would require
a sliding window or another technique to keep state of previous sections
as new tokens are passed to the model</li>
</ul></li>
<li>Question and answering
<ul>
<li>Historically this was only possible with RAG given the limited amount of
context and models&#39; factual recall being low</li>
</ul></li>
<li>Agentic workflows
<ul>
<li>Text is the underpinning of how agents keep state of what they have done
and what they need to do; not having enough information about the world
and the agent&#39;s goal is a limitation on the reliability of agents</li>
</ul></li>
</ul>

<p><a href="https://arxiv.org/pdf/2404.11018">Many-shot in-context learning</a> is one of the
...
<h3 id="long-form-video" data-text="Long form video" tabindex="-1">Long form video</h3>

<p>Video content&#39;s utility has long been constrained by the lack of accessibility
...
<p>Some emerging and standard use cases for video long context include:</p>

<ul>
<li>Video question and answering</li>
<li>Video memory, as shown with <a href="https://deepmind.google/technologies/gemini/project-astra/">Google&#39;s Project Astra</a></li>
<li>Video captioning</li>
<li>Video recommendation systems, by enriching existing metadata with new
multimodal understanding</li>
<li>Video customization, by looking at a corpus of data and associated video
...
<p>When working with videos, it is important to consider how the <a href="/gemini-api/docs/tokens#media-token">videos are
processed into tokens</a>, which affects
billing and usage limits. You can learn more about prompting with video files in
the <a href="/gemini-api/docs/prompting_with_media?lang=python#prompting-with-videos">Prompting
guide</a>.</p>

<h3 id="long-form-audio" data-text="Long form audio" tabindex="-1">Long form audio</h3>

<p>The Gemini models were the first natively multimodal large language models
...
the multiple model setup.</p>

<p>Some emerging and standard use cases for audio context include:</p>

<ul>
<li>Real-time transcription and translation</li>
<li>Podcast / video question and answering</li>
<li>Meeting transcription and summarization</li>
<li>Voice assistants</li>
</ul>

<p>You can learn more about prompting with audio files in the <a href="/gemini-api/docs/prompting_with_media?lang=python#prompting-with-videos">Prompting
guide</a>.</p>

<h2 id="long-context-optimizations" data-text="Long context optimizations" tabindex="-1">Long context optimizations</h2>

<p>The primary optimization when working with long context and the Gemini
models is to use <a href="/gemini-api/docs/caching">context
caching</a>. Beyond the previous
...
<h2 id="long-context-limitations" data-text="Long context limitations" tabindex="-1">Long context limitations</h2>

<p>In various sections of this guide, we talked about how Gemini models achieve
...
while keeping the performance high.</p>

<h2 id="faqs" data-text="FAQs" tabindex="-1">FAQs</h2>

<h3 id="where_is_the_best_place_to_put_my_query_in_the_context_window" data-text="Where is the best place to put my query in the context window?" tabindex="-1">Where is the best place to put my query in the context window?</h3>

<p>In most cases, especially if the total context is long, the model&#39;s
performance will be better if you put your query / question at the end of the
prompt (after all the other context).</p>

<h3 id="do_i_lose_model_performance_when_i_add_more_tokens_to_a_query" data-text="Do I lose model performance when I add more tokens to a query?" tabindex="-1">Do I lose model performance when I add more tokens to a query?</h3>

<p>Generally, if you don&#39;t need tokens to be passed to the model, it is best to
...
<h3 id="how_can_i_lower_my_cost_with_long-context_queries" data-text="How can I lower my cost with long-context queries?" tabindex="-1">How can I lower my cost with long-context queries?</h3>

<p>If you have a similar set of tokens / context that you want to re-use many
times, <a href="/gemini-api/docs/caching">context caching</a> can help reduce the costs
associated with asking questions about that information.</p>

<h3 id="does_the_context_length_affect_the_model_latency" data-text="Does the context length affect the model latency?" tabindex="-1">Does the context length affect the model latency?</h3>

<p>There is some fixed amount of latency in any given request, regardless of the
...
<devsite-content-footer class="nocontent" data-nosnippet>
  ...
  <p>Last updated 2026-06-22 UTC.</p>
