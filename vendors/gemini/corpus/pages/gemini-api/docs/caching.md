...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/caching"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/caching" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/caching" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/caching?hl=sq" /><title>Context caching &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Context caching &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Learn how to use Context Caching in the Interactions API">
  <meta property="og:description" content="Learn how to use Context Caching in the Interactions API"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/caching"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Context caching<devsite-actions hidden data-nosnippet>
...
<p>In a typical AI workflow, you might pass the same input tokens over and over to
a model. The Gemini API offers implicit caching to optimize performance and costs.</p>
<aside class="note"><strong>Note:</strong><span> The <strong>Interactions API</strong> only supports implicit caching. Explicit caching
...
<a href="/gemini-api/docs/generate-content/caching">generateContent API</a>.</span></aside>
<h2 id="implicit-caching" data-text="Implicit caching" tabindex="-1">Implicit caching</h2>

<p>Implicit caching is enabled by default for all Gemini 2.5 and newer models. It is
supported for both <a href="/gemini-api/docs/text-generation#multi-turn-conversations">stateful</a> (using <code translate="no" dir="ltr">previous_interaction_id</code>)
and <a href="/gemini-api/docs/text-generation#stateless-conversations">stateless</a> conversation modes.
...
token count for context caching is listed in the following table for each model:</p>

<table>
<thead>
<tr>
<th style="text-align: left">Model</th>
<th style="text-align: left">Min token limit</th>
</tr>
</thead>
...
<p>To increase the chance of an implicit cache hit:</p>

<ul>
<li>Try putting large and common contents at the beginning of your prompt</li>
<li>Try to send requests with similar prefix in a short amount of time</li>
</ul>

<p>You can see the number of tokens which were cache hits in the response object&#39;s
<code translate="no" dir="ltr">usage.total_cached_tokens</code> (Python and JavaScript) field.</p>
