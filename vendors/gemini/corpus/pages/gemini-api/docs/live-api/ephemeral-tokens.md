...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens?hl=sq" /><title>Ephemeral tokens &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Ephemeral tokens &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/live-api/ephemeral-tokens"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Ephemeral tokens<devsite-actions hidden data-nosnippet>
...
<aside class="preview"><strong>Preview:</strong><span> Ephemeral tokens are in
<a href="https://cloud.google.com/products#product-launch-stages">Preview</a>.</span></aside>
<p>Ephemeral tokens are short-lived authentication tokens for accessing the Gemini
API through <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API">WebSockets</a>. They are designed to enhance security when
you are connecting directly from a user&#39;s device to the API (a
<a href="/gemini-api/docs/live#implementation-approach">client-to-server</a>
...
key security.</p>
<aside class="note"><strong>Note:</strong><span> At this time, ephemeral tokens are only compatible with <a href="/gemini-api/docs/live">Live API</a>.</span></aside>
<h2 id="how-it-works" data-text="How ephemeral tokens work" tabindex="-1">How ephemeral tokens work</h2>

<p>Here&#39;s how ephemeral tokens work at a high level:</p>

<ol>
<li>Your client (e.g. web app) authenticates with your backend.</li>
<li>Your backend requests an ephemeral token from Gemini API&#39;s provisioning
service.</li>
<li>Gemini API issues a short-lived token.</li>
<li>Your backend sends the token to the client for WebSocket connections to Live
API. You can do this by swapping your API key with an ephemeral token.</li>
<li>The client then uses the token as if it were an API key.</li>
</ol>

<p><img src="/static/gemini-api/docs/images/Live_API_01.png" alt="Ephemeral tokens overview"></p>

<p>This enhances security because even if extracted, the token is short-lived,
...
to proxy the real time data.</p>

<h2 id="create-a-token" data-text="Create an ephemeral token" tabindex="-1">Create an ephemeral token</h2>

<p>Here is a simplified example of how to get an ephemeral token from Gemini.
By default, you&#39;ll have 1 minute to start new Live API sessions using the token
from this request (<code translate="no" dir="ltr">newSessionExpireTime</code>), and 30 minutes to send messages over
that connection (<code translate="no" dir="ltr">expireTime</code>).</p>
...
<span class="devsite-syntax-n">token</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">auth_tokens</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">create</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-s1">'uses'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-mi">1</span><span class="devsite-syntax-p">,</span> <span class="devsite-syntax-c1"># The ephemeral token can only be used to start a single session</span>
    <span class="devsite-syntax-s1">'expire_time'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-n">now</span> <span class="devsite-syntax-o">+</span> <span class="devsite-syntax-n">datetime</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">timedelta</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">minutes</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-mi">30</span><span class="devsite-syntax-p">),</span> <span class="devsite-syntax-c1"># Default is 30 minutes in the future</span>
    <span class="devsite-syntax-c1"># 'expire_time': '2025-05-17T00:00:00Z',   # Accepts isoformat.</span>
    <span class="devsite-syntax-s1">'new_session_expire_time'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-n">now</span> <span class="devsite-syntax-o">+</span> <span class="devsite-syntax-n">datetime</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">timedelta</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">minutes</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-mi">1</span><span class="devsite-syntax-p">),</span> <span class="devsite-syntax-c1"># Default 1 minute in the future</span>
  <span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-p">)</span>

<span class="devsite-syntax-c1"># You'll need to pass the value under token.name back to your client to use it</span>
...
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">uses</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-mf">1</span><span class="devsite-syntax-p">,</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-c1">// The default</span>
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">expireTime</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">expireTime</span><span class="devsite-syntax-p">,</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-c1">// Default is 30 mins</span>
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">newSessionExpireTime</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-ow">new</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nb">Date</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-nb">Date</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">now</span><span class="devsite-syntax-p">()</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">+</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-mf">1</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">*</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-mf">60</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">*</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-mf">1000</span><span class="devsite-syntax-p">)),</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-c1">// Default 1 minute in the future</span>
...
<span class="devsite-syntax-s1">    "newSessionExpireTime": "YYYY-MM-DDTHH:MM:SSZ"</span>
<span class="devsite-syntax-s1">  }'</span>
</code></pre></devsite-code></section>
</devsite-selector></div>
<p>For <code translate="no" dir="ltr">expireTime</code> value constraints, defaults, and other field specs, see the
<a href="https://ai.google.dev/api/live#ephemeral-auth-tokens">API reference</a>.
Within the <code translate="no" dir="ltr">expireTime</code> timeframe, you&#39;ll need
<a href="/gemini-api/docs/live-session#session-resumption"><code translate="no" dir="ltr">sessionResumption</code></a> to
reconnect the call every 10 minutes (this can be done with the same token even
if <code translate="no" dir="ltr">uses: 1</code>).</p>

<p>It&#39;s also possible to lock an ephemeral token to a set of configurations. This
might be useful to further improve security of your application and keep your
system instructions on the server side.</p>
<div><devsite-selector data-ds-scope="code-sample">
...
<span class="devsite-syntax-n">token</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">auth_tokens</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">create</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-s1">'live_connect_constraints'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-p">{</span>
        <span class="devsite-syntax-s1">'model'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-s1">'gemini-3.8-live'</span><span class="devsite-syntax-p">,</span>
        <span class="devsite-syntax-s1">'config'</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-p">{</span>
            <span class="devsite-syntax-s1">'session_resumption'</span><span class="devsite-syntax-p">:{},</span>
            <span class="devsite-syntax-s1">'response_modalities'</span><span class="devsite-syntax-p">:[</span><span class="devsite-syntax-s1">'AUDIO'</span><span class="devsite-syntax-p">]</span>
        <span class="devsite-syntax-p">}</span>
    <span class="devsite-syntax-p">},</span>
    <span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-p">)</span>
...
<span class="devsite-syntax-w">            </span><span class="devsite-syntax-nx">model</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s1">'gemini-3.8-live'</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">            </span><span class="devsite-syntax-nx">config</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span>
<span class="devsite-syntax-w">                </span><span class="devsite-syntax-nx">sessionResumption</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{},</span>
...
<span class="devsite-syntax-s1">      "model": "models/gemini-3.8-live",</span>
<span class="devsite-syntax-s1">      "config": {</span>
<span class="devsite-syntax-s1">        "sessionResumption": {},</span>
...
<p>You can also lock a subset of fields, see the <a href="https://googleapis.github.io/python-genai/genai.html#genai.types.CreateAuthTokenConfig.lock_additional_fields">SDK documentation</a>
for more info.</p>

<h2 id="connect-live-api" data-text="Connect to Live API with an ephemeral token" tabindex="-1">Connect to Live API with an ephemeral token</h2>

<p>Once you have an ephemeral token, you use it as if it were an API key (but
remember, it only works for the live API, and only with the <code translate="no" dir="ltr">v1beta</code> version of
the API).</p>

<p>The use of ephemeral tokens only adds value when deploying applications
that follow <a href="/gemini-api/docs/live#implementation-approach">client-to-server implementation</a> approach.</p>
<div><devsite-selector data-ds-scope="code-sample">
...
<span class="devsite-syntax-c1">// Use the token generated in the "Create an ephemeral token" section here</span>
...
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-nx">apiKey</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">token</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">name</span>
<span class="devsite-syntax-p">});</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">callbacks</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">...</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">},</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">});</span>
...
</devsite-selector></div><aside class="note"><strong>Note:</strong><span> If not using the SDK, note that ephemeral tokens must either be passed in
an <code translate="no" dir="ltr">access_token</code> query parameter, or in an HTTP <code translate="no" dir="ltr">Authorization</code> prefixed by the
<a href="https://datatracker.ietf.org/doc/html/rfc7235#section-2.1">auth-scheme</a>
<code translate="no" dir="ltr">Token</code>.</span></aside>
<p>See <a href="/gemini-api/docs/live">Get started with Live API</a> for more examples.</p>

<h2 id="best-practices" data-text="Best practices" tabindex="-1">Best practices</h2>

<ul>
<li>Set a short expiration duration using the <code translate="no" dir="ltr">expire_time</code> parameter.</li>
<li>Tokens expire, requiring re-initiation of the provisioning process.</li>
<li>Verify secure authentication for your own backend. Ephemeral tokens will
only be as secure as your backend authentication method.</li>
<li>Generally, avoid using ephemeral tokens for backend-to-Gemini connections,
as this path is typically considered secure.</li>
</ul>

<h2 id="limitations" data-text="Limitations" tabindex="-1">Limitations</h2>

<p>Ephemeral tokens are only compatible with <a href="/gemini-api/docs/live">Live API</a> at this time.</p>

<h2 id="whats-next" data-text="What's next" tabindex="-1">What's next</h2>

<ul>
<li>Read the Live API <a href="https://ai.google.dev/api/live#ephemeral-auth-tokens">reference</a>
on ephemeral tokens for more information.</li>
</ul>
