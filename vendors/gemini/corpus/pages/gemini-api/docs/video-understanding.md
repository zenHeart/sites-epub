  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/video-understanding"><link rel="search" type="application/opensearchdescription+xml"
      ...
      <link rel="alternate" hreflang="en"
          ...
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/video-understanding?hl=sq" /><title>Video understanding &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Video understanding &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Get started building with Gemini&amp;#39;s multimodal capabilities in the Gemini API">
  <meta property="og:description" content="Get started building with Gemini&amp;#39;s multimodal capabilities in the Gemini API"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/video-understanding"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/vision.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Video understanding<devsite-actions hidden data-nosnippet>
...
refer to specific timestamps within a video.</p>

<p>You can provide videos as input to Gemini in the following ways:</p>

<table>
<thead>
<tr>
<th style="text-align: left">Input method</th>
...
<tbody>
<tr>
<td style="text-align: left"><a href="#upload-video">File API</a></td>
<td style="text-align: left">20GB (paid) / 2GB (free)</td>
<td style="text-align: left">Large files (100MB+), long videos (10min+), reusable files.</td>
</tr>
<tr>
<td style="text-align: left"><a href="https://ai.google.dev/gemini-api/docs/file-input-methods#registration">Cloud Storage Registration</a></td>
<td style="text-align: left">2GB (per file, no storage limits)</td>
<td style="text-align: left">Large files (100MB+), long videos (10min+), persistent, reusable files.</td>
</tr>
<tr>
<td style="text-align: left"><a href="#inline-video">Inline Data</a></td>
<td style="text-align: left">&lt; 100MB</td>
<td style="text-align: left">Small files (&lt;100MB), short duration (&lt;1min), one-off inputs.</td>
</tr>
<tr>
<td style="text-align: left"><a href="#youtube">YouTube URLs</a></td>
<td style="text-align: left">N/A</td>
<td style="text-align: left">Public YouTube videos.</td>
</tr>
</tbody>
</table>

<blockquote>
<p><strong>Note:</strong> The <a href="#upload-video">File API</a> is recommended for most use cases, especially for files larger than 100MB or when you want to reuse the file across multiple requests.</p>
</blockquote>

<p>To learn about other file input methods, such as using external URLs or files
stored in Google Cloud, see the
<a href="/gemini-api/docs/file-input-methods">File input methods</a> guide.</p>

<h3 id="upload-video" data-text="Upload a video file" tabindex="-1">Upload a video file</h3>

<p>The following code downloads a sample video, uploads it using the <a href="/gemini-api/docs/files">Files API</a>,
...
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-kd">const</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">myfile</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-k">await</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">ai</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">files</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">upload</span><span class="devsite-syntax-p">({</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nx">file</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"path/to/sample.mp4"</span><span class="devsite-syntax-p">,</span>
...
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-kd">let</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">getFile</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-k">await</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">ai</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">files</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">get</span><span class="devsite-syntax-p">({</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">name</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">myfile</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">name</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">});</span>
...
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">getFile</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-k">await</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">ai</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">files</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">get</span><span class="devsite-syntax-p">({</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">name</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">myfile</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">name</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">});</span>
...
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-p">});</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-k">if</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-nx">getFile</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">state</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">===</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s1">'FAILED'</span><span class="devsite-syntax-p">)</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span>
...
<span class="devsite-syntax-w">        </span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-na">uri</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-s">"gs://cloud-samples-data/generative-ai/video/pixel8.mp4"</span><span class="devsite-syntax-p">)</span>
...
<span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Starting file upload..."</span>
...
<span class="devsite-syntax-w">  </span>-D<span class="devsite-syntax-w"> </span><span class="devsite-syntax-si">${</span><span class="devsite-syntax-nv">tmp_header_file</span><span class="devsite-syntax-si">}</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-se">\</span>
...
<span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Uploading video data..."</span>
...
<span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"File uploaded successfully. File URI: </span><span class="devsite-syntax-si">${</span><span class="devsite-syntax-nv">file_uri</span><span class="devsite-syntax-si">}</span><span class="devsite-syntax-s2">"</span>

<span class="devsite-syntax-c1"># Polling loop</span>
<span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Waiting for file to be processed..."</span>
...
<span class="devsite-syntax-w">  </span>curl<span class="devsite-syntax-w"> </span>-s<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"https://generativelanguage.googleapis.com/v1beta/</span><span class="devsite-syntax-si">${</span><span class="devsite-syntax-nv">file_name</span><span class="devsite-syntax-si">}</span><span class="devsite-syntax-s2">"</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-se">\</span>
<span class="devsite-syntax-w">    </span>-H<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"x-goog-api-key: </span><span class="devsite-syntax-nv">$GEMINI_API_KEY</span><span class="devsite-syntax-s2">"</span><span class="devsite-syntax-w"> &gt; </span>file_status.json
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-nv">state</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-k">$(</span>jq<span class="devsite-syntax-w"> </span>-r<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">".state"</span><span class="devsite-syntax-w"> </span>file_status.json<span class="devsite-syntax-k">)</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Current state: </span><span class="devsite-syntax-nv">$state</span><span class="devsite-syntax-s2">"</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"File processing failed."</span>
...
<span class="devsite-syntax-nb">echo</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Generating content from video..."</span>
...
The File API accepts video file formats directly.</p>

<p>To learn more about working with media files, see
<a href="/gemini-api/docs/files">Files API</a>.</p>

<h3 id="inline-video" data-text="Pass video data inline" tabindex="-1">Pass video data inline</h3>

<p>Instead of uploading a video file using the File API, you can pass smaller
videos directly in the request. This is suitable for
shorter videos under 20MB total request size.</p>

<p>Here&#39;s an example of providing inline video data:</p>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="python_1" data-text="Python" tabindex="-1">Python</h3><div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Python"><code translate="no" dir="ltr"><span class="devsite-syntax-kn">from</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nn">google</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-kn">import</span> <span class="devsite-syntax-n">genai</span>
<span class="devsite-syntax-kn">import</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nn">base64</span>

<span class="devsite-syntax-n">video_file_name</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-s2">"/path/to/your/video.mp4"</span>
<span class="devsite-syntax-n">video_bytes</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-nb">open</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">video_file_name</span><span class="devsite-syntax-p">,</span> <span class="devsite-syntax-s1">'rb'</span><span class="devsite-syntax-p">)</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">read</span><span class="devsite-syntax-p">()</span>
...
<span class="devsite-syntax-n">interaction</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">interactions</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">create</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-nb">input</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-p">[</span>
        ...
        <span class="devsite-syntax-p">{</span>
            ...
            <span class="devsite-syntax-s2">"data"</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-n">base64</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">b64encode</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">video_bytes</span><span class="devsite-syntax-p">)</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">decode</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-s1">'utf-8'</span><span class="devsite-syntax-p">),</span>
...
<span class="devsite-syntax-kd">const</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">ai</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-ow">new</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">GoogleGenAI</span><span class="devsite-syntax-p">({});</span>
<span class="devsite-syntax-kd">const</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">base64VideoFile</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">fs</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">readFileSync</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-s2">"path/to/small-sample.mp4"</span><span class="devsite-syntax-p">,</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-p">{</span>
...
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">data</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nx">base64VideoFile</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">mime_type</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"video/mp4"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">],</span>
<span class="devsite-syntax-p">});</span>
...
<section><h3 id="rest_1" data-text="REST" tabindex="-1">REST</h3><aside class="note"><strong>Note:</strong><span> If you get an <code translate="no" dir="ltr">Argument list too long</code> error, the base64 encoding of
your file might be too long for the curl command line. Use the File API
method instead for larger files.</span></aside><div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr"><span class="devsite-syntax-nv">VIDEO_PATH</span><span class="devsite-syntax-o">=</span>/path/to/your/video.mp4
...
<span class="devsite-syntax-s1">          "data": "'</span><span class="devsite-syntax-k">$(</span>base64<span class="devsite-syntax-w"> </span><span class="devsite-syntax-nv">$B64FLAGS</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nv">$VIDEO_PATH</span><span class="devsite-syntax-k">)</span><span class="devsite-syntax-s1">'",</span>
...
<h3 id="youtube" data-text="Pass YouTube URLs" tabindex="-1">Pass YouTube URLs</h3>
<aside class="preview"><strong>Preview:</strong><span> The YouTube URL feature is in preview and is available at no charge.
Pricing and rate limits are likely to change.</span></aside>
<p>You can pass YouTube URLs directly to Gemini API as part of your request as follows:</p>
<div><devsite-selector data-ds-scope="code-sample">
...
<span class="devsite-syntax-n">interaction</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">interactions</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">create</span><span class="devsite-syntax-p">(</span>
    ...
    <span class="devsite-syntax-nb">input</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-p">[</span>
        ...
        <span class="devsite-syntax-p">{</span>
            <span class="devsite-syntax-s2">"type"</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-s2">"video"</span><span class="devsite-syntax-p">,</span>
            <span class="devsite-syntax-s2">"uri"</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-s2">"https://www.youtube.com/watch?v=9hE5-98ZeCg"</span>
        <span class="devsite-syntax-p">}</span>
    <span class="devsite-syntax-p">]</span>
<span class="devsite-syntax-p">)</span>
<span class="devsite-syntax-nb">print</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">interaction</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">output_text</span><span class="devsite-syntax-p">)</span>
...
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">{</span>
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">type</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"video"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">      </span><span class="devsite-syntax-nx">uri</span><span class="devsite-syntax-o">:</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"https://www.youtube.com/watch?v=9hE5-98ZeCg"</span><span class="devsite-syntax-p">,</span>
<span class="devsite-syntax-w">    </span><span class="devsite-syntax-p">}</span>
<span class="devsite-syntax-w">  </span><span class="devsite-syntax-p">],</span>
<span class="devsite-syntax-p">});</span>
<span class="devsite-syntax-nx">console</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">log</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-nx">interaction</span><span class="devsite-syntax-p">.</span><span class="devsite-syntax-nx">output_text</span><span class="devsite-syntax-p">);</span>
...
<span class="devsite-syntax-s1">        {</span>
<span class="devsite-syntax-s1">          "type": "video",</span>
<span class="devsite-syntax-s1">          "uri": "https://www.youtube.com/watch?v=9hE5-98ZeCg"</span>
<span class="devsite-syntax-s1">        }</span>
<span class="devsite-syntax-s1">      ]</span>
<span class="devsite-syntax-s1">    }'</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-m">2</span>&gt;<span class="devsite-syntax-w"> </span>/dev/null
</code></pre></devsite-code></section>
...
<ul>
<li>For the free tier, you can&#39;t upload more than 8 hours of YouTube video per day.</li>
<li>For the paid tier, there is no limit based on video length.</li>
<li>For models prior to Gemini 2.5, you can upload only 1 video per request. For Gemini 2.5 and later models, you can upload a maximum of 10 videos per request.</li>
...
<p>Gemini models offer powerful capabilities for understanding video content by
processing information from both the <strong>audio and visual</strong> streams. This lets you
extract a rich set of details, including generating descriptions of what is
happening in a video and answering questions about its content.</p>

<p>For visual descriptions, the model samples the video at a rate of <strong>1 frame
...
<p>Gemini supports the following video format MIME types:</p>
