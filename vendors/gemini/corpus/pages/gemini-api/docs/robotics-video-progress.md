...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/robotics-video-progress"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/robotics-video-progress" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/robotics-video-progress?hl=sq" /><title>Video understanding &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Video understanding &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Use Gemini Robotics ER 2 to track task progress and identify key moments in robot task videos.">
  <meta property="og:description" content="Use Gemini Robotics ER 2 to track task progress and identify key moments in robot task videos."><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/robotics-video-progress"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<aside class="note"><strong>Note:</strong><span> Video understanding requires Gemini Robotics ER 2
(<code translate="no" dir="ltr">gemini-robotics-er-2-preview</code>). It is not available on ER 1.6.</span></aside>
<p>Gemini Robotics ER 2 can track task progress from continuous video feeds using
two capabilities:</p>

<ul>
<li>Moment finding: identifies the precise timestamp where a key event occurs.</li>
<li>Progress classification: assigns each video to one of five completion
brackets (0–20%, 20–40%, 40–60%, 60–80%, 80–100%).</li>
</ul>

<h2 id="moment-finding" data-text="Moment finding" tabindex="-1">Moment finding</h2>

<p>Moment finding identifies the exact video frame where a critical event occurs —
for example, when a cup is full or a knot is tied. Robots use this to verify
success, sequence steps, and trigger corrections.</p>

<p>The following example prompt asks the model to identify the completion moment
for a given task in a video:</p>
...
<span class="devsite-syntax-n">uploaded_file</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">client</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">files</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">upload</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">file</span><span class="devsite-syntax-o">=</span><span class="devsite-syntax-s2">"task_video.mp4"</span><span class="devsite-syntax-p">)</span>

<span class="devsite-syntax-n">prompt</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-s2">"""</span>
<span class="devsite-syntax-s2">At what timestamp (in seconds) does the task reach successful completion?</span>
<span class="devsite-syntax-s2">Return a JSON object: {"completion_time_seconds": &lt;float&gt;}.</span>
<span class="devsite-syntax-s2">If the task is not completed, return {"completion_time_seconds": null}.</span>
...
<p>The following shows example frames from a moment-finding video, with the
model identifying the task completion timestamp:</p>

<p><img src="/static/gemini-api/docs/images/robotics/video-moment-finding.png" alt="Example video frames showing the moment finding output with a timestamp overlay" width="50%"> </p>

<h2 id="progress-classification" data-text="Progress classification" tabindex="-1">Progress classification</h2>

<p>Progress classification assigns a video to one of five completion brackets:
...
restarting an entire workflow.</p>

<p>The following example prompt asks the model to classify the current progress
level from a video:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Python"><code translate="no" dir="ltr"><span class="devsite-syntax-kn">from</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nn">google</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-kn">import</span> <span class="devsite-syntax-n">genai</span>
...
<span class="devsite-syntax-n">prompt</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-s2">"""</span>
<span class="devsite-syntax-s2">Watch this video and classify the task progress level at the final frame.</span>
<span class="devsite-syntax-s2">Return a JSON object with the progress bracket:</span>
<span class="devsite-syntax-s2">{"progress_level": "0-20" | "20-40" | "40-60" | "60-80" | "80-100"}.</span>
<span class="devsite-syntax-s2">"""</span>
...
<p>The following shows example frames from a progress classification video, with
the model assigning a progress bracket:</p>

<p><img src="/static/gemini-api/docs/images/robotics/video-progress-classification.png" alt="Example video frames showing the progress classification output with a progress bracket label" width="75%"> </p>

<h2 id="full-examples" data-text="Examples" tabindex="-1">Examples</h2>

<p>For full runnable examples including multi-step task tracking, see the
...
<ul>
<li><a href="/gemini-api/docs/robotics-streaming">Live API for robotics</a> — real-time bidirectional streaming.</li>
<li><a href="/gemini-api/docs/robotics-orchestration">Task orchestration</a> — long-horizon tasks with spatial reasoning.</li>
<li><a href="/gemini-api/docs/robotics-overview">Gemini Robotics ER overview</a> — model comparison and capabilities.</li>
</ul>
