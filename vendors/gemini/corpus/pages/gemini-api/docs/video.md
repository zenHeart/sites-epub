...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/video"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/video" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/video" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/video?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/video?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/video?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/video?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/video?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/video?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/video?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/video?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/video?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/video?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/video?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/video?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/video?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/video?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/video?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/video?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/video?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/video?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/video?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/video?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/video?hl=sq" /><title>Video generation in the Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Video generation in the Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta name="description" content="Choose the right video generation model for your use case — Gemini Omni Flash for fast conversational editing, or Veo 3.1 for high-fidelity cinematic videos.">
  <meta property="og:description" content="Choose the right video generation model for your use case — Gemini Omni Flash for fast conversational editing, or Veo 3.1 for high-fidelity cinematic videos."><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/video"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Video generation in the Gemini API<devsite-actions hidden data-nosnippet>
...
<p>The Gemini API offers two models for generating video,
<a href="/gemini-api/docs/omni">Gemini Omni Flash</a> and <a href="/gemini-api/docs/veo">Veo</a>.
Each are designed for different workflows.</p>

<p>Use Gemini Omni Flash as your default model for video generation. It provides
...
legacy pipelines are required.</p>

<h2 id="omni-flash" data-text="Gemini Omni Flash" tabindex="-1">Gemini Omni Flash</h2>

<p>Gemini Omni Flash is a fast, multimodal model for video generation and
...
using the Interactions API.</p>

<p><a href="/gemini-api/docs/omni">Get started with Gemini Omni Flash →</a></p>

<h2 id="veo" data-text="Veo 3.1" tabindex="-1">Veo 3.1</h2>

<p>Veo 3.1 is a model for generating video with native audio. It supports
features like video extension, frame-specific generation, and image-based
direction through the <code translate="no" dir="ltr">generateContent</code> API.</p>

<p><a href="/gemini-api/docs/veo">Get started with Veo 3.1 →</a></p>

<h2 id="understanding" data-text="Video understanding" tabindex="-1">Video understanding</h2>

<p>If you need to ingest and analyze existing video content rather than generate
new video, see the <a href="/gemini-api/docs/video-understanding">Video understanding guide</a>.</p>
...
<devsite-content-footer class="nocontent" data-nosnippet>
  ...
  <p>Last updated 2026-06-30 UTC.</p>
