...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/live-api"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/live-api" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/live-api" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/live-api?hl=sq" /><title>Gemini Live API overview &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini Live API overview &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/live-api"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini Live API overview<devsite-actions hidden data-nosnippet>
...
<aside class="preview"><strong>Preview:</strong><span> The Live API is in
<a href="https://cloud.google.com/products#product-launch-stages">Preview</a>.</span></aside>
<p>The Live API enables low-latency, real-time voice and vision interactions with
...
<p><img src="/static/gemini-api/docs/images/live-api-overview.png" alt="Live API Overview"></p>
...
<div class="quickstart">
  ...
  <a class="button button-with-icon button-primary" href="https://github.com/google-gemini/gemini-live-api-examples">
    Clone example apps from GitHub<span class="material-icons icon-after" aria-hidden="true" translate="no">code</span>
  </a>
...
<p>Live API can be used to build real-time voice agents for a
variety of industries, including:</p>

<ul>
<li><strong>E-commerce and retail:</strong> Shopping assistants that offer personalized
recommendations and support agents that resolve customer issues.</li>
<li><strong>Gaming:</strong> Interactive non-player characters (NPCs), in-game help
assistants, and real-time translation of in-game content.</li>
<li><strong>Next-gen interfaces:</strong> Voice- and video-enabled experiences in robotics,
smart glasses, and vehicles.</li>
<li><strong>Healthcare:</strong> Health companions for patient support and education.</li>
<li><strong>Financial services:</strong> AI advisors for wealth management and investment
guidance.</li>
<li><strong>Education:</strong> AI mentors and learner companions that provide personalized
instruction and feedback.</li>
<li><strong>Translation and localization:</strong> Real-time, low-latency translation of
spoken conversations, enabling seamless multilingual communication.</li>
<li><strong>Live transcription and captioning:</strong> Real-time speech-to-text streaming for
live subtitles, meeting transcription, voice dictation, and customer call logging.</li>
</ul>

<h2 id="key-features" data-text="Key features" tabindex="-1">Key features</h2>

<p>Live API offers a comprehensive set of features for building
robust voice agents:</p>

<ul>
<li><a href="/gemini-api/docs/live-guide#supported-languages"><strong>Multilingual support</strong></a>:
Converse in 70 supported languages.</li>
<li><a href="/gemini-api/docs/live-guide#interruptions"><strong>Barge-in</strong></a>:
Users can interrupt the model at any time for responsive interactions.</li>
<li><a href="/gemini-api/docs/live-tools"><strong>Tool use</strong></a>:
Integrates tools like function calling and Google Search for dynamic
interactions.</li>
<li><a href="/gemini-api/docs/live-guide#audio-transcription"><strong>Audio transcriptions</strong></a>:
Provides text transcripts of both user input and model output.</li>
<li><a href="/gemini-api/docs/live-guide#proactive-audio"><strong>Proactive audio</strong></a>:
Lets you control when the model responds and in what contexts.</li>
<li><a href="/gemini-api/docs/live-guide#affective-dialog"><strong>Affective dialog</strong></a>:
Adapts response style and tone to match the user&#39;s input expression.</li>
<li><a href="/gemini-api/docs/live-api/live-transcribe"><strong>Live Transcription</strong></a>:
Real-time, continuous speech-to-text streaming with automatic language detection and custom vocabulary.</li>
<li><a href="/gemini-api/docs/live-api/live-translate"><strong>Live Translation</strong></a>:
Real-time voice-to-voice translation in 70+ languages.</li>
</ul>
...
<td style="text-align: left">Audio (raw 16-bit PCM audio, 24kHz, little-endian)</td>
</tr>
<tr>
...
<h2 id="implementation-approach" data-text="Choose an implementation approach" tabindex="-1">Choose an implementation approach</h2>

<p>When integrating with Live API, you&#39;ll need to choose one of the following
implementation approaches:</p>

<ul>
<li><strong>Server-to-server</strong>: Your backend connects to the Live API using
<a href="https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API">WebSockets</a>. Typically, your client sends stream data (audio, video,
text) to your server, which then forwards it to the Live API.</li>
<li><strong>Client-to-server</strong>: Your frontend code connects directly to the Live API
using <a href="https://developer.mozilla.org/en-US/docs/Web/API/WebSockets_API">WebSockets</a> to stream data, bypassing your backend.</li>
</ul>
<aside class="note"><strong>Note:</strong><span> Client-to-server generally offers better performance for streaming audio
...
using <a href="/gemini-api/docs/ephemeral-tokens">ephemeral tokens</a> instead of standard
API keys.</span></aside>
<h2 id="get-started" data-text="Get started" tabindex="-1">Get started</h2>

<p>Select the guide that matches your development environment:</p>
  ...
  <span
    ...
    >
      ...
      Server-to-server
          ...
          <h3 class="hide-from-toc no-link" id="genai-sdk-tutorial" data-text="                                                      GenAI SDK tutorial                                                    " tabindex="-1">
            
              <a href="/gemini-api/docs/live-api/get-started-sdk" track-metadata-eventdetail="get-started-sdk" track-type="card" track-name="
  GenAI SDK tutorial
" track-metadata-child_headline="GenAI SDK tutorial" track-metadata-child_chip_label="Server-to-server">
  ...
  <span
    ...
    >
      ...
      Client-to-server
          ...
          <h3 class="hide-from-toc no-link" id="websocket-tutorial" data-text="                                                      WebSocket tutorial                                                    " tabindex="-1">
            
              <a href="/gemini-api/docs/live-api/get-started-websocket" track-metadata-eventdetail="get-started-websocket" track-type="card" track-name="
  WebSocket tutorial
" track-metadata-child_headline="WebSocket tutorial" track-metadata-child_chip_label="Client-to-server">
  ...
  <span
    ...
    >
      ...
      Agent development kit
          ...
          <h3 class="hide-from-toc no-link" id="adk-tutorial" data-text="                                                      ADK tutorial                                                    " tabindex="-1">
            
              <a href="https://google.github.io/adk-docs/streaming/" track-metadata-eventdetail="https://google.github.io/adk-docs/streaming/" track-type="card" track-name="
  ADK tutorial
" track-metadata-child_headline="ADK tutorial" track-metadata-child_chip_label="Agent Development Kit">
...
<div class="main-content">
  <h2 id="partner-integrations" data-text="Partner integrations" tabindex="-1">Partner integrations</h2>
  <p>
  ...
  <div class="gemini-api-recommended">
    <a href="https://docs.livekit.io/agents/models/realtime/plugins/gemini/" class="gemini-api-card-overview">
    ...
    <a href="https://docs.pipecat.ai/guides/features/gemini-live" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
        Pipecat by Daily
      </p>
      <p class="gemini-api-card-description">
    ...
    <a href="https://docs.fishjam.io/tutorials/gemini-live-integration" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
    ...
    <a href="https://visionagents.ai/integrations/gemini" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
    ...
    <a href="https://voximplant.com/products/gemini-client" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
        Voximplant
      </p>
      <p class="gemini-api-card-description">
    ...
    <a href="https://docs.agora.io/en/conversational-ai/models/mllm/gemini" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
        Agora
      </p>
      <p class="gemini-api-card-description">
    ...
    <a href="https://firebase.google.com/docs/ai-logic/live-api?api=dev" class="gemini-api-card-overview">
      <p class="gemini-api-card-title">
        Firebase AI SDK
      </p>
      <p class="gemini-api-card-description">
