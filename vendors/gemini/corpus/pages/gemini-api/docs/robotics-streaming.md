...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/robotics-streaming"><link rel="search" type="application/opensearchdescription+xml"
...
<h3 id="implement_the_heartbeat" data-text="Implement the heartbeat" tabindex="-1">Implement the heartbeat</h3>

<p>The heartbeat coroutine runs as a separate <code translate="no" dir="ltr">asyncio</code> task in the same session.
It opportunistically targets a 1 Hz cadence (matching the video input rate limit)
while waiting for each turn to complete (<code translate="no" dir="ltr">er_turn_done</code>) to avoid interrupting
in-flight reasoning:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Python"><code translate="no" dir="ltr"><span class="devsite-syntax-k">async</span> <span class="devsite-syntax-k">def</span><span class="devsite-syntax-w"> </span><span class="devsite-syntax-nf">heartbeat</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">session</span><span class="devsite-syntax-p">,</span> <span class="devsite-syntax-n">camera</span><span class="devsite-syntax-p">,</span> <span class="devsite-syntax-n">er_turn_done</span><span class="devsite-syntax-p">:</span> <span class="devsite-syntax-n">asyncio</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">Event</span><span class="devsite-syntax-p">):</span>
    <span class="devsite-syntax-n">TARGET_INTERVAL_SEC</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-mf">1.0</span>

    <span class="devsite-syntax-k">while</span> <span class="devsite-syntax-kc">True</span><span class="devsite-syntax-p">:</span>
        <span class="devsite-syntax-n">start_time</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">asyncio</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">get_running_loop</span><span class="devsite-syntax-p">()</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">time</span><span class="devsite-syntax-p">()</span>
        ...
        <span class="devsite-syntax-c1"># Wait for the model to finish responding before sending the next heartbeat</span>
        <span class="devsite-syntax-k">await</span> <span class="devsite-syntax-n">er_turn_done</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">wait</span><span class="devsite-syntax-p">()</span>
        <span class="devsite-syntax-n">er_turn_done</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">clear</span><span class="devsite-syntax-p">()</span>

        <span class="devsite-syntax-c1"># Sleep only the remaining time to maintain ~1 Hz cadence</span>
        <span class="devsite-syntax-n">elapsed</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">asyncio</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">get_running_loop</span><span class="devsite-syntax-p">()</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">time</span><span class="devsite-syntax-p">()</span> <span class="devsite-syntax-o">-</span> <span class="devsite-syntax-n">start_time</span>
        <span class="devsite-syntax-n">remaining</span> <span class="devsite-syntax-o">=</span> <span class="devsite-syntax-n">TARGET_INTERVAL_SEC</span> <span class="devsite-syntax-o">-</span> <span class="devsite-syntax-n">elapsed</span>
        <span class="devsite-syntax-k">if</span> <span class="devsite-syntax-n">remaining</span> &gt; <span class="devsite-syntax-mi">0</span><span class="devsite-syntax-p">:</span>
            <span class="devsite-syntax-k">await</span> <span class="devsite-syntax-n">asyncio</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">sleep</span><span class="devsite-syntax-p">(</span><span class="devsite-syntax-n">remaining</span><span class="devsite-syntax-p">)</span>
</code></pre></devsite-code><aside class="caution"><strong>Caution:</strong><span> Sending a new prompt while the model is generating acts as an
interruption (barge-in), which cancels in-flight reasoning and tool calls. If
you fire heartbeats on a blind timer without waiting for the previous turn to
complete, you may trap the model in a cancellation loop, making it appear
unresponsive. See the
<a href="/gemini-api/docs/live-api/capabilities#interruptions">Live API guide on interruptions</a>
for more details.</span></aside>
<h3 id="update_the_receive_loop" data-text="Update the receive loop" tabindex="-1">Update the receive loop</h3>

<p>To signal when the model has completed its turn, update your <code translate="no" dir="ltr">receive_loop</code>
to set <code translate="no" dir="ltr">er_turn_done</code>:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Python"><code translate="no" dir="ltr"><span class="devsite-syntax-c1"># In receive_loop: signal when the model finishes its turn</span>
<span class="devsite-syntax-k">if</span> <span class="devsite-syntax-n">sc</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">turn_complete</span><span class="devsite-syntax-p">:</span>
    <span class="devsite-syntax-n">er_turn_done</span><span class="devsite-syntax-o">.</span><span class="devsite-syntax-n">set</span><span class="devsite-syntax-p">()</span>
</code></pre></devsite-code>
