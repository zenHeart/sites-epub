...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/transcribe"><link rel="search" type="application/opensearchdescription+xml"
...
<aside class="note"><strong>Note:</strong><span> You cannot combine <code translate="no" dir="ltr">custom_vocabulary</code> with speaker diarization or word-level timestamps. The API rejects requests that include <code translate="no" dir="ltr">custom_vocabulary</code> with either feature.</span></aside><div><devsite-selector data-ds-scope="code-sample">
...
<td style="text-align: left">Array of strings</td>
<td style="text-align: left">Up to 1,000 custom terms, acronyms, or proper names to bias speech recognition. Incompatible with speaker diarization and word-level timestamps.</td>
</tr>
<tr>
...
<td style="text-align: left">Array of strings</td>
<td style="text-align: left"><em>(Verbatim mode only)</em> Granularity of timestamps to return. Pass <code translate="no" dir="ltr">[&quot;word&quot;]</code> to enable word start and end offsets. Incompatible with custom vocabulary.</td>
</tr>
<tr>
<td style="text-align: left"><code translate="no" dir="ltr">mode.diarization_mode</code></td>
<td style="text-align: left">String</td>
<td style="text-align: left"><em>(Verbatim mode only)</em> Diarization mode. Pass <code translate="no" dir="ltr">&quot;speaker&quot;</code> to identify and label distinct speakers. Incompatible with custom vocabulary.</td>
</tr>
</tbody>
</table>
...
<li><strong>Custom vocabulary:</strong> You can provide up to 1,000 terms in <code translate="no" dir="ltr">custom_vocabulary</code>, but best results are typically achieved with up to 100 terms. You cannot combine <code translate="no" dir="ltr">custom_vocabulary</code> with speaker diarization or word-level timestamps; the API rejects requests that specify <code translate="no" dir="ltr">custom_vocabulary</code> alongside either feature.</li>
