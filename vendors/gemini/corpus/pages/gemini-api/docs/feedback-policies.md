...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/gemini-api/docs/feedback-policies"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/gemini-api/docs/feedback-policies" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/gemini-api/docs/feedback-policies?hl=sq" /><title>Feedback &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Feedback &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/gemini-api/docs/feedback-policies"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Feedback<devsite-actions hidden data-nosnippet>
...
<h2 id="inline-preference-voting" data-text="Inline Preference Voting" tabindex="-1">Inline Preference Voting</h2>

<p>In Google AI Studio, you might occasionally see a side-by-side comparison of two
...
understand which model outputs users find most helpful.</p>

<h3 id="why-inline-preference-voting" data-text="Why are we doing this?" tabindex="-1">Why are we doing this?</h3>

<p>We&#39;re constantly working to improve our AI models and services. Your feedback
...
<a href="/gemini-api/terms">Gemini API Additional Terms of Service</a> and
<a href="https://policies.google.com/privacy">Privacy Policy</a>.</p>

<h3 id="included-data" data-text="What data is included in Feedback?" tabindex="-1">What data is included in Feedback?</h3>

<p>To make informed decisions about our models, we collect certain data when you
participate in Inline Preference Voting:</p>

<ul>
<li><strong>Prompts and Responses:</strong> We record all prompts and responses, including any
...
understand the context of your preference.</li>
<li><strong>Your Vote:</strong> We record which response you preferred. This is the core of the
feedback we&#39;re collecting.</li>
<li><strong>Usage Details:</strong> This includes information about which model generated the
response and other technical and operational details about your usage of this
feature.</li>
</ul>

<h3 id="privacy" data-text="Your Privacy" tabindex="-1">Your Privacy</h3>

<p>We take your privacy seriously. Google takes steps to protect your privacy as
part of this process. This includes disconnecting this data from your Google
Account, API key, and Cloud project before reviewers see or annotate it. <strong>Do
not submit feedback on conversations that include sensitive, confidential, or
personal information.</strong></p>

<h3 id="opting-out" data-text="Opting Out" tabindex="-1">Opting Out</h3>

<p>You&#39;ll have the option to skip the Inline Preference Voting when it appears.</p>

<p>Thank you for helping us improve Google AI Studio!</p>
