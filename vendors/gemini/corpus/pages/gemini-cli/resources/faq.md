...
of our [applicable terms and policies](/docs/resources/tos-privacy). Doing so bypasses our
...
Refer to [Gemini CLI Configuration](/docs/reference/configuration) for more
details.
