...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/api"><link rel="search" type="application/opensearchdescription+xml"
            title="Google AI for Developers" href="https://ai.google.dev/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://ai.google.dev/api" /><link rel="alternate" hreflang="x-default" href="https://ai.google.dev/api" /><link rel="alternate" hreflang="ar"
          href="https://ai.google.dev/api?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/api?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/api?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/api?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/api?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/api?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/api?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/api?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/api?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/api?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/api?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/api?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/api?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/api?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/api?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/api?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/api?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/api?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/api?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/api?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/api?hl=sq" /><title>Gemini API reference &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini API reference &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/api"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini API reference<devsite-actions hidden data-nosnippet>
...
<p>This API reference describes the unary, streaming, and real-time APIs you can
...
<a href="https://ai.google.dev/gemini-api/docs/get-started">Get started guide</a>
...
link for that language in the left navigation under <strong>SDK references</strong>.</p>

<h2 id="primary-endpoints" data-text="Primary endpoints" tabindex="-1">Primary endpoints</h2>

<p>The Gemini API is organized around the following major endpoints:</p>

<ul>
<li><strong>Interactions (<a href="/api/interactions-api#CreateInteraction"><code translate="no" dir="ltr">CreateInteraction</code></a>) (Recommended):</strong>
...
<li><strong>Standard content generation (<a href="/api/generate-content#method:-models.generatecontent"><code translate="no" dir="ltr">generateContent</code></a>):</strong>
...
where you can wait for the entire result.</li>
<li><strong>Streaming content generation (<a href="/api/generate-content#method:-models.streamgeneratecontent"><code translate="no" dir="ltr">streamGenerateContent</code></a>):</strong>
...
applications like chatbots.</li>
<li><strong>Live API (<a href="/api/live#send-messages"><code translate="no" dir="ltr">BidiGenerateContent</code></a>):</strong> A stateful WebSocket-based
API for bi-directional streaming, designed for real-time conversational use
cases.</li>
<li><strong>Batch mode (<a href="/api/batch-mode"><code translate="no" dir="ltr">batchGenerateContent</code></a>):</strong> A standard REST
endpoint for submitting batches of <code translate="no" dir="ltr">generateContent</code> requests.</li>
<li><strong>Embeddings (<a href="/api/embeddings"><code translate="no" dir="ltr">embedContent</code></a>):</strong> A standard REST endpoint
that generates a text embedding vector from the input <code translate="no" dir="ltr">Content</code>.</li>
<li><strong>Gen Media APIs:</strong> Endpoints for generating media with our specialized
models such as <a href="/api/models#method:-models.predict">Imagen for image generation</a>,
and <a href="/api/models#method:-models.predictlongrunning">Veo for video generation</a>.
Gemini also has these capabilities built in which you can access using the
<code translate="no" dir="ltr">generateContent</code> API.</li>
<li><strong>Platform APIs:</strong> Utility endpoints that support core capabilities such as
<a href="/api/files">uploading files</a>, and <a href="/api/tokens">counting tokens</a>.</li>
</ul>

<h2 id="authentication" data-text="Authentication" tabindex="-1">Authentication</h2>

<p>All requests to the Gemini API must include a <code translate="no" dir="ltr">x-goog-api-key</code> header with your
API key. Create one with a few clicks in <a href="https://aistudio.google.com/apikey">Google AI
Studio</a>.</p>

<p>The following is an example request with the API key included in the header:</p>
...
<p>For instructions on how to pass your key to the API using Gemini SDKs,
see the <a href="/gemini-api/docs/api-key">Using Gemini API keys</a> guide.</p>
