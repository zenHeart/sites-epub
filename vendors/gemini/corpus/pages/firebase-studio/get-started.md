...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/get-started"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/get-started" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/get-started" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/get-started?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/get-started?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/get-started?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/get-started?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/get-started?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/get-started?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/get-started?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/get-started?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/get-started?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/get-started?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/get-started?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/get-started?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/get-started?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/get-started?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/get-started?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/get-started?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/get-started?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/get-started?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/get-started?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/get-started?hl=vi" /><title>Get started with Firebase Studio</title>

<meta property="og:title" content="Get started with Firebase Studio"><meta name="description" content="A guide to getting started with Firebase Studio, with instructions on how to manage existing workspaces and migrate your projects.">
  <meta property="og:description" content="A guide to getting started with Firebase Studio, with instructions on how to manage existing workspaces and migrate your projects."><meta property="og:url" content="https://firebase.google.com/docs/studio/get-started"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Get started with Firebase Studio<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p><span class="notranslate">Firebase Studio</span> is sunsetting on March 22, <u>2027</u>. As of
June 22, 2026, new workspace creation and user signup are disabled.</p>

<p>If you have existing workspaces, you can continue to develop, test, and
deploy them until the sunset date. However, if you are starting a new project,
or want to transition your existing work to a long-term home, we recommend
migrating your projects.</p>

<h2 id="manage-existing" data-text="Manage existing workspaces" tabindex="-1">Manage existing workspaces</h2>

<p>You can continue to work on your existing projects in <span class="notranslate">Firebase Studio</span>:</p>

<ol>
<li>Open the <a href="https://studio.firebase.google.com/"><span class="notranslate">Firebase Studio</span> console</a>.</li>
<li>Select your existing workspace to load the cloud-based development
environment.</li>
<li>Use the built-in tools, terminal, and AI assistance to continue your work.</li>
</ol>

<h2 id="migrate-projects" data-text="Migrate your projects" tabindex="-1">Migrate your projects</h2>

<p>To ensure your applications can continue to be developed and deployed after
the sunset date, migrate your workspaces to one of our flagship developer
tools:</p>

<ul>
<li><strong><span class=\"notranslate\">Google&nbsp;AI Studio</span></strong>: Ideal for web-based rapid prototyping and
prompt-based development.</li>
<li><strong><span class="notranslate">Google Antigravity</span></strong>: Ideal for a local, code-first development
environment with advanced agentic workflows.</li>
</ul>

<p>For step-by-step instructions, see the
