...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/build-gemini-api-app"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/build-gemini-api-app" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/build-gemini-api-app?hl=vi" /><title>Build an app with the Gemini&nbsp;API &nbsp;|&nbsp; Firebase Studio</title>

<meta property="og:title" content="Build an app with the Gemini&nbsp;API &nbsp;|&nbsp; Firebase Studio"><meta name="description" content="A tutorial on how to build an app with the Gemini API in Firebase Studio, either by starting from a template or by adding the API to an existing application.">
  <meta property="og:description" content="A tutorial on how to build an app with the Gemini API in Firebase Studio, either by starting from a template or by adding the API to an existing application."><meta property="og:url" content="https://firebase.google.com/docs/studio/build-gemini-api-app"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Build an app with the Gemini&nbsp;API<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>While you can use <a href="/docs/studio/get-started-ai">the <span class="notranslate">App Prototyping agent</span></a>
to automatically create a new app prototype with the <span class=\"notranslate\">Gemini&nbsp;API</span>, you can
also launch a blank canvas with the
<a href="https://ai.google.dev/"><span class=\"notranslate\">Gemini</span> Developer API</a> through one click of
a button. Start using the latest generative AI models from Google in your
app with a template that includes all the <span class=\"notranslate\">Gemini&nbsp;API</span> infrastructure you
need. All you need to do is add your
<a href="https://ai.google.dev/tutorials/setup"><span class=\"notranslate\">Gemini&nbsp;API</span> key</a> and get coding!</p>

<h2 id="build-a-new-app" data-text="Build a new app with the Gemini API pre-loaded" tabindex="-1">Build a new app with the <span class='\"notranslate\"'>Gemini API</span> pre-loaded</h2>

<p>Access the <span class="notranslate">Firebase Studio</span> <span class=\"notranslate\">Gemini&nbsp;API</span> template from the
templates dashboard and build with the power of AI.</p>

<ol>

<li>Open the <a href="https://studio.firebase.google.com//new/gemini"
target="_blank"><span class="notranslate">Firebase Studio</span> template for the <span class=\"notranslate\">Gemini&nbsp;API</span></a> from
the <span class="notranslate">Firebase Studio</span> template dashboard.</li>

<li> Select the language and framework for your environment. The
<span class=\"notranslate\">Gemini&nbsp;API</span> template
   in <span class="notranslate">Firebase Studio</span> is available in JavaScript (with Vite or
   <span class="notranslate">Genkit</span>) and Python (notebook or web app with Flask).</li>

<li><em>(Optional)</em> If you want to add the
<a href="https://www.langchain.com/" target="_blank" class="external">LangChain</a>
   framework to your app, select the <strong>Use LangChain</strong> option.</li>

<li> When your workspace loads, open the <code translate="no" dir="ltr">main.js</code> or
<code translate="no" dir="ltr">main.py</code> file and update
   the <code translate="no" dir="ltr">API_KEY</code> variable with your <span class=\"notranslate\">Gemini&nbsp;API</span> key from <a
   href="https://aistudio.google.com/app/apikey" target="_blank"
   class="external">Google AI Studio</a>.</li>

<li> Test the base app in the web preview panel to watch the <span class=\"notranslate\">Gemini&nbsp;API</span> in
   action, and modify your new <span class=\"notranslate\">Gemini&nbsp;API</span> app accordingly.</li>

</ol>

<h2 id="add-the-gemini-api" data-text="Add the Gemini API to an existing app" tabindex="-1">Add the <span class='\"notranslate\"'>Gemini API</span> to an existing app</h2>

<p>You can also add the <span class=\"notranslate\">Gemini&nbsp;API</span> to your existing app directly from
<span class="notranslate">Firebase Studio</span>.</p>

<ol>
<li><p>Open <a href="https://studio.firebase.google.com/" class="external"><span class="notranslate">Firebase Studio</span></a>.</p></li>
<li><p>Click the <span class="notranslate">Firebase Studio</span> icon from the navigation pane to open the
<span class="notranslate">Firebase Studio</span> panel.</p></li>
<li><p>Expand the <strong>Google Integrations</strong> section and click <strong>Add <span class=\"notranslate\">Gemini&nbsp;API</span></strong>.</p></li>
<li><p>Follow the prompts to authenticate your account and add a <span class=\"notranslate\">Gemini&nbsp;API</span> key
to your app.</p></li>
</ol>
