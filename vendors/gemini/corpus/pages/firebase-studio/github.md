...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/github"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/github" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/github" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/github?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/github?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/github?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/github?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/github?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/github?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/github?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/github?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/github?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/github?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/github?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/github?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/github?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/github?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/github?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/github?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/github?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/github?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/github?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/github?hl=vi" /><title>Upload your app to GitHub &nbsp;|&nbsp; Firebase Studio</title>

<meta property="og:title" content="Upload your app to GitHub &nbsp;|&nbsp; Firebase Studio"><meta name="description" content="A guide to integrating Firebase Studio with GitHub, including instructions on how to commit changes and publish a project to a GitHub repository.">
  <meta property="og:description" content="A guide to integrating Firebase Studio with GitHub, including instructions on how to commit changes and publish a project to a GitHub repository."><meta property="og:url" content="https://firebase.google.com/docs/studio/github"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Upload your app to GitHub<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>You can integrate <span class="notranslate">Firebase Studio</span> with GitHub to ensure that your projects
are backed up and can be shared with others.</p>
<aside class="note"><strong>Note:</strong><span> If you&#39;re using the <span class="notranslate">App Prototyping agent</span>, note that it commits its
  changes to your local branch
  on every response. <span class="notranslate">Firebase Studio</span> in <span class="notranslate">Code</span> view
  requires you to manually commit changes after you make them. You can do this
  from the Source Control pane
  or from the Terminal in <a href="/docs/studio/get-started-workspace"><span class="notranslate">Firebase Studio</span> <span class="notranslate">Code</span>
  view</a>.</span></aside>
<h2 id="before-you-begin" data-text="Before you begin" tabindex="-1">Before you begin</h2>

<ul>
<li><a href="https://docs.github.com/en/get-started/start-your-journey/creating-an-account-on-github" id="external">Create an account on GitHub</a> </li>
</ul>

<h2 id="add-your-project" data-text="Add your project to GitHub" tabindex="-1">Add your project to GitHub</h2>

<p>To add your project to GitHub:</p>

<ol>
<li><p>In your open workspace, from the <strong>View</strong> menu, select <strong>Source Control</strong>
or press <code translate="no" dir="ltr">Ctrl-Shift-G</code> (<code translate="no" dir="ltr">Cmd-Shift-G</code> in MacOS).</p>
...
<li><p>Review the Source Control graph. If there are any uncommitted changes, use
either of the these two methods to commit them locally:</p>

<ul>
<li><p>From the Source Control pane:</p>

<ol>
<li><p>Click <strong>Commit</strong>.</p></li>
<li><p>When prompted to stage changes, click <strong>Yes</strong>.</p></li>
<li><p>Add a commit message that describes your changes in the
<code translate="no" dir="ltr">COMMIT_EDITMSG</code> file that opens.</p></li>
<li><p>Save and close the file.</p></li>
</ol></li>
<li><p>From the Terminal:</p>

<ol>
<li><p>To view uncommitted files, run:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">git<span class="devsite-syntax-w"> </span>status
</code></pre></devsite-code></li>
<li><p>Add the files to source control:</p>

<ul>
<li><p>To add single files, run:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">git<span class="devsite-syntax-w"> </span>add<span class="devsite-syntax-w"> </span><span class="devsite-syntax-o">[</span>list<span class="devsite-syntax-w"> </span>of<span class="devsite-syntax-w"> </span>files<span class="devsite-syntax-o">]</span>
</code></pre></devsite-code></li>
<li><p>To add all uncommitted files, run:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">git<span class="devsite-syntax-w"> </span>add<span class="devsite-syntax-w"> </span>*
</code></pre></devsite-code></li>
</ul></li>
<li><p>Commit your changes:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">git<span class="devsite-syntax-w"> </span>commit<span class="devsite-syntax-w"> </span>-m<span class="devsite-syntax-w"> </span><span class="devsite-syntax-s2">"Your commit message describing the changes."</span>
</code></pre></devsite-code></li>
</ol></li>
</ul>
<aside class="warning"><strong>Warning:</strong><span> Inspect the files that you plan to upload to GitHub to ensure you
are not uploading any API keys or other secrets. Add any exclusions to
the <a href="https://docs.github.com/en/get-started/git-basics/ignoring-files" class="external"><code translate="no" dir="ltr">.gitignore</code>
file</a>.</span></aside></li>
<li><p>In the <strong>Source Control</strong> pane, click <strong>Publish Branch.</strong></p></li>
<li><p>When prompted to log into Git, click <strong>Allow</strong> and follow the instructions
to authenticate.</p></li>
<li><p>After you&#39;ve authenticated, return to the <span class="notranslate">Firebase Studio</span> window and
enter a name for your project in the active field, then select one of the
following:</p>

<ul>
<li><p><strong>Publish to GitHub private repository</strong> to publish your app privately on
GitHub.</p></li>
<li><p><strong>Publish to GitHub public repository</strong> to publish your app publicly on
GitHub.</p></li>
</ul></li>
</ol>
<aside class="tip"><strong>Tip:</strong><span> We recommend uploading to a private repository at first. You can set
     the repository to public on GitHub at any time.</span></aside>
...
<li><a href="/docs/studio/custom-templates">Create a custom template</a>.</li>
</ul>
