...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/migrating-project"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/migrating-project" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/migrating-project" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/migrating-project?hl=vi" /><title>Firebase Studio sunset and project migration</title>

<meta property="og:title" content="Firebase Studio sunset and project migration"><meta name="description" content="A guide to migrating your Firebase Studio projects to Google AI Studio or Google Antigravity.">
  <meta property="og:description" content="A guide to migrating your Firebase Studio projects to Google AI Studio or Google Antigravity."><meta property="og:url" content="https://firebase.google.com/docs/studio/migrating-project"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Firebase Studio sunset and project migration<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<aside class="warning">
  <strong>As of June 22, 2026, new workspace creation and new user signup for
  <span class="notranslate">Firebase Studio</span> are disabled.</strong>
  <p>
    Until the sunset date (March 22, <u>2027</u>), you can continue
    working on projects in <em>existing</em> <span class="notranslate">Firebase Studio</span> workspaces.
    However, for any projects that you want to maintain beyond that sunset date,
    you must migrate them <em>before March 22, <u>2027</u></em> using
    the instructions on this page.
  </p>
</aside>

<p><strong><span class="notranslate">Firebase Studio</span> is sunsetting on March 22, <u>2027</u>.</strong>
We&#39;re simplifying our AI developer offerings by transitioning the lessons
learned from the Firebase Studio preview into our flagship tools:
<strong><span class=\"notranslate\">Google&nbsp;AI Studio</span></strong> and <strong><span class="notranslate">Google Antigravity</span></strong>.</p>

<p>While the interface for building apps is evolving, our commitment to the
Firebase ecosystem is stronger than ever. By integrating agentic
capabilities directly into our flagship AI platforms, we&#39;re ensuring that
Firebase continues to provide a seamless, reliable backend for
AI-driven development. Core Firebase services, such as <span class="notranslate">Cloud Firestore</span>,
<span class="notranslate">Authentication</span>, and <span class="notranslate">App Hosting</span>, will continue to work outside of
<span class="notranslate">Firebase Studio</span>.</p>

<h2 id="why-change" data-text="Why we're making this change" tabindex="-1">Why we're making this change</h2>

<p><span class="notranslate">Firebase Studio</span> launched as a preview to explore the future of AI-driven,
full-stack development. Based on your feedback, we&#39;re streamlining our tools
to provide clearer, more powerful paths forward:</p>

<ul>
<li><p><strong>For code-first, agentic development</strong>: We&#39;re focusing on
<strong><span class="notranslate">Antigravity</span></strong>, our next-generation platform designed for high-velocity,
autonomous multi-agent workflows.</p></li>
<li><p><strong>For rapid, browser-based prototyping</strong>: We&#39;ve integrated <span class="notranslate">Cloud Firestore</span> and
<span class="notranslate">Firebase Authentication</span> directly into <strong><span class=\"notranslate\">Google&nbsp;AI Studio</span></strong> to provide the
fastest path from prompt to production.</p></li>
</ul>

<p>Your core Firebase services (<span class="notranslate">Cloud Firestore</span>, <span class="notranslate">Authentication</span>, <span class="notranslate">App Hosting</span>,
etc.) are not affected. Your databases and user data will continue to function
normally. This sunset only applies to the <span class="notranslate">Firebase Studio</span> development
environment.</p>

<h2 id="timeline" data-text="Sunset timeline" tabindex="-1">Sunset timeline</h2>

<p>We&#39;re providing a one-year transition period to ensure you have ample time to
migrate your projects:</p>

<ul>
<li><strong>March 19, 2026</strong>: Sunset announcement, and migration tools start rolling
out to <span class="notranslate">Firebase Studio</span>.</li>
<li><strong>June 22, 2026</strong>: New workspace creation and user signup are disabled. You
can continue to work in and migrate existing workspaces.</li>
<li><strong>March 22, <u>2027</u></strong>: <span class="notranslate">Firebase Studio</span> is shut down, and all
remaining data is permanently deleted and cannot be recovered.</li>
</ul>

<h2 id="choose-path" data-text="Choose your migration path" tabindex="-1">Choose your migration path</h2>

<p>Depending on how you use <span class="notranslate">Firebase Studio</span>, choose the migration path that
best fits your workflow.</p>

<h3 id="antigravity" data-text="Migrate to Google Antigravity" tabindex="-1">Migrate to <span class="notranslate">Google Antigravity</span></h3>

<p>For a code-first, agentic development experience, we recommend
<a href="#migrate-antigravity">migrating to <span class="notranslate">Antigravity</span></a>. This is our
next-generation, agent-first platform designed for high-velocity, autonomous
workflows and multi-agent orchestration. You should choose <span class="notranslate">Antigravity</span> if
you meet any of the following criteria:</p>

<ul>
<li>Prefer working in an agent-first desktop environment with deeper
control over your codebase using the <strong><span class="notranslate">Antigravity</span> IDE</strong> or terminal</li>
<li>Created your app using a built-in template or imported repository in
<span class="notranslate">Firebase Studio</span></li>
<li>Primarily use the Code View environment in <span class="notranslate">Firebase Studio</span></li>
<li>Want direct access to state-of-the-art agentic AI development capabilities
within a powerful agent hub, with support for using different models like
Claude and GPT-OSS, in addition to <span class=\"notranslate\">Gemini</span></li>
<li>Started in <span class="notranslate">Prototyper</span> mode, but added significant
features or execution scripts that require a local environment without cloud
limitations</li>
</ul>

<h3 id="ai-studio" data-text="Migrate to Google AI Studio" tabindex="-1">Migrate to <span class='\"notranslate\"'>Google AI Studio</span></h3>

<p>For a web-based prototyping environment that brings the power of AI into your
browser, we recommend <a href="#migrate-ai-studio">migrating to <span class=\"notranslate\">Google&nbsp;AI Studio</span></a>. It
offers the fastest path from prompt to full-stack production app. You should
choose <span class=\"notranslate\">Google&nbsp;AI Studio</span> if you meet any of the following criteria:</p>

<ul>
<li>Prefer a web-based experience, which is ideal for multi-device workflows or
environments where you cannot install local software</li>
<li>Created your app using the <span class="notranslate">App Prototyping agent</span> in <span class="notranslate">Firebase Studio</span>
and value rapid prototyping and prompt-based app generation</li>
<li>Want the fastest path from prompt to full-stack production app</li>
</ul>
<aside class="note"><strong>Note:</strong><span> If you initially choose to start with <span class=\"notranslate\">Google&nbsp;AI Studio</span>, you can migrate
to <span class="notranslate">Google Antigravity</span> at a later stage by switching to the <strong>Code</strong> tab in
<span class=\"notranslate\">Google&nbsp;AI Studio</span> &gt; <strong>Export</strong> &gt; <strong>Export to <span class="notranslate">Antigravity</span></strong>.</span></aside>
<h2 id="migrate-ai-studio" data-text="Migrate apps to Google AI Studio" tabindex="-1">Migrate apps to <span class='\"notranslate\"'>Google AI Studio</span></h2>

<p><span class=\"notranslate\">Google&nbsp;AI Studio</span> offers the fastest path from prompt to full-stack production
app.</p>

<h3 id="ais-transfer-workspace" data-text="Step 1: Transfer your workspace" tabindex="-1">Step 1: Transfer your workspace</h3>

<ol>
<li>Click the <strong>Move now</strong> button at the top of your workspace, then select
<strong>Prepare for AI Studio</strong>.</li>
<li>After the preparation step is complete, click
<strong>Move to <span class=\"notranslate\">Google&nbsp;AI Studio</span></strong>.</li>
<li>If requested, review and accept the Terms of Service. Your code will
automatically open in a new <span class=\"notranslate\">Google&nbsp;AI Studio</span> workspace.</li>
</ol>

<p>It may take several minutes for <span class=\"notranslate\">Google&nbsp;AI Studio</span> to convert and load
your app. It will notify you when it&#39;s complete. When finished, you can
continue iterating on your app with help from the <span class=\"notranslate\">Google&nbsp;AI Studio</span> agent.
Learn more about building apps in
<a href="https://ai.google.dev/gemini-api/docs/aistudio-build-mode" class="external"><span class=\"notranslate\">Google&nbsp;AI Studio</span></a>.</p>

<h3 id="ais-publish" data-text="Step 2: Choose your publishing method" tabindex="-1">Step 2: Choose your publishing method</h3>

<p>Depending on your deployment needs and whether you want to preserve your
existing application URL, select one of the following publishing methods.</p>

<h4 id="ais-publish-app-hosting" data-text="Option A: Publish to App Hosting and keep your existing URL" tabindex="-1">Option A: Publish to <span class="notranslate">App Hosting</span> and keep your existing URL</h4>

<p>If you previously published your app through <span class="notranslate">Firebase Studio</span> and want to
keep your <code translate="no" dir="ltr">*.hosted.app</code> URL or custom domain, secure your Gemini API key and
use GitHub Sync:</p>
<aside class="note"><strong>Note:</strong><span> When you used <span class="notranslate">Firebase Studio</span> to publish your app to <span class="notranslate">App Hosting</span>,
<span class="notranslate">Firebase Studio</span> automatically extracted your Gemini API key from your
workspace <code translate="no" dir="ltr">.env</code> file and configured it as an <span class="notranslate">App Hosting</span> environment
variable, accessible by your app but not your users. When you migrate to
<span class=\"notranslate\">Google&nbsp;AI Studio</span>, you must manually set the environment variable in the
<span class="notranslate">Firebase</span> console to continue publishing to <span class="notranslate">App Hosting</span> through GitHub
sync (as the <code translate="no" dir="ltr">.env</code> file shouldn&#39;t be stored in GitHub to avoid API key
exposure). While this method stores the key securely, it remains
accessible to anyone with access to your Firebase project. If you require more
granular access controls, consider storing your key in
<a href="/docs/app-hosting/configure#secret-parameters"><span class="notranslate">Secret Manager</span></a>
instead.</span></aside>
<ol>
<li><p>Secure your Gemini API key:</p>

<ol>
<li>In the <span class="notranslate">Firebase</span> console, go to the
<a href="https://console.firebase.google.com/project/_/apphosting?useAutoProject=true" class="external"><span class="notranslate">App Hosting</span> page</a>.</li>
<li>Find your existing backend (usually named <code translate="no" dir="ltr">studio</code>) and click <strong>View</strong>.</li>
<li>In the <strong>Settings</strong> tab, navigate to <strong>Environment</strong>.</li>
<li><p>Click <strong>Add new</strong> and paste the contents of your <code translate="no" dir="ltr">.env</code> file into the
<strong>Key</strong> field to securely store your Gemini API key as an environment
variable.</p>
<aside class="tip"><strong>Tip:</strong><span> You can find your <code translate="no" dir="ltr">.env</code> file by switching to <strong>Code mode</strong> in
<span class="notranslate">Firebase Studio</span>.</span></aside></li>
</ol></li>
<li><p>Sync to GitHub from <span class=\"notranslate\">Google&nbsp;AI Studio</span>:</p>

<ol>
<li>In <span class=\"notranslate\">Google&nbsp;AI Studio</span>, click the <strong>Settings</strong> icon and navigate to the
<strong>GitHub</strong> panel.</li>
<li>Click <strong>Sign in to GitHub</strong> and install the <span class=\"notranslate\">Google&nbsp;AI Studio</span> GitHub
App.</li>
<li><p>Click <strong>Create GitHub repository</strong>.</p>
<aside class="special"><strong>Important:</strong><span> Review the file list and confirm <code translate="no" dir="ltr">.env</code> is not included.</span></aside></li>
<li><p>Select <strong>Stage and commit all changes</strong>.</p></li>
</ol></li>
<li><p>Connect the repository to <span class="notranslate">App Hosting</span>:</p>

<ol>
<li>In the <span class="notranslate">Firebase</span> console, go to the
<a href="https://console.firebase.google.com/project/_/apphosting?useAutoProject=true" class="external"><span class="notranslate">App Hosting</span> page</a>.</li>
<li>Find your existing backend (usually named <code translate="no" dir="ltr">studio</code>) and click <strong>View</strong>.</li>
<li>In the <strong>Settings</strong> tab, select <strong>Deployment</strong> &gt; <strong>Connect to GitHub</strong>.</li>
<li>Sign in to GitHub and install the <span class="notranslate">Firebase App Hosting</span> GitHub App.</li>
<li>Select your repository, set the branch to <code translate="no" dir="ltr">main</code>, and the root directory
to <code translate="no" dir="ltr">/</code>.</li>
<li>Click <strong>Save and deploy</strong>.</li>
</ol></li>
<li><p>Sync your changes to GitHub and deploy:</p>

<ol>
<li>In <span class=\"notranslate\">Google&nbsp;AI Studio</span>, navigate to the <strong>GitHub panel</strong>.</li>
<li>Review the changes to be published.</li>
<li>Click <strong>Stage and commit all changes</strong>.</li>
<li>Navigate to the
<a href="https://console.firebase.google.com/project/_/apphosting?useAutoProject=true" class="external"><span class="notranslate">Firebase</span> console</a> 
to monitor the progress of the <span class="notranslate">App Hosting</span> deployment.</li>
</ol></li>
</ol>

<h4 id="ais-publish-cloud-run" data-text="Option B: Move to Cloud Run and publish your app to a new URL" tabindex="-1">Option B: Move to <span class="notranslate">Cloud Run</span> and publish your app to a new URL</h4>

<p>If you prefer a one-click experience and either haven&#39;t previously published
your app, or don&#39;t mind a new URL (<code translate="no" dir="ltr">*.run.app</code>), use the <em>Publish</em> button in
<span class=\"notranslate\">Google&nbsp;AI Studio</span>:</p>

<ol>
<li>Open your app in <span class=\"notranslate\">Google&nbsp;AI Studio</span>, and click <strong>Publish</strong>.</li>
<li>In the project selector, click <strong>Import project</strong>.</li>
<li>Search for and select the project name used by Firebase Studio (found in the
top navigation bar of your <span class="notranslate">Firebase Studio</span> workspace).</li>
<li>Click <strong>Import</strong>, and then click <strong>Publish</strong>.</li>
</ol>
<aside class="note"><strong>Note:</strong><span> If you have a custom domain, you must map it to your new
<span class="notranslate">Cloud Run</span> service. Domain mapping can take up to 24 hours and may
result in downtime for your app. Alternatively, you can continue publishing to
<span class="notranslate">Firebase App Hosting</span> using
<a href="#ais-publish-app-hosting">GitHub sync in AI Studio</a> to avoid migrating domains.</span></aside>
<h2 id="migrate-antigravity" data-text="Migrate apps to Antigravity" tabindex="-1">Migrate apps to <span class="notranslate">Antigravity</span></h2>

<div class="video-wrapper">
  <iframe class="devsite-embedded-youtube-video" data-video-id="7K_8bD7YkH8"
          data-autohide="1" data-showinfo="0" frameborder="0" allow="fullscreen">
  </iframe>
</div>

<p><span class="notranslate">Antigravity</span> is a local, agent-first platform and agent hub that brings the
power of autonomous multi-agent workflows into your local development
environment.</p>

<h3 id="antigravity-prerequisites" data-text="Prerequisites" tabindex="-1">Prerequisites</h3>

<p>Ensure you have the following installed locally and fully up-to-date:</p>

<ul>
<li><a href="https://antigravity.google/download" class="external"><span class="notranslate">Google Antigravity</span> IDE</a>:
From the download options, choose the <strong>Antigravity IDE</strong>
(the editor environment).
This is the code-first workspace where you will open and run your migrated
app.</li>
<li><a href="https://nodejs.org/en" class="external">Node.js</a> (version 20 or higher)</li>
<li><a href="https://firebase.google.com/docs/cli" class="external"><span class="notranslate">Firebase</span> CLI</a> 
(version 15.10.0 or higher)</li>
</ul>

<h3 id="antigravity-export-app" data-text="Step 1: Export and initialize your app" tabindex="-1">Step 1: Export and initialize your app</h3>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="antigravity-automated-migration" data-text=" Automated migration " tabindex="-1"> Automated migration </h3><p>This workflow uses the <span class="notranslate">Antigravity</span> agent to autonomously handle project
transformation.</p>

<ol>
<li>In <span class="notranslate">Firebase Studio</span>, click the <strong>Move now</strong> button at the top of your
workspace.</li>
<li><p>Follow the export method based on the window that appears:</p>

<ul>
<li>If you see a <strong>Zip and Download</strong> button, click it.</li>
<li>Otherwise, open the command palette (<code translate="no" dir="ltr">Cmd</code>+<code translate="no" dir="ltr">Shift</code>+<code translate="no" dir="ltr">P</code> on Mac or
<code translate="no" dir="ltr">Ctrl</code>+<code translate="no" dir="ltr">Shift</code>+<code translate="no" dir="ltr">P</code> on ChromeOS, Windows, or Linux) and run the
<strong><span class="notranslate">Firebase Studio</span>: Zip &amp; Download</strong> command.</li>
</ul>
<aside class="tip"><strong>Tip:</strong><span> If the download window doesn&#39;t appear, check your browser&#39;s address
bar for a pop-up blocker icon and ensure pop-ups are allowed.</span></aside></li>
<li><p>Extract the folder locally and open it in the <strong><span class="notranslate">Antigravity</span> IDE</strong>.</p></li>
<li><p>In the <strong>Agent</strong> pane within the <strong><span class="notranslate">Antigravity</span> IDE</strong> interface, enter
the following prompt.
To optimize your workflow and conserve tokens, we recommend selecting the
<strong><span class=\"notranslate\">Gemini</span> Flash</strong> model. It&#39;s designed for speed and efficiency in
high-volume transformation tasks like file conversion.</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">@fbs-to-agy-export
</code></pre></devsite-code></li>
<li><p>The <span class="notranslate">Antigravity</span> agent will begin project migration, requesting your
...
<section><h3 id="antigravity-manual-export" data-text=" Manual export " tabindex="-1"> Manual export </h3><p>If you prefer to manage the migration yourself without using AI tokens, you
can use the <span class="notranslate">Firebase</span> CLI to manually export your project. This method is
direct and does not require agent interaction.</p>

<p>Open your terminal and run the following command, replacing <var translate="no">PATH</var>
with the path to your extracted project folder or the original zip file
(use <code translate="no" dir="ltr">.</code> if you&#39;re already in the target directory):</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">npx firebase-tools@latest studio:export <var translate="no">PATH</var>
</code></pre></devsite-code><aside class="note"><strong>Note:</strong><span> The <code translate="no" dir="ltr">studio:export</code> command is optimized for Next.js, Flutter, and
Angular workspaces. While you can use this command for other workspace types,
the migration may not update all code artifacts for use in <span class="notranslate">Antigravity</span>.
We&#39;re actively working to improve the migration flow.</span></aside></section>
</devsite-selector></div>
<h3 id="antigravity-preview-app" data-text="Step 2: Preview your app" tabindex="-1">Step 2: Preview your app</h3>

<p>Once you&#39;ve extracted your project and opened it within the <span class="notranslate">Antigravity</span> IDE,
you can view your application locally:</p>

<ol>
<li>In the <strong><span class="notranslate">Antigravity</span> IDE</strong>, navigate to the <strong>Run and Debug</strong> menu
located in the left sidebar.</li>
<li>Click the play button to start your local development server.</li>
<li>Follow the instructions in the terminal to preview your app.</li>
</ol>
<aside class="tip"><strong>Tip:</strong><span> To refine your app or troubleshoot issues, chat with the agent using
natural language in the agent pane. If the agent pane is hidden, click the
<strong>Toggle Agent</strong> icon at the top of the window to reopen it.</span></aside>
<h3 id="antigravity-publish-app" data-text="Step 3: Publish your app" tabindex="-1">Step 3: Publish your app</h3>

<p><span class="notranslate">Antigravity</span> uses agent skills to publish your app using Firebase best
practices.</p>

<ol>
<li><p>In the agent chat panel, enter the following prompt:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">Publish my app
</code></pre></devsite-code></li>
<li><p>When prompted to run <code translate="no" dir="ltr">firebase deploy</code>, choose <strong>Yes</strong>. The agent will
publish to your existing URL if you&#39;ve previously published to
<span class="notranslate">Firebase App Hosting</span>. If this is your first time publishing to
<span class="notranslate">App Hosting</span>, the agent will walk you through the process.</p></li>
<li><p>For future updates, instruct the agent to <code translate="no" dir="ltr">publish my app</code> in the
chat panel.</p></li>
</ol>

<h2 id="migrate-other" data-text="Migrate apps to other platforms" tabindex="-1">Migrate apps to other platforms</h2>

<p>If you prefer to move your project to a different development environment or
hosting platform, you can export your source code and manage deployments
manually.</p>

<h3 id="migrate-other-export-source" data-text="Step 1: Export your project source" tabindex="-1">Step 1: Export your project source</h3>

<p>Before the sunset date, you must download a local copy of your project files:</p>

<ol>
<li>Click the <strong>Move now</strong> button at the top of your workspace &gt; <strong>Zip and
Download</strong>.</li>
<li>Extract the archive to your local machine.</li>
</ol>
<aside class="tip"><strong>Tip:</strong><span> You can also export your workspace to GitHub. Learn more at
<a href="/docs/studio/github">Upload your app to GitHub</a>.</span></aside>
<h3 id="migrate-other-publishing-method" data-text="Step 2: Choose your publishing method" tabindex="-1">Step 2: Choose your publishing method</h3>

<p>Once your code is local, you can continue to serve your app using the following
methods:</p>

<ul>
<li><p><strong><span class="notranslate">Firebase</span> CLI (keeps your existing URL)</strong></p>

<ol>
<li><p>Install the <a href="/docs/cli#install_the_firebase_cli"><span class="notranslate">Firebase</span> CLI</a> using
<code translate="no" dir="ltr">npm</code> by running the following command:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">npm install -g firebase-tools
</code></pre></devsite-code></li>
<li><p>Navigate to your project directory in your terminal.</p></li>
<li><p>Run this command to set up <span class="notranslate">App Hosting</span> deployments for your local
project:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">firebase init apphosting
</code></pre></devsite-code></li>
<li><p>When prompted, select <strong>Link to an existing backend</strong> and choose the
backend named <strong>studio</strong>. This ensures your app&#39;s URL remains the same.</p></li>
<li><p>Follow the prompts to complete setup. Your <span class="notranslate">App Hosting</span> configuration
will be added to <code translate="no" dir="ltr">firebase.json</code>.</p></li>
<li><p>Deploy the application:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded syntax="Bash"><code translate="no" dir="ltr">firebase<span class="devsite-syntax-w"> </span>deploy
</code></pre></devsite-code></li>
</ol></li>
<li><p><strong>External hosting:</strong> Since your exported code is a standard web application,
you can initialize it with any hosting provider. Note that moving to an
external provider will result in a new URL.</p></li>
<li><p><strong>Local development only:</strong> You can continue to develop and test your app
locally using the <a href="/docs/emulator-suite"><span class="notranslate">Firebase Local Emulator Suite</span></a> for
faster, offline testing without deploying to a live environment.</p></li>
</ul>
<aside class="note"><strong>Note:</strong><span> Core Firebase services like <span class="notranslate">Cloud Firestore</span> and <span class="notranslate">Authentication</span> will continue to
function normally regardless of which platform you choose for hosting.</span></aside>
<h2 id="faq" data-text="Troubleshooting and FAQ" tabindex="-1">Troubleshooting and FAQ</h2>

<p>Review the following common questions and troubleshooting steps for migrating
your <span class="notranslate">Firebase Studio</span> projects.</p>

<h3 id="access-until-sunset" data-text="Can I continue using Firebase Studio until the sunset occurs?" tabindex="-1">Can I continue using <span class="notranslate">Firebase Studio</span> until the sunset occurs?</h3>

<p>Yes, you can access existing workspaces until March 22, <u>2027</u>.
We&#39;ll continue to provide critical security patches and <span class=\"notranslate\">Gemini</span> model
updates to ensure your current projects remain stable. Note that new workspace
creation will be disabled starting June 22, 2026.</p>
<aside class="special"><strong>Important:</strong><span> <strong>You must migrate your projects before
March 22, <u>2027</u></strong>. On that date, <span class="notranslate">Firebase Studio</span> will be
shut down, and all remaining data will be permanently deleted and cannot be
recovered.</span></aside>
<h3 id="agent-history" data-text="Will my agent chat history be migrated?" tabindex="-1">Will my agent chat history be migrated?</h3>

<p>Your agent chat history isn&#39;t part of the current exported zip file. However,
you can locate <span class=\"notranslate\">Gemini</span> chat history files for
the <span class="notranslate">App Prototyping agent</span> and Gemini in <span class="notranslate">Firebase</span> agents within your
workspace in the <code translate="no" dir="ltr">/home/user/.idx/ai</code> directory of your
<span class="notranslate">Firebase Studio</span> workspace. This contains prompts and responses from all
<span class=\"notranslate\">Gemini</span> chat modes.</p>

<p>Here&#39;s how to create a zip file that contains your history:</p>

<ol>
<li>Select <strong>File &gt; Open Folder</strong>.</li>
<li>Accept the default <code translate="no" dir="ltr">/home/user</code> directory.</li>
<li>After the files load, right-click on the <code translate="no" dir="ltr">.idx/ai</code> directory and select
<strong>Zip and Download</strong>.</li>
<li>When prompted to rebuild the environment, click <strong>Cancel</strong>.</li>
<li>After your download completes, re-open your working directory from the
<strong>File</strong> menu to move back into your workspace.</li>
</ol>

<p>For <span class="notranslate">Prototyper</span> sessions, you can also view your prompts as
part of the <code translate="no" dir="ltr">git</code> log. Here&#39;s how to locate them:</p>

<ol>
<li><p>Open <strong>Code</strong> view
(<img src="/static/docs/studio/images/icons/codicon-code.svg" alt="Code switch icon" class="inline-icon">).</p></li>
<li><p>Perform either of the following:</p>

<ul>
<li>Open a terminal session (<code translate="no" dir="ltr">Cmd-Shift-C</code> on Mac or <code translate="no" dir="ltr">Ctrl-Shift-C</code> on
ChromeOS, Windows, or Linux) and type <code translate="no" dir="ltr">git log</code>.</li>
<li>Open <strong>Source Control</strong> (<code translate="no" dir="ltr">Cmd+Shift+G</code> on Mac or <code translate="no" dir="ltr">Ctrl-Shift+G</code> on
ChromeOS, Windows, or Linux) and view Source history.</li>
</ul></li>
</ol>

<h3 id="download-issues" data-text="I tried to zip and download my files in Firebase Studio, but nothing happened." tabindex="-1">I tried to zip and download my files in <span class="notranslate">Firebase Studio</span>, but nothing happened.</h3>

<p>This is usually caused by a browser pop-up blocker. Because the migration flow
opens a new interface to process your request, some browsers may flag it as an
unwanted pop-up.</p>

<p>To fix this, look for a &quot;Pop-up blocked&quot; notification in your browser&#39;s address
bar (usually on the right side). Click the icon and select the option to allow
pop-ups, and then try clicking the button again.</p>

<p>If this doesn&#39;t work, use the instructions at <a href="/docs/studio/troubleshooting#download-files">How do I download my files from
<span class="notranslate">Firebase Studio</span>?</a> to run the
<strong>Zip and Download</strong> command manually.</p>

<h3 id="shared-workspaces" data-text="Can I migrate Firebase Studio workspaces that have been shared with me?" tabindex="-1">Can I migrate <span class="notranslate">Firebase Studio</span> workspaces that have been shared with me?</h3>

<p>Only the person who created the <span class="notranslate">Firebase Studio</span> workspace can use the
<strong>Move now</strong> button. If you want a copy of the project, you can do either of
the following:</p>

<ul>
<li><a href="/docs/studio/get-started-workspace#duplicate-workspace"><strong>Duplicate the workspace</strong></a>:
Create a copy of the project under your own account, allowing you to link it
to your own Firebase project and use the migration tools.</li>
<li><strong>Manually export your code:</strong> From <strong>Code view</strong>, you can open the command
palette (<code translate="no" dir="ltr">Cmd</code>+<code translate="no" dir="ltr">Shift</code>+<code translate="no" dir="ltr">P</code> on Mac or <code translate="no" dir="ltr">Ctrl</code>+<code translate="no" dir="ltr">Shift</code>+<code translate="no" dir="ltr">P</code> on ChromeOS, Windows,
or Linux) and run the <strong><span class="notranslate">Firebase Studio</span>: Zip &amp; Download</strong> command.</li>
</ul>
<aside class="special"><strong>Important:</strong><span> If you choose to manually export code from a shared workspace,
remember that the backend configuration (like the Firebase project
and API keys) will still point to the original owner&#39;s resources. You&#39;ll need
to create a new Firebase project and update your environment variables
to ensure the app functions under your own account.</span></aside>
<h3 id="ais-find-apps" data-text="Where can I find the apps I've migrated to Google AI Studio?" tabindex="-1">Where can I find the apps I've migrated to <span class='\"notranslate\"'>Google AI Studio</span>?</h3>

<p>The <a href="https://aistudio.google.com/apps?source=user"><strong>Your apps</strong> page</a> provides
a unified list of all your projects, including those created from scratch in
<span class=\"notranslate\">Google&nbsp;AI Studio</span> and any you&#39;ve migrated.</p>

<h3 id="ais-google-sign-in" data-text="Firebase Authentication with Google Sign-In doesn't work after migrating to Google AI Studio." tabindex="-1"><span class="notranslate">Firebase Authentication</span> with Google Sign-In doesn't work after migrating to <span class='\"notranslate\"'>Google AI Studio</span>.</h3>

<p>If your app uses Google Sign-In, you must authorize your new project domain.</p>

<ol>
<li>In the <span class="notranslate">Firebase</span> console, go to the
<a href="https://console.firebase.google.com/project/_/authentication/settings?useAutoProject=true" class="external"><span class="notranslate">Authentication</span> settings page</a>.</li>
<li>Click <strong>Authorized domains</strong>.</li>
<li>Click <strong>Add domain</strong> and add the domain of your <span class=\"notranslate\">Google&nbsp;AI Studio</span> app.</li>
</ol>

<h3 id="ais-errors" data-text="What should I do if the Google AI Studio agent stops working or I see errors in Google AI Studio after the migration?" tabindex="-1">What should I do if the <span class='\"notranslate\"'>Google AI Studio</span> agent stops working or I see errors in <span class='\"notranslate\"'>Google AI Studio</span> after the migration?</h3>

<p>Because the <span class=\"notranslate\">Google&nbsp;AI Studio</span> agent manages complex background tasks while
migrating your app, the agent can occasionally encounter issues like
&quot;task canceled,&quot; repeating messages, or unresponsive threads.</p>

<ul>
<li>If the agent stops mid-task without a clear error, giving it a prompt like
&quot;Continue where you left off&quot; or &quot;Try that last step again&quot; often jump-starts
the process.</li>
<li>If you see a message that there were errors running the code, click the
<strong>Fix</strong> button to prompt the agent to resolve them automatically.</li>
</ul>

<h3 id="export-stalls" data-text="What if the export stalls or times out?" tabindex="-1">What if the export stalls or times out?</h3>

<p>If the migration process hangs while preparing your files, it&#39;s often due to an
oversized project folder.</p>

<p>To clear the path for a successful migration:</p>

<ul>
<li><strong>Delete <code translate="no" dir="ltr">node_modules</code>:</strong> As part of the migration process, this folder is
generally removed. However, if you renamed or moved it, or plan to manually
zip and download your code, delete it before
initiating the migration. You don&#39;t need to migrate this folder because you
can run <code translate="no" dir="ltr">npm install</code> once you&#39;ve moved to your new environment.</li>
<li><strong>Remove large artifacts:</strong> Delete any large media files, database exports,
or build folders that aren&#39;t strictly necessary for the source code.</li>
<li><strong>Check for &quot;hidden&quot; bloat:</strong> Make sure you aren&#39;t accidentally zipping a
massive <code translate="no" dir="ltr">.git</code> history or local logs.</li>
</ul>

<p>Once you&#39;ve deleted any large files, try again to migrate your project.</p>

<h3 id="terminal-errors" data-text="Why are my Firebase CLI or npx commands failing in the Antigravity terminal?" tabindex="-1">Why are my <span class="notranslate">Firebase</span> CLI or <code translate="no" dir="ltr">npx</code> commands failing in the <span class="notranslate">Antigravity</span> terminal?</h3>

<p>If you encounter &quot;command not found&quot; errors or issues running <code translate="no" dir="ltr">npx</code> commands
within <span class="notranslate">Antigravity</span>—even though they work in your standard system
terminal—it&#39;s likely due to how your shell environment is being initialized.</p>

<p><span class="notranslate">Antigravity</span>&#39;s terminal environment looks for configuration settings in your
<code translate="no" dir="ltr">~/.bash_profile</code>. Many developers have their npx and path configurations
stored in <code translate="no" dir="ltr">~/.bashrc</code> instead. If these settings aren&#39;t shared, <span class="notranslate">Antigravity</span>
won&#39;t know where to find your tools.</p>

<p>You can fix this by sourcing your <code translate="no" dir="ltr">.bashrc</code> file inside your .bash_profile. This
ensures that all your existing configurations are loaded whenever
<span class="notranslate">Antigravity</span> starts.</p>

<ol>
<li>Open your <code translate="no" dir="ltr">~/.bash_profile</code> file in <span class="notranslate">Antigravity</span>.</li>
<li><p>Add the following code block to the file:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr">if [ -f ~/.bashrc ]; then
    source ~/.bashrc
fi
</code></pre></devsite-code></li>
<li><p>Save the file.</p></li>
<li><p>Restart <span class="notranslate">Antigravity</span>.</p></li>
</ol>

<h2 id="resources" data-text="Other resources" tabindex="-1">Other resources</h2>

<ul>
<li><a href="https://codelabs.developers.google.com/antigravity/how-to-migrate-from-firebase-studio-to-antigravity" class="external">Try the <span class="notranslate">Firebase Studio</span> to <span class="notranslate">Antigravity</span> migration codelab</a>.</li>
<li><a href="https://antigravity.google/docs/firebase-studio-migration" class="external">Explore the <span class="notranslate">Antigravity</span> documentation</a>.</li>
<li><a href="https://ai.google.dev/gemini-api/docs/aistudio-build-mode" class="external">Explore the <span class=\"notranslate\">Google&nbsp;AI Studio</span> documentation</a>.</li>
</ul>

<h2 id="help" data-text="Need help?" tabindex="-1">Need help?</h2>

<p>If you have questions, feedback, or encounter any issues migrating your
projects, reach out in one of the following places:</p>

<ul>
<li>Contact <a href="/support/troubleshooter/studio/help">Firebase Support</a>.</li>
<li>Post in the
<a href="https://community.firebasestudio.dev/" class="external"><span class="notranslate">Firebase Studio</span> Community Forum</a>.</li>
</ul>
