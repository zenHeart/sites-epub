...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/google-integrations"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/google-integrations" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/google-integrations" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/google-integrations?hl=vi" /><title>Integrate with Google and Firebase services &nbsp;|&nbsp; Firebase Studio</title>

<meta property="og:title" content="Integrate with Google and Firebase services &nbsp;|&nbsp; Firebase Studio"><meta name="description" content="A guide to integrating Google and Firebase services into a Firebase Studio workspace, with instructions on how to use the Firebase Studio panel to add various APIs and services.">
  <meta property="og:description" content="A guide to integrating Google and Firebase services into a Firebase Studio workspace, with instructions on how to use the Firebase Studio panel to add various APIs and services."><meta property="og:url" content="https://firebase.google.com/docs/studio/google-integrations"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Integrate with Google and Firebase services<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>In <span class="notranslate">Firebase Studio</span>, you can directly add Google API keys and services
from the <span class="notranslate">Firebase Studio</span> panel in your workspace.</p>
<aside class="tip"><strong>Tip:</strong><span> The <span class="notranslate">App Prototyping agent</span> can also help you set up Firebase services.
When you prompt it to connect a Firebase project or ask for assistance setting
up Firebase services, it provisions and connects a Firebase project on your
behalf to help you start the integration. For troubleshooting tips, visit
<a href="/docs/studio/troubleshooting#integrations">Firebase Studio troubleshooting &amp; FAQ</a>.</span></aside>
<h2 id="add-api-keys" data-text="Use the Firebase Studio panel" tabindex="-1">Use the <span class="notranslate">Firebase Studio</span> panel</h2>

<p>With fully-integrated workflows from <span class="notranslate">Firebase Studio</span>, you can add
Google and Firebase APIs and services to your app with the click of a button.</p>

<ol>
<li><p>Open <a href="https://studio.firebase.google.com/" class="external"><span class="notranslate">Firebase Studio</span></a>.</p></li>
<li><p>In <span class="notranslate">Code</span> view, click the <span class="notranslate">Firebase Studio</span>
icon on the right side of the workspace.</p></li>
<li><p>Expand the <strong>Google Integrations</strong> section to see the list of available
workflows.</p></li>
<li><p>Click the action you want to take for the API or service you want to add to
your app.</p></li>
<li><p>Follow the prompts to authenticate your account, select a billing project
(if required), and add the selected service to your app.</p>

<p>The <span class="notranslate">Firebase Studio</span> panel provides the following integrations:</p>

<ul>
<li><a href="/docs/studio/deploy-app">Publish your app with <span class="notranslate">Firebase Hosting</span> or
<span class="notranslate">Cloud Run</span></a>.</li>
<li>Enable <span class=\"notranslate\">Gemini</span> Developer API and get a <span class=\"notranslate\">Gemini&nbsp;API</span> key.</li>
<li>Set up the <a href="https://mapsplatform.google.com/">Google Maps API</a> and get a
Maps API key.</li>
<li>Use <a href="https://cloud.google.com/security/products/secret-manager"><span class="notranslate">Google Cloud</span> Secret Manager</a>
to securely store API keys and credentials.</li>
</ul></li>
</ol>
...
<ul>
<li><a href="/docs/studio/deploy-app">Deploy your app</a></li>
<li><a href="/docs/studio/build-gemini-api-app">Build an app with Gemini API</a></li>
</ul>
