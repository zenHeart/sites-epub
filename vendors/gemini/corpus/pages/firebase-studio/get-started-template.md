...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/firebase/images/touchicon-180.png"><link rel="canonical" href="https://firebase.google.com/docs/studio/get-started-template"><link rel="search" type="application/opensearchdescription+xml"
            title="Firebase" href="https://firebase.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://firebase.google.com/docs/studio/get-started-template" /><link rel="alternate" hreflang="x-default" href="https://firebase.google.com/docs/studio/get-started-template" /><link rel="alternate" hreflang="ar"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=de" /><link rel="alternate" hreflang="he"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=id" /><link rel="alternate" hreflang="it"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://firebase.google.com/docs/studio/get-started-template?hl=vi" /><title>Get started with a Firebase Studio template</title>

<meta property="og:title" content="Get started with a Firebase Studio template"><meta name="description" content="A guide to getting started with a Firebase Studio template, with a list of available templates and instructions on how to create a new workspace from a template.">
  <meta property="og:description" content="A guide to getting started with a Firebase Studio template, with a list of available templates and instructions on how to create a new workspace from a template."><meta property="og:url" content="https://firebase.google.com/docs/studio/get-started-template"><meta property="og:locale" content="en">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Get started with a Firebase Studio template<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<aside class="warning">
  <p><strong>Important:</strong> Creating new workspaces from templates is
  disabled as of June 22, 2026. To use these templates and continue developing
  your projects, we recommend migrating to <span class="notranslate">Google Antigravity</span> or
  <span class=\"notranslate\">Google&nbsp;AI Studio</span>. For details, see the
  <a href="/docs/studio/migrating-project">migration guide</a>.</p>
</aside>

<p><span class="notranslate">Firebase Studio</span> supports many frameworks and backends and provides a large
number of <a href="http://github.com/firebase-studio/templates" class="external">pre-configured
templates</a> and <a href="https://github.com/firebase-studio/templates?category=solutions" class="external">sample
apps</a> 
for a multitude of frameworks, languages, databases, and APIs.</p>

<p>All of the templates below&mdash;and, most importantly, a blank template that
you can use for any framework you want&mdash;are available in
<span class="notranslate">Firebase Studio</span> and on
<a href="https://github.com/firebase-studio/templates" class="external">GitHub</a>. You
can also find
<a href="https://github.com/firebase-studio/community-templates" class="external">Community templates</a> 
on GitHub, which allow contributions from the Open Source community.</p>

<p><section class="expandable" id="frameworks">
  <h3 class="showalways" id="frameworks" data-text="Backend templates" tabindex="-1">Backend templates</h3></p>

<ul>
<li><a href="https://studio.firebase.google.com/new/go">Go</a></li>
<li><a href="https://studio.firebase.google.com/new/python-flask">Python Flask</a></li>
<li><a href="https://studio.firebase.google.com/new/node-express">Node Express</a></li>
<li><a href="https://studio.firebase.google.com/new/rust">Rust</a></li>
<li><a href="https://studio.firebase.google.com/new/laravel">Laravel</a></li>
<li><a href="https://studio.firebase.google.com/new/python-django">Python Django</a></li>
<li><a href="https://studio.firebase.google.com/new/golang-gemini"><span class=\"notranslate\">Gemini&nbsp;API</span> (Go backend)</a></li>
<li><a href="https://studio.firebase.google.com/new/pyweb-gemini"><span class=\"notranslate\">Gemini&nbsp;API</span> (Python backend)</a></li>
<li><a href="https://studio.firebase.google.com/new/dotnet">.NET</a></li>
<li><a href="https://studio.firebase.google.com/new/java">Java</a></li>
<li><a href="https://studio.firebase.google.com/new/dart">Dart</a></li>
<li><a href="https://studio.firebase.google.com/new/cpp">C++</a></li>
<li><a href="https://studio.firebase.google.com/new/ruby">Ruby</a></li>
<li><a href="https://studio.firebase.google.com/new/php">PHP</a></li>
</ul>

<p></section></p>

<p><section class="expandable" id="ai">
  <h3 class="showalways" id="ai" data-text="AI templates" tabindex="-1">AI templates</h3></p>

<ul>
<li><a href="https://studio.firebase.google.com/new/gemini"><span class=\"notranslate\">Gemini&nbsp;API</span></a></li>
<li><a href="https://studio.firebase.google.com/new/langchain">LangChain with Gemini</a></li>
<li><a href="https://studio.firebase.google.com/new/genkit"><span class="notranslate">Genkit</span></a></li>
<li><a href="https://studio.firebase.google.com/new/agent-ghaction">Firebase Studio agents: GitHub Actions</a></li>
<li><a href="https://studio.firebase.google.com/new/agent-vsce">Firebase Studio agents: VSCode extension</a></li>
<li><a href="https://studio.firebase.google.com/new/gemini-notebook"><span class=\"notranslate\">Gemini&nbsp;API</span> Notebook</a></li>
<li><a href="https://studio.firebase.google.com/new/gemini-maps"><span class=\"notranslate\">Gemini&nbsp;API</span> + Google Maps Platform</a></li>
</ul>

<p></section></p>

<p><section class="expandable" id="web-apps">
<h3 class="showalways" id="web-apps" data-text="Web templates" tabindex="-1">Web templates</h3></p>

<ul>
<li><a href="https://studio.firebase.google.com/new/angular">Angular</a></li>
<li><a href="https://studio.firebase.google.com/new/nextjs">Next.js</a></li>
<li><a href="https://studio.firebase.google.com/new/astro">Astro</a></li>
<li><a href="https://studio.firebase.google.com/new/react">React</a></li>
<li><a href="https://studio.firebase.google.com/new/html">Simple HTML</a></li>
<li><a href="https://studio.firebase.google.com/new/svelte">Svelte</a></li>
<li><a href="https://studio.firebase.google.com/new/vue">Vue.js</a></li>
<li><a href="https://studio.firebase.google.com/new/solid">SolidJS</a></li>
<li><a href="https://studio.firebase.google.com/new/preact">Preact</a></li>
<li><a href="https://studio.firebase.google.com/new/maps">React + Google Maps platform</a></li>
<li><a href="https://studio.firebase.google.com/new/google-pay-101">Google Pay API for Web</a></li>
</ul>

<p></section></p>

<p><section class="expandable" id="mobile">
  <h3 class="showalways" id="mobile" data-text="Mobile templates" tabindex="-1">Mobile templates</h3></p>

<ul>
<li><a href="https://studio.firebase.google.com/new/android-studio">Android Studio</a></li>
<li><a href="https://studio.firebase.google.com/new/flutter">Flutter</a></li>
<li><a href="https://studio.firebase.google.com/new/react-native">React Native</a></li>
<li><a href="https://studio.firebase.google.com/new/react-native-expo">React Native + Expo</a></li>
</ul>

<p></section></p>

<p><section class="expandable" id="databases">
  <h3 class="showalways" id="databases" data-text="Databases" tabindex="-1">Databases</h3></p>

<ul>
<li><a href="https://studio.firebase.google.com/new/postgres">Postgres</a></li>
<li><a href="https://studio.firebase.google.com/new/mysql">MySQL</a></li>
<li><a href="https://studio.firebase.google.com/new/prisma">Prisma</a></li>
<li><a href="https://studio.firebase.google.com/new/mongodb">MongoDB</a></li>
<li><a href="https://studio.firebase.google.com/new/dataconnect">Firebase Data Connect</a></li>
</ul>

<p></section></p>

<p><section class="expandable" id="solutions">
  <h3 class="showalways" id="solutions" data-text="Solutions and sample apps" tabindex="-1">Solutions and sample apps</h3></p>

<ul>
<li><a href="https://github.com/FirebaseExtended/solution-ai-barista">Agentic Barista</a></li>
<li><a href="https://github.com/FirebaseExtended/compass-travel-planning-sample">Compass Travel demo</a></li>
<li><a href="https://github.com/google-gemini/angular-rock-paper-scissors-sample">Rock Paper Scissors game</a></li>
<li><a href="https://github.com/google-gemini/angular-journal-buddy-sample">Journal buddy</a></li>
<li><a href="https://github.com/google-gemini/angular-webaudio-melodies-sample">Melody generation with <span class=\"notranslate\">Gemini</span></a></li>
<li><a href="https://github.com/google-gemini/flutter-tabletop-character-sample">Tabletop RPG character generator</a></li>
<li><a href="https://github.com/google-gemini/flutter-draw-it-sample">Gemini picture game with Flutter</a></li>
<li><a href="https://github.com/google-gemini/angular-database-schema-sample">Create a database schema using natural language</a></li>
<li><a href="https://github.com/google-gemini/angular-language-learning-sample">Language learning flash cards with <span class=\"notranslate\">Gemini</span></a></li>
<li>...and many more</li>
</ul>

<p></section></p>

<h2 id="get-started" data-text="Get started with a template" tabindex="-1">Get started with a template</h2>

<div>
<devsite-nav-buttons id="#get-started" name="template_type" param="always">
  <button value="official" default>Official templates</button>
  <button value="community">Community templates</button>
</devsite-nav-buttons>
</div>

<p>To start a <span class="notranslate">Firebase Studio</span> project from a template:</p>
...
<li><p>If you see a template you&#39;d like to use, select it. Otherwise, click
<strong>See all templates</strong> and select a template that matches what you&#39;d like to
use.</p></li>
<li><p>When prompted, enter a name for your workspace and, depending on the type
of project you selected, any other needed information. For example, if you
chose a Python Flask project, you can choose a package manager (poetry or
pip) and a server type (API server or web server).</p></li>
<li><p>Click <strong>Create</strong>. <span class="notranslate">Firebase Studio</span> creates a new workspace based on
the template you chose.</p></li>
</ol>



<p>Note that templates can include:</p>

<ul>
<li><strong>Custom AI rules files</strong> that add context for <span class="notranslate">Gemini</span> to
better understand and process changes for the type of app you&#39;re developing.
These files can be modified or deleted to adjust how you prefer to interact
with <span class="notranslate">Gemini</span>. <a href="/docs/studio/set-up-gemini#custom-instructions">Learn more about where to find and edit AI rules
files</a>.</li>
<li><strong>MCP servers</strong> that provide additional tools and data sources for
<span class="notranslate">Gemini</span> to use. <a href="/docs/studio/mcp-servers">Learn more about where to find or change which
MCP servers <span class="notranslate">Gemini</span> can connect to</a>.</li>
</ul>

<h2 id="next" data-text="Next steps" tabindex="-1">Next steps</h2>

<ul>
<li><a href="/docs/studio/get-started-workspace">Learn more about <span class="notranslate">Firebase Studio</span>
workspaces</a>.</li>
<li><a href="/docs/studio/customize-workspace">Customize your <span class="notranslate">Firebase Studio</span> workspace</a>.</li>
<li><a href="/docs/studio/ai-assistance">Discover how <span class="notranslate">Gemini</span> can assist and accelerate your app
development</a> with its ability to help guide
development, answer questions, generate and edit code, fix bugs, and run
tools.</li>
<li>Try out a template-based solution:
<a href="/docs/studio/build-gemini-api-app">Build an app with the Gemini API</a>.</li>
</ul>
