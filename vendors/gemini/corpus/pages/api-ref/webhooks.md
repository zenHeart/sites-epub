  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/googledevai/images/touchicon-180-new.png"><link rel="canonical" href="https://ai.google.dev/api/webhooks"><link rel="search" type="application/opensearchdescription+xml"
      ...
      <link rel="alternate" hreflang="en"
          ...
          href="https://ai.google.dev/api/webhooks?hl=ar" /><link rel="alternate" hreflang="bn"
          href="https://ai.google.dev/api/webhooks?hl=bn" /><link rel="alternate" hreflang="zh-Hans"
          href="https://ai.google.dev/api/webhooks?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://ai.google.dev/api/webhooks?hl=zh-tw" /><link rel="alternate" hreflang="fa"
          href="https://ai.google.dev/api/webhooks?hl=fa" /><link rel="alternate" hreflang="fr"
          href="https://ai.google.dev/api/webhooks?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://ai.google.dev/api/webhooks?hl=de" /><link rel="alternate" hreflang="he"
          href="https://ai.google.dev/api/webhooks?hl=he" /><link rel="alternate" hreflang="hi"
          href="https://ai.google.dev/api/webhooks?hl=hi" /><link rel="alternate" hreflang="id"
          href="https://ai.google.dev/api/webhooks?hl=id" /><link rel="alternate" hreflang="it"
          href="https://ai.google.dev/api/webhooks?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://ai.google.dev/api/webhooks?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://ai.google.dev/api/webhooks?hl=ko" /><link rel="alternate" hreflang="pl"
          href="https://ai.google.dev/api/webhooks?hl=pl" /><link rel="alternate" hreflang="pt-BR"
          href="https://ai.google.dev/api/webhooks?hl=pt-br" /><link rel="alternate" hreflang="ru"
          href="https://ai.google.dev/api/webhooks?hl=ru" /><link rel="alternate" hreflang="es-419"
          href="https://ai.google.dev/api/webhooks?hl=es-419" /><link rel="alternate" hreflang="th"
          href="https://ai.google.dev/api/webhooks?hl=th" /><link rel="alternate" hreflang="tr"
          href="https://ai.google.dev/api/webhooks?hl=tr" /><link rel="alternate" hreflang="vi"
          href="https://ai.google.dev/api/webhooks?hl=vi" /><link rel="alternate" hreflang="sq"
          href="https://ai.google.dev/api/webhooks?hl=sq" /><title>Gemini Webhooks API &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers</title>

<meta property="og:title" content="Gemini Webhooks API &nbsp;|&nbsp; Gemini API &nbsp;|&nbsp; Google AI for Developers"><meta property="og:url" content="https://ai.google.dev/api/webhooks"><meta property="og:image" content="https://ai.google.dev/static/site-assets/images/share-gemini-api-2026-07.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Gemini Webhooks API<devsite-actions hidden data-nosnippet>
