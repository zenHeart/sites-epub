...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/clouddocs/images/favicons/onecloud/super_cloud.png"><link rel="canonical" href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts"><link rel="search" type="application/opensearchdescription+xml"
            title="Google Cloud Documentation" href="https://docs.cloud.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts" /><link rel="alternate" hreflang="zh-Hans"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=zh-tw" /><link rel="alternate" hreflang="fr"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=de" /><link rel="alternate" hreflang="he"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=he" /><link rel="alternate" hreflang="id"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=id" /><link rel="alternate" hreflang="it"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=ko" /><link rel="alternate" hreflang="pt-BR"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=pt-br" /><link rel="alternate" hreflang="pt"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=pt" /><link rel="alternate" hreflang="es"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=es" /><link rel="alternate" hreflang="es-419"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts?hl=es-419" /><link rel="alternate" hreflang="en-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts" /><link rel="alternate" hreflang="zh-Hans-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=zh-tw" /><link rel="alternate" hreflang="fr-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=fr" /><link rel="alternate" hreflang="de-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=de" /><link rel="alternate" hreflang="he-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=he" /><link rel="alternate" hreflang="id-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=id" /><link rel="alternate" hreflang="it-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=it" /><link rel="alternate" hreflang="ja-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=ja" /><link rel="alternate" hreflang="ko-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=ko" /><link rel="alternate" hreflang="pt-BR-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=pt-br" /><link rel="alternate" hreflang="pt-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=pt" /><link rel="alternate" hreflang="es-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=es" /><link rel="alternate" hreflang="es-419-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/keyboard-shortcuts?hl=es-419" /><title>Keyboard shortcuts for Gemini Code Assist features &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation</title>

<meta property="og:title" content="Keyboard shortcuts for Gemini Code Assist features &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation"><meta name="description" content="Outlines and describes the keyboard shortcuts for Gemini Code Assist in VS Code and JetBrains IDEs.">
  <meta property="og:description" content="Outlines and describes the keyboard shortcuts for Gemini Code Assist in VS Code and JetBrains IDEs."><meta property="og:url" content="https://docs.cloud.google.com/gemini/docs/codeassist/keyboard-shortcuts"><meta property="og:image" content="https://docs.cloud.google.com/_static/cloud/images/social-icon-google-cloud-1200-630.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Keyboard shortcuts for Gemini Code Assist features<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>Gemini Code Assist provides AI-powered assistance to help your
development team build, deploy, and operate applications throughout the software
development lifecycle.</p>

<p>This page provides an overview of the keyboard shortcuts you can use in VS Code,
IntelliJ, and
<a href="/gemini/docs/codeassist/supported-languages#supported_ides">other supported JetBrains IDEs</a>,
for Windows, Linux, and macOS users.</p>

<h2 id="code-shortcuts" data-text="Code generation shortcuts" tabindex="-1">Code generation shortcuts</h2>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code" data-text=" VS Code " tabindex="-1"> VS Code </h3><table>
<tr>
  <th>Action</th>
  <th>Keyboard shortcut (Windows/Linux)</th>
  <th>Keyboard shortcut (macOS)</th>
</tr>
<tr>
  <td>Navigate to chat interface</td>
  <td><kbd>Alt+G</kbd></td>
  <td><kbd>Option+G</kbd></td>
</tr>
<tr>
  <td>
    <a href="/gemini/docs/codeassist/chat-gemini#add_selected_code_snippets_to_context">Add
    selected code snippet to Gemini Chat context</a>
  </td>
  <td><kbd>Control+Alt+X</kbd></td>
  <td><kbd>Command+Alt+X</kbd></td>
</tr>
<tr>
  <td>
    <a href="/gemini/docs/codeassist/write-code-gemini#finish-changes">Finish code
    changes in a file</a>
  </td>
  <td><kbd>Alt+F</kbd></td>
  <td><kbd>Option+F</kbd></td>
</tr>
</table></section>
<section><h3 id="intellij" data-text=" IntelliJ " tabindex="-1"> IntelliJ </h3><table>
<tr>
  <th>Action</th>
  <th>Keyboard shortcut (Windows/Linux)</th>
  <th>Keyboard shortcut (macOS)</th>
...
<tr>
  <td>Generate code inline of a code file</td>
  <td><kbd>Control+G</kbd></td>
  <td><kbd>Option+G</kbd></td>
</tr>
<tr>
  <td>Open In-Editor prompt</td>
...
<h2 id="terminal_shortcuts" data-text="Terminal shortcuts" tabindex="-1">Terminal shortcuts</h2>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code_1" data-text=" VS Code " tabindex="-1"> VS Code </h3><table>
<tr>
  <th>Action</th>
  <th>Keyboard shortcut (Windows/Linux)</th>
  <th>Keyboard shortcut (macOS)</th>
...
<tr>
  <td><a href="/gemini/docs/codeassist/chat-gemini#prompt_with_selected_terminal_output_using_chat">Add the current highlighted terminal content to the Gemini Chat context</a></td>
  <td><kbd>Control+Alt+X</kbd></td>
  <td><kbd>Command+Alt+X</kbd></td>
</tr>
</table></section>
<section><h3 id="intellij_1" data-text=" IntelliJ " tabindex="-1"> IntelliJ </h3><p>There aren&#39;t any default terminal shortcuts for
Gemini Code Assist for IntelliJ and other supported JetBrains
IDEs at this time.</p></section>
</devsite-selector></div>
<h2 id="chat_shortcuts" data-text="Chat shortcuts" tabindex="-1">Chat shortcuts</h2>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code_2" data-text=" VS Code " tabindex="-1"> VS Code </h3><table>
<tr>
  <th>Action</th>
  <th>Keyboard shortcut (Windows/Linux)</th>
  <th>Keyboard shortcut (macOS)</th>
...
<tr>
  <td>Cycle through prior chat prompts</td>
  <td><kbd>Up/down arrows</kbd></td>
  <td><kbd>Up/down arrows</kbd></td>
</tr>
<tr>
  <td><a href="/gemini/docs/codeassist/chat-gemini#outline">Generate an outline</a></td>
  <td><kbd>Alt+O</kbd></td>
  <td><kbd>Option+O</kbd></td>
</tr>
</table></section>
<section><h3 id="intellij_2" data-text=" IntelliJ " tabindex="-1"> IntelliJ </h3><table>
<tr>
  <th>Action</th>
  <th>Keyboard shortcut (Windows/Linux)</th>
  <th>Keyboard shortcut (macOS)</th>
...
<tr>
  <td>New chat</td>
  <td><kbd>Control+Alt+Windows+Up</kbd></td>
  <td><kbd>Control+Alt+Command+Up</kbd></td>
</tr>
<tr>
  <td><a href="/gemini/docs/codeassist/chat-gemini#outline">Generate an outline</a></td>
  <td><kbd>Alt+O</kbd></td>
...
<h2 id="edit_keyboard_shortcuts" data-text="Edit keyboard shortcuts" tabindex="-1">Edit keyboard shortcuts</h2>

<p>If you prefer to change any of the default Gemini Code Assist
shortcuts, you can do so by following these steps:</p>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code_3" data-text=" VS Code " tabindex="-1"> VS Code </h3><ol>
<li><p>In your IDE, click <strong>File</strong> (for Windows and Linux) or <strong>Code</strong> (for
macOS), and then navigate to <strong>Settings</strong> <span aria-label="and then">></span> <strong>Keyboard
Shortcuts</strong>.</p></li>
<li><p>In the list of keyboard shortcuts, scroll until you find the shortcut that
you want to change. For example: <strong>Gemini Code Assist: Generate code</strong>.</p></li>
<li><p>Click the shortcut that you want to change (for example, <strong>Gemini Code
Assist: Generate Code</strong>), and then click
<span class="google-symbols" translate="no">edit</span> <strong>Change
Keybinding</strong>.</p></li>
<li><p>In the dialog that appears, enter your own shortcut.</p></li>
<li><p>Press <kbd>Enter</kbd> (for Windows and Linux) or <kbd>Return</kbd> (for
macOS).</p></li>
</ol>

<p>You can now use your newly assigned keyboard shortcut in your IDE.</p>

<p>To learn more about changing shortcuts in your IDE, see
<a href="https://code.visualstudio.com/docs/getstarted/keybindings">Keybindings for Visual Studio Code</a>.</p></section>
<section><h3 id="intellij_3" data-text=" IntelliJ " tabindex="-1"> IntelliJ </h3><ol>
<li><p>Navigate to <span class="google-symbols" translate="no">settings</span>
<strong>IDE and Project Settings</strong> <span aria-label="and then">></span> <strong>Settings</strong> <span aria-label="and then">></span>
<strong>Keymap</strong> <span aria-label="and then">></span> <strong>Plugins</strong> <span aria-label="and then">></span> <strong>Gemini Code Assist</strong>.</p></li>
<li><p>Right-click the shortcut you want to change (for example, <strong>Generate
Code</strong>) and select <strong>Add Keyboard Shortcut</strong>.</p></li>
<li><p>Enter your preferred keyboard shortcut and then click <strong>OK</strong>.</p></li>
<li><p>Right-click the shortcut again and remove the shortcut. For example,
right-click <strong>Generate code</strong> and select <strong>Remove <kbd>Alt+G</kbd></strong> (for
Windows and Linux), or <strong>Remove <kbd>Option+G</kbd></strong> (for macOS).</p></li>
</ol>

<p>You can now use your new keyboard shortcut in your IDE.</p></section>
</devsite-selector></div>
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/products/"
            ...
            track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/products/"track-metadata-child_headline="products and pricing"track-type="footer link"track-name="see all products"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/pricing/"
            ...
            track-type="footer link"track-metadata-eventDetail="cloud.google.com/pricing/"track-name="google cloud pricing"track-metadata-module="footer"track-metadata-child_headline="products and pricing"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/marketplace/"
            ...
            track-name="google cloud marketplace"track-metadata-position="footer"track-metadata-child_headline="resources"track-type="footer link"track-metadata-module="footer"track-metadata-eventDetail="cloud.google.com/marketplace/">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/contact/"
            ...
            track-type="footer link"track-name="contact sales"track-metadata-eventDetail="cloud.google.com/contact/"track-metadata-module="footer"track-metadata-position="footer"track-metadata-child_headline="engage">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//discuss.google.dev/c/google-cloud/14/"
             ...
             data-label="Footer Link (index 1)"
            target="_blank"rel="noopener"track-metadata-eventDetail="www.googlecloudcommunity.com"track-metadata-module="footer"track-type="footer link"track-name="google cloud community"track-metadata-child_headline="engage"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/support-hub/"
             ...
             data-label="Footer Link (index 2)"
            track-metadata-child_headline="resources"track-type="footer link"track-metadata-eventDetail="cloud.google.com/support-hub/"track-name="support"track-metadata-position="footer"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//docs.cloud.google.com/release-notes"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-eventDetail="cloud.google.com/release-notes/"track-metadata-position="footer"track-metadata-module="footer"track-name="release notes"track-type="footer link"track-metadata-child_headline="resources">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//status.cloud.google.com"
             ...
             data-label="Footer Link (index 4)"
            track-metadata-module="footer"track-metadata-position="footer"target="_blank"track-name="system status"track-type="footer link"track-metadata-eventDetail="status.cloud.google.com"track-metadata-child_headline="resources">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//github.com/googlecloudPlatform/"
             ...
             data-label="Footer Link (index 1)"
            track-metadata-eventDetail="github.com/googlecloudPlatform/"track-metadata-module="footer"track-name="github"track-type="footer link"track-metadata-position="footer"track-metadata-child_headline="resources">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/docs/get-started/"
             ...
             data-label="Footer Link (index 2)"
            track-type="footer link"track-name="google cloud quickstarts"track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/docs/get-started/"track-metadata-module="footer"track-metadata-child_headline="resources">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/docs/samples"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-eventDetail="cloud.google.com/docs/samples"track-metadata-child_headline="resources"track-type="footer link"track-name="code samples"track-metadata-position="footer"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/learn/training/"
            ...
            track-metadata-position="footer"track-metadata-module="footer"track-name="training"track-type="footer link"track-metadata-child_headline="resources"track-metadata-eventDetail="cloud.google.com/learn/training/">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/blog/"
             ...
             data-label="Footer Link (index 1)"
            track-metadata-eventDetail="cloud.google.com/blog/"track-type="footer link"track-name="blog"track-metadata-position="footer"track-metadata-module="footer"track-metadata-child_headline="engage">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/events/"
             ...
             data-label="Footer Link (index 2)"
            track-metadata-child_headline="engage"track-name="events"track-type="footer link"track-metadata-eventDetail="cloud.google.com/events/"track-metadata-module="footer"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//x.com/googlecloud"
             ...
             data-label="Footer Link (index 3)"
            track-name="follow on x"track-metadata-module="footer"track-type="footer link"target="_blank"track-metadata-child_headline="engage"track-metadata-position="footer"rel="noopener"track-metadata-eventDetail="x.com/googlecloud">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloud"
             ...
             data-label="Footer Link (index 4)"
            track-metadata-child_headline="engage"track-metadata-position="footer"track-metadata-eventDetail="www.youtube.com/googlecloud"rel="noopener"target="_blank"track-type="footer link"track-name="google cloud on youtube"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloudplatform"
             ...
             data-label="Footer Link (index 5)"
            track-metadata-position="footer"track-metadata-child_headline="engage"track-metadata-eventDetail="www.youtube.com/googlecloudplatform"rel="noopener"track-type="footer link"track-name="google cloud tech on youtube"track-metadata-module="footer"target="_blank">
