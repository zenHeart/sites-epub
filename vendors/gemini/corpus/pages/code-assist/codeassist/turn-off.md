...
<ul>
<li>To update a Gemini for Google Cloud subscription, make sure you have the
<code translate="no" dir="ltr">billing.subscriptions.update</code> Identity and Access Management (IAM) permission. The
<code translate="no" dir="ltr">billing.subscriptions.update</code> permission is included in the
...
<li><p>Optional: If you are disabling all Gemini for Google Cloud products, then turn off
the <a href="/gemini/docs/turn-off-gemini#companion-api">Gemini for Google Cloud API</a>.</p></li>
</ol>
