  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/vdc800838fb8be04a9a7685606311d18c65800504bccf261551968ac74bffd42e/clouddocs/images/favicons/onecloud/super_cloud.png"><link rel="canonical" href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode"><link rel="search" type="application/opensearchdescription+xml"
      ...
      <link rel="alternate" hreflang="en"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode" /><link rel="alternate" hreflang="zh-Hans"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=zh-tw" /><link rel="alternate" hreflang="fr"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=de" /><link rel="alternate" hreflang="he"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=he" /><link rel="alternate" hreflang="id"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=id" /><link rel="alternate" hreflang="it"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=ko" /><link rel="alternate" hreflang="pt-BR"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=pt-br" /><link rel="alternate" hreflang="pt"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=pt" /><link rel="alternate" hreflang="es"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=es" /><link rel="alternate" hreflang="es-419"
          href="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode?hl=es-419" /><link rel="alternate" hreflang="en-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode" /><link rel="alternate" hreflang="zh-Hans-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=zh-tw" /><link rel="alternate" hreflang="fr-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=fr" /><link rel="alternate" hreflang="de-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=de" /><link rel="alternate" hreflang="he-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=he" /><link rel="alternate" hreflang="id-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=id" /><link rel="alternate" hreflang="it-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=it" /><link rel="alternate" hreflang="ja-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=ja" /><link rel="alternate" hreflang="ko-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=ko" /><link rel="alternate" hreflang="pt-BR-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=pt-br" /><link rel="alternate" hreflang="pt-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=pt" /><link rel="alternate" hreflang="es-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=es" /><link rel="alternate" hreflang="es-419-cn"
          href="https://docs.cloud.google.cn/gemini/docs/codeassist/agent-mode?hl=es-419" /><title>Agent mode overview &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation</title>

<meta property="og:title" content="Agent mode overview &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation"><meta name="description" content="Learn about Gemini Code Assist agent mode.">
  <meta property="og:description" content="Learn about Gemini Code Assist agent mode."><meta property="og:url" content="https://docs.cloud.google.com/gemini/docs/codeassist/agent-mode"><meta property="og:image" content="https://docs.cloud.google.com/_static/cloud/images/social-icon-google-cloud-1200-630.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Agent mode overview<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>This document describes agent mode in Gemini Code Assist.</p>

<p>Agent mode is available in the VS Code and IntelliJ integrated development
environments (IDEs). To start using agent mode, see
<a href="/gemini/docs/codeassist/use-agentic-chat-pair-programmer">Use the Gemini Code Assist agent mode</a>.</p>
...
<li><a href="/gemini/docs/codeassist/use-agentic-chat-pair-programmer#configure-mcp-servers">Configure MCP servers</a> to extend the agent&#39;s abilities.</li>
...
<h2 id="how-agent-mode-works" data-text="How agent mode works" tabindex="-1">How agent mode works</h2>

<p>In agent mode, your prompt is sent to the Gemini API with a list of
<a href="#tools">tools</a> that are available. The Gemini
API processes the prompt and returns a response. The response might be a direct
answer or a request to use an available tool.</p>

<p>When a tool is requested, the agent prepares to use the tool and checks to see
if it is allowed to use the tool with or without explicit permission:</p>

<ul>
<li>For tool requests that modify the file system, or perform mutating
operations on any resources, Gemini will ask you to allow the
operation unless you have configured Gemini to always allow
the tool or tools.</li>
<li>Tool requests that are read-only might not ask for permission before
completing the task.</li>
</ul>

<p>When asked to allow the use of a tool, you can choose to allow or deny the
...
<a href="/gemini/docs/codeassist/use-agentic-chat-pair-programmer#yolo-mode">Always allow agent actions</a>.</p>

<p>Once permission to use the tool is given or self-granted, the agent uses the
...
evaluation continues until the task is complete.</p>

<p>For complex tasks, Gemini might show a high-level plan for your
...
for clarifications or permissions as needed as it executes the plan.</p>

<h2 id="agent-mode-context" data-text="Agent mode context" tabindex="-1">Agent mode context</h2>
...
responses, and your prompt details.</p>

<p>Depending on your IDE and settings, different contexts might be available to the
agent.</p>

<p>The following tabs detail how context is gathered for different IDEs.</p>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code" data-text="VS Code" tabindex="-1">VS Code</h3><p>The following methods of getting context are usually available to
Gemini Code Assist in agent mode:</p>

<ul>
<li>Information in your IDE workspace.</li>
<li>Tool responses from built-in tools like grep, terminal, file read, or
file write.</li>
<li>Google Search responses.</li>
<li>Content from a given URL provided in a prompt or by a tool.</li>
<li>Context files you create in Markdown.</li>
</ul></section>
<section><h3 id="intellij" data-text="IntelliJ" tabindex="-1">IntelliJ</h3><p>The following methods of getting context are usually available to
Gemini Code Assist in agent mode:</p>

<ul>
<li>Information in your IDE project including your files, indexed symbols
and usage of symbols in your project.</li>
<li>Tool responses from built-in tools like grep, file read, or
file write.</li>
<li>IntelliJ <a href="https://www.jetbrains.com/help/idea/version-control-integration.html">version control</a>.</li>
<li>Configured MCP servers and tools</li>
<li>Context files you create in Markdown.</li>
</ul>

<p>You can see the context available to the agent in the context drawer in the
agent mode chat prompt area.</p>

<div style="text-align: center;">
<img width="500" src="/static/gemini/images/intellij-agent-mode-welcome-context-drawer.png" alt="Agent mode context drawer.">
</div></section>
</devsite-selector></div>
<h2 id="tools" data-text="Tools" tabindex="-1">Tools</h2>
...
might only offer one function, or they might offer multiple related functions.</p>

<p>Some example tools are built-in tools like grep and file read or write, local or
remote Model Context Protocol (MCP) servers and their executable functions, and
RESTful API calls.</p>

<h3 id="built-in-tools" data-text="Built-in tools" tabindex="-1">Built-in tools</h3>

<p>In agent mode, Gemini has access to your built-in system tools. Select
your IDE to view a list of built-in tools available to Gemini in
agent mode.</p>
<div><devsite-selector data-ds-scope="code-sample">
<section><h3 id="vs-code_1" data-text="VS Code" tabindex="-1">VS Code</h3><p>All of the
<a href="https://geminicli.com/docs/reference/tools/">Gemini CLI built-in tools</a> are
available to agent mode in Gemini Code Assist.</p></section>
<section><h3 id="intellij_1" data-text="IntelliJ" tabindex="-1">IntelliJ</h3><dl>
<dt><code translate="no" dir="ltr">read_file</code></dt>
<dd>Retrieves the text content of a file using its absolute path.</dd>
<dt><code translate="no" dir="ltr">write_file</code></dt>
<dd>Writes the given text to a specified file, creating the file if it doesn&#39;t exist.</dd>
<dt><code translate="no" dir="ltr">analyze_current_file</code></dt>
<dd>Analyzes the open file in the editor for errors and warnings.</dd>
<dt><code translate="no" dir="ltr">find_files</code></dt>
<dd>Finds the absolute path to files given a filename or a part of the path</dd>
<dt><code translate="no" dir="ltr">grep</code></dt>
<dd>Finds all files inside the project that contain a given text pattern or regular expression.</dd>
<dt><code translate="no" dir="ltr">list_files</code></dt>
<dd>Lists all files and directories in a given absolute path.</dd>
<dt><code translate="no" dir="ltr">resolve_symbol</code></dt>
<dd>Resolves a specific symbol reference to its original declaration.</dd>
<dt><code translate="no" dir="ltr">find_usages</code></dt>
<dd>Searches the project for all references to a given symbol declaration.</dd>
<dt><code translate="no" dir="ltr">git</code></dt>
<dd>Runs a Git command-line interface (CLI) command and returns the result.</dd>
<dt><code translate="no" dir="ltr">list_vcs_roots</code></dt>
<dd>Returns all Version Control System (VCS) roots, such as Git repositories, in the current project.</dd>
</dl></section>
</devsite-selector></div>
...
doesn&#39;t <a href="/gemini/docs/discover/works#how-when-gemini-cites-sources">cite sources</a>
and you can&#39;t
...
<ul>
<li><a href="/gemini/docs/codeassist/use-agentic-chat-pair-programmer">Use the Gemini Code Assist agent mode</a>.</li>
<li>Learn about <a href="/gemini/docs/quotas#quotas-for-agent-mode-gemini-cli">agent mode quotas</a>.</li>
</ul>
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/products/"
            ...
            track-name="see all products"track-metadata-eventDetail="cloud.google.com/products/"track-metadata-child_headline="products and pricing"track-type="footer link"track-metadata-position="footer"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/pricing/"
            ...
            track-type="footer link"track-metadata-eventDetail="cloud.google.com/pricing/"track-metadata-position="footer"track-metadata-child_headline="products and pricing"track-name="google cloud pricing"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/marketplace/"
            ...
            track-metadata-child_headline="resources"track-metadata-module="footer"track-type="footer link"track-name="google cloud marketplace"track-metadata-eventDetail="cloud.google.com/marketplace/"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/contact/"
            ...
            track-metadata-child_headline="engage"track-metadata-module="footer"track-name="contact sales"track-metadata-eventDetail="cloud.google.com/contact/"track-type="footer link"track-metadata-position="footer">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//discuss.google.dev/c/google-cloud/14/"
             ...
             data-label="Footer Link (index 1)"
            rel="noopener"track-metadata-position="footer"track-name="google cloud community"track-metadata-eventDetail="www.googlecloudcommunity.com"track-type="footer link"track-metadata-module="footer"track-metadata-child_headline="engage"target="_blank">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/support-hub/"
             ...
             data-label="Footer Link (index 2)"
            track-name="support"track-metadata-module="footer"track-metadata-child_headline="resources"track-type="footer link"track-metadata-eventDetail="cloud.google.com/support-hub/"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//docs.cloud.google.com/release-notes"
             ...
             data-label="Footer Link (index 3)"
            track-type="footer link"track-metadata-child_headline="resources"track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/release-notes/"track-metadata-module="footer"track-name="release notes">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//status.cloud.google.com"
             ...
             data-label="Footer Link (index 4)"
            track-type="footer link"target="_blank"track-metadata-child_headline="resources"track-metadata-module="footer"track-name="system status"track-metadata-position="footer"track-metadata-eventDetail="status.cloud.google.com">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//github.com/googlecloudPlatform/"
             ...
             data-label="Footer Link (index 1)"
            track-type="footer link"track-metadata-eventDetail="github.com/googlecloudPlatform/"track-metadata-child_headline="resources"track-metadata-position="footer"track-name="github"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/docs/get-started/"
             ...
             data-label="Footer Link (index 2)"
            track-metadata-eventDetail="cloud.google.com/docs/get-started/"track-metadata-position="footer"track-name="google cloud quickstarts"track-metadata-module="footer"track-metadata-child_headline="resources"track-type="footer link">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/docs/samples"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-module="footer"track-metadata-eventDetail="cloud.google.com/docs/samples"track-type="footer link"track-name="code samples"track-metadata-child_headline="resources"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/architecture/"
             ...
             data-label="Footer Link (index 4)"
            track-name="cloud architecture center"track-metadata-module="footer"track-metadata-eventDetail="cloud.google.com/architecture/"track-metadata-child_headline="resources"track-metadata-position="footer"track-type="footer link">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/learn/training/"
            ...
            track-name="training"track-metadata-eventDetail="cloud.google.com/learn/training/"track-metadata-child_headline="resources"track-metadata-position="footer"track-metadata-module="footer"track-type="footer link">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/events/"
             ...
             data-label="Footer Link (index 2)"
            track-metadata-position="footer"track-name="events"track-metadata-child_headline="engage"track-metadata-eventDetail="cloud.google.com/events/"track-metadata-module="footer"track-type="footer link">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//x.com/googlecloud"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-eventDetail="x.com/googlecloud"track-type="footer link"track-metadata-child_headline="engage"track-name="follow on x"rel="noopener"track-metadata-position="footer"track-metadata-module="footer"target="_blank">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloud"
             ...
             data-label="Footer Link (index 4)"
            track-metadata-position="footer"track-name="google cloud on youtube"track-metadata-child_headline="engage"track-metadata-module="footer"rel="noopener"track-metadata-eventDetail="www.youtube.com/googlecloud"track-type="footer link"target="_blank">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloudplatform"
             ...
             data-label="Footer Link (index 5)"
            track-type="footer link"target="_blank"track-metadata-position="footer"track-metadata-child_headline="engage"track-metadata-module="footer"track-name="google cloud tech on youtube"rel="noopener"track-metadata-eventDetail="www.youtube.com/googlecloudplatform">
