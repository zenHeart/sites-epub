...
<html 
  ...
  <head>
    ...
    <link rel="apple-touch-icon" href="https://www.gstatic.com/devrel-devsite/prod/veec7311b6c5f99ef32994eb65aab7022195f72bfa4f3d934bdc7556da7fa7c3b/clouddocs/images/favicons/onecloud/super_cloud.png"><link rel="canonical" href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide"><link rel="search" type="application/opensearchdescription+xml"
            title="Google Cloud Documentation" href="https://docs.cloud.google.com/s/opensearch.xml">
      <link rel="alternate" hreflang="en"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide" /><link rel="alternate" hreflang="zh-Hans"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=zh-tw" /><link rel="alternate" hreflang="fr"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=fr" /><link rel="alternate" hreflang="de"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=de" /><link rel="alternate" hreflang="he"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=he" /><link rel="alternate" hreflang="id"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=id" /><link rel="alternate" hreflang="it"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=it" /><link rel="alternate" hreflang="ja"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=ja" /><link rel="alternate" hreflang="ko"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=ko" /><link rel="alternate" hreflang="pt-BR"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=pt-br" /><link rel="alternate" hreflang="es-419"
          href="https://docs.cloud.google.com/gemini/docs/code-review/style-guide?hl=es-419" /><link rel="alternate" hreflang="en-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide" /><link rel="alternate" hreflang="x-default" href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide" /><link rel="alternate" hreflang="zh-Hans-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=zh-cn" /><link rel="alternate" hreflang="zh-Hant-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=zh-tw" /><link rel="alternate" hreflang="fr-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=fr" /><link rel="alternate" hreflang="de-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=de" /><link rel="alternate" hreflang="he-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=he" /><link rel="alternate" hreflang="id-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=id" /><link rel="alternate" hreflang="it-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=it" /><link rel="alternate" hreflang="ja-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=ja" /><link rel="alternate" hreflang="ko-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=ko" /><link rel="alternate" hreflang="pt-BR-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=pt-br" /><link rel="alternate" hreflang="es-419-cn"
          href="https://docs.cloud.google.cn/gemini/docs/code-review/style-guide?hl=es-419" /><title>Code review style guide &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation</title>

<meta property="og:title" content="Code review style guide &nbsp;|&nbsp; Gemini for Google Cloud &nbsp;|&nbsp; Google Cloud Documentation"><meta name="description" content="Learn how to customize Gemini Code Assist behavior.">
  <meta property="og:description" content="Learn how to customize Gemini Code Assist behavior."><meta property="og:url" content="https://docs.cloud.google.com/gemini/docs/code-review/style-guide"><meta property="og:image" content="https://docs.cloud.google.com/_static/cloud/images/social-icon-google-cloud-1200-630.png">
...
<article class="devsite-article">
  ...
  <button>
    ...
    <h1 class="devsite-page-title" tabindex="-1">
      Code review style guide<devsite-actions hidden data-nosnippet><devsite-feature-tooltip
...
<p>If you have a custom set of best practices or conventions that you want
...
<code translate="no" dir="ltr">styleguide.md</code> Markdown file to the <code translate="no" dir="ltr">.gemini/</code> root folder of your repository.
You can <a href="#bulk-config">use the Google Cloud console</a> to add style guide information
...
<h2 id="standard_code_review_patterns" data-text="Standard code review patterns" tabindex="-1">Standard code review patterns</h2>

<p>When custom style guides aren&#39;t specified, these are the main categories of
areas where Gemini Code Assist focuses its code review on:</p>

<ul>
<li><p><strong>Correctness</strong>: Makes sure the code functions as intended and handles edge
cases, checks for logic errors, race conditions, or incorrect API usage.</p></li>
<li><p><strong>Efficiency</strong>: Identifies potential performance bottlenecks or areas for
optimization, like excessive loops, memory leaks, inefficient data structures,
redundant calculations, excessive logging, and inefficient string manipulation.</p></li>
<li><p><strong>Maintainability</strong>: Assesses code readability, modularity, and adherence to
...
duplication, inconsistent formatting, and magic numbers.</p></li>
<li><p><strong>Security</strong>: Identifies potential vulnerabilities in data handling or input
...
Direct Object References (IDOR).</p></li>
<li><p><strong>Miscellaneous</strong>: Other topics are considered when reviewing the pull
request, like testing, performance, scalability, modularity and reusability, and
error logging and monitoring.</p></li>
</ul>

<h3 id="example" data-text="Example style guide" tabindex="-1">Example style guide</h3>

<p>The <code translate="no" dir="ltr">styleguide.md</code> file does not have a defined schema. Instead, it&#39;s a
...
<code translate="no" dir="ltr">styleguide.md</code> file:</p>
<div></div><devsite-code><pre class="devsite-click-to-copy" translate="no" dir="ltr" is-upgraded><code translate="no" dir="ltr"># Company X Python Style Guide
...
<h2 id="bulk-config" data-text="Manage style guides across multiple repositories" tabindex="-1">Manage style guides across multiple repositories</h2>

<p>You can have one style guide apply to multiple repositories. Repositories are
grouped by a <a href="/gemini/docs/code-review/review-repo-code#considerations">Developer Connect connection</a>,
and managing their collective style guide is accomplished through the
Google Cloud console.</p>

<p>If a repository is managed as part of a group but also has its own
<code translate="no" dir="ltr">styleguide.md</code> file, the repository&#39;s <code translate="no" dir="ltr">styleguide.md</code> is combined with the
group style guide.</p>

<p>The following steps show how you can control one
...
want to apply a style guide to.</p>

<p>The details page for the connection opens.</p></li>
<li><p>In the <strong>Style guide</strong> tab, add the style guide you want the repositories
associated with this connection to use.</p></li>
...
<ul>
<li><a href="/gemini/docs/code-review/customize-repo-review">Modify the configuration</a>
for Gemini Code Assist on GitHub.</li>
</ul>
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/products/"
            ...
            track-metadata-module="footer"track-metadata-child_headline="products and pricing"track-name="see all products"track-metadata-position="footer"track-type="footer link"track-metadata-eventDetail="cloud.google.com/products/">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/pricing/"
            ...
            track-metadata-position="footer"track-type="footer link"track-name="google cloud pricing"track-metadata-eventDetail="cloud.google.com/pricing/"track-metadata-child_headline="products and pricing"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/marketplace/"
            ...
            track-metadata-module="footer"track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/marketplace/"track-metadata-child_headline="resources"track-type="footer link"track-name="google cloud marketplace">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/contact/"
            ...
            track-metadata-eventDetail="cloud.google.com/contact/"track-metadata-child_headline="engage"track-metadata-position="footer"track-type="footer link"track-name="contact sales"track-metadata-module="footer">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//discuss.google.dev/c/google-cloud/14/"
             ...
             data-label="Footer Link (index 1)"
            rel="noopener"track-metadata-position="footer"track-metadata-child_headline="engage"track-metadata-module="footer"target="_blank"track-type="footer link"track-name="google cloud community"track-metadata-eventDetail="www.googlecloudcommunity.com">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/support-hub/"
             ...
             data-label="Footer Link (index 2)"
            track-name="support"track-type="footer link"track-metadata-child_headline="resources"track-metadata-module="footer"track-metadata-eventDetail="cloud.google.com/support-hub/"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//docs.cloud.google.com/release-notes"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-child_headline="resources"track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/release-notes/"track-metadata-module="footer"track-name="release notes"track-type="footer link">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//status.cloud.google.com"
             ...
             data-label="Footer Link (index 4)"
            track-metadata-position="footer"track-type="footer link"track-name="system status"target="_blank"track-metadata-eventDetail="status.cloud.google.com"track-metadata-child_headline="resources"track-metadata-module="footer">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//github.com/googlecloudPlatform/"
             ...
             data-label="Footer Link (index 1)"
            track-type="footer link"track-name="github"track-metadata-module="footer"track-metadata-child_headline="resources"track-metadata-eventDetail="github.com/googlecloudPlatform/"track-metadata-position="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="/architecture/"
             ...
             data-label="Footer Link (index 4)"
            track-name="cloud architecture center"track-type="footer link"track-metadata-child_headline="resources"track-metadata-position="footer"track-metadata-eventDetail="cloud.google.com/architecture/"track-metadata-module="footer">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/learn/training/"
            ...
            track-metadata-eventDetail="cloud.google.com/learn/training/"track-type="footer link"track-name="training"track-metadata-child_headline="resources"track-metadata-position="footer"track-metadata-module="footer">
      ...
      <ul class="devsite-footer-linkbox-list">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/blog/"
             ...
             data-label="Footer Link (index 1)"
            track-metadata-child_headline="engage"track-metadata-position="footer"track-name="blog"track-type="footer link"track-metadata-module="footer"track-metadata-eventDetail="cloud.google.com/blog/">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//cloud.google.com/events/"
             ...
             data-label="Footer Link (index 2)"
            track-metadata-child_headline="engage"track-metadata-eventDetail="cloud.google.com/events/"track-metadata-position="footer"track-metadata-module="footer"track-type="footer link"track-name="events">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//x.com/googlecloud"
             ...
             data-label="Footer Link (index 3)"
            track-metadata-child_headline="engage"track-metadata-position="footer"track-type="footer link"track-metadata-eventDetail="x.com/googlecloud"track-name="follow on x"rel="noopener"track-metadata-module="footer"target="_blank">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloud"
             ...
             data-label="Footer Link (index 4)"
            track-metadata-eventDetail="www.youtube.com/googlecloud"track-metadata-position="footer"rel="noopener"track-metadata-module="footer"target="_blank"track-metadata-child_headline="engage"track-name="google cloud on youtube"track-type="footer link">
        ...
        <li class="devsite-footer-linkbox-item">
          ...
          <a href="//www.youtube.com/googlecloudplatform"
             ...
             data-label="Footer Link (index 5)"
            rel="noopener"track-metadata-module="footer"track-name="google cloud tech on youtube"track-type="footer link"track-metadata-eventDetail="www.youtube.com/googlecloudplatform"target="_blank"track-metadata-position="footer"track-metadata-child_headline="engage">
