...
<CardGroup cols={3}>
  ...
  <Card title="Web Search in Chat" icon={<svg style={{maskImage: "url(https://mintlify.s3.us-west-1.amazonaws.com/zhipu-ef7018ed/resource/icon/comments.svg)", WebkitMaskImage: "url(https://mintlify.s3.us-west-1.amazonaws.com/zhipu-ef7018ed/resource/icon/comments.svg)", maskRepeat: "no-repeat", maskPosition: "center center",}} className={"h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"} />}>
    将搜索结果融入大模型生成**回答并标注网页结果来源**，实时检索+LLM生成无缝衔接
  </Card>

  <Card title="Search Agent" icon={<svg style={{maskImage: "url(https://mintcdn.com/zhipu-ef7018ed/6jZAOYw-eXEZh1pv/resource/icon/headset.svg?fit=max&auto=format&n=6jZAOYw-eXEZh1pv&q=85&s=f42f526ce8d7b3098ec5c72bfe9a401a)", WebkitMaskImage: "url(https://mintcdn.com/zhipu-ef7018ed/6jZAOYw-eXEZh1pv/resource/icon/headset.svg?fit=max&auto=format&n=6jZAOYw-eXEZh1pv&q=85&s=f42f526ce8d7b3098ec5c72bfe9a401a)", maskRepeat: "no-repeat", maskPosition: "center center",}} className={"h-6 w-6 bg-primary dark:bg-primary-light !m-0 shrink-0"} />}>
