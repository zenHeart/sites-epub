<!doctype html><html lang="en-us" class="antialiased leading-tight motion-safe:scroll-smooth" data-theme="dark"><head>
    ...
    <meta name="theme-color" content="#0a0a0a">
      ...
      <link rel="preload" as="image" imagesrcset="https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=768&amp;name=zen-cli-blog.webp 768w,
                         https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=1280&amp;name=zen-cli-blog.webp 1280w,
                         https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=1600&amp;name=zen-cli-blog.webp 1600w,
                         https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=2048&amp;name=zen-cli-blog.webp 2048w" imagesizes="(min-width: 1024px) 1024px, 100vw" fetchpriority="high">
...
<style>
  @font-face {
    ...
    <style>
      ...
      <title>Level Up Your AI Coding - Now Right Inside Your IDE</title>
      ...
      <meta name="description" content="The new platform connects major IDEs and AI CLIs—including VS Code, JetBrains, Codex and Claude Code—eliminating tool silos.
">
    ...
    <meta property="og:url" content="http://zencoder.ai/blog/universal-platform">
    <meta property="og:title" content="Level Up Your AI Coding - Now Right Inside Your IDE">
    <meta property="og:description" content="The new platform connects major IDEs and AI CLIs—including VS Code, JetBrains, Codex and Claude Code—eliminating tool silos.
">
    
      <meta property="og:image" content="//zencoder.ai/hubfs/zen-cli-blog.webp">
    ...
    <meta property="twitter:url" content="http://zencoder.ai/blog/universal-platform">
    <meta property="twitter:title" content="Level Up Your AI Coding - Now Right Inside Your IDE">
    <meta property="twitter:description" content="The new platform connects major IDEs and AI CLIs—including VS Code, JetBrains, Codex and Claude Code—eliminating tool silos.
">
    
      <meta property="twitter:image" content="//zencoder.ai/hubfs/zen-cli-blog.webp">
...
<script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    
    {
      "@type":
        "WebPage",
      "@id": "http://zencoder.ai/blog/universal-platform#webpage",
      "url": "http://zencoder.ai/blog/universal-platform",
      "name": "Level Up Your AI Coding - Now Right Inside Your IDE",
      "description": "The new platform connects major IDEs and AI CLIs—including VS Code, JetBrains, Codex and Claude Code—eliminating tool silos.",
      "inLanguage": "en-us",
    ...
    ,{
      "@type": "BreadcrumbList",
      "@id": "http://zencoder.ai/blog/universal-platform#breadcrumb",
      "itemListElement": [
        { "@type": "ListItem", "position": 1, "name": "Home", "item": "https://zencoder.ai/" }

        
          ,{ "@type": "ListItem", "position": 2, "name": "Level Up Your AI Coding - Now Right Inside Your IDE",
             "item": "http://zencoder.ai/blog/universal-platform" }
...
">
    <meta property="og:title" content="Level Up Your AI Coding - Now Right Inside Your IDE">
    <meta name="twitter:description" content="The new platform connects major IDEs and AI CLIs—including VS Code, JetBrains, Codex and Claude Code—eliminating tool silos.
">
    <meta name="twitter:title" content="Level Up Your AI Coding - Now Right Inside Your IDE">
    ...
    <script type="application/ld+json">
{
  "mainEntityOfPage" : {
    "@type" : "WebPage",
    "@id" : "http://zencoder.ai/blog/universal-platform"
  },
  "author" : {
    "name" : "Andrew Filev",
  ...
  "headline" : "Level Up Your AI Coding - Now Right Inside Your IDE",
  "datePublished" : "2025-09-18T05:58:11.000Z",
  "dateModified" : "2025-10-31T09:23:22.474Z",
  "publisher" : {
    "name" : "Zencoder",
    "logo" : {
  ...
  "@context" : "https://schema.org",
  "@type" : "BlogPosting",
  "image" : [ "//zencoder.ai/hubfs/zen-cli-blog.webp" ]
}
</script>
...
<link rel="amphtml" href="http://zencoder.ai/blog/universal-platform?hs_amp=true">

<meta property="og:image" content="//zencoder.ai/hubfs/zen-cli-blog.webp">
<meta property="og:image:width" content="1815">
<meta property="og:image:height" content="908">

<meta name="twitter:image" content="//zencoder.ai/hubfs/zen-cli-blog.webp">


<meta property="og:url" content="http://zencoder.ai/blog/universal-platform">
<meta name="twitter:card" content="summary_large_image">

<link rel="canonical" href="http://zencoder.ai/blog/universal-platform">
...
<div class="mb-8">
  <nav class="flex" aria-label="Breadcrumb">
    <ol class="flex items-center space-x-2">
      ...
      <div class="mb-8">
        <h1 class="h1 text-pretty text-center"><span id="hs_cos_wrapper_name" class="hs_cos_wrapper hs_cos_wrapper_meta_field hs_cos_wrapper_type_text" data-hs-cos-general-type="meta_field">Level Up Your AI Coding - Now Right Inside Your IDE</span></h1>
      </div>
      ...
      <div class="flex items-center justify-center mb-12">
        <a href="//zencoder.ai/blog/author/andrew-filev" class="text-center group">
          ...
          <p class="text-sm text-muted-foreground">
            Published: <time datetime="2025-09-18">September 18, 2025</time>
    ...
    <div class="mb-12 max-w-5xl mx-auto">
      <img src="https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=1600&amp;height=900&amp;name=zen-cli-blog.webp" srcset="https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=768&amp;name=zen-cli-blog.webp 768w, https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=1280&amp;name=zen-cli-blog.webp 1280w, https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=1600&amp;name=zen-cli-blog.webp 1600w, https://zencoder.ai/hs-fs/hubfs/zen-cli-blog.webp?width=2048&amp;name=zen-cli-blog.webp 2048w" sizes="(min-width: 1024px) 1024px, 100vw" alt="Level Up Your AI Coding - Now Right Inside Your IDE" width="1600" height="900" class="w-full h-auto rounded-2xl ring-1 ring-ring" loading="eager" fetchpriority="high" decoding="async">
    </div>
    ...
    <div class="pb-16 border-b border-ring">
      ...
      ">
        <span id="hs_cos_wrapper_post_body" class="hs_cos_wrapper hs_cos_wrapper_meta_field hs_cos_wrapper_type_rich_text" style="" data-hs-cos-general-type="meta_field" data-hs-cos-type="rich_text"><p>When I founded Zencoder, one of our core principles was simple: <strong>developers shouldn’t have to choose between powerful AI and the tools they already love.</strong> Today, we’re doubling down on that with a major update to the Zencoder Platform: <strong>more AI coding options, directly in your IDE.</strong></p>
<!--more-->
<h2><span style="font-size: 20px;"><strong>One Step Back, Two Steps Forward</strong></span></h2>
<p>As developers stretch the limits of their AI subscriptions, many have been juggling multiple terminal-based agents. Green-on-black still has its charm, but let’s be honest:</p>
<ul>
<li aria-level="1">Editing long prompts in a terminal is clunky</li>
<li aria-level="1">Copy-pasting images is impossible</li>
<li aria-level="1">Reviewing diffs takes extra steps</li>
<li aria-level="1">Rules get fragmented, MD files duplicated</li>
<li aria-level="1">And without features like Zen Agents, collaboration suffers</li>
</ul>
<p>That worked for a minute—but now there’s a better way.</p>
<h2 style="font-size: 20px;"><strong>Use What You Already Have</strong></h2>
<p>Already paying for ChatGPT, Claude, or Gemini? With our new VS Code and JetBrains extensions, you can bring those subscriptions straight into Zencoder—combine daily limits, switch between models, and unlock even more power without changing your workflow.</p>
<h2><span style="font-size: 20px;"><strong>Built for Teams, Simple for Individuals</strong></span></h2>
<ul>
<li aria-level="1">Navigate massive repos with <strong>multi-repository intelligence</strong><strong><br></strong></li>
<li aria-level="1">Save time with <strong>reusable Zen agents</strong> for testing, reviews, and consistency</li>
<li aria-level="1">Stay secure with <strong>compliance guardrails and analytics</strong><strong><br><br></strong></li>
</ul>
<p>For solo developers, Zencoder is free to start—just connect your subscription and start coding. For teams, everything scales with you.</p>
<p style="font-size: 20px;"><strong>Start Today</strong></p>
<p>The updated Zen Platform is live. Connect your account now and see what <em>vibe coding</em> feels like.</p>
<p style="font-size: 18px;"><span style="color: #ffffff;">👉<a href="/product/universal-ai-platform" style="font-size: 11px; color: #ffffff;" rel="noopener"> <span style="text-decoration: underline;"><span style="font-size: 18px;">Get started for free</span></span></a></span></p></span>
      </article>
    </div>
...
_hsq.push(["setCanonicalUrl", "http:\/\/zencoder.ai\/blog\/universal-platform"]);
_hsq.push(["setPageId", "195763184166"]);
_hsq.push(["setContentMetadata", {
    "contentPageId": 195763184166,
    "legacyPageId": "195763184166",
    "contentFolderId": null,
    "contentGroupId": 167002545819,
    "abTestId": null,
    "languageVariantId": 195763184166,
    "languageCode": "en-us",
...
<script type="text/javascript">
var hsVars = {
    render_id: "d3a22d6f-b49c-4aab-b753-1c381cc5566a",
    ticks: 1788971775381,
    page_id: 195763184166,
    ...
    analytics_page_id: "195763184166",
    category_id: 3,
    folder_id: 0,
