...
<td>
<p>可控制表单组件在什么情况下展示禁用状态。<br>
例如，禁用态绑定了<code>example_workflow.disable</code>，当对应的工作流的<code>disable</code>属性为<code>true</code>时，表单组件将展示为禁用状态。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>可控制表单组件在什么情况下展示加载状态。<br>
例如，加载态绑定了<code>example_workflow.loading</code>，当对应的工作流的<code>loading</code>属性为<code>true</code>时，表单组件将展示为加载状态。</p>
</td>
</tr>
</tbody>
</table>
...
<td>
<p>配置表单组件的模糊效果，数值越大，模糊效果越明显。支持设置图层模糊和背景模糊。</p>
<ul data-style="0">
...
</div><h3 id="220df3fc" tabindex="-1">状态设置</h3>
<p>控制表单组件悬浮态、点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 143,696 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置表单组件的悬浮态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：当鼠标悬浮到表单组件上时，表单组件的样式变化情况。包括背景色、边框等。详细说明，请参考<a href="/guides/form_web#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：当鼠标悬浮到表单组件上时，表单组件的动态变化情况。包括缩放、旋转等。详细说明，请参考<a href="/guides/form_web#5e1afc91" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置表单组件悬浮态的动画效果。
<ul data-style="1">
...
<ul data-style="0">
<li>样式效果：点击表单组件时，表单组件的样式变化情况。详细说明，请参考<a href="/guides/form_web#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：点击表单组件时，表单组件的动态变化情况。详细说明，请参考<a href="/guides/form_web#5e1afc91" target="_blank">变换设置</a>。</li>
...
<td>
<p>设置表单组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="4af26cae" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制表单组件隐藏或显示的参数，支持在特定条件下隐藏表单组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制表单组件的可见性。<br>
例如可以通过开关组件控制表单组件的可见性。开关组件 ID 为 <code>Switch 1</code>，当你将表单组件的<strong>可见性</strong>设置为<code>{{ Switch1.value}}</code>后，开关打开时，<code>{{ Switch1.value}}</code>值为 true，表单组件将被隐藏。</li>
</ul>
