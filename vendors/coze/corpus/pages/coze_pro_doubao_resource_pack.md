...
<td>
<p>Doubao-1.5-vision-pro-32k 推理服务</p>
</td>
<td>
<ul data-style="1">
<li>输入：3 积分</li>
...
<td>
<p>Doubao-vision-pro-32k 推理服务</p>
</td>
<td>
<ul data-style="1">
<li>输入：3 积分</li>
...
<td>
<p>Doubao-vision-lite-32k 推理服务</p>
</td>
<td>
<ul data-style="1">
<li>输入：1.5 积分</li>
...
<li>方舟模型： <!-- @cols-width: 312,385 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 312px;" /><col style="width: 385px;" /></colgroup><thead>
<tr>
<th>
...
<p>例如对于使用 Doubao-pro-32k-推理服务的智能体，调用 1 次智能体时输入 400 tokens，输出 600 tokens，扣减 1.52 积分，计算方式为：</p>
<p><strong>400 tokens/1000 × 0.8 （抵扣系数）+  600 tokens/1000 × 2 （抵扣系数）= 1.52 积分</strong></p>
<h2 id="f5b0cde3" tabindex="-1">抵扣规则</h2>
<p>购买豆包大模型资源包后，费用结算时系统优先从资源包中抵扣用量。如果用量超出资源包额度，根据按量计费的价格统计资源用量。</p>
<div class="topic-callout tip"><p class="topic-callout-title">说明</p>
<p>账号中存在多个资源包时，优先抵扣到期时间更早的积分。</p>
</div>
<h2 id="bcf4e89f" tabindex="-1">规格与定价</h2>
<p>积分的规格与定价为：</p>
<!-- @cols-width: 105,105,105,223 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 223px;" /></colgroup><thead>
<tr>
<th>
<p>资源包</p>
</th>
...
<th>
<p><strong>抵扣 Token</strong> <strong>数量</strong></p>
</th>
</tr>
</thead>
<tbody>
...
<p><strong>输入</strong>与<strong>输出</strong>的 Token 用量取决于智能体使用的模型版本，此处的抵扣 Token 数量仅用于参考。</p>
</div>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/coze_pro_resource_pack" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">智能体资源包（已下架）</div></a><div class="placeholder-v9IAVe"></div></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="抵扣范围" href="#c459cfaf" data-href="#c459cfaf">抵扣范围</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="抵扣系数" href="#944905fe" data-href="#944905fe">抵扣系数</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="抵扣规则" href="#f5b0cde3" data-href="#f5b0cde3">抵扣规则</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="规格与定价" href="#bcf4e89f" data-href="#bcf4e89f">规格与定价</a></div></div></div></div></div></div></div></div>
</body></html>