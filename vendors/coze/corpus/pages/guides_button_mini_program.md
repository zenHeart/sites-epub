...
<p>按钮组件的图标设置开关。</p>
<ul data-style="0">
<li><strong>开启状态</strong>：启用图标设置开关后，可以自定义按钮图标。</li>
<li><strong>关闭状态</strong>：关闭图标设置开关后，按钮将不支持图标配置，且默认图标<code>+</code>也不会显示。</li>
</ul>
</td>
</tr>
<tr>
...
<td>
<p>开启<strong>分享小程序</strong>开关后，支持一键单击按钮，快速分享小程序链接。</p>
</td>
</tr>
</tbody>
</table>
...
</div><h3 id="930c1217" tabindex="-1">状态设置</h3>
<p>控制按钮组件禁用态、加载态、点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置按钮组件的禁用状态。具体配置说明如下：</p>
<ul data-style="0">
<li>设置为 true：组件处于禁用状态。</li>
<li>设置为 false：组件处于可用状态</li>
<li>设置为变量：通过变量值（true 或 false）动态控制按钮组件的禁用状态。<br>
例如可以通过单行输入组件控制按钮组件的禁用状态。单行输入组件 ID 为 <code>Input1</code>，当你将按钮组件<strong>禁用态</strong>设置为<code>{{Input1.value}}</code>后，在单行输入组件中输入文本时，<code>{{Input1.value}}</code>值为 true，按钮组件将处于禁用状态。</li>
</ul>
<div class="topic-callout tip"><p class="topic-callout-title">说明</p>
<p>在内容生成类的应用场景中，建议为生成键（按钮组件）的禁用态和加载态属性同时绑定工作流的<code>loading</code>值。绑定后，可以防止在工作流执行过程中重复点击生成按钮，避免不必要的重复操作。</p>
</div>
</td>
</tr>
<tr>
...
<td>
<p>配置按钮组件的加载状态。具体配置说明如下：</p>
<ul data-style="0">
<li>设置为 true：组件展示加载状态，隐藏组件内容。</li>
<li>设置为 false：关闭加载状态。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制按钮组件的加载状态。<br>
例如可以通过单行输入组件控制按钮组件的加载状态。单行输入组件 ID 为 <code>Input1</code>，当你将按钮组件的<strong>加载态</strong>设置为<code>{{Input1.value}}</code>后，在单行输入组件中输入文本时，<code>{{Input1.value}}</code>值为 true，按钮组件展示加载态。</li>
</ul>
<div class="topic-callout tip"><p class="topic-callout-title">说明</p>
<p>在内容生成类的应用场景中，建议为生成键（按钮组件）的禁用态和加载态属性同时绑定工作流的<code>loading</code>值。绑定后，可以防止在工作流执行过程中重复点击生成按钮，避免不必要的重复操作。</p>
</div>
...
<ul data-style="0">
<li>样式效果：点击按钮组件时，按钮组件的样式变化情况。详细说明，请参考<a href="/guides/button_mini_program#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：点击按钮组件时，按钮组件的动态变化情况。详细说明，请参考<a href="/guides/button_mini_program#5e1afc91" target="_blank">变换设置</a>。</li>
...
<td>
<p>设置按钮组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入等动画效果。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="33f5b3ac" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制按钮组件隐藏或显示的参数，支持在特定条件下隐藏按钮组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制按钮组件的可见性。<br>
例如可以通过单行输入组件控制按钮组件的可见性。单行输入组件 ID 为 <code>Input1</code>，当你将按钮组件的<strong>可见性</strong>设置为<code>{{ Input1.value}}</code>后，在单行输入组件中输入文本时，<code>{{ Input1.value}}</code>值为 true，按钮组件将被隐藏。</li>
</ul>
