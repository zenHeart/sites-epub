...
+ &apos;&response_type=code&redirect_uri=&apos; + encodeURIComponent(&apos;https://www.coze.cn/auth/callback&apos;))" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
...
通过修改 <code>state</code> 参数中 <code>navigatePath</code> 的值、执行两次 URL 编码、拼接至 RelayState，即可得到 RelayState 参数的值。具体流程与示例如下表所示：<!-- @cols-width: 164,249,265,248,254 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 164px;" /><col style="width: 249px;" /><col style="width: 265px;" /><col style="width: 248px;" /><col style="width: 254px;" /></colgroup><thead>
<tr>
<th>
<p><strong>拼接流程</strong></p>
</th>
<th>
<p><strong>扣子 Agent</strong></p>
</th>
<th>
<p><strong>扣子编程主页</strong></p>
</th>
<th>
<p><strong>扣子编程工作空间</strong></p>
</th>
<th>
<p><strong>扣子编程工作空间中的智能体</strong></p>
</th>
</tr>
</thead>
<tbody>
<tr>
<td>1. 在<code>state</code>参数的<code>navigatePath</code>字段中配置 SSO 跳转的目标页面。</td>
<td>{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;/session/764153****&quot;,&quot;type&quot;:&quot;login&quot;}</td>
<td>{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;<a href="https://code.coze.cn/home" target="_blank">https://code.coze.cn/home</a>&quot;,&quot;type&quot;:&quot;login&quot;}</td>
<td>{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;<a href="https://code.coze.cn/space" target="_blank">https://code.coze.cn/space</a>&quot;,&quot;type&quot;:&quot;login&quot;}</td>
<td>{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;<a href="https://code.coze.cn/space/7436975598481899583/bot/754166928014542***5" target="_blank">https://code.coze.cn/space/7436975598481899583/bot/754166928014542***5</a>&quot;,&quot;type&quot;:&quot;login&quot;}</td>
</tr>
<tr>
<td>2. 使用在线 URL 编码工具对 <code>state</code> 中的 JSON 字符串执行两次 URL 编码。</td>
<td>%257B%2522platform%2522%253A%2522eps_cloud_identity%2522%252C%2522navigatePath%2522%253A%2522%252Fsession%252F%2520764153****%2522%252C%2522type%2522%253A%2522login%2522%257D</td>
<td>%257B%2522platform%2522%253A%2522eps_cloud_identity%2522%252C%2522navigatePath%2522%253A%2522https%253A%252F%252Fcode.coze.cn%252Fhome%2522%252C%2522type%2522%253A%2522login%2522%257D</td>
<td>%257B%2522platform%2522%253A%2522eps_cloud_identity%2522%252C%2522navigatePath%2522%253A%2522https%253A%252F%252Fcode.coze.cn%252Fspace%2522%252C%2522type%2522%253A%2522login%2522%257D</td>
<td>%257B%2522platform%2522%253A%2522eps_cloud_identity%2522%252C%2522navigatePath%2522%253A%2522https%253A%252F%252Fcode.coze.cn%252Fspace%252F7436975598481899583%252Fbot%252F754166928014542***5%2522%252C%2522type%2522%253A%2522login%2522%257D</td>
</tr>
<tr>
<td>3. 将编码后的值拼接到 <code>RelayState</code> 参数中。</td>
<td>redirect_uri=https%3A%2F%2Fsignin-saas.volccloudidentity.com%2Fapi%2Fcloudidentity%2Fauthorize%2FfederateOAuth%3Fclient_id%3D9836804098%26state%3D%25257B%252522platform%252522%25253A%252522eps_cloud_identity%252522%25252C%252522navigatePath%252522%25253A%252522%25252Fsession%25252F%252520764153%25252A%25252A%25252A%25252A%252522%25252C%252522type%252522%25253A%252522login%252522%25257D%26response_type%3Dcode%26redirect_uri%3Dhttps%253A%252F%252Fwww.coze.cn%252Fauth%252Fcallback%26scenario%3Dcoze</td>
...
<li>将拼接好的 <code>RelayState</code> 参数的值配置至 IdP 平台的登录跳转地址中：
<div style="position: relative">
	<pre><code class="hljs language-TypeScript"><span class="hljs-comment">// js代码示例</span>
<span class="hljs-comment">// POST方式</span>
{<span class="hljs-string">&quot;RelayState&quot;</span>: <span class="hljs-string">`<span class="hljs-subst">${RelayStateString}</span>`</span>}

<span class="hljs-comment">//Redirect方式</span>
<span class="hljs-string">`&amp;RelayState=<span class="hljs-subst">${<span class="hljs-built_in">encodeURIComponent</span>(RelayStateString)}</span>`</span>
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="// js代码示例
// POST方式
{&quot;RelayState&quot;: `${RelayStateString}`}

//Redirect方式
`&RelayState=${encodeURIComponent(RelayStateString)}`" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
</li>
</ol>
<h2 id="578a5ced" tabindex="-1">OAuth SSO 登录</h2>
<p>通过构造并传递 <code>state</code> 参数携带跳转路径信息，实现登录后直达扣子或扣子编程的指定页面，操作步骤如下：</p>
<ol data-style="0">
<li>构造一个 <code>coze_state</code> JSON 对象。
<ol data-style="1">
<li>按以下示例构造coze_state JSON 对象，用于指定目标跳转页面。
<div style="position: relative">
	<pre><code class="hljs language-JavaScript"><span class="hljs-keyword">const</span> coze_state =  <span class="hljs-string">&#x27;{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;/space&quot;,&quot;type&quot;:&quot;login&quot;}&#x27;</span>
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="const coze_state =  &apos;{&quot;platform&quot;:&quot;eps_cloud_identity&quot;,&quot;navigatePath&quot;:&quot;/space&quot;,&quot;type&quot;:&quot;login&quot;}&apos;" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
参数说明如下：<!-- @cols-width: 124,421 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 124px;" /><col style="width: 421px;" /></colgroup><thead>
<tr>
<th>
...
<tr>
<td>platform</td>
<td>平台标识，固定值为<code>eps_cloud_identity</code>。</td>
</tr>
<tr>
<td>
<p>navigatePath</p>
...
<p>目标页面路径。取值如下：</p>
<ul data-style="2">
<li><code>/session/764153****</code>：某个扣子 Agent。</li>
<li><code>https://code.coze.cn/home</code>：扣子编程主页</li>
<li><code>https://code.coze.cn/space</code>：扣子编程工作空间</li>
<li><code>https://code.coze.cn/space/74****/bot/75****</code>：扣子编程工作空间下的某个智能体</li>
</ul>
<div class="topic-callout tip"><p class="topic-callout-title">说明</p>
<p>如果路径中包含传参，需要进行 <code>encodeURIComponent</code> 编码。</p>
</div>
</td>
</tr>
<tr>
<td>type</td>
<td>操作类型，固定值为<code>login</code>。</td>
</tr>
</tbody>
</table>
</div></li>
<li>将上一步生成的<code>coze_state</code> JSON 字符串进行<code>encodeURIComponent</code>编码。</li>
</ol>
</li>
<li>构造 <code>redirect_uri</code>。
<ol data-style="1">
<li>将云身份中心实例名、<code>client_id</code> 、编码后的<code>coze_state</code>等参数填入模板。
<div style="position: relative">
	<pre><code class="hljs language-TypeScript"><span class="hljs-keyword">const</span> redirect_uri = <span class="hljs-string">`https://<span class="hljs-subst">${instance_name}</span>.volccloudidentity.com/api/cloudidentity/authorize/federateOAuth?client_id=9836804098&amp;state=<span class="hljs-subst">${<span class="hljs-built_in">encodeURIComponent</span>(coze_state)}</span>&amp;response_type=code&amp;redirect_uri=https%3A%2F%2Fwww.coze.cn%2Fauth%2Fcallback&amp;scenario=coze`</span>
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="const redirect_uri = `https://${instance_name}.volccloudidentity.com/api/cloudidentity/authorize/federateOAuth?client_id=9836804098&state=${encodeURIComponent(coze_state)}&response_type=code&redirect_uri=https%3A%2F%2Fwww.coze.cn%2Fauth%2Fcallback&scenario=coze`" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
<!-- @cols-width: 136,368 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 136px;" /><col style="width: 368px;" /></colgroup><thead>
<tr>
<th>
<p><strong>参数</strong></p>
</th>
...
<tr>
<td>client_id</td>
<td>云身份中心的<code>client_id</code>，固定值为9836804098。</td>
</tr>
<tr>
<td>state</td>
<td>步骤 1 中生成的编码后的 <code>coze_state</code> 字符串。</td>
</tr>
<tr>
<td>response_type</td>
<td>响应类型，固定值为 <code>code</code>。</td>
</tr>
<tr>
<td>redirect_uri</td>
<td><code>扣子的回调地址，固定值为 https%3A%2F%2Fwww.coze.cn%2Fauth%2Fcallback。</code></td>
</tr>
<tr>
<td>scenario</td>
<td>场景标识，固定值为 <code>coze</code>。</td>
</tr>
</tbody>
</table>
</div></li>
<li>对整个<code>redirect_uri</code>再执行一次 URL 编码，得到<code>encodeURIComponent(redirect_uri)</code>。</li>
</ol>
</li>
<li>构造<code>state</code>参数。<br>
将编码后的<code>redirect_uri</code>作为值，拼接到<code>redirect_uri=</code>前缀后，再执行一次 URL 编码，得到最终用于 OAuth 请求的<code>state</code>参数：
<div style="position: relative">
	<pre><code class="hljs language-TypeScript"><span class="hljs-keyword">const</span> state = <span class="hljs-built_in">encodeURIComponent</span>(<span class="hljs-string">&#x27;redirect_uri=&#x27;</span> + <span class="hljs-built_in">encodeURIComponent</span>(redirect_uri))
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="const state = encodeURIComponent(&apos;redirect_uri=&apos; + encodeURIComponent(redirect_uri))" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
</li>
<li>构造完整的 SSO 登录地址。<br>
将云身份中心<code>EntityID</code>和最终的<code>state</code>参数填入地址模板：
<div style="position: relative">
	<pre><code class="hljs language-TypeScript"><span class="hljs-attr">https</span>:<span class="hljs-comment">//signin.volcengine.com/cloud-identity/cn-beijing/${entity_id}/userlogin/oauth/sso?state=${state}</span>
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="https://signin.volcengine.com/cloud-identity/cn-beijing/${entity_id}/userlogin/oauth/sso?state=${state}" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
用户访问该地址，即可完成 OAuth SSO 登录并直接跳转扣子或扣子编程的指定页面。</li>
</ol>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/tutorial_configure_sso_from_feishu" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">通过飞书进行 SAML SSO 登录</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/developer_guides_coze_cli_quickstart" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">Coze CLI：账号登录与授权</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="功能介绍" href="#6f898ec1" data-href="#6f898ec1">功能介绍</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="前提条件" href="#865ecc92" data-href="#865ecc92">前提条件</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="SAML SSO 登录" href="#b38dbb08" data-href="#b38dbb08">SAML SSO 登录</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="OAuth SSO 登录" href="#578a5ced" data-href="#578a5ced">OAuth SSO 登录</a></div></div></div></div></div></div></div></div>
</body></html>