...
</div><h2 id="3b9014e5" tabindex="-1">计费范围</h2>
<p>扣子<strong>仅对线上运行产生的 Trace 日志进行收费</strong>，其他场景（如在扣子编程内调试等）产生的 Trace 日志完全免费。具体的计费场景如下：</p>
<!-- @cols-width: 245,529 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 245px;" /><col style="width: 529px;" /></colgroup><thead>
<tr>
<th>
<p><strong>Trace 日志来源</strong></p>
</th>
<th>
...
<td>
<p>低代码、编程项目的智能体或工作流在线上运行。<br>
Trace 日志上报开关默认开启，支持关闭。具体操作，请参考<a href="https://docs.coze.cn/guides/view_running_log#b88ed6f1" target="_blank">关闭 Trace 上报</a>。</p>
</td>
</tr>
<tr>
<td>
...
</div><h2 id="551b6d73" tabindex="-1">单价</h2>
<p>Trace 日志费用的计费单价如下表所示：</p>
<!-- @cols-width: 151,211,225 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 151px;" /><col style="width: 211px;" /><col style="width: 225px;" /></colgroup><thead>
<tr>
<th rowspan="2">
...
<tr>
<th>
<p><strong>积分结算（积分/GB/天）</strong></p>
</th>
<th>
<p><strong>现金结算（元/GB/天）</strong></p>
</th>
</tr>
</thead>
<tbody>
...
</div><h2 id="7b25ffd4" tabindex="-1">计费公式</h2>
<p>按照如下公式计算 Trace 日志费用：</p>

<div style="position: relative">
	<pre><code class="hljs language-Plain">Trace 日志费用 = 存储容量（GB） ✖️ 存储时长（天） ✖️ 单价
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="Trace 日志费用 = 存储容量（GB） ✖️ 存储时长（天） ✖️ 单价" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
...
<ul data-style="0">
<li>存储容量：单次上报的 Trace 数据量。系统会精确到 Byte 来统计使用量，最终换算为 GB。</li>
<li>存储时长：Trace 数据的存储时长。</li>
</ul>
<h2 id="b529ee3c" tabindex="-1">计费示例</h2>
<p>假设你是个人进阶版用户，Trace 存储天数默认为 7 天，如果你的某个智能体线上运行上报了 0.1 GB 的 Trace 数据，则你需要一次性支付积分：<code>0.1 GB * 7 天 * 140 积分= 98 积分</code>。</p>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/coze_pro_cozeloop_intelligent_optimization_fee" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">提示词智能优化费用</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/coze_pro_Issue_invoice" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">开具发票</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="计费方式" href="#85157b69" data-href="#85157b69">计费方式</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="计费范围" href="#3b9014e5" data-href="#3b9014e5">计费范围</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="单价" href="#551b6d73" data-href="#551b6d73">单价</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="计费公式" href="#7b25ffd4" data-href="#7b25ffd4">计费公式</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="计费示例" href="#b529ee3c" data-href="#b529ee3c">计费示例</a></div></div></div></div></div></div></div></div>
</body></html>