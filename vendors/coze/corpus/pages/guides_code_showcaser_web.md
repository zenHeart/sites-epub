...
<td>
<p>选择要展示的代码的语言，支持<code>JSON</code>、<code>JavaScript</code>、<code>Python</code>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码展示中的显示内容，支持配置静态内容和动态绑定数据，详情请参见<a href="/guides/set_content_parameters" target="_blank">设置组件内容参数</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码展示中的字体大小，数值越大字体越大。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="c1366b49" tabindex="-1">位置设置</h3>
<p>代码展示组件提供三种位置类型选项，以灵活配置组件在界面中的位置。</p>
<ul data-style="0">
<li>相对定位：堆叠布局下，元素自动向下或向右排列。</li>
<li>绝对定位：页面滚动时，绝对定位的元素会随页面一起滚动。</li>
<li>固定定位：页面滚动时，固定定位的元素会保持固定位置不变。</li>
</ul>
<h3 id="887675b7" tabindex="-1">尺寸设置</h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置代码展示组件的尺寸限制，支持配置最大高度、最小高度、最大宽度、最小宽度。<br>
合理设置尺寸限制参数可以确保组件在不同屏幕尺寸下保持布局的稳定性和一致性，避免因屏幕尺寸差异而导致的布局问题。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="35c937cf" tabindex="-1"><strong>样式设置</strong></h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置代码展示组件背景的圆角，支持单独设置四个角的圆角。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码展示组件背景的内边距，可以单独设置四个方向的内边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码展示组件背景的外边距，可以单独设置四个方向的外边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码展示组件背景的阴影样式，增强组件的立体感。支持如下设置方式：</p>
<ul data-style="0">
...
<td>
<p>配置代码展示器组件的模糊效果，数值越大，模糊效果越明显。支持设置图层模糊和背景模糊。</p>
<ul data-style="0">
...
</div><h3 id="31586e07" tabindex="-1">变换设置</h3>
<p>丰富界面视觉效果的参数。</p>
<!-- @cols-width: 145,704 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置代码展示器组件在水平和垂直方向上的倾斜角度。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="a6b59f83" tabindex="-1">状态设置</h3>
<p>控制代码展示器组件加载态、悬浮态、点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 143,696 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置代码展示器组件的悬浮态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：当鼠标悬浮到代码展示器组件上时，代码展示器组件的样式变化情况。包括背景色、边框等。详细说明，请参考<a href="/guides/code_showcaser_web#35c937cf" target="_blank">样式设置</a>。</li>
<li>变换效果：当鼠标悬浮到代码展示器组件上时，代码展示器组件的动态变化情况。包括缩放、旋转等。详细说明，请参考<a href="/guides/code_showcaser_web#31586e07" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置代码展示器组件悬浮态的动画效果。
<ul data-style="1">
...
<td>
<p>配置代码展示器组件的点击态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：点击代码展示器组件时，代码展示器组件的样式变化情况。详细说明，请参考<a href="/guides/code_showcaser_web#35c937cf" target="_blank">样式设置</a>。</li>
<li>变换效果：点击代码展示器组件时，代码展示器组件的动态变化情况。详细说明，请参考<a href="/guides/code_showcaser_web#31586e07" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置代码展示器组件点击态的动画效果。
<ul data-style="1">
<li>动画效果：支持设置为缓入缓出、缓入、缓出、线性等动画。</li>
<li>持续时间：设置动画的持续时间，单位为毫秒。</li>
<li>延迟时间：设置动画延迟出现的时间，单位为毫秒。</li>
...
<td>
<p>设置代码展示器组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="3254955b" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制代码展示器组件隐藏或显示的参数，支持在特定条件下隐藏代码展示器组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制代码展示器组件的可见性。<br>
例如可以通过开关组件控制代码展示器组件的可见性。开关组件 ID 为 <code>Switch 1</code>，当你将代码展示器组件的<strong>可见性</strong>设置为<code>{{ Switch1.value}}</code>后，开关打开时，<code>{{ Switch1.value}}</code>值为 true，代码展示器组件将被隐藏。</li>
</ul>
<h2 id="ca993386" tabindex="-1">事件设置</h2>
<p>通过配置代码展示组件的事件，可以为代码展示组件添加丰富的交互功能，以增强用户体验和界面的互动性。</p>
<!-- @cols-width: 148,709 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<p>支持以下方法：</p>
<ul data-style="0">
<li>清除：清除组件的内容，例如代码展示中的代码。</li>
<li>滚动到视图：将组件滚动到可视区域内。</li>
<li>设置内容：为组件设置或更新内容。</li>
...
</div></div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/guides_icon_web" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">图标</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/guides_markdown_web" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">Markdown</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="属性设置" href="#b0bf4759" data-href="#b0bf4759">属性设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="常用设置" href="#bb25294f" data-href="#bb25294f">常用设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="位置设置" href="#c1366b49" data-href="#c1366b49">位置设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="尺寸设置" href="#887675b7" data-href="#887675b7">尺寸设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="样式设置" href="#35c937cf" data-href="#35c937cf">样式设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="变换设置" href="#31586e07" data-href="#31586e07">变换设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="状态设置" href="#a6b59f83" data-href="#a6b59f83">状态设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="可见性设置" href="#3254955b" data-href="#3254955b">可见性设置</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="事件设置" href="#ca993386" data-href="#ca993386">事件设置</a></div></div></div></div></div></div></div></div>
</body></html>