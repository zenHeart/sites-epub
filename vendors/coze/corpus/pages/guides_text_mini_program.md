...
<tr>
<td>内容</td>
<td>配置文本组件显示内容，支持配置静态文本内容和动态绑定数据，详情请参见<a href="/guides/set_content_parameters" target="_blank">设置组件内容参数</a>。</td>
</tr>
<tr>
<td>字号</td>
<td>配置文本组件显示字体大小，数值越大字体越大。</td>
</tr>
<tr>
<td>
<p>字重</p>
...
<p>配置文本组件显示字重大小。</p>
<ul data-style="0">
<li>范围：极细、特细、细体、常规、中等、半粗、粗体、特粗、黑体。</li>
<li>默认值：常规。</li>
</ul>
</td>
</tr>
...
<tr>
<td>最大行数</td>
<td>配置文本组件最大显示行数，超过最大行数显示为<code> ...</code>。</td>
</tr>
</tbody>
</table>
</div><h3 id="b42128c7" tabindex="-1">位置设置</h3>
<p>文本组件提供三种位置类型选项，以灵活配置组件在界面中的位置。</p>
<ul data-style="0">
...
<td>
<p>配置文本组件的尺寸限制，支持配置最大高度、最小高度、最大宽度、最小宽度。</p>
...
<tr>
<td>圆角</td>
<td>配置文本组件背景的圆角，支持单独设置四个角的圆角。</td>
</tr>
<tr>
<td>内边距</td>
<td>配置文本组件背景的内边距，可以单独设置四个方向的内边距。</td>
</tr>
<tr>
<td>外边距</td>
<td>配置文本组件背景的外边距，可以单独设置四个方向的外边距。</td>
</tr>
<tr>
<td>
<p>边框</p>
...
<td>
<p>配置文本组件背景的阴影样式，增强组件的立体感。支持如下设置方式：</p>
<ul data-style="0">
...
<tr>
<td>图层模糊</td>
<td>配置文本组件的模糊效果。数值越大，模糊效果越明显。</td>
</tr>
<tr>
<td>
<p>溢出</p>
...
<tr>
<td>旋转</td>
<td>配置文本组件围绕中心点旋转的角度。</td>
</tr>
<tr>
<td>位移</td>
<td>配置文本组件在水平和垂直方向上的移动距离。</td>
</tr>
<tr>
<td>倾斜</td>
<td>配置文本组件在水平和垂直方向上的倾斜角度。</td>
</tr>
</tbody>
</table>
</div><h3 id="d12c8210" tabindex="-1">状态设置</h3>
<p>控制文本组件点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 137,702 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置文本组件的点击态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：点击文本组件时，文本组件的样式变化情况。详细说明，请参考<a href="/guides/text_mini_program#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：点击文本组件时，文本组件的动态变化情况。详细说明，请参考<a href="/guides/text_mini_program#5e1afc91" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置文本组件点击态的动画效果。
<ul data-style="1">
...
<tr>
<td>出场效果</td>
<td>设置文本组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入等动画效果。</td>
</tr>
</tbody>
</table>
</div><h3 id="128d31d4" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制文本组件隐藏或显示的参数，支持在特定条件下隐藏文本组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制文本组件的可见性。<br>
例如可以通过单行输入组件控制文本组件的可见性。单行输入组件 ID 为 <code>Input1</code>，当你将文本组件的<strong>可见性</strong>设置为<code>{{ Input1.value}}</code>后，在单行输入组件中输入文本时，<code>{{ Input1.value}}</code>值为 true，文本组件将被隐藏。</li>
</ul>
<h2 id="23196d0b" tabindex="-1">事件设置</h2>
<p>通过配置文本组件的事件，可以为文本组件添加丰富的交互功能，例如点击、加载等，以增强用户体验和界面的互动性。</p>
<!-- @cols-width: 148,709 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
