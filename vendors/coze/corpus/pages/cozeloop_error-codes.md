...
<td>
<ul data-style="0">
<li>原因：请求参数错误，主要原因包括参数格式错误、必选参数缺失等。</li>
<li>解决方案：请参考 API 文档检查请求参数。</li>
</ul>
</td>
</tr>
<tr>
<td>
<p>文件大小超过限制，请减小文件大小后再上传。</p>
</td>
<td>
<ul data-style="0">
<li>原因：文件大小超过限制。</li>
<li>解决方案：减小文件大小后重新上传。</li>
</ul>
</td>
</tr>
<tr>
<td>
<p>请求参数 {{invalid_param}} 错误，请检查您的输入。</p>
</td>
<td>
<ul data-style="0">
<li>原因：请求参数错误，主要原因包括参数格式错误、必选参数缺失等。</li>
...
<tr>
<td>
<p>Prompt {{prompt_key}} 未提交版本，请先提交版本。</p>
</td>
<td>
<ul data-style="0">
<li>原因：Prompt 仍是草稿状态，没有一个提交版本。</li>
<li>解决方案：请先提交一个版本。</li>
</ul>
</td>
</tr>
...
<td>
<p>身份验证无效（未找到creator id、VerifyAccessToken）</p>
</td>
<td>
<ul data-style="0">
<li>原因：个人访问令牌（PAT）不正确。</li>
<li>解决方案：请检查后重试。</li>
</ul>
</td>
</tr>
...
<td>
<p>Prompt {{prompt_key}} 不存在，请检查该 prompt key 是否存在。</p>
</td>
<td>
<ul data-style="0">
<li>原因：Prompt key 不存在。</li>
<li>解决方案：确认 Prompt key 是否正确。</li>
</ul>
</td>
</tr>
<tr>
<td>
<p>Prompt: {{prompt_key}} , Version: {{version}} 不存在，请确认对应版本已发布。</p>
</td>
<td>
<ul data-style="0">
<li>原因：指定的prompt版本不存在。</li>
<li>解决方案：请检查 Prompt版本参数是否正确。</li>
</ul>
</td>
</tr>
<tr>
...
<td>
<p>当前空间批量获取Prompt QPS过高，请稍后重试或联系平台咨询。</p>
</td>
<td>
<ul data-style="0">
<li>原因：当前空间获取Prompt请求QPS过高。</li>
<li>解决方案：降低请求频率。</li>
</ul>
</td>
</tr>
...
<ul data-style="0">
<li>原因：系统内部错误。</li>
<li>解决方案：请联系扣子罗盘技术支持。</li>
</ul>
</td>
</tr>
<tr>
<td>
<p>文件上传时发生系统内部错误。请稍后重试您的请求。如果问题一直存在，请联系我们的支持团队。</p>
</td>
<td>
<ul data-style="0">
<li>原因：文件上传内部错误。</li>
...
</div></div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/cozeloop_ptaas-for-java-sdk" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">调用 Prompt</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/cozeloop_evaluate_trace_of_react_agent" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">基于 Trace 自动评测 Agent</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"></div></div></div></div></div>
</body></html>