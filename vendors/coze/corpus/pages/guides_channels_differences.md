...
<ul data-style="0">
<li>＊①：应用发布 Chat SDK 时，仅对话流搭建的应用支持问答节点，工作流搭建的应用不支持问答节点。</li>
<li>＊②：智能体发布 Chat SDK、微信小程序、抖音小程序、微信、飞书、多维表格、掘金时，不支持卡片效果。</li>
<li>＊③：应用发布微信、飞书、多维表格、掘金时，不支持卡片效果。</li>
<li>微信服务号、微信客服、微信订阅号不支持工作流输出节点提前输出消息内容，仅支持汇总后统一输出。</li>
<li>微信小程序支持工作流输出节点提前输出。</li>
</ul>
</div>
<h2 id="0884cd0c" tabindex="-1">功能点</h2>
<p>不同渠道的能力差异如下表所示。</p>
<p>✔️表示支持，- 表示不支持。</p>
<!-- @cols-width: 105,105,105,105,105,105,105,105,105,100 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 105px;" /><col style="width: 100px;" /></colgroup><thead>
<tr>
<th><strong>功能点</strong></th>
<th><strong>微信</strong></th>
<th><strong>飞书</strong></th>
<th><strong>多维表格</strong></th>
<th><strong>掘金</strong></th>
<th><strong>微信/抖音小程序</strong></th>
<th><strong>Chat SDK</strong></th>
<th><strong>Web SDK</strong></th>
<th><strong>API</strong></th>
<th><strong>扣子商店</strong></th>
</tr>
</thead>
<tbody>
<tr>
...
<ul data-style="0">
<li>＊①：微信客服渠道不支持语音输入和开场白。</li>
<li>＊②：发布小程序后，仅支持展示全部预设问题，不支持展示部分预设问题。</li>
</ul>
</div>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/guides_manage_channels" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">管理发布渠道</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/guides_publish_faq" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">发布常见问题</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="工作流节点" href="#7c275617" data-href="#7c275617">工作流节点</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="功能点" href="#0884cd0c" data-href="#0884cd0c">功能点</a></div></div></div></div></div></div></div></div>
</body></html>