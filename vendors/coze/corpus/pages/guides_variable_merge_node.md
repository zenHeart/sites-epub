...
![Image=326x335](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/6c5816e696f3472188b5d5f096e14af3~tplv-goo7wpa0wc-topic.webp)

![Image=322x419](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/ce25884921a547898ce1e1c83af7d286~tplv-goo7wpa0wc-topic.webp)
...
![Image=658x345](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/12af95bb96d6437f9171525557c91b6a~tplv-goo7wpa0wc-topic.webp)
...
![Image=681x181](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/8be2e54725324bfa821c3e41b4d6ef4e~tplv-goo7wpa0wc-topic.webp)

节点配置如下：

<!-- @cols-width: 115,498,234 -->
| 节点类型  | 说明  | 示例  |
| --- | --- | --- |
| 开始节点  | 定义两个变量： | ![Image=151x147](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/f65a9e0c00864d09a1717371004802fe~tplv-goo7wpa0wc-topic.webp)  | \
| | | | \
| | * BOT_USER_INPUT：用户输入的问题，也就是学生的问题。 | | \
| | * type：问题对应的学科。  | |
| 选择器节点  | 判断用户输入的 type 属于哪个学科，将问题流转到对应分支处理。这里我们定义语文和数学两个分支，其他学科统一流转到另外一个分支。  | ![Image=135x186](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/5c3a299a30e54b7aac19e6ddaf9682d4~tplv-goo7wpa0wc-topic.webp)  |
| 大模型节点  | 用于回答对应学科的问题，需要设置： | ![Image=120x235](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/a17e285673e14e8e9babb0cd38dc3a57~tplv-goo7wpa0wc-topic.webp)  | \
| | | | \
...
| 变量聚合节点  | 聚合大模型节点的两个输出变量 answer 和 type。每个分组只能输出一个变量，所以我们需要设置两个分组。  | ![Image=158x294](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/658f690c4e5343f1a752a0fa6721c691~tplv-goo7wpa0wc-topic.webp)  |
| 结束节点  | 选择返回文本模式，并设置输出变量和回答内容，透传大模型节点生成的答案即可。 | ![Image=188x218](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/12e01f2989ea441c8678b1442f244b1c~tplv-goo7wpa0wc-topic.webp)  | \
| | | | \
