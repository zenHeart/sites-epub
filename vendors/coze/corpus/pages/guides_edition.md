...
<tr>
<th rowspan="2">
<p><strong>套餐类型</strong></p>
</th>
<th colspan="5">
<p><strong>个人版</strong></p>
</th>
<th colspan="3">
<p><strong>团队版</strong></p>
</th>
<th colspan="2">
...
<li>企业版：积分为 0 后<strong>扣除账户现金余额</strong>。</li>
</ul>
</blockquote>
<p>各个套餐的权益对比，请参考<a href="https://code.coze.cn/subscription-paywall?surl_token=FJvCs&amp;zlink_code=FFKdE&amp;utm_medium=docs&amp;utm_source=docs&amp;utm_content=landingpage&amp;utm_id=&amp;utm_campaign=&amp;utm_term=docs&amp;utm_source_platform=" target="_blank">版本权益</a>。</p>
<h2 id="1c6c6cf4" tabindex="-1"><strong>权益介绍</strong></h2>
<p>购买对应套餐后，可获得相应的扣子权益，核心权益介绍如下表所示。</p>
<!-- @cols-width: 120,259,491 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 120px;" /><col style="width: 259px;" /><col style="width: 491px;" /></colgroup><thead>
<tr>
<th colspan="2">
...
<td>接入自定义模型</td>
<td>你可以接入自己的模型 API，包括自行部署的模型、第三方在线模型等。接入后，你的扣子 Agent 就可以使用自己的模型服务。更多信息，请参考<a href="/cozespace/agent_management#a7d8be25" target="_blank">接入自定义模型</a>。</td>
</tr>
<tr>
<td>
<p>视频创作：精选模型使用</p>
...
<td>
<p>扣子内置了 Seedance 模型，通过对话就能完成从构思到视频生成的全过程。更多信息，请参考<a href="https://docs.coze.cn/cozespace/video" target="_blank">视频制作</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>扣子内置了多模态音视频生成大模型 Seedance 2.5，通过对话就能完成从构思到视频生成的全过程。更多信息，请参考<a href="https://docs.coze.cn/cozespace/video" target="_blank">视频制作</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>可以提前体验尚未正式接入的新模型。</p>
</td>
</tr>
<tr>
<td rowspan="4">扣子-云设备</td>
<td>积分兑换云手机</td>
<td>为 Agent 提供云手机环境，通过对话下达指令，Agent 可像人类一样操作设备完成任务。更多信息，请参考<a href="/cozespace/device" target="_blank">云设备</a>。</td>
</tr>
<tr>
<td>
<p>积分兑换云电脑</p>
...
<td>
<p>为 Agent 提供云电脑环境，通过对话下达指令，Agent 可像人类一样操作设备完成任务。更多信息，请参考<a href="/cozespace/device" target="_blank">云设备</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>当云设备的 CPU、内存或系统盘使用率较高时，可以扩容云设备。更多信息，请参考<a href="/cozespace/device#3cf622ba" target="_blank">扩容云设备</a>。</p>
</td>
</tr>
<tr>
<td>
...
<tr>
<td rowspan="8">扣子-Agent</td>
<td>创建云端Agent/职业模板</td>
<td>支持基于多种职业模板创建扣子 Agent，同时支持基于 Claude Code、Codex CLI、OpenClaw 框架创建云端Agent。更多信息，请参考<a href="/cozespace/local_agent" target="_blank">本地 Agent</a>、<a href="/cozespace/cloud_agent" target="_blank">云端 Agent</a>。</td>
</tr>
<tr>
<td>
<p>连接本地Agent</p>
...
<td>
<p>支持将本地已部署的 Agent 接入扣子，包括 Claude Code、Codex CLI、基于 OpenClaw 开源框架的各类 Agent。更多信息，请参考<a href="/cozespace/local_agent" target="_blank">本地 Agent</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持围绕特定话题、目标或任务创建项目，并且可以邀请成员和多个 Agent 共同参与，一起补充信息、分配任务、确认结果并沉淀产出。更多信息，请参考<a href="/cozespace/collaboration" target="_blank">项目与协作</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>为你的扣子 Agent 分配一个专属邮箱地址，只需简单对话指令，就能自动收发邮件、注册并登录各类平台和第三方服务，全程高效自动化。更多信息，请参考<a href="/cozespace/mail" target="_blank">邮箱</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持对上传素材及扣子生成的产物进行有序归档管理。更多信息，请参考<a href="/cozespace/files" target="_blank">文件</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>在复制或导出 AI 生成的图片、视频时，可移除“AI 生成”文本水印与“扣子”品牌水印。更多信息，请参考<a href="/cozespace/remove_image_watermark" target="_blank">图片去水印</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>视频生成任务按队列顺序执行，不同套餐享有不同的排队优先级。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持将扣子生成的视频导出为剪映工程文件，便于后续二次编辑。更多信息，请参考<a href="/cozespace/video#968d4088" target="_blank">步骤六：导出视频</a>。</p>
</td>
</tr>
<tr>
<td>扣子CLI</td>
<td>扣子CLI</td>
<td>专为 Agent 设计的命令行工具，支持在后台完成网页端的各类操作。更多信息，请参考<a href="/developer_guides/coze_cli" target="_blank">Coze CLI 介绍</a>。</td>
</tr>
<tr>
...
<td>
<p>扣子编程会为每个部署项目自动分配以 <code>.coze.site</code> 为后缀的默认域名，你可以按需修改域名前缀。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持绑定第三方或火山引擎购买的自定义域名，并配置免费 SSL 证书。更多信息，请参考<a href="/guides/configure_custom_domain" target="_blank">配置自定义域名</a>。</p>
</td>
</tr>
<tr>
<td>
<p>支持开启 DDoS 防护（网页类型项目）</p>
</td>
<td>
<p>自动识别并拦截异常高频请求与慢速攻击，防止服务不可用或积分被恶意消耗。更多信息，请参考<a href="/guides/usage_management#d6e2f8d3" target="_blank">DDos 防护</a>。</p>
</td>
</tr>
<tr>
<td rowspan="3">数据安全与合规</td>
<td>会话数据加密：自定义加密密钥</td>
<td>支持使用火山引擎 KMS 密钥对会话数据进行存储加密，从而满足企业对数据安全的高要求。更多信息，请参考<a href="/guides/data_encryption_management" target="_blank">数据加密管理</a>。</td>
</tr>
<tr>
<td>
<p>VPC私网连接（OpenAPI&amp;插件）</p>
</td>
<td>
<p>支持将火山引擎私网服务封装为私网插件并安全访问，同时支持从火山私网环境通过终端节点域名调用扣子编程 OpenAPI。更多信息，请参考<a href="/guides/private_link" target="_blank">管理私网连接</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>自动识别并过滤用户与智能体对话过程中的涉黄、涉敏、诈骗等各类风险，确保内容合规。更多信息，请参考<a href="/guides/conversation_content_security_policy" target="_blank">对话内容安全策略</a>。</p>
</td>
</tr>
<tr>
<td rowspan="6">企业管理与服务</td>
<td>SSO</td>
<td>通过单点登录（SSO），企业成员可以使用内部已有的用户账号登录扣子编程。更多信息，请参考<a href="/guides/configure_sso" target="_blank">配置单点登录（SSO）</a>。</td>
</tr>
<tr>
<td>
<p>企业技能商店</p>
...
<td>
<p>企业技能商店是专为企业打造的内部技能分发中心。对于涉及核心业务逻辑或仅限内部使用的技能，上架到企业市场既能保护知识产权，又能提升内部协作效率。更多信息，请参考<a href="/cozespace/publish_skill#cf4ec0c9" target="_blank">将技能上架到企业市场</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持查看终端用户的用量数据、用量明细、管理设备配额以及查看设备流水详情。更多信息，请参考<a href="/dev_how_to_guides/device_usage" target="_blank">终端用户用量查询和配额管控</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>组织是企业下的虚拟分组，扣子支持按部门或项目维度创建组织，实现多业务部门的独立运作与统一管理。更多信息，请参考<a href="/guides/manage_organization" target="_blank">创建组织</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持设置组织、空间、成员维度的积分额度限制。超额后对应范围内的成员将无法继续使用积分消耗类功能。更多信息，请参考<a href="/coze_pro/bills_and_usage#cfe19d09" target="_blank">设置积分额度限制</a>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>支持对企业成员的角色与操作权限进行统一管理。更多信息，请参考<a href="/guides/team_and_enterprise_overview#3669986e" target="_blank">成员与权限</a>。</p>
</td>
</tr>
</tbody>
</table>
</div><h2 id="b8784ae2" tabindex="-1"><strong>权益对比</strong></h2>
<p>各个订阅套餐的权益范围不同，具体说明如下。其中，✔️ 表示支持的功能，➖ 表示不支持的功能。</p>
<h3 id="6195257b" tabindex="-1">套餐说明</h3>
...
</div><h3 id="64a120a9" tabindex="-1">扣子权益</h3>
<!-- @cols-width: 161,174,104,104,104,104,112,125,125,125,128,128 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 161px;" /><col style="width: 174px;" /><col style="width: 104px;" /><col style="width: 104px;" /><col style="width: 104px;" /><col style="width: 104px;" /><col style="width: 112px;" /><col style="width: 125px;" /><col style="width: 125px;" /><col style="width: 125px;" /><col style="width: 128px;" /><col style="width: 128px;" /></colgroup><thead>
<tr>
<th colspan="2">
<p><strong>权益项</strong></p>
</th>
...
</div><h3 id="04a1973c" tabindex="-1">扣子 CLI</h3>
...
</div><h3 id="8e3b22b1" tabindex="-1">扣子编程</h3>
...
</div><h3 id="e4bd0beb" tabindex="-1">数据安全与合规</h3>
...
</div><h3 id="6901c972" tabindex="-1">企业管理与服务</h3>
...
</div><h2 id="75617e0a" tabindex="-1">客户服务</h2>
...
<h2 id="f657e30a" tabindex="-1">常见问题</h2>
<ul data-style="0">
<li><a href="/coze_pro/premium_package_faq#9551891d" target="_blank">如何选择套餐？</a></li>
<li><a href="/coze_pro/premium_package_faq#b73c0608" target="_blank">企业版支持哪些高级特性？</a></li>
<li><a href="/coze_pro/premium_package_faq#7e1d86d3" target="_blank">如何查看我的订阅套餐？ </a></li>
<li><a href="/coze_pro/premium_package_faq#44267631" target="_blank">付费套餐可以升级或降级吗？</a></li>
<li><a href="/coze_pro/premium_package_faq#aa914b12" target="_blank">如何设置自动续订套餐？</a></li>
<li><a href="/coze_pro/premium_package_faq#fd7f25e9" target="_blank">每个账号可以购买多个套餐吗？ </a></li>
<li><a href="/coze_pro/premium_package_faq#045a1ae7" target="_blank">订阅套餐可以退订吗？</a></li>
<li><a href="/coze_pro/premium_package_faq#62b91ffa" target="_blank">如何查看企业版的相关条款？</a></li>
<li><a href="/coze_pro/premium_package_faq#57c5b8fb" target="_blank">订阅套餐内的积分用完后可以额外购买吗？ </a></li>
</ul>
<h3 id="f54c0bd1" tabindex="-1"></h3>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/guides_vibe_coding_limit" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">配额与限制</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/guides_help_and_support" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">获取帮助</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="套餐类型" href="#d89cde10" data-href="#d89cde10">套餐类型</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="权益介绍" href="#1c6c6cf4" data-href="#1c6c6cf4">权益介绍</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="权益对比" href="#b8784ae2" data-href="#b8784ae2">权益对比</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="套餐说明" href="#6195257b" data-href="#6195257b">套餐说明</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="扣子权益" href="#64a120a9" data-href="#64a120a9">扣子权益</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="扣子 CLI" href="#04a1973c" data-href="#04a1973c">扣子 CLI</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="扣子编程" href="#8e3b22b1" data-href="#8e3b22b1">扣子编程</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="数据安全与合规" href="#e4bd0beb" data-href="#e4bd0beb">数据安全与合规</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="企业管理与服务" href="#6901c972" data-href="#6901c972">企业管理与服务</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="客户服务" href="#75617e0a" data-href="#75617e0a">客户服务</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="常见问题" href="#f657e30a" data-href="#f657e30a">常见问题</a></div></div></div></div></div></div></div></div>
</body></html>