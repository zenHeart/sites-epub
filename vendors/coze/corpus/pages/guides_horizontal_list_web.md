...
1. 为横向列表组件绑定一个 Array 类型的数据源。
   ...
   **绑定数据源**
   ...
   ![Image=293x252](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/fadfcee4a9a54029a448cb147b6d6afc~tplv-goo7wpa0wc-image.image)
   
   @col 33
   **配置事件**
   
   ![Image=370x583](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/3a25bc6508b34d05b59966473a2672ba~tplv-goo7wpa0wc-image.image)
   ::::
...
![Image=298x163](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/15cd6df4a520435ca185e9b02472321e~tplv-goo7wpa0wc-image.image)
...
![Image=522x203](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/02ef523f51f8426dbab77223a0dcc9ef~tplv-goo7wpa0wc-image.image)
...
1. 创建工作流。
   ...
   ![Image=634x166](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/08c43a6da8ce4663be574d1f0a3dcf5f~tplv-goo7wpa0wc-image.image)
2. 绑定数据。
   ...
   2. 为横向列表组件添加**调用工作流**事件。
      ...
      ![Image=330x510](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/648baa98ad7444adbeebcde6a83fda4d~tplv-goo7wpa0wc-image.image)
...
3. 预览效果。
   以横向列表形式展示新闻内容。
   ![Image=489x269](https://p9-arcosite.byteimg.com/tos-cn-i-goo7wpa0wc/d86c39538ee6458ba8e7e1258ec64674~tplv-goo7wpa0wc-image.image)
