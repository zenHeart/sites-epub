...
<td>
<p>配置是否显示代码编辑组件的标签，标签可以为代码编辑组件提供文字描述，使用户能够更直观地理解代码编辑组件的状态或功能。<br>
默认关闭显示标签的开关。</p>
</td>
</tr>
<tr>
...
<td>
<p>配置代码编辑组件的标签内容，支持配置静态内容和动态绑定数据，详情请参见<a href="/guides/set_content_parameters" target="_blank">设置组件内容参数</a>。<br>
仅打开了代码编辑组件的标签开关时，才支持此配置项。默认标签内容为<strong>请输入代码</strong>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码编辑是否为必填项。<br>
例如在表单填报场景中，当开启“是否必填”开关时，代码编辑会被标记为必填项。用户在提交表单之前必须输入代码内容，否则表单将不允许提交。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>选择代码语言，支持<code>JSON</code>、<code>Javascript</code>、<code>Python</code>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置标签与代码输入框的布局方式，支持上下布局和左右布局。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>可控制代码编辑组件在什么情况下展示禁用状态。</p>
<ul data-style="0">
<li>表达式的结果为 true：代码编辑组件呈禁用态。</li>
<li>表达式的结果为 false：代码编辑组件呈可用态。</li>
</ul>
...
<td>
<p>可控制代码编辑组件在什么情况下展示加载状态。</p>
<ul data-style="0">
<li>表达式的结果为 true：代码编辑组件呈加载态。</li>
<li>表达式的结果为 false：代码编辑组件呈可用态。</li>
</ul>
...
</div><h3 id="0a0bb99e" tabindex="-1">位置设置</h3>
<p>代码编辑组件提供三种位置类型选项，以灵活配置组件在界面中的位置。</p>
<ul data-style="0">
<li>相对定位：堆叠布局下，元素自动向下或向右排列。</li>
<li>绝对定位：页面滚动时，绝对定位的元素会随页面一起滚动。</li>
<li>固定定位：页面滚动时，固定定位的元素会保持固定位置不变。</li>
</ul>
<h3 id="a166446e" tabindex="-1">尺寸设置</h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置代码编辑组件的尺寸限制，支持配置最大高度、最小高度、最大宽度、最小宽度。<br>
合理设置尺寸限制参数可以确保组件在不同屏幕尺寸下保持布局的稳定性和一致性，避免因屏幕尺寸差异而导致的布局问题。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="6c5bee0e" tabindex="-1"><strong>样式设置</strong></h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置代码编辑组件背景的圆角，支持单独设置四个角的圆角。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码编辑组件背景的内边距，可以单独设置四个方向的内边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码编辑组件背景的外边距，可以单独设置四个方向的外边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置代码编辑组件背景的阴影样式，增强组件的立体感。支持如下设置方式：</p>
<ul data-style="0">
...
<td>
<p>配置代码编辑组件的模糊效果，数值越大，模糊效果越明显。支持设置图层模糊和背景模糊。</p>
<ul data-style="0">
...
</div><h3 id="647219b2" tabindex="-1">变换设置</h3>
<p>丰富界面视觉效果的参数。</p>
<!-- @cols-width: 145,704 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置代码编辑组件在水平和垂直方向上的倾斜角度。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="e2ce4665" tabindex="-1">状态设置</h3>
<p>控制代码编辑组件悬浮态、点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 143,696 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置代码编辑组件的悬浮态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：当鼠标悬浮到代码编辑组件上时，代码编辑组件的样式变化情况。包括背景色、边框等。详细说明，请参考<a href="/guides/code_editor_web#6c5bee0e" target="_blank">样式设置</a>。</li>
<li>变换效果：当鼠标悬浮到代码编辑组件上时，代码编辑组件的动态变化情况。包括缩放、旋转等。详细说明，请参考<a href="/guides/code_editor_web#647219b2" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置代码编辑组件悬浮态的动画效果。
<ul data-style="1">
...
<td>
<p>配置代码编辑组件的点击态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：点击代码编辑组件时，代码编辑组件的样式变化情况。详细说明，请参考<a href="/guides/code_editor_web#6c5bee0e" target="_blank">样式设置</a>。</li>
<li>变换效果：点击代码编辑组件时，代码编辑组件的动态变化情况。详细说明，请参考<a href="/guides/code_editor_web#647219b2" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置代码编辑组件点击态的动画效果。
<ul data-style="1">
<li>动画效果：支持设置为缓入缓出、缓入、缓出、线性等动画。</li>
<li>持续时间：设置动画的持续时间，单位为毫秒。</li>
<li>延迟时间：设置动画延迟出现的时间，单位为毫秒。</li>
...
<td>
<p>设置代码编辑组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="0c2814c7" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制代码编辑组件隐藏或显示的参数，支持在特定条件下隐藏代码编辑组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制代码编辑组件的可见性。<br>
例如可以通过开关组件控制代码编辑组件的可见性。开关组件 ID 为 <code>Switch 1</code>，当你将代码编辑组件的<strong>可见性</strong>设置为<code>{{ Switch1.value}}</code>后，开关打开时，<code>{{ Switch1.value}}</code>值为 true，代码编辑组件将被隐藏。</li>
</ul>
<h2 id="8d93f6e8" tabindex="-1">事件设置</h2>
<p>通过配置代码编辑组件的事件，可以为代码编辑组件添加丰富的交互功能，以增强用户体验和界面的互动性。</p>
<!-- @cols-width: 148,709 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
</div></div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/guides_drop-down_selection_web" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">下拉选择</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/guides_numeric_Input_web" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">数字输入</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="属性设置" href="#d6df8334" data-href="#d6df8334">属性设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="常用设置" href="#d14814f2" data-href="#d14814f2">常用设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="位置设置" href="#0a0bb99e" data-href="#0a0bb99e">位置设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="尺寸设置" href="#a166446e" data-href="#a166446e">尺寸设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="样式设置" href="#6c5bee0e" data-href="#6c5bee0e">样式设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="变换设置" href="#647219b2" data-href="#647219b2">变换设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="状态设置" href="#e2ce4665" data-href="#e2ce4665">状态设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="可见性设置" href="#0c2814c7" data-href="#0c2814c7">可见性设置</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="事件设置" href="#8d93f6e8" data-href="#8d93f6e8">事件设置</a></div></div></div></div></div></div></div></div>
</body></html>