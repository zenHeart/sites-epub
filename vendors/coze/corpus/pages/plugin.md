...
<tr>
<td>技能</td>
<td>为 Agent 提供完成特定任务所需的步骤、经验和判断。</td>
</tr>
<tr>
<td>MCP</td>
<td>将 Agent 与外部工具、数据或服务连接起来。</td>
</tr>
<tr>
<td>Panel</td>
<td>为 Agent 提供可视化工作界面，用于展示和操作画布、看板、表格、预览等内容。</td>
</tr>
</tbody>
</table>
</div><p>其中，Panel 会显示在对话区右侧。它可以是一块自由画布、一个数据看板、一条音视频时间线，也可以是其他适合当前任务的界面。你可以直接查看、选择或修改其中的内容，相关操作会成为 Agent 继续工作的上下文。对话继续时，Panel 仍会保留，方便你和 Agent 围绕同一份内容持续调整。</p>
<p>插件也可以让 Agent 进入你熟悉的软件。例如，连接 WPS Office 插件后，你可以让 Agent 在 WPS 中制作或修改文档；使用设计类插件时，则可以在 Panel 中直接选择画布里的对象，再让 Agent 根据你的选择继续修改。</p>
<p>不同插件包含的能力和使用方式不同，具体以插件详情页为准。</p>
<h2 id="使用限制" tabindex="-1">使用限制</h2>
<p>不同插件的连接方式、可用客户端和套餐要求可能不同。添加插件前，请留意以下限制：</p>
<ul data-style="0">
<li>部分插件需要连接第三方账号或本地软件。完成一次连接后，同一账号下的其他 Agent 添加该插件时，可以直接复用连接，无需再次授权或配置。</li>
<li>需要连接本地设备的插件应在扣子桌面端完成连接。网页端和移动端可以查看连接状态，但不能建立本地设备连接。</li>
<li>插件商店中的专享插件仅对符合权益要求的账号开放。个人高阶版、旗舰版和尊享版，以及团队版、企业版的全部套餐均可使用专享插件。</li>
</ul>
<h2 id="发现插件" tabindex="-1">发现插件</h2>
<h3 id="插件商店" tabindex="-1">插件商店</h3>
<p>插件商店集中展示扣子提供的各类插件。你可以先浏览或搜索插件，再打开详情页了解它能完成的任务以及使用要求。</p>
<ol data-style="0">
<li>在扣子左侧导航栏进入<strong>扩展</strong>，然后选择<strong>插件</strong>。</li>
<li>按分类浏览插件，或在搜索框中输入插件名称、工具名称或需要完成的任务。</li>
<li>选择插件卡片，打开插件详情。</li>
<li>查看插件说明、适用场景及其包含的技能、MCP 和 Panel。</li>
<li>查看插件是否需要第三方授权、本地设备连接或专享权益。<br>
插件卡片和详情页会展示当前账号下的连接状态及权益标签。如果插件名称旁显示钻石图标，表示当前账号暂不包含该插件权益；如果显示<strong>专享权益</strong>标签，表示当前账号可以使用。</li>
</ol>
<h3 id="热门插件推荐" tabindex="-1">热门插件推荐</h3>
<p>插件商店覆盖设计、内容生产、开发、研究、金融和经营等场景。你可以根据任务选择合适的插件。</p>
<!-- @cols-width: 140,1000,749 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 1000px;" /><col style="width: 749px;" /></colgroup><thead>
<tr>
<th><strong>插件或场景</strong></th>
<th><strong>可以完成的任务</strong></th>
<th>示例指令</th>
</tr>
</thead>
<tbody>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7675685482180689920" target="_blank">视频创作</a></td>
<td>覆盖视频生成、脚本分镜、素材组织、轨道剪辑、动态效果与成片渲染，帮助你从创意快速完成视频创作。</td>
<td>根据 xx 主题生成视频脚本、分镜方案和完整视频，时长大约 15 秒。</td>
</tr>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7676005249643053066" target="_blank">编程开发</a></td>
<td>一款面向 Web、小程序与 App 多端开发的编程插件，提供从项目创建、编码实现到实时预览验证的一站式开发流程，助你高效完成应用从 0 到 1 的构建。</td>
<td>帮我做一个记账 App，支持账号登录、支出自动分类，可以生成消费分析报告。</td>
</tr>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7676792002733965362" target="_blank">飞书</a></td>
<td>连接到飞书，让Agent进入你的飞书工作流程。</td>
<td>帮我创建一个飞书日程，今天晚上 5 点开周会。</td>
</tr>
<tr>
<td>设计画布</td>
<td>制作海报、整理参考图或设计产品页面，并在 Panel 中继续选择和修改内容。</td>
<td>为这个活动制作一张竖版宣传海报。</td>
</tr>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7677806573430833152" target="_blank">网页游戏开发</a></td>
<td>创建网页小游戏，并在 Panel 中直接试玩和继续修改。</td>
<td>创建一个带冲刺技能的平台跳跃游戏。</td>
</tr>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7676019890331107370" target="_blank">持仓神器</a></td>
<td>查看行情、持仓、报告等信息，持续跟踪关注对象。</td>
<td>分析我的持仓表现，并总结今天需要关注的变化。</td>
</tr>
<tr>
<td><a href="https://www.coze.cn/skills?tab=space&amp;capability=plugin&amp;plugin_share_pid=7678624493727662090" target="_blank">WPS Office</a></td>
<td>让 Agent 在获得授权后操作 WPS，协助制作或修改文档、表格和演示文稿。</td>
<td>用 WPS 制作一份项目复盘演示文稿。</td>
</tr>
</tbody>
</table>
</div><h2 id="添加插件" tabindex="-1">添加插件</h2>
<p>找到需要的插件后，将它添加给目标 Agent。根据插件类型，你可能需要直接添加、完成第三方授权，或先连接本地设备。</p>
<h3 id="添加普通插件" tabindex="-1">添加普通插件</h3>
<p>普通插件无需额外授权或连接，可以直接添加给 Agent。</p>
<ol data-style="0">
<li>在插件列表中选择目标插件右侧的<strong>添加</strong>，或进入详情页后选择<strong>添加</strong>。</li>
<li>在 Agent 列表中找到需要使用该插件的 Agent。</li>
<li>选择 Agent 右侧的<strong>添加</strong>。</li>
<li>添加成功后，选择<strong>使用</strong>进入该 Agent 的对话。</li>
</ol>
<p>首次为 Agent 添加插件时，系统会同时将插件安装到 Agent 所属账号。后续可以将已安装的插件添加给同一账号下的其他 Agent，无需重新安装。</p>
<h3 id="添加需要第三方授权的插件" tabindex="-1">添加需要第三方授权的插件</h3>
<p>部分插件需要访问第三方账号或服务。添加此类插件前，请根据页面提示完成授权。</p>
<ol data-style="0">
<li>选择插件卡片上的<strong>连接</strong>。</li>
<li>在确认窗口中选择<strong>去授权</strong>。</li>
<li>在第三方页面查看授权范围并完成授权。</li>
<li>返回扣子，确认插件显示为已连接。</li>
<li>选择目标 Agent，并完成添加。</li>
</ol>
<p>仅向可信的服务提供方授权。授权前请核对需要访问的数据和操作权限。如果连接凭证失效，可以在插件详情页重新连接。</p>
<h3 id="添加需要本地设备的插件" tabindex="-1">添加需要本地设备的插件</h3>
<p>WPS Office 等插件需要连接本地软件。请先安装并打开扣子桌面端，再完成以下操作：</p>
<ol data-style="0">
<li>在扣子桌面端找到目标插件并选择<strong>添加</strong>。</li>
<li>页面提示需要连接本地设备时，选择<strong>连接</strong>。</li>
<li>根据提示打开对应的本地软件，等待连接完成。</li>
<li>插件显示为已连接后，将其添加给目标 Agent。</li>
</ol>
<p>连接完成后，进入已添加该插件的 Agent 对话，直接说明要完成的任务。例如，连接 WPS Office 后，你可以让 Agent 打开 WPS 并制作演示文稿。使用过程中，应保持扣子桌面端、本地软件和插件连接正常。</p>
<p>如果你正在使用网页端或移动端，页面会提示前往或下载扣子桌面端。桌面端连接完成后，网页端和移动端会同步展示连接状态。</p>
<h3 id="hVBP5c1Zh" tabindex="-1">添加专享插件</h3>
<p>专享插件的使用权益由 Agent 所属账号决定，而不是由当前协作者的个人套餐决定。</p>
<p>当前账号包含权益时，可以按照普通插件的步骤添加。当前账号不包含权益时，尝试添加或使用插件会显示升级提示；你可以选择<strong>查看套餐详情</strong>，了解支持该插件的套餐。</p>
<h2 id="hN3tUQHSs" tabindex="-1">使用插件</h2>
<p>将插件添加给 Agent 后，你可以直接描述任务，让 Agent 自动选择合适的插件能力；也可以在指令中明确指定插件。</p>
<h3 id="ho2QAASYS" tabindex="-1">让 Agent 自动调用插件</h3>
<p>如果不需要指定插件，直接在目标 Agent 的对话中描述要完成的任务。例如：</p>

<div style="position: relative">
	<pre><code class="hljs language-Plain">整理我今天收到的项目资料，并生成一份重点事项清单。
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="整理我今天收到的项目资料，并生成一份重点事项清单。" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
...
<p>Agent 会根据任务和当前已启用的插件选择可用能力。为了提高调用准确性，建议在指令中说明目标、需要处理的对象和期望的结果形式。</p>
<h3 id="hun18kcH5" tabindex="-1">主动指定插件</h3>
<p>如果希望 Agent 使用某个插件，可以从输入框的能力入口选择，也可以在指令中直接写明插件名称。</p>
<p>在对话输入框中通过 <code>+</code> 或 <code>@</code>打开能力列表，选择需要使用的插件或插件能力，然后输入任务要求并发送。例如：</p>

<div style="position: relative">
	<pre><code class="hljs language-Plain">使用 WPS Office 插件，根据这份项目复盘内容制作一份演示文稿。
</code></pre>

	<button class="markdown-it-code-copy topic-code-block__copy markdown-it-code-copy--custom" data-clipboard-text="使用 WPS Office 插件，根据这份项目复盘内容制作一份演示文稿。" style="position: absolute; top: 7.5px; right: 6px; cursor: pointer; outline: none;" title="Copy">
		<span style="font-size: 21px; opacity: 0.4;" class="topic-code-block__copy-icon"><svg viewBox="0 0 16 16" aria-hidden="true" focusable="false"><path d="M5.5 2A1.5 1.5 0 0 0 4 3.5v7A1.5 1.5 0 0 0 5.5 12h5A1.5 1.5 0 0 0 12 10.5v-7A1.5 1.5 0 0 0 10.5 2zM5 3.5a.5.5 0 0 1 .5-.5h5a.5.5 0 0 1 .5.5v7a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5z"></path><path d="M2.5 5A1.5 1.5 0 0 0 1 6.5v6A1.5 1.5 0 0 0 2.5 14h5a1.5 1.5 0 0 0 1.5-1.5V12h-1v.5a.5.5 0 0 1-.5.5h-5a.5.5 0 0 1-.5-.5v-6a.5.5 0 0 1 .5-.5H3V5z"></path></svg></span>
	</button>
</div>
<h3 id="hbTi7XNAF" tabindex="-1">使用 Panel</h3>
<p>部分插件会在对话区右侧打开 Panel，方便你持续查看任务状态和结果，并直接参与修改。</p>
<p>你可以在 Panel 中查看画布、看板、表格或预览，也可以直接选择、移动或修改内容。Agent 可以根据你在 Panel 中的选择和操作继续执行任务。例如，你可以在设计画布中选中一张图片，然后让 Agent 只修改这张图片。</p>
<p>部分 Panel 的更多菜单还提供<strong>刷新</strong>或<strong>重置数据</strong>。重置会清理当前 Agent 中该插件产生的数据和定时任务，但不会移除插件。</p>
<h2 id="hKcKD0np5" tabindex="-1">管理已安装的插件</h2>
<p>进入<strong>扩展 &gt; 我的插件</strong>，可以查看当前账号已经安装或创建的插件，以及每个插件已添加的 Agent 数量。你可以在这里调整 Agent 的使用关系、修复连接，或移除不再使用的插件。</p>
<h3 id="hcoju7J6o" tabindex="-1">管理 Agent 插件</h3>
<p>需要让其他 Agent 使用插件，或停止某个 Agent 使用插件时，可以管理 Agent 插件。</p>
<p>选择插件对应的 Agent 数量，查看已添加和未添加该插件的 Agent，然后执行以下操作：</p>
<ul data-style="0">
<li>选择<strong>添加</strong>，将插件添加给其他 Agent。</li>
<li>选择<strong>使用</strong>，进入已添加该插件的 Agent 对话。</li>
<li>选择<strong>移除</strong>，仅从当前 Agent 中移除插件，不影响其他 Agent。</li>
<li>在 Agent 设置的扩展能力中启用或停用插件。该操作只影响当前 Agent，不会删除账号中的插件或断开连接。</li>
</ul>
<p>从最后一个 Agent 中移除插件后，插件仍会保留在<strong>我的插件</strong>中，并显示已添加到 0 个 Agent。</p>
<h3 id="hYVh6E9iO" tabindex="-1">管理插件连接</h3>
<p>插件提示授权已失效、本地设备离线或无法调用相关能力时，可以在插件详情页重新连接。如果暂时不希望插件继续访问第三方账号或本地设备，可以主动断开连接。</p>
<p>断开连接后，依赖该连接的插件将不能继续执行相关操作，但仍会保留在已添加它的 Agent 中。重新连接成功后，可以直接回到这些 Agent 继续使用，无需再次添加插件。</p>
<h3 id="hjcweDCEp" tabindex="-1">从当前账号移除插件</h3>
<p>如果当前账号不再需要某个从商店安装的插件，可以将它从账号中移除。</p>
<ol data-style="0">
<li>进入<strong>扩展 &gt; 我的插件</strong>，找到目标插件。</li>
<li>打开插件的更多操作，选择<strong>删除插件</strong>。</li>
<li>查看影响范围，然后确认删除。</li>
</ol>
<p>删除后，系统会同时从当前账号下所有 Agent 中移除该插件。</p>
<h2 id="hRQT2FtP1" tabindex="-1">常见问题</h2>
<h3 id="hAOWoGWrT" tabindex="-1">为什么插件已经添加，但 Agent 仍然不能使用？</h3>
<p>请依次检查以下状态：</p>
<ol data-style="0">
<li>插件是否已添加给当前 Agent，并处于启用状态。</li>
<li>需要授权或连接的插件是否显示为已连接。</li>
<li>本地设备及对应软件是否在线。</li>
<li>当前 Agent 所属账号是否包含专享插件权益。</li>
<li>第三方服务是否可用，授权范围是否满足当前操作。</li>
</ol>
<p>如果页面显示连接已失效，请先重新连接，再重新执行任务。</p>
<h3 id="hjl6AR3Eq" tabindex="-1">为什么网页端或移动端不能连接本地设备？</h3>
<p>本地设备插件需要识别并连接当前电脑上的软件，因此只能在扣子桌面端建立连接。连接后，只有在扣子桌面端、本地软件和插件保持正常连接的情况下，Agent 才能操作该软件。网页端和移动端可以同步查看连接状态。</p>
<h3 id="hiuvuFYFF" tabindex="-1">扣子套餐到期后，专享插件还能用吗？</h3>
<p>不能继续使用需要专享权益的插件能力。插件仍会保留在管理列表中，已生成的历史内容不会被删除，已有 Panel 也可以继续查看。恢复相应权益后，可以继续使用插件，无需重新安装。</p>
<h3 id="hNXyhlUps" tabindex="-1">为什么插件要求重新连接？</h3>
<p>第三方授权过期、本地设备离线或插件连接配置发生变化时，插件可能要求重新连接。进入插件详情页，按照提示重新授权或连接即可。连接恢复后，可以直接回到原来的 Agent 继续使用插件，不用重新添加。</p>
</div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/cozespace_local_device" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">本地设备</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/cozespace_using_skills" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">使用技能</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="什么是插件" href="#hC0ME5yRE" data-href="#hC0ME5yRE">什么是插件</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="使用限制" href="#使用限制" data-href="#使用限制">使用限制</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="发现插件" href="#发现插件" data-href="#发现插件">发现插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="插件商店" href="#插件商店" data-href="#插件商店">插件商店</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="热门插件推荐" href="#热门插件推荐" data-href="#热门插件推荐">热门插件推荐</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="添加插件" href="#添加插件" data-href="#添加插件">添加插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="添加普通插件" href="#添加普通插件" data-href="#添加普通插件">添加普通插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="添加需要第三方授权的插件" href="#添加需要第三方授权的插件" data-href="#添加需要第三方授权的插件">添加需要第三方授权的插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="添加需要本地设备的插件" href="#添加需要本地设备的插件" data-href="#添加需要本地设备的插件">添加需要本地设备的插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="添加专享插件" href="#hVBP5c1Zh" data-href="#hVBP5c1Zh">添加专享插件</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="使用插件" href="#hN3tUQHSs" data-href="#hN3tUQHSs">使用插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="让 Agent 自动调用插件" href="#ho2QAASYS" data-href="#ho2QAASYS">让 Agent 自动调用插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="主动指定插件" href="#hun18kcH5" data-href="#hun18kcH5">主动指定插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="使用 Panel" href="#hbTi7XNAF" data-href="#hbTi7XNAF">使用 Panel</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="管理已安装的插件" href="#hKcKD0np5" data-href="#hKcKD0np5">管理已安装的插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="管理 Agent 插件" href="#hcoju7J6o" data-href="#hcoju7J6o">管理 Agent 插件</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="管理插件连接" href="#hYVh6E9iO" data-href="#hYVh6E9iO">管理插件连接</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="从当前账号移除插件" href="#hjcweDCEp" data-href="#hjcweDCEp">从当前账号移除插件</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="常见问题" href="#hRQT2FtP1" data-href="#hRQT2FtP1">常见问题</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="为什么插件已经添加，但 Agent 仍然不能使用？" href="#hAOWoGWrT" data-href="#hAOWoGWrT">为什么插件已经添加，但 Agent 仍然不能使用？</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="为什么网页端或移动端不能连接本地设备？" href="#hjl6AR3Eq" data-href="#hjl6AR3Eq">为什么网页端或移动端不能连接本地设备？</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="扣子套餐到期后，专享插件还能用吗？" href="#hiuvuFYFF" data-href="#hiuvuFYFF">扣子套餐到期后，专享插件还能用吗？</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="为什么插件要求重新连接？" href="#hNXyhlUps" data-href="#hNXyhlUps">为什么插件要求重新连接？</a></div></div></div></div></div></div></div></div>
</body></html>