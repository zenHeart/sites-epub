...
<td>
<p>配置是否显示开关组件的标签，标签可以为开关组件提供文字描述，使用户能够更直观地理解开关的状态或功能。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置开关组件的标签内容，支持配置静态内容和动态绑定数据，详情请参见<a href="/guides/set_content_parameters" target="_blank">设置组件内容参数</a>。<br>
仅打开了标签设置开关时，才支持此配置项。默认标签内容为<strong>请设置</strong>。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置标签与开关按钮的布局方式，支持上下布局和左右布局。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>以百分比方式配置开关组件的标签的宽度。<br>
仅组件布局方式为左右布局时，支持此配置项。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>可控制开关组件在什么情况下展示禁用状态。</p>
<ul data-style="0">
<li>表达式的结果为 true：开关组件呈禁用态。</li>
<li>表达式的结果为 false：开关组件呈可用态。</li>
</ul>
...
<td>
<p>可控制开关组件在什么情况下展示加载状态。</p>
<ul data-style="0">
<li>表达式的结果为 true：开关组件呈加载态。</li>
<li>表达式的结果为 false：开关组件呈可用态。</li>
</ul>
...
<p>开关组件提供三种位置类型选项，以灵活配置组件在界面中的位置。</p>
<ul data-style="0">
...
<td>
<p>配置开关组件的尺寸限制，支持配置最大高度、最小高度、最大宽度、最小宽度。<br>
...
<td>
<p>配置开关组件背景的内边距，可以单独设置四个方向的内边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置开关组件背景的外边距，可以单独设置四个方向的外边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置开关组件背景的阴影样式，增强组件的立体感。支持如下设置方式：</p>
<ul data-style="0">
...
<td>
<p>配置开关组件的模糊效果，数值越大，模糊效果越明显。支持设置图层模糊和背景模糊。</p>
<ul data-style="0">
...
<td>
<p>配置开关组件在水平和垂直方向上的倾斜角度。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="042677ce" tabindex="-1">状态设置</h3>
<p>控制开关组件悬浮态、点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 143,696 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置开关组件的悬浮态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：当鼠标悬浮到开关组件上时，开关组件的样式变化情况。包括背景色、边框等。详细说明，请参考<a href="/guides/switch_web#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：当鼠标悬浮到开关组件上时，开关组件的动态变化情况。包括缩放、旋转等。详细说明，请参考<a href="/guides/switch_web#5e1afc91" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置开关组件悬浮态的动画效果。
<ul data-style="1">
...
<td>
<p>配置开关组件的点击态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：点击开关组件时，开关组件的样式变化情况。详细说明，请参考<a href="/guides/switch_web#0947adab" target="_blank">样式设置</a>。</li>
<li>变换效果：点击开关组件时，开关组件的动态变化情况。详细说明，请参考<a href="/guides/switch_web#5e1afc91" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置开关组件点击态的动画效果。
<ul data-style="1">
<li>动画效果：支持设置为缓入缓出、缓入、缓出、线性等动画。</li>
<li>持续时间：设置动画的持续时间，单位为毫秒。</li>
<li>延迟时间：设置动画延迟出现的时间，单位为毫秒。</li>
...
<td>
<p>设置开关组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="d41b9d99" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制开关组件隐藏或显示的参数，支持在特定条件下隐藏开关组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制开关组件的可见性。<br>
例如可以通过文本输入组件控制开关组件的可见性。文本输入组件 ID 为 <code>Textarea1</code>，当你将开关组件的<strong>可见性</strong>设置为<code>{{ Textarea1.value}}</code>后，在文本输入组件中输入文本时，<code>{{ Textarea1.value}}</code>值为 true，开关组件将被隐藏。</li>
</ul>
<h2 id="23196d0b" tabindex="-1">事件设置</h2>
<p>通过配置开关组件的事件，可以为开关组件添加丰富的交互功能，以增强用户体验和界面的互动性。</p>
<!-- @cols-width: 148,709 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<p>支持以下方法：</p>
<ul data-style="0">
<li>清除：清除组件的内容，使开关组件的状态恢复到默认状态。</li>
