...
<td>
<p>配置图片的来源，支持本地上传和通过工作流动态绑定图片数据。</p>
<ul data-style="0">
<li>本地上传：支持<code>jpg</code>、<code>png</code>格式，暂不支持<code>svg</code>。</li>
<li>绑定数据：鼠标悬浮绑定数据的编辑框，单击<strong>展开</strong>图标，选择要绑定的工作流。</li>
</ul>
</td>
</tr>
<tr>
...
<p>配置图片适应容器的方式。</p>
<ul data-style="0">
<li>覆盖：图片可能会被裁剪，确保容器内没有空白。</li>
<li>包含：图片不会被裁剪，可能会在容器内留有空白。</li>
<li>拉伸：图片的比例可能会失真。</li>
</ul>
</td>
</tr>
...
<td>
<p>打开支持大图的开关，用户点击缩略图时支持放大图片。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="f3256a6e" tabindex="-1">位置设置</h3>
<p>图片组件提供三种位置类型选项，以灵活配置组件在界面中的位置。</p>
<ul data-style="0">
<li>相对定位：堆叠布局下，元素自动向下或向右排列。</li>
<li>绝对定位：页面滚动时，绝对定位的元素会随页面一起滚动。</li>
<li>固定定位：页面滚动时，固定定位的元素会保持固定位置不变。</li>
</ul>
<h3 id="c3d2509e" tabindex="-1">尺寸设置</h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>打开固定比例开关，可以设置图片的比例，例如<code>16:9</code>、<code>3:2</code>等。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置图片的固定比例，支持<code>保持图片初始比例</code>、<code>16:9</code>、<code>3:2</code>、<code>4:3</code>、<code>1:1</code>、<code>9:16</code>、<code>2:3</code>、<code>3:4</code>。<br>
仅打开固定比例开关，才支持该参数配置。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置图片组件的尺寸限制，支持配置最大高度、最小高度、最大宽度、最小宽度。<br>
合理设置尺寸限制参数可以确保组件在不同屏幕尺寸下保持布局的稳定性和一致性，避免因屏幕尺寸差异而导致的布局问题。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="9d87411a" tabindex="-1"><strong>样式设置</strong></h3>
<!-- @cols-width: 140,712 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 140px;" /><col style="width: 712px;" /></colgroup><thead>
...
<td>
<p>配置图片组件背景的内边距，可以单独设置四个方向的内边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置图片组件背景的外边距，可以单独设置四个方向的外边距。</p>
</td>
</tr>
<tr>
<td>
...
<td>
<p>配置图片组件背景的阴影样式，增强组件的立体感。支持如下设置方式：</p>
<ul data-style="0">
...
<td>
<p>配置图片组件的模糊效果。数值越大，模糊效果越明显。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="f2deed4f" tabindex="-1">变换设置</h3>
<p>丰富界面视觉效果的参数。</p>
<!-- @cols-width: 138,707 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<td>
<p>配置图片组件在水平和垂直方向上的倾斜角度。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="ee66f567" tabindex="-1">状态设置</h3>
<p>控制图片组件点击态和出现态的视觉效果参数。</p>
<!-- @cols-width: 137,702 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
<colgroup><col style="width: 137px;" /><col style="width: 702px;" /></colgroup><thead>
<tr>
<th>
<p><strong>属性</strong></p>
</th>
...
<td>
<p>配置图片组件的点击态效果。具体配置说明如下：</p>
<ul data-style="0">
<li>样式效果：点击图片组件时，图片组件的样式变化情况。详细说明，请参考<a href="/guides/image_mini_program#9d87411a" target="_blank">样式设置</a>。</li>
<li>变换效果：点击图片组件时，图片组件的动态变化情况。详细说明，请参考<a href="/guides/image_mini_program#f2deed4f" target="_blank">变换设置</a>。</li>
<li>过渡效果：设置图片组件点击态的动画效果。
<ul data-style="1">
...
<td>
<p>设置图片组件在界面中出现时的动画效果。目前支持设置为淡入、缩放、模糊、水平翻转、垂直翻转、从下滑入、从上滑入、从左滑入、从右滑入等动画效果。</p>
</td>
</tr>
</tbody>
</table>
</div><h3 id="b7661b56" tabindex="-1"><strong>可见性设置</strong></h3>
<p>控制图片组件隐藏或显示的参数，支持在特定条件下隐藏图片组件。</p>
<ul data-style="0">
<li>设置为 false：显示组件。</li>
<li>设置为 true：隐藏组件。</li>
<li>设置为变量：通过变量值（true 或 false）动态控制图片组件的可见性。<br>
例如可以通过单行输入组件控制图片组件的可见性。单行输入组件 ID 为 <code>Input1</code>，当你将图片组件的<strong>可见性</strong>设置为<code>{{ Input1.value}}</code>后，在单行输入组件中输入文本时，<code>{{ Input1.value}}</code>值为 true，图片组件将被隐藏。</li>
</ul>
<h2 id="dcedbf08" tabindex="-1">事件设置</h2>
<p>通过配置图片组件的事件，可以为图片组件添加丰富的交互功能，例如点击、加载等，以增强用户体验和界面的互动性。</p>
<!-- @cols-width: 148,709 -->
<div class="topic-table-container">
<table class="topic-table-fixed">
...
<li>下载到本地：下载图片文件到本地。配置示例，请参考<a href="/guides/set_properties_events#42166c00" target="_blank">下载图片到本地</a>。</li>
</ul>
</td>
</tr>
</tbody>
</table>
</div></div><div class="container-ApkkZZ" data-topic-doc-footer="true"><div class="feedback-yTsEsj"><div class="feedbackTitle-UYegOR">文档对您有帮助吗?</div><div class="feedbackActions-hzIGU9"><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK "></span><span>有帮助</span></button><button type="button" class="feedbackButton-GuivRC "><span class="feedbackButtonIcon-PqHraK feedbackButtonIconDislike-FBH16L"></span><span>无帮助</span></button></div></div><div class="divider-sbHpm5"></div><div class="neighborList-cu6NCC"><a class="card-T4zaCm " href="/guides_audio" data-discover="true"><div class="cardLabel-sDu1uC "><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-left"><path d="M20.272 11.27 7.544 23.998l12.728 12.728M43 24H8.705"></path></svg><span>上一篇</span></div><div class="cardTitle-yINH12 ">音频</div></a><a class="card-T4zaCm nextCard-lFoioT" href="/guides_lottie_mini_program" data-discover="true"><div class="cardLabel-sDu1uC nextCardLabel-Qi4XVq"><span>下一篇</span><svg fill="none" stroke="currentColor" stroke-width="4" viewBox="0 0 48 48" aria-hidden="true" focusable="false" class="cardIcon-mIgMBZ arco-icon arco-icon-arrow-right"><path d="m27.728 11.27 12.728 12.728-12.728 12.728M5 24h34.295"></path></svg></div><div class="cardTitle-yINH12 nextCardTitle-cRAZDs">Lottie 动画</div></a></div></div></div><div class="container-PtuqqI" data-topic-anchor="true"><div class="arco-anchor"><div class="arco-anchor-list"><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="属性设置" href="#d6d8773b" data-href="#d6d8773b">属性设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="常用设置" href="#a39e2280" data-href="#a39e2280">常用设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="位置设置" href="#f3256a6e" data-href="#f3256a6e">位置设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="尺寸设置" href="#c3d2509e" data-href="#c3d2509e">尺寸设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="样式设置" href="#9d87411a" data-href="#9d87411a">样式设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="变换设置" href="#f2deed4f" data-href="#f2deed4f">变换设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="状态设置" href="#ee66f567" data-href="#ee66f567">状态设置</a></div><div class="arco-anchor-link" style="margin-left:20px"><a class="arco-anchor-link-title" title="可见性设置" href="#b7661b56" data-href="#b7661b56">可见性设置</a></div><div class="arco-anchor-link" style="margin-left:10px"><a class="arco-anchor-link-title" title="事件设置" href="#dcedbf08" data-href="#dcedbf08">事件设置</a></div></div></div></div></div></div></div></div>
</body></html>